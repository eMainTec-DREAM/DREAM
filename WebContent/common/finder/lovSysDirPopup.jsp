...
function initGrid()
{
	...
	if(listOfValForm.elements['listOfValDTO.multiSelect'].value == "Y")myGrid.enableMultiselect(true);
...
function findGridList()
{
	...
	form.strutsAction.value = '<%=ListOfValAction.LOV_SYS_DIR_FIND%>';
...
function goConfirm()
{
    ...
    if(spId.length != 1)
    {
    	...
    	for(var i in spId)
    	{
    		if(listOfValForm.elements['listOfValDTO.multiSelect'].value == "Y")
    		{
    			rtnOne.push(getValueById(myGrid, spId[i], 1));
    		}
    ...
    {
    	rtnOne = getValueById(myGrid, selectedId,1);
    	rtnTwo = htmlEnDeCode.htmlDecode(getValueById(myGrid, selectedId,2));
    }
    ...
    if(typeof ifm.setLovValue == "function") ifm.setLovValue(returnArray, dirType);
...
<BODY style="MARGIN: 0px" marginheight="0" marginwidth="0">
	...
	<html:form action="/listOfVal" >
		...
		<html:hidden property="listOfValDTO.multiSelect" />
