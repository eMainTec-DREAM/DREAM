<%--===========================================================================
List Of Value Popup
code, description 형태로 조회되는 사용자 코드 테이블
author  javaworker
version $Id: lovUsrDirPopup.jsp,v 1.3 2014/01/28 07:49:27 pochul2423 Exp $
since   1.0
===========================================================================--%>
...
function findGridList()
{
	...
	form.strutsAction.value = '<%=ListOfValAction.LOV_USR_DIR_FIND%>';
...
function goConfirm()
{
    ...
    {
    	rtnOne = getValueById(myGrid, selectedId,"code");
    	rtnTwo = getValueById(myGrid, selectedId,"description");
    }
