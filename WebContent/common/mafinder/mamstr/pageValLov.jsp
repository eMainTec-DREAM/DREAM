...
function initGrid()
{
	...
	setHeader(myGrid, "gridbox", "goSearch", "pageValLov"); // grid, grid id
}
...
function findGridList(sheetAction)
{
	...
	form.strutsAction.value = '<%=LovPageListAction.LOV_PAGE_AC_FIND%>';
	var url = contextPath + "/pageValLov.do";
	
	doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(form), "page_id", "Y");
}
