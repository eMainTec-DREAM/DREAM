...
%>
<!-- 기계이력관리시스템 -->
<div class="config_logo_box"><a href="javascript:goMenuPage('consult');"><h1><p><bean:message key='LABEL.cmms' /></p></h1></a></div>
<div class="tmenu_box">
	<!-- <span class="t_date"><%=tDate%></span>  -->
	<b class="t_name"><%=userName%></b> [<%=deptDesc%>] <bean:message key='LABEL.topMenuMsg01'/>
	<span>ㅣ</span><a href="javascript:goLogOut('<%=ConsultAction.LOGOUT%>');"><b><bean:message key='LABEL.logout'/></b></a>
</div>