...
1개 파일 파일첨부
author  jung7126
version $Id: fileUpload3.jsp,v 1.3 2014/02/06 07:52:41 javaworker Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 파일관리 -->
<title><bean:message key="fileUpload3.title"/></title>
...
function loadPage() 
{	
	if (fileUploadForm.strutsAction.value == "<%=FileUploadAction.USER_FILE_UPLOAD_SAVE%>")
	{	
...
function goSave()
{
	...
	fileUploadForm.strutsAction.value = "<%=FileUploadAction.USER_FILE_UPLOAD_SAVE%>";
	fileUploadForm.action = contextPath + "/fileUpload3.do";
