...
<div class="nav_box scrollbar-inner" align="left" style="min-height: 350px;">
	<ul>
		<li>
			...
			<div id="mainMenu" class="smb" style="height:auto;">
				<div class="tree_box">
					<ul>
					<%
						// 넘겨진 Menu가 0 보다 큰경우
					...
					%>
									...
									<li id="TD_SUB_MENU_<%=subMenuId%>"><a class="<%=isParent%> <%=selected%>" id="<%=subMenuId%>"><bean:message key="${subMenuKeyType}.${subMenuKeyNo}"/></a>
									...
									if(subMenuList.size() > 0)	
									{
										...
										%>
											...
											<li id="TD_SUB_MENU_<%=subMenuId2%>">
												<a class="m_child <%=selected2%>" id="<%=subMenuId2%>"><bean:message key="${subMenuKeyType2}.${subMenuKeyNo2}"/></a>
											</li>
