...
{
	if(buttonId == "create" && parent.currentPageId == 'maWoDailyLibList')
	{
		$('.b_create').hide();
	}
}
...
{
    var url = contextPath + "/maWoDailyLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoDailyLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoDailyLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "maWoDailyLibDetail");
}
...
{
	goClose('maWoDailyLibDetail', this);
	//goSearch();
...
<html:form action="/maWoDailyLibList.do">
