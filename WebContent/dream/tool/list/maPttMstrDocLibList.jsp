...
{
    var url = contextPath + "/maPttMstrDocLibList.do";
...
function goOpen()
{
	goTabPage('maPttMstrDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maPttMstrDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maPttMstrDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maPttMstrDocLibDetail', this);
	//goSearch();
...
<html:form action="/maPttMstrDocLibList.do">
