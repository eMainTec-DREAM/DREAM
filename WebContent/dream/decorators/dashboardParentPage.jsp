...
<link rel="shortcut icon" href="<c:url value="/common/images/${ctPath}/favicon_mware.ico" />" type="image/x-icon" />
<link rel="icon" href="<c:url value="/common/images/${ctPath}/favicon_mware.ico" />" type="image/x-icon" />
