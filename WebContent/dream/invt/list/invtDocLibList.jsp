...
function initGrid()
{
	...
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("invtDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
...
{
    var url = contextPath + "/invtDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'invtDocLibDetail'); 
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "invtDocLibDetail" , "goCreateAction");
}
...
function goExcel()
{
	//excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("invtDocLibList", maDocLibListForm );  
}
...
<html:form action="/invtDocLibList.do">
