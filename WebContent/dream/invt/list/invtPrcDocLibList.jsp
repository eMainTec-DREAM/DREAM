...
function initGrid()
{
	...
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("invtPrcDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
...
{
    var url = contextPath + "/invtPrcDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'invtPrcDocLibDetail'); 
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "invtPrcDocLibDetail" , "goCreateAction");
}
...
{
	goClose('invtPrcDocLibDetail', this);
	//goSearch();
...
function goExcel()
{
	//excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("invtPrcDocLibList", maDocLibListForm );  
}
...
<html:form action="/invtPrcDocLibList.do">
