...
function goOpen()
{
	goTabPage('invtPrcTpDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'invtPrcTpDocLibDetail'); 
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "invtPrcTpDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "invtPrcTpDocLibDetail");
}
...
{
	goClose('invtPrcTpDocLibDetail', this);
	//goSearch();
