...
구매절차 첨부문서 Item 목록
author  hyosung
version $Id: maDocLibList.jsp,v 1.1 2015/12/03 01:45:27 hyosung Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/invtPrcTpItemDocLibList.do";
...
function goOpen()
{
	goTabPage('invtPrcTpItemDocLibDetail');
}
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'invtPrcTpItemDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "invtPrcTpItemDocLibDetail" , "goCreateAction");
}
...
{
	goClose('invtPrcTpItemDocLibDetail', this);
	//goSearch();
...
<html:form action="/invtPrcTpItemDocLibList.do">
