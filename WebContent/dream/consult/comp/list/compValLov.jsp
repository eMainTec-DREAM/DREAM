...
{
	consultCompListLovForm.elements['strutsAction'].value = '<%=ConsultCompListLovAction.LOV_COMP_AC_FIND%>';
    var url = contextPath + "/compValLov.do";
	
	doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(consultCompListLovForm), "COMP_NO");
...
<html:hidden property="consultCompListLovDTO.code" />
            ...
            <div class="article_box">
                <div class="form_box">
                    <div class="field">
                        ...
                        <div class="input_box">
                            <html:text property="consultCompListLovDTO.compNo" />
                        </div>
                    </div>
                    <div class="field">
                        <!-- 회사명 -->
