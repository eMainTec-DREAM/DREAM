...
function initGrid()
{
	...
	setHeader(myGrid, "gridbox", "goSearch", "lovWhList"); // grid, grid id
}
...
function findGridList()
{
	...
	form.strutsAction.value = '<%=LovWhListAction.LOV_WH_FIND%>';
...
{	
    ...
    returnArray[0] = getValueById(myGrid, selectedId,"wcodeId"); // ID
    returnArray[1] = getValueById(myGrid, selectedId,"wname"); // wname
    returnArray[2] = getValueById(myGrid, selectedId,"whType"); // 창고분류
    returnArray[3] = getValueById(myGrid, selectedId,"outWcode"); // ERP 창고코드
    returnArray[4] = getValueById(myGrid, selectedId,"outPlant"); // ERP 플랜트코드
//     returnArray[2] = getValueById(myGrid, selectedId,2); // wname
	

	var dirType = lovWhListForm.elements['lovWhListDTO.codeType'].value;
