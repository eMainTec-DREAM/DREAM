...
{
    var url = contextPath + "/maWrkImpDocLibList.do";
...
function goOpen()
{
	goTabPage('maWrkImpDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maWrkImpDocLibDetail'); 
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWrkImpDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWrkImpDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWrkImpDocLibList.do">
