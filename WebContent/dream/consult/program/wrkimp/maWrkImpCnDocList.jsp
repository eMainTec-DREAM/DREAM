...
<%@ page import="dream.consult.program.wrkimp.action.MaCnDocListAction" %>
...
function initGrid()
{
	...
	//Inner Page
	if(maDocLibListForm.elements['strutsAction'].value == '<%=MaCnDocListAction.BASE_QUICK_SEARCH%>')
	{
...
function findGridList(sheetAction)
{
    ...
    maDocLibListForm.elements['strutsAction'].value = '<%=MaCnDocListAction.DOCLIB_LIST_FIND%>';
...
function goTabPageAction(pageId, selectedId)
{
	...
	goCommonTabPage(maDocLibListForm, '<%=MaCnDocDetailAction.DOCLIB_DETAIL_INIT%>', pageId);
}
...
function goCreate()
{
	createValidationCheck(myGrid, "maWrkImpCnDocDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	maDocLibListForm.strutsAction.value = '<%=MaCnDocListAction.DOCLIB_LIST_DELETE%>';
	var url = contextPath + "/maWrkImpCnDocList.do";
...
{
	goClose('maWrkImpCnDocDetail', this);
	//goSearch();
...
<html:form action="/maWrkImpCnDocList.do">
