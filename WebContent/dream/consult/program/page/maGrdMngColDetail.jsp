...
칼럼 상세 
author  jung7126
version $Id: maGrdMngColDetail.jsp,v 1.0 2015/12/04 07:26:18 jung7126 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
	...
	acSysDesc("maGrdMngColDetailDTO.displayYn","maGrdMngColDetailDTO.displayYn","IS_USE", true);
}
...
<html:form action="/maGrdMngColDetail.do">
               	   ...
               	   <div class="field">
		               <label><bean:message key="LABEL.columnDesc"/></label>
	               	   <div class="input_box">
								...
								onblur="valLang('maGrdMngColDetailDTO.keyType', 'maGrdMngColDetailDTO.keyNo','maGrdMngColDetailDTO.columnDesc', true);"/>
							<p class="open_spop">
								<a href="javascript:lovLang('maGrdMngColDetailDTO.keyType','maGrdMngColDetailDTO.keyNo','maGrdMngColDetailDTO.columnDesc');">
									<span>조회</span>
								</a>
							</p>
	               	   </div>
               	   ...
               	   <div class="field">
		               <label><bean:message key="LABEL.columnType"/></label>
	               	   <div class="input_box">
							...
							onblur="valSysDir('maGrdMngColDetailDTO.type', 'maGrdMngColDetailDTO.typeDesc', 'COLUMN_TYPE', true);"/>
						<p class="open_spop">
							<a href="javascript:lovSysDir('maGrdMngColDetailDTO.type', 'maGrdMngColDetailDTO.typeDesc','COLUMN_TYPE');">
								<span>조회</span>
							</a>
						</p>
	               	   </div>
				...
				<div class="field">
	               <label class="check"><bean:message key="LABEL.align"/></label>
               	   <div class="input_box">
							...
							onblur="valSysDir('maGrdMngColDetailDTO.align', 'maGrdMngColDetailDTO.alignDesc', 'ALIGN_TYPE', true);"/>
						<p class="open_spop">
							<a href="javascript:lovSysDir('maGrdMngColDetailDTO.align', 'maGrdMngColDetailDTO.alignDesc','ALIGN_TYPE');">
								<span>조회</span>
							</a>
						</p>
               	   </div>
				...
				<div class="field">
	               <label><bean:message key="LABEL.hidden"/></label>
               	   <div class="input_box">
	                        ...
	                        onblur="valYn('maGrdMngColDetailDTO.hidden', true);"/>
	                    <p class="open_spop">
	                        <a href="javascript:lovTable('maGrdMngColDetailDTO.hidden', 'maGrdMngColDetailDTO.hidden','YN');">
	                            <span>조회</span>
	                        </a>
	                    </p>
               	   </div>
				...
				<div class="field">
	               <label><bean:message key="LABEL.systemCol"/></label>
               	   <div class="input_box">
	                        ...
	                        onblur="valYn('maGrdMngColDetailDTO.systemCol', true);"/>
	                    <p class="open_spop">
	                        <a href="javascript:lovTable('maGrdMngColDetailDTO.systemCol', 'maGrdMngColDetailDTO.systemCol','YN');">
	                            <span>조회</span>
	                        </a>
	                    </p>
               	   </div>
