...
목록
author  kim21017
version $Id: maPgMngGrdColList.jsp,v 1.1 2015/12/03 01:45:27 jung7126 Exp $
since   1.0
===========================================================================--%>
...
function goCreate()
{
 	createValidationCheck(myGrid, "maPgMngGrdColDetail" , "goCreateAction");
}
...
<html:form action="/maPgMngGrdColList.do">
