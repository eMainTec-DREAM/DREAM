...
function initGrid()
{
	...
	myGrid.init();
	setHeader(myGrid, "gridbox", "goSearch","menuValLov"); // grid, grid id
...
{
    var form = document.lovMenuListForm;	
	form.strutsAction.value = '<%=LovMenuListAction.LOV_MENU_AC_FIND%>';
	var url = contextPath + "/menuValLov.do";
