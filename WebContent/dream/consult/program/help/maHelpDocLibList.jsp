...
{
    var url = contextPath + "/maHelpDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maHelpDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maHelpDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maHelpDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maHelpDocLibList", maDocLibListForm );
}
...
<html:form action="/maHelpDocLibList.do">
