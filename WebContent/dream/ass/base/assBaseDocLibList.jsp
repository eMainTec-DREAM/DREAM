...
첨부문서 - 목록
author  kim21017
version $Id: assBaseDocLibList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/assBaseDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'assBaseDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "assBaseDocLibDetail" , "goCreateAction");
}
...
{
	goClose('assBaseDocLibDetail', this);
	//goSearch();
...
<html:form action="/assBaseDocLibList.do">
