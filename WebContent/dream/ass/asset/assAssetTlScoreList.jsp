...
<head>
<!-- 평가점수 -->
<title><bean:message key='TAB.assAssetTlScoreList'/></title>
	...
	myGrid.enableSmartRendering(true,500);
	   ...
	   myGrid.attachEvent("onCellMarked", function(rowId,columnId){
	    ...
	    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
	        ...
	        return sortColumn("assAssetTlScoreList", this, assAssetScoreListForm, "EQASSPVALID", ind, direction);
	    });
...
function goEdit()
{
    ...
    goClose("assAssetTlScoreDetail", this);
	...
	var url = contextPath + "/assAssetTlScoreList.do";
...
function goTabPageAction(pageId, selectedId)
{
	...
	goCommonTabPage(assAssetScoreListForm, <%= AssAssetScoreDetailAction.DETAIL_INIT %>, "assAssetTlScoreDetail");
}
/**
 * 상세열기
 */
function goOpen()
{
	goTabPage('assAssetTlScoreDetail');
}
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(assAssetScoreListForm), 'assAssetTlScoreDetail'); 
} 
...
function goCreate()
{
 	createValidationCheck(myGrid, "assAssetTlScoreDetail" , "goCreateAction");
}
...
{
	assAssetScoreListForm.elements['assAssetScoreListDTO.eqAssPValId'].value = "";
    excelServerAction("assAssetTlScoreList", assAssetScoreListForm );  
}
//-->
</script>
...
<html:form action="/assAssetTlScoreList.do">
