...
function goSave()
{
	...
	var actionUrl = contextPath + "/assAssetScoreDetail.do";
...
{
	var objectId = assAssetScoreDetailForm.elements['assAssetScoreDetailDTO.eqAssPValId'].value;
...
<html:form action="/assAssetScoreDetail.do" >
