...
/** 자동완성 변수 */
var eqLocAc, empAc, equipAc, pEquipAc, deptAc, plantAc;


function loadPage() 
{
	assAssetListForm.elements['assAssetCommonDTO.eqCtgType'].value = "TL"; 
	...
	// 상위설비 자동완성 
	pEquipAc = new autoC({"assAssetCommonDTO.filterParEquipDesc":"description"});
	pEquipAc.setTable("TAEQUIPMENT");
	pEquipAc.setAcResultMap({
        "assAssetCommonDTO.filterParEquipId":"EQUIP_ID"
    });
	pEquipAc.setAcDConditionMap({
    	"eqloc_id" : "assAssetCommonDTO.filterParEqLocId"
    });
	pEquipAc.init();
	
	// 상위설비위치 자동완성
    eqLocAc = new autoC({"assAssetCommonDTO.filterParEqLocDesc":"full_desc"});
    eqLocAc.setTable("TAEQLOC");
    eqLocAc.setAcConditionMap({
    	"comp_no":loginUser.compNo
    })
    eqLocAc.setAcResultMap({
        "assAssetCommonDTO.filterParEqLocId":"EQLOC_ID"
    });
    eqLocAc.init();
	...
	// 설비사용부서 
	deptAc = new autoC({"assAssetCommonDTO.filterParUsageDeptDesc":"description"});
    deptAc.setAcConditionMap({
    	"comp_no":loginUser.compNo
	});
    deptAc.setTable("TADEPT");
    deptAc.setAcResultMap({
        "assAssetCommonDTO.filterParUsageDeptId":"dept_id"
    });
    deptAc.init();
    /*deptAc = new autoC({"assAssetCommonDTO.filterParUsageDeptDesc":"description"});
    deptAc.setTable("TADEPT");
...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("assAssetTlList", this, assAssetListForm, "EQASSLISTID", ind, direction);
    });
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(assAssetListForm), 'assAssetTlDetail'); 
} 
...
function goCreate()
{
    createValidationCheck(myGrid, "assAssetTlDetail" , "goCreateAction");
...
{
	assAssetListForm.elements['assAssetCommonDTO.eqasslistId'].value = "";
    excelServerAction("assAssetTlList", assAssetListForm );  
}
...
<html:form action="/assAssetTlList.do">
...
<html:hidden property="assAssetCommonDTO.filterParEquipId"/>            <!-- 상위설비ID -->
<html:hidden property="assAssetCommonDTO.filterParEqLocId"/>            <!-- 상위설비위치ID -->
<html:hidden property="assAssetCommonDTO.filterParUsageDeptId"/>        <!-- 설비사용부서ID -->
        ...
        <div class="article_box">
            <div class="form_box">
                ...
                <div class="field">
                    ...
                    <div class="input_box">
                        <html:text property="assAssetCommonDTO.filterParEquipDesc" tabindex="30"/>
                        <p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
                ...
                <div class="field">
                    ...
                    <div class="input_box">
                        <html:text property="assAssetCommonDTO.filterParEqLocDesc" tabindex="40"/>
                        <p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
                ...
                <div class="field">
                    ...
                    <div class="input_box">
                        <html:text property="assAssetCommonDTO.filterParUsageDeptDesc" tabindex="45"/>
                        <p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
                ...
                <!-- 계측기 -->
                <div class="field">
                    <label><bean:message key="LABEL.eqTool"/></label>
                    <div class="input_box">
                        <html:text property="assAssetCommonDTO.filterEquipDesc" tabindex="65"/>
                        <p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
