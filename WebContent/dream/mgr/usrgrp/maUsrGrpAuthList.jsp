...
{
    var url = contextPath + "/maUsrGrpAuthList.do";
    maUsrGrpAuthListForm.elements['maUsrGrpCommonDTO.filterServiceType'].value = "WEB";
...
function goSearch()
{
	maUsrGrpAuthListForm.elements['maUsrGrpCommonDTO.menuId'].value = "";
...
function goPmstd()
{
	...
	if(pageId == "") {
		alertMessage1("<bean:message key='MESSAGE.MSG0274'/>");
		return;
	}
