...
{
    var url = contextPath + "/reqInvRecWorkDocLibList.do";
...
function goOpen()
{
	goTabPage('reqInvRecWorkDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'reqInvRecWorkDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "reqInvRecWorkDocLibDetail" , "goCreateAction");
}
...
{
	goClose('reqInvRecWorkDocLibDetail', this);
	//goSearch();
...
<html:form action="/reqInvRecWorkDocLibList.do">
