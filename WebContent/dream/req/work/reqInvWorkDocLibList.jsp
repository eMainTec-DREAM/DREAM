...
{
    var url = contextPath + "/reqInvWorkDocLibList.do";
...
function goOpen()
{
	goTabPage('reqInvWorkDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'reqInvWorkDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "reqInvWorkDocLibDetail" , "goCreateAction");
}
...
{
	goClose('reqInvWorkDocLibDetail', this);
	//goSearch();
...
<html:form action="/reqInvWorkDocLibList.do">
