...
첨부문서 - 목록
author  jung7126
version $Id: reqWorkDocLibList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'reqWorkDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "reqWorkDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "reqWorkDocLibDetail");
}
...
<html:form action="/reqWorkDocLibList.do">
...
<html:hidden property="maDocLibCommonDTO.description" />
	...
	<c:set var="filePath" value="enhance/${compName}/req/work/reqWorkDocLibList_${compNo}.jsp" />
	<c:if test="${udf:isExist(filePath)}">
		<c:import charEncoding="UTF-8" url="/enhance/${compName}/req/work/reqWorkDocLibList_${compNo}.jsp"></c:import>
	</c:if>
</html:form>
</body>
</html>