...
{
    var url = contextPath + "/maQnaDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maQnaDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maQnaDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maQnaDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maQnaDocLibList", maDocLibListForm );
}
...
<html:form action="/maQnaDocLibList.do">
