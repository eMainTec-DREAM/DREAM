...
{
    var url = contextPath + "/maQnaAnsDocLibList.do";
...
function goOpen()
{
	goTabPage('maQnaAnsDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maQnaAnsDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maQnaAnsDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maQnaAnsDocLibDetail', this);
	//goSearch();
...
<html:form action="/maQnaAnsDocLibList.do">
