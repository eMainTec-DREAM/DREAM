...
{
    var url = contextPath + "/rcmPmtaskDocLibList.do";
...
function goOpen()
{
	goTabPage('rcmPmtaskDocLibDetail');
}
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'rcmPmtaskDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "rcmPmtaskDocLibDetail" , "goCreateAction");
}
...
{
	goClose('rcmPmtaskDocLibDetail', this);
	//goSearch();
...
<html:form action="/rcmPmtaskDocLibList.do">
