...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("rcmPmtaskCrityDetail");
	});
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
		rcmFmeaCrityListForm.elements['rcmFmeaCrityListDTO.rcmcrityId'].value = "";
	   	return sortColumn("rcmPmtaskCrityList", this, rcmFmeaCrityListForm, "rcmcrityId", ind, direction);
	});
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/rcmPmtaskCrityList.do";
...
function goOpenAction()
{
	...
	rcmFmeaCrityListForm.elements['rcmFmeaCrityListDTO.rcmcrityId'].value = getValueById(myGrid, selectedId,'rcmcrityId');
	rcmFmeaCrityListForm.elements['strutsAction'].value = '<%=RcmFmeaCrityDetailAction.RCM_FMEA_DETAIL_INIT%>';
    openQuickTabPage(FormQueryString(rcmFmeaCrityListForm),'rcmPmtaskCrityDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "rcmPmtaskCrityDetail" , "goCreateAction");
}
...
<html:form action="/rcmPmtaskCrityList.do">
...
<html:hidden property="rcmFmeaCrityListDTO.crityvalueId"/>
    <!-- searchbox 박스 Line -->
