...
{
    var url = contextPath + "/rcmFmeaDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'rcmFmeaDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "rcmFmeaDocLibDetail" , "goCreateAction");
}
...
{
	goClose('rcmFmeaDocLibDetail', this);
	//goSearch();
...
<html:form action="/rcmFmeaDocLibList.do">
