...
var empAc, deptAc, docCategDescAc;
...
function initGrid()
{
	...
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	...
    	return sortColumn("rcmSysDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
	});
	...
	// 등록자 자동완성
	empAc = new autoC({"maDocLibCommonDTO.regDesc":"emp_name"});
    empAc.setTable("TAEMP");
    empAc.setAcResultMap({
        "maDocLibCommonDTO.regId":"emp_id"
    });
    empAc.setKeyName("maDocLibCommonDTO.regId");
    empAc.init();
    ...
    deptAc.setKeyName("maDocLibCommonDTO.regDeptId");
...
{
    var url = contextPath + "/rcmSysDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'rcmSysDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "rcmSysDocLibDetail" , "goCreateAction");
}
...
{
	goClose('rcmSysDocLibDetail', this);
	//goSearch();
...
<html:form action="/rcmSysDocLibList.do">
