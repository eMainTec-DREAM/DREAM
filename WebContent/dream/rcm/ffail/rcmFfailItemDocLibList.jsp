...
function goOpen()
{
	goTabPage('rcmFfailItemDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'rcmFfailItemDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "rcmFfailItemDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "rcmFfailItemDocLibDetail");
}
...
{
	goClose('rcmFfailItemDocLibDetail', this);
	//goSearch();
