...
function goOpen()
{
	goTabPage('rcmFfailDocLibDetail');
}
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'rcmFfailDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "rcmFfailDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "rcmFfailDocLibDetail");
}
...
{
	goClose('rcmFfailDocLibDetail', this);
	//goSearch();
