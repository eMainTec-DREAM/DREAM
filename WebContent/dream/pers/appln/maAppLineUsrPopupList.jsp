...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maAppLineUsrPopupDetail");
	});
...
function findGridList(sheetAction)
{
	...
	doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(maAppLineUsrListForm), "apprlineusrId");
...
function goTabPageAction(pageId, selectedId)
{
	...
	goCommonTabPage(form, <%=MaAppLineUsrDetailAction.QNA_ANS_DETAIL_INIT %>, pageId);
...
function goCreate()
{
	createValidationCheck(myGrid, "maAppLineUsrPopupDetail" , "goCreateAction");
}
...
function afterDelete(){
	goClose('maAppLineUsrPopupDetail');
	//goSearch();
