...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'certEmpDocLibDetail'); 
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "certEmpDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/certEmpDocLibList.do";
...
{
	goClose('certEmpDocLibDetail', this);
	//goSearch();
...
<html:form action="/certEmpDocLibList.do">
