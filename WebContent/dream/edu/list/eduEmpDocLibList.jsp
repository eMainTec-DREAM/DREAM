...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'eduEmpDocLibDetail'); 
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "eduEmpDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/eduEmpDocLibList.do";
...
{
	goClose('eduEmpDocLibDetail', this);
	//goSearch();
...
<html:form action="/eduEmpDocLibList.do">
