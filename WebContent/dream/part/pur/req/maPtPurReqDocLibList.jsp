...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maPtPurReqDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
	//Inner Page
...
{
    var url = contextPath + "/maPtPurReqDocLibList.do";
...
function goOpen()
{
	goTabPage('maPtPurReqDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maPtPurReqDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maPtPurReqDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maPtPurReqDocLibDetail', this);
	//goSearch();
...
<html:form action="/maPtPurReqDocLibList.do">
