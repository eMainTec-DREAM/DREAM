...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maPtDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maPtDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "maPtDocLibDetail");
}
