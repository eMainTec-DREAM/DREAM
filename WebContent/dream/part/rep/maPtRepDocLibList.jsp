...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maPtRepDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
	//Inner Page
...
{
    var url = contextPath + "/maPtRepDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maPtRepDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maPtRepDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maPtRepDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maPtRepDocLibList", maDocLibListForm );
}
...
<html:form action="/maPtRepDocLibList.do">
