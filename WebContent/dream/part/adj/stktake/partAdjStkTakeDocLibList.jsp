...
{
    var url = contextPath + "/partAdjStkTakeDocLibList.do";
...
function goOpen()
{
	goTabPage('partAdjStkTakeDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'partAdjStkTakeDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "partAdjStkTakeDocLibDetail" , "goCreateAction");
}
...
{
	goClose('partAdjStkTakeDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("partAdjStkTakeDocLibList", maDocLibListForm);
}
...
<html:form action="/partAdjStkTakeDocLibList.do">
...
<html:hidden property="maDocLibCommonDTO.description" />
    ...
    <div class="section_wrap hideFilter">
	 ...
	 <div class="section_wrap">
		...
		<c:set var="filePath" value="enhance/${compName}/part/adj/stktake/partAdjStkTakeDocLibList_${compNo}.jsp" />
		<c:if test="${udf:isExist(filePath)}">
			<c:import charEncoding="UTF-8" url="/enhance/${compName}/part/adj/stktake/partAdjStkTakeDocLibList_${compNo}.jsp"></c:import>
		</c:if>
