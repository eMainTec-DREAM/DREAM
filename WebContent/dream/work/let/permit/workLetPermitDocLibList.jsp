...
<head>
<!-- 첨부문서 -->
<title><bean:message key='TAB.maDocLibList'/></title>
...
function initGrid()
{
	...
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
...
function goOpen()
{
	goTabPage('workLetPermitDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workLetPermitDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "workLetPermitDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "workLetPermitDocLibDetail");
}
...
<html:form action="/workLetPermitDocLibList.do">
