...
{
    var url = contextPath + "/workRptMaintRateDetailByPartList.do";
    workRptMaintRateListForm.elements['strutsAction'].value = '<%=WorkRptMaintRateDetailAction.PART_DETAIL_FIND%>';
...
<html:form action="/workRptMaintRateDetailByPartList.do">
