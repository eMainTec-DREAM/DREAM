...
첨부문서 - 목록
author  youngjoo38
version $Id: workListDocLibList.jsp,v 1.1 2017/09/19 01:45:27 youngjoo38 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/workListDocLibList.do";
...
function goOpen()
{
	goTabPage('workListDocLibDetail');
}

function goOpenAction()
{
    //openQuickTabPage(FormQueryString(maDocLibListForm),'workListDocLibDetail');
...
function goCreate()
{
	createValidationCheck(myGrid, "workListDocLibDetail" , "goCreateAction");
}
...
{
	goClose('workListDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("workListDocLibList",maDocLibListForm);
}
...
<html:form action="/workListDocLibList.do">
