...
작업결과(월간작업일정) 검사항목
author  kim21017
version $Id: maWoResultMonthPointDetail.jsp,v 1.0 2015/12/04 07:26:18 kim21017 Exp $
since   1.0
===========================================================================--%>
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPointDetailDTO.resultValue" tabindex="20" styleClass="num" />
				</div>
			</div>
			<!-- 검사세부내용 -->
			<div class="field_long">
