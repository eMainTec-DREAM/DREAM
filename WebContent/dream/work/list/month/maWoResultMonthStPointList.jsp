<%--===========================================================================
작업결과(월간작업일정) 필수항목 검사항목
author  kim21017
version $Id: maWoResultMonthStPointList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultMonthStPointDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	maWoResultStPointListForm.elements['maWoResultStPointListDTO.woStPointId'].value = "";
        return sortColumn("maWoResultStPointList", this, maWoResultStPointListForm, "WOSTPOINTID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(maWoResultStPointListForm), "WOSTPOINTID", "Y");
 ...
 */
  ...
  */
  ...
  {
	maWoResultStPointListForm.elements['maWoResultStPointListDTO.woStPointId'].value = "";
  	excelServerAction("maWoResultStPointList",maWoResultStPointListForm);
  } 
  /**
   * 생성
   */
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultMonthStPointDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultMonthStPointDetail',this);
	//goSearch();
