...
작업결과 - 상세
author  kim21017
version $Id: maWoResultMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
	...
	else 
	{
		...
		if(maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woTypeId'].value=="PMI"){
			goTabPage("maWoResultPointList");
			goTabPage("maWoResultCraftList");
			
		}else if(maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woTypeId'].value=="PMW"){
			goTabPage("maWoResultPartList");
			goTabPage("maWoResultCraftList");
		}else{
			goTabPage("maWoResultFailDetail");
			goTabPage("maWoResultCraftList");
		}
	}
...
function goInput()
{
	...
	var selectedWoType = maWoResultMstrDetailForm.elements['maPmMstrCommonDTO.selectedWoType'].value;
	var selectedPmType = maWoResultMstrDetailForm.elements['maPmMstrCommonDTO.selectedPmType'].value;
	//작업종류 
 ...
 */
 ...
 function afterConfirm(ajaxXmlDoc)
 {
	...
	if(parent.currentPageId == "maBdPointWoRsltList"){
	    if(parent.parent.parent.goTabPage){
	    	parent.parent.parent.goTabPage(parent.parent.currentPageId);
	    }
	}
		...
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box" id="equipDiv">
					<html:text property="maWoResultMstrDetailDTO.equipDesc" tabindex="50" />
			...
			<div class="field">
				...
				<div class="input_read" id="eqLocDescDiv">
					<html:text property="maWoResultMstrDetailDTO.eqLocDesc" tabindex="60" readonly="true"/>
				</div>
			</div>
			<!-- 설비코드 -->
			<div class="field">
			...
			<div class="field_long">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.wkOrDesc" tabindex="70" />
				</div>
			</div>
			<!-- 작업일자 -->
			<div class="field">
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					...
					<div class="input_box">
						<html:text property="maWoResultMstrDetailDTO.startTime"   tabindex="130"/>
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultMstrDetailDTO.endDate" tabindex="140" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultMstrDetailDTO.endTime" tabindex="150" />
						<p class="open_time"><span>시간</span></p>
					</div>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.selfVendorTypeDesc" tabindex="170" />
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 거래처 -->
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorDesc" tabindex="180" />
                    <p class="open_spop">
                        <a>
                            <span>조회</span>
                        </a>
			...
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorName" tabindex="183" />
                </div>
			</div>
			<!-- 금액 -->
			<div class="field" id="amtDiv">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.totAmt" tabindex="185" styleClass="num"/>
				</div>
			</div>
			<!-- 확정자 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="186" readonly="true" />
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="187" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="188" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="189"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
