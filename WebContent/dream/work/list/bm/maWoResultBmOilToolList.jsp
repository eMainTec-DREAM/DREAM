...
투입공기구 목록
author  kim21017
version $Id: maWoResultBmOilToolList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultBmOilToolDetail");
	});
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/maWoResultBmOilToolList.do";
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultToolListForm), 'maWoResultBmOilToolDetail'); 
  ...
  */
  ...
  {
	maWoResultToolListForm.elements['maWoResultToolListDTO.woToolId'].value = "";
  	excelServerAction("maWoResultBmOilToolList", maWoResultToolListForm);
  } 
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultBmOilToolDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultBmOilToolDetail',this);
	//goSearch();
...
<html:form action="/maWoResultBmOilToolList.do">
