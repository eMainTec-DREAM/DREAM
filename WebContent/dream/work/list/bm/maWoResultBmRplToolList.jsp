...
투입공기구 목록
author  kim21017
version $Id: maWoResultBmRplToolList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultBmRplToolDetail");
	});
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/maWoResultBmRplToolList.do";
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultToolListForm), 'maWoResultBmRplToolDetail'); 
  ...
  */
  ...
  {
	maWoResultToolListForm.elements['maWoResultToolListDTO.woToolId'].value = "";
	  excelServerAction("maWoResultBmRplToolList", maWoResultToolListForm);
  } 
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultBmRplToolDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultBmRplToolDetail',this);
	//goSearch();
...
<html:form action="/maWoResultBmRplToolList.do">
