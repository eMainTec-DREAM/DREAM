...
작업결과(고장작업-윤활) 투입자재
author  kim21017
version $Id: maWoResultBmOilPartList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultBmOilPartDetail");
	});
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultBmOilPartDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultBmOilPartDetail',this);
	//goSearch();
...
function goSave(){
	...
	{
		var url = contextPath + "/maWoResultBmOilPartList.do";
...
<html:hidden property="maWoResultPartDetailDTO.multiIssDesc"/><!-- MultiSelect Iss Desc -->
    ...
    <div class="article_box" id="listBox">
 	...
 	<c:set var="filePath" value="enhance/${compName}/work/list/bm/maWoResultBmOilPartList_${compNo}.jsp" />
	<c:if test="${udf:isExist(filePath)}">
		<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/bm/maWoResultBmOilPartList_${compNo}.jsp"></c:import>
	</c:if>
