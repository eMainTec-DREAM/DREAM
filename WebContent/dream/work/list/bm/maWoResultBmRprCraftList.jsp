...
작업결과(고장작업-수리) 작업자
author  kim21017
version $Id: maWoResultBmRprCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultBmRprCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultBmRprCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultBmRprCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultBmRprCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultBmRprCraftList.do";
