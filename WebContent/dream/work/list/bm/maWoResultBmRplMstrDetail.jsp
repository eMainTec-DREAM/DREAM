...
작업결과 - 상세(고장작업-교체)
author  kim21017
version $Id: maWoResultBmRplMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
    ...
    /* subEmpAc.setAcDConditionMap({
    	"dept_id" : "maWoResultMstrDetailDTO.deptId"
    }); 20191016 담당자의 부서를 생산담당자 조회조건에 넣으면 안됨*/ 
    subEmpAc.init();
 ...
 */
 function goConfirm(){
	 ...
	 else
	 {
		   ...
		   maWoResultMstrDetailForm.strutsAction.value = '<%=MaWoResultMstrDetailAction.WO_RESULT_SERIAL_COUNT%>';
		   $.post(url,FormQueryString(maWoResultMstrDetailForm) , function(_data){
			   setValidSerialCount(_data);
		    });
		 
	 }
}

function setValidSerialCount(cnt)
{
	if(cnt != 0)
	{
		// 시리얼 자재의 사용수량과 시리얼 수량은 같아야 합니다.
        alertMessage1("<bean:message key='MESSAGE.MSG0171' />");
    	return;
	}
...
/**
 ...
 function afterApproval()
 {
	...
	goClose('maWoResultBmRplMstrDetail');
 }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isDraft" tabindex="107"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="198" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="199" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
