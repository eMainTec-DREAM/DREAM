...
작업결과 - 목록
author  kim21017
version $Id: maWoResultBmMstrList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<%@ page import="common.spring.BaseJdbcDaoSupportSql"%>
<%
...
<head>
<!-- 작업결과 -->
<title><bean:message key='MENU.WOBMRESULT'/></title>
...
/*      if(loginUser.wkctrId!='null'){
    ...
    acSysDesc("maWoResultMstrCommonDTO.filterPmTypeDesc","maWoResultMstrCommonDTO.filterPmTypeId",'BM_TYPE');
    ...
    caCdDesc = new autoC({"maWoResultMstrCommonDTO.filterCaCdDesc":"failureDesc"});
    ...
    caCdDesc.setKeyName("maWoResultMstrCommonDTO.filterCaCd");
    caCdDesc.setAcResultMap({
        "maWoResultMstrCommonDTO.filterCaCd":"failure_id"
       ,"maWoResultMstrCommonDTO.filterCaCdDesc":"failureDesc"
    });
    caCdDesc.init();
    
    reCdDesc = new autoC({"maWoResultMstrCommonDTO.filterReCdDesc":"failureDesc"});
    ...
    reCdDesc.setKeyName("maWoResultMstrCommonDTO.filterReCd");
    reCdDesc.setAcResultMap({
        "maWoResultMstrCommonDTO.filterReCd":"failure_id"
       ,"maWoResultMstrCommonDTO.filterReCdDesc":"failureDesc"
    });
    reCdDesc.init();
}
...
/*     myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	...
    	return sortColumn("maWoResultBmMstrList", this, maWoResultMstrListForm, "WKORID", ind, direction);
	}); */
...
{
    var url = contextPath + "/maWoResultBmMstrList.do";

    maWoResultMstrListForm.elements['strutsAction'].value = '<%=MaWoResultMstrListAction.WOBM_RESULT_LIST_FIND%>';
 ...
 */
 ...
 {
	maWoResultMstrListForm.elements['maWoResultMstrCommonDTO.wkOrId'].value = "";
 	excelServerAction("maWoResultBmMstrList", maWoResultMstrListForm );  
 }
...
// 		createValidationCheck(myGrid, param , "goCreateAction");
 ...
 function openSelectType(){
 	...
 	var param = "strutsAction=1004"+"&maWoResultSelectDTO.selectedPmType=BM_TYPE";
...
<html:hidden property="maWoResultMstrCommonDTO.filterCaCd"/>
<html:hidden property="maWoResultMstrCommonDTO.filterReCd"/>
		...
		<div class="article_box">
			<div class="form_box">
				...
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoResultMstrCommonDTO.filterCaCdDesc" tabindex="130" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				<!-- 고장조치  -->
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoResultMstrCommonDTO.filterReCdDesc" tabindex="130" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				<!-- 설비 사용부서  -->
