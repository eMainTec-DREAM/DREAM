...
작업결과(고장작업-윤활) 작업자
author  kim21017
version $Id: maWoResultBmOilCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultBmOilCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultBmOilCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultBmOilCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultBmOilCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultBmOilCraftList.do";
