...
{
    var url = contextPath + "/maWoResultBmOilDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultBmOilDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultBmOilDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultBmOilDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultBmOilDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWoResultBmOilDocLibList.do">
