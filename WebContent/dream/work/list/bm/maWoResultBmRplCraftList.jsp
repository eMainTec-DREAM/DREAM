...
작업결과(고장작업-교체) 작업자
author  kim21017
version $Id: maWoResultBmRplCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultBmRplCraftDetail");
	});
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultBmRplCraftDetail'); 
}
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultBmRplCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultBmRplCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultBmRplCraftList.do";
