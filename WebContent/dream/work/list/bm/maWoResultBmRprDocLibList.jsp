...
{
    var url = contextPath + "/maWoResultBmRprDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultBmRprDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultBmRprDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultBmRprDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultBmRprDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWoResultBmRprDocLibList.do">
