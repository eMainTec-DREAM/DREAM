...
작업결과 - 상세(고장작업-윤활)
author  kim21017
version $Id: maWoResultBmOilMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
	...
	$("input[name='maWoResultFailDetailDTO.lnDnEndDate']").blur( function(){
		setBmWorkTime('lnDn');
    });
	$("input[name='maWoResultFailDetailDTO.lnDnEndTime']").blur( function(){
		setBmWorkTime('lnDn');
    });
	$("input[name='maWoResultFailDetailDTO.lnDnStartDate']").blur( function(){
		setBmWorkTime('lnDn');
    });
	$("input[name='maWoResultFailDetailDTO.lnDnStartTime']").blur( function(){
		setBmWorkTime('lnDn');
    });
	$("input[name='maWoResultFailDetailDTO.eqDnStartDate']").blur( function(){
		setBmWorkTime('eqDn');
	});
	$("input[name='maWoResultFailDetailDTO.eqDnStartTime']").blur( function(){
		setBmWorkTime('eqDn');
	});
	...
	$("input[name='maWoResultFailDetailDTO.eqDnEndDate']").blur( function(){
		setBmWorkTime('eqDn');
	});
	$("input[name='maWoResultFailDetailDTO.eqDnEndTime']").blur( function(){
		setBmWorkTime('eqDn');
	});
	...
	{
		goUpdate();
		goTabPage("maWoResultBmOilCraftList");
		goTabPage("maWoResultBmOilPartList");
	}
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultBmOilDocLibList")
	{	
...
/**
 ...
 function afterApproval()
 {
	...
	goClose('maWoResultBmOilMstrDetail');
 }
 ...
 * 확인절차서 출력
 */
 function goWoconfirmprintLink(){
	//고장작업결과서 출력	 
	 reportCall('woconfirmprint','woconfirmprint', "<%=user.getCompNo()%>", "<%=user.getUserId()%>", "<%=user.getLangId()%>",maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.wkOrId'].value); 
}
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.selfVendorTypeDesc" tabindex="100" />
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 거래처 -->
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorDesc" tabindex="110" />
                    <p class="open_spop">
                        <a>
                            <span>조회</span>
                        </a>
			...
			<div class="field" id="amtDiv">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.laborAmt" tabindex="115" styleClass="num"/>
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="116" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="117" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="119"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
			<div class="field_long">
				...
				<div class="input_box">
					<html:textarea property="maWoResultMstrDetailDTO.perform" styleClass="ta50" tabindex="120" />
				</div>
			</div>
			<!-- 향후개선대책 -->
			<div class="field_long">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.moCdDesc" tabindex="130"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.moDesc" tabindex="140" />
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.caCdDesc" tabindex="150"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.caDesc" tabindex="155" />
				</div>
			</div>
			<!-- 고장조치 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.reCdDesc" tabindex="160"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.reDesc" tabindex="165" />
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultMstrDetailDTO.startDate"  tabindex="170" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultMstrDetailDTO.startTime"  tabindex="172"/>
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultFailDetailDTO.eqDnStartDate" tabindex="180" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultFailDetailDTO.eqDnStartTime" tabindex="182"/>
						<p class="open_time"><span>시간</span></p>
					</div>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultMstrDetailDTO.endDate" tabindex="183" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultMstrDetailDTO.endTime" tabindex="184" />
						<p class="open_time"><span>시간</span></p>
					</div>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultFailDetailDTO.eqDnEndDate" tabindex="185" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultFailDetailDTO.eqDnEndTime" tabindex="186" />
						<p class="open_time"><span>시간</span></p>
					</div>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.workTime" tabindex="187" styleClass="num"/>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultFailDetailDTO.eqDnWorkTime" tabindex="188" styleClass="num"/>
				</div>
			</div>
			...
			<c:set var="filePath" value="enhance/${compName}/work/list/bm/maWoResultBmOilMstrDetail_${compNo}.jsp" />
			<c:if test="${udf:isExist(filePath)}">
				<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/bm/maWoResultBmOilMstrDetail_${compNo}.jsp"></c:import>
			</c:if>
		</div> <!-- End of Form_box -->
