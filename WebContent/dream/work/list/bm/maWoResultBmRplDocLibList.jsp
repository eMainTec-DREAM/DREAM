...
{
    var url = contextPath + "/maWoResultBmRplDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultBmRplDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultBmRplDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultBmRplDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultBmRplDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWoResultBmRplDocLibList.do">
