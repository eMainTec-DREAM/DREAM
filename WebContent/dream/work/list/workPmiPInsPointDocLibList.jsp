...
function goOpen()
{
	goTabPage('workPmiPInsPointDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiPInsPointDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "workPmiPInsPointDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/workPmiPInsPointDocLibList.do";
...
{
	goClose('workPmiPInsPointDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("workPmiPInsPointDocLibList",maDocLibListForm);
}
...
<html:form action="/workPmiPInsPointDocLibList.do">
