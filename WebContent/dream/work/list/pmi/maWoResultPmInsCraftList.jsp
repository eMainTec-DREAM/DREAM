...
작업결과(예방작업-점검) 작업자
author  kim21017
version $Id: maWoResultPmInsCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPmInsCraftDetail");
	});
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultPmInsCraftDetail'); 
}
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPmInsCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPmInsCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultPmInsCraftList.do";
