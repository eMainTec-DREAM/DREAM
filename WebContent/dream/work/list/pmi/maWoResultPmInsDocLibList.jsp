...
{
    var url = contextPath + "/maWoResultPmInsDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPmInsDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultPmInsDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPmInsDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPmInsDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPmInsDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPmInsDocLibList.do">
