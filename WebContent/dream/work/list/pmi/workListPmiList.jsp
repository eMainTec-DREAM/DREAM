...
예방점검작업 - 목록
author  kim21017
version $Id: workListPmiList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
	maWoResultMstrListForm.elements['maWoResultMstrCommonDTO.filterWoTypeId'].value = woType;
...
/*         if(loginUser.wkctrId!='null'){
	...
	// 작업형태 AC
    acSysDesc("maWoResultMstrCommonDTO.filterPmTypeDesc","maWoResultMstrCommonDTO.filterPmTypeId", woType+"_TYPE");
...
// 		createValidationCheck(myGrid, param , "goCreateAction");
 ...
 function openSelectType(){
 	...
 	var param = "strutsAction=1004";
 	param += "&"+"maWoResultSelectDTO.selectedPmType="+woType+"_TYPE";
...
<html:form action="/workListPmiList.do">
