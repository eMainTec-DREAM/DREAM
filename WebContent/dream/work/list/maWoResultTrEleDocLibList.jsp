...
{
    var url = contextPath + "/maWoResultTrEleDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultTrEleDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultTrEleDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultTrEleDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultTrEleDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWoResultTrEleDocLibList.do">
