...
작업결과(교육) 작업자
author  kim21017
version $Id: maWoResultTrEleCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultTrEleCraftDetail");
	});
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultTrEleCraftDetail'); 
}
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultTrEleCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultTrEleCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultTrEleCraftList.do";
