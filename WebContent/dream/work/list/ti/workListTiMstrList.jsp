...
작업결과 - 설치/테스트 목록
author  kim21017
version $Id: workListTiMstrList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 설치/테스트 목록 -->
<title><bean:message key='MENU.WOTIRESULT'/></title>
...
/*         if(loginUser.wkctrId!='null'){
    ...
    acSysDesc("maWoResultMstrCommonDTO.filterPmTypeDesc","maWoResultMstrCommonDTO.filterPmTypeId",'TI_TYPE');
...
function findGridList(sheetAction)
{
    ...
    maWoResultMstrListForm.elements['strutsAction'].value = '<%=MaWoResultMstrListAction.WOTI_RESULT_LIST_FIND%>';
...
// 		createValidationCheck(myGrid, param , "goCreateAction");
 ...
 function openSelectType(){
 	...
 	var param = "strutsAction=1004"+"&maWoResultSelectDTO.selectedPmType=TI_TYPE";
...
<html:hidden property="maWoResultMstrCommonDTO.filterWoTypeDesc"/>
<html:hidden property="maWoResultMstrCommonDTO.filterEqCtgTypeId"/>
