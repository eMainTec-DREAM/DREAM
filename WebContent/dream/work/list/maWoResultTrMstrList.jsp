...
작업결과 - 목록
author  kim21017
version $Id: maWoResultTrMstrList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
/*         if(loginUser.wkctrId!='null'){
    ...
    //작업형태
    acSysDesc("maWoResultMstrCommonDTO.filterPmTypeDesc","maWoResultMstrCommonDTO.filterPmTypeId","TR_TYPE");
	//법정설비여부 AC
...
{
    var url = contextPath + "/maWoResultTrMstrList.do";
    maWoResultMstrListForm.elements['strutsAction'].value = '<%=MaWoResultMstrListAction.WO_TR_LIST_FIND%>';
...
function goOpenAction()
{
 ...
 {  
	  goClose(beforePageId);
	   openSelectType();
	maWoResultMstrListForm.elements['maWoResultMstrCommonDTO.wkOrId'].value = "";
	//createValidationCheck(myGrid, 'maWoResultTrEleMstrDetail' , "goCreateAction");
 }
...
// 		createValidationCheck(myGrid, param , "goCreateAction");
 ...
 function openSelectType(){
    ...
    var param = "strutsAction=1004"+"&maWoResultSelectDTO.selectedPmType=TR_TYPE";
...
<html:form action="/maWoResultTrMstrList.do">
