...
작업결과 투입자재
author  kim21017
version $Id: maWoResultPartDetail.jsp,v 1.0 2015/12/04 07:26:18 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
    ...
    partNoAc.setTable("TAPTSTOCK");
    partNoAc.setAcDConditionMap({
    	"wcode_id" : "maWoResultPartDetailDTO.wcodeId",
    	"wname" : "maWoResultPartDetailDTO.wcodeDesc"
  	});
    partNoAc.setAcConditionMap({
   	   "comp_no":loginUser.compNo
   	   });
    partNoAc.setAcResultMap({
    	"maWoResultPartDetailDTO.partDesc":"pt_desc",
    	"maWoResultPartDetailDTO.partSize":"pt_size",
        "maWoResultPartDetailDTO.partId":"part_id",
        "maWoResultPartDetailDTO.wcodeId":"wcode_id",
        "maWoResultPartDetailDTO.wcodeDesc":"wname",
        "maWoResultPartDetailDTO.partGrade":"part_grade",
        "maWoResultPartDetailDTO.partGradeDesc":"part_grade_desc",
        "maWoResultPartDetailDTO.stockQty":"stock_qty"
    });
...
function goSave(){
	...
	if(ckCreate(currentPageId)) maWoResultPartDetailForm.strutsAction.value = '<%=MaWoResultPartDetailAction.WO_RESULT_PART_DETAIL_INPUT%>';
	else maWoResultPartDetailForm.strutsAction.value = '<%= MaWoResultPartDetailAction.WO_RESULT_PART_DETAIL_UPDATE %>';
...
function afterSavenew() {
	...
	maWoResultPartDetailForm.elements['maWoResultPartDetailDTO.partSize'].value = '';
	maWoResultPartDetailForm.elements['maWoResultPartDetailDTO.remark'].value = '';
}
...
<html:form action="/maWoResultPartDetail.do">
	...
	<div class="article_box">
		<div class="form_box">
			...
			<c:set var="filePath" value="enhance/${compName}/work/list/maWoResultPartDetail_${compNo}.jsp" />
			<c:if test="${udf:isExist(filePath)}">
				<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/maWoResultPartDetail_${compNo}.jsp"></c:import>
			</c:if>
		</div><!--form_box end-->
