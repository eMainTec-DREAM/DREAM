...
작업결과 투입자재
author  kim21017
version $Id: maWoResultPartList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPartDetail");
	});
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultPartListForm), 'maWoResultPartDetail'); 
 	maWoResultPartListForm.elements['maWoResultPartListDTO.woPartId'].value = "";
}
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPartDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPartDetail',this);
	//goSearch();
...
<html:hidden property="maWoResultPartDetailDTO.multiIssDesc"/><!-- MultiSelect Iss Desc -->
    ...
    <div class="article_box" id="listBox">
 	...
 	<c:set var="filePath" value="enhance/${compName}/work/list/maWoResultPartList_${compNo}.jsp" />
	<c:if test="${udf:isExist(filePath)}">
		<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/maWoResultPartList_${compNo}.jsp"></c:import>
	</c:if>
