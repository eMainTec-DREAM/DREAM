...
작업결과 - 상세(교육)
author  kim21017
version $Id: maWoResultTrEleMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
    ...
    courseNoAc = new autoC("maWoResultMstrDetailDTO.trainDesc");
	...
	courseNoAc.setAcResultMap({
    	"maWoResultMstrDetailDTO.trainDesc":"description"
        ,"maWoResultMstrDetailDTO.courseListId":"courselist_id"
    });
	courseNoAc.setKeyName("maWoResultMstrDetailDTO.courseListId");
	courseNoAc.init();
	...
	{
		goUpdate();
		goTabPage("maWoResultTrEleCraftList");
	}
...
function afterSetDate(_name)
{
 ...
 function afterApproval()
 {
	...
	goClose('maWoResultTrEleMstrDetail');
 }
...
<body style="MARGIN: 0px" marginheight="0" marginwidth="0">
	...
	<html:hidden property="maWoResultMstrDetailDTO.woNgPointResId" />
 	...
 	<html:hidden property="maWoResultMstrDetailDTO.courseListId"/>
	...
	<div class="article_box">
		<div class="form_box">
			...
			<!-- 교육담당자 -->
			<div class="field">
				<label class="check"><bean:message key="LABEL.trainManager"/></label>
				<div class="input_box">
		    ...
		    <div class="field">
		   	    ...
		   	    <div class="input_box">
		   	    	<html:text property="maWoResultMstrDetailDTO.trainDesc" tabindex="135" />
		   	    	<p class="open_spop"><a><span>조회</span></a></p>
		   	    </div>
		   	</div>
			<!-- 교육시작시간 -->
			...
			<!-- 교육상세내용 -->
			<div class="field_long">
				<label><bean:message key="LABEL.trainRemark"/></label>
				<div class="input_box">
