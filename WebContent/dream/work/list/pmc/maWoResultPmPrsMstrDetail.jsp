...
작업결과 - 상세(검교정-압력)
author  kim21017
version $Id: maWoResultPmPrsMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultPrsCaDocLibList")
	{	
...
// 	setWorkTime();
 ...
 function goPrint()
 {
	 reportCall('maWoResultPmPrsMstrDetail','maWoResultPmPrsMstrDetail', "<%=user.getCompNo()%>", "<%=user.getUserId()%>", "<%=user.getLangId()%>",maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.wkOrId'].value); 
//  	var url   = contextPath + "/maWoResultMstrDetail.do";
...
<%-- 	param = "strutsAction=" + <%=MaWoResultMstrDetailAction.WO_RESULT_PM_PRS_DETAIL_REPORT%> + "&" + param; --%>
...
function goApproval()
{
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmPrsMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorDesc" tabindex="120" />
                    <p class="open_spop">
                        <a>
                            <span>조회</span>
                        </a>
			...
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorName" tabindex="125" />
                </div>
			</div>
			<!-- 검사기관 -->
			<div class="field">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calEnv" tabindex="135" />
				</div>
			</div>
			<!-- 최종판정 -->
			<div class="field">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calTypeDesc" tabindex="145" />
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="169"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 교정성적서No -->
