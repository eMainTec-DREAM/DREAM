...
표준기목록
author  kim21017
version $Id: workListSclCaEqList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workListSclCaEqDetail");
	});
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workListSclCaEqDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workListSclCaEqDetail',this);
	//goSearch();
