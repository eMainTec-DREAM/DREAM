...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultGnlCaCraftDetail");
	});
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultGnlCaCraftDetail'); 
}
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultGnlCaCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultGnlCaCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultGnlCaCraftList.do";
