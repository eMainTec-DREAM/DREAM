...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maWoResultGnlCaDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
...
{
    var url = contextPath + "/maWoResultGnlCaDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultGnlCaDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultGnlCaDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultGnlCaDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultGnlCaDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultGnlCaDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultGnlCaDocLibList.do">
