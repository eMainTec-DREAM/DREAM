...
function initGrid()
{
	...
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maWoResultPmCalDocLibList", this, maDocLibListForm, "docId", ind, direction);
    });
	//Inner Page
...
{
    var url = contextPath + "/maWoResultPmCalDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPmCalDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultPmCalDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPmCalDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPmCalDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPmCalDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPmCalDocLibList.do">
