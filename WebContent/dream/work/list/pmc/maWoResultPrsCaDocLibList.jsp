...
첨부문서 - 목록
author  jung7126
version $Id: maWoResultPrsCaDocLibList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/maWoResultPrsCaDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPrsCaDocLibDetail');
}
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maWoResultPrsCaDocLibDetail'); 
}
...
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPrsCaDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPrsCaDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPrsCaDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPrsCaDocLibList.do">
