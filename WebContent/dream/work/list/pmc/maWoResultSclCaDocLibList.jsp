...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maWoResultSclCaDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
	//Inner Page
...
{
    var url = contextPath + "/maWoResultSclCaDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultSclCaDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultSclCaDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultSclCaDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultSclCaDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultSclCaDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultSclCaDocLibList.do">
