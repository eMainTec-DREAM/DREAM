...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultSclCaCraftDetail");
	});
...
function goOpenAction()
{
	var selectedId=myGrid.getSelectedRowId();
 	...
 	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultSclCaCraftDetail'); 
}
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultSclCaCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultSclCaCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultSclCaCraftList.do";
