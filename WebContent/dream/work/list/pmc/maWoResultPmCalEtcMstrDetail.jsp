...
작업결과 - 상세(검교정)
author  kim21017
version $Id: maWoResultPmCalEtcMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
{	
    ...
    equipDescAc.setAcResultMap({
        ...
        ,"maWoResultMstrDetailDTO.pequipDesc":"parEquipDesc"
    ...
    calCorpAc.setAcResultMap({
        "maWoResultPmCalDTO.calCorpId":"cdusr_no"
    });
    calCorpAc.init();
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultPmCalDocLibList")
	{	
...
// 	setWorkTime();
  ...
  */
  function goPrint()
  {
 	 reportCall('maWoResultPmcEtcMstrDetail','maWoResultPmcEtcMstrDetail', "<%=user.getCompNo()%>", "<%=user.getUserId()%>", "<%=user.getLangId()%>",maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.wkOrId'].value); 
  }
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmCalEtcMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calEnv" tabindex="125" />
				</div>
			</div>
			<!-- 최종판정 -->
			<div class="field">
				<label class="check"><bean:message key="LABEL.calResStat"/></label>
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calRsltStatDesc" tabindex="130" />
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calTypeDesc" tabindex="135" />
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="140" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="145" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="150"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 교정성적서No -->
			...
			<div class="field">
				...
				<div class="datetime_wrap">
                    <div class="input_read">
                        <html:text property="maWoResultMstrDetailDTO.calibCycle" tabindex="220" styleClass="num"/>
                    </div>
                    <div class="input_read">
                        <html:text property="maWoResultMstrDetailDTO.periodTypeDesc" tabindex="230" />
                    </div>
                </div>
			</div>
			<!-- 차기교정일 -->
