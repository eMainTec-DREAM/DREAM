...
표준기목록
author  kim21017
version $Id: workListPrsCaEqList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workListPrsCaEqDetail");
	});
...
function findGridList(sheetAction)
{
	...
	doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(workListGnlCaEqListForm), "wocalibstdeqId");
 ...
 */
 ...
 function goOpenAction()
 {
     ...
     workListGnlCaEqListForm.elements['maWoResultMstrCommonDTO.wocalibstdeqId'].value = getValueById(myGrid, selectedId,'wocalibstdeqId');
     workListGnlCaEqListForm.elements['strutsAction'].value = '<%=WorkListGnlCaEqDetailAction.WORK_LIST_GNLCAEQ_DETAIL_INIT%>';
     openQuickTabPage(FormQueryString(workListGnlCaEqListForm), 'workListPrsCaEqDetail'); 
 } 
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workListPrsCaEqDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workListPrsCaEqDetail',this);
	//goSearch();
