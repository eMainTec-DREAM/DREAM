...
검교정상세 측정값상세
author  kim21017
version $Id: workListPrsCaEqDetail.jsp,v 1.0 2015/12/04 07:26:18 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function setSequenceVal(sequenceVal)
{
	...
	workListGnlCaEqDetailForm.elements['workListGnlCaEqDetailDTO.woNo'].value = workListGnlCaEqDetailForm.elements['maWoResultMstrCommonDTO.woNo'].value;
...
// 	if(checkRequireValue('workListGnlCaEqDetailDTO.endDate','<bean:message key="LABEL.woDate"/>')) return;
	checkDuplication();
	if(isValid!='0') return;
	
	if(ckCreate(currentPageId)) workListGnlCaEqDetailForm.strutsAction.value = '<%=WorkListGnlCaEqDetailAction.WORK_LIST_GNLCAEQ_DETAIL_INPUT%>';
	else workListGnlCaEqDetailForm.strutsAction.value = '<%= WorkListGnlCaEqDetailAction.WORK_LIST_GNLCAEQ_DETAIL_UPDATE %>';
