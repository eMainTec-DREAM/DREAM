...
작업결과 - 상세(검교정-저울)
author  kim21017
version $Id: maWoResultPmSclMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultSclCaDocLibList")
	{	
...
// 	setWorkTime();
 ...
 function goPrint()
 {
	 reportCall('maWoResultPmSclMstrDetail','maWoResultPmSclMstrDetail', "<%=user.getCompNo()%>", "<%=user.getUserId()%>", "<%=user.getLangId()%>",maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.wkOrId'].value); 
// 	 var url   = contextPath + "/maWoResultMstrDetail.do";
...
<%-- 		param = "strutsAction=" + <%=MaWoResultMstrDetailAction.WO_RESULT_PM_SCL_DETAIL_REPORT%> + "&" + param; --%>
...
// 		openWindowWithPost(url, "PRINT", param, pos);
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmSclMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.empDesc" tabindex="100"/>
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.subEmpDesc" tabindex="105"/>
			...
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorName" tabindex="120" />
                </div>
			</div>
			<!-- 검사기관 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calCorpDesc" tabindex="130" />
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calEnv" tabindex="140" />
				</div>
			</div>
			<!-- 최종판정 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calRsltStatDesc" tabindex="150" />
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultPmCalDTO.calTypeDesc" tabindex="160" />
					<p class="open_spop">
						<a><span>조회</span></a>
					</p>
				</div>
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="165" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="166" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="167"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 교정성적서No -->
			...
			<div class="field_long">
				...
				<div class="input_read">
					<html:textarea property="maWoResultMstrDetailDTO.perform" styleClass="ta50" tabindex="250" />
				</div>
			</div>
			<!-- 확정자 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="180" readonly="true"/>
				</div>
			</div>
		</div> <!-- End of Form_box -->
