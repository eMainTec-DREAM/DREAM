...
{
    var url = contextPath + "/maWoResultCmRplDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultCmRplDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultCmRplDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultCmRplDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultCmRplDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWoResultCmRplDocLibList.do">
