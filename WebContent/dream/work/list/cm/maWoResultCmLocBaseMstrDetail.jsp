...
작업결과 - 상세(개선-일반(위치))
author  kim21017
version $Id: maWoResultCmLocBaseMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultCmLocBaseDocLibList")
	{	
...
function afterSetDate(_name)
{
  ...
  */
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultCmLocBaseMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field" id="amtDiv">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.totAmt" tabindex="145" styleClass="num"/>
				</div>
			</div>
			<!-- 확정자 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="146" readonly="true" />
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="147" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="148" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="149"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
