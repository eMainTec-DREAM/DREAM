...
{
    var url = contextPath + "/maWoResultCmRprDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultCmRprDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultCmRprDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultCmRprDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultCmRprDocLibDetail', this);
	//goSearch();
...
<html:form action="/maWoResultCmRprDocLibList.do">
