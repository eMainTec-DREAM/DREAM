...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workListCmRplPartSerialDetail");
	});
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workListCmRplPartSerialDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workListCmRplPartSerialDetail',this);
	//goSearch();
