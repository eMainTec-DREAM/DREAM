...
작업결과(개선작업-수리) 작업자
author  kim21017
version $Id: maWoResultCmRprCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultCmRprCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultCmRprCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultCmRprCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultCmRprCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultCmRprCraftList.do";
 ...
 */
 ...
 {
    var objectId = maWoResultCraftListForm.elements['maWoResultCraftListDTO.woCraftId'].value;
