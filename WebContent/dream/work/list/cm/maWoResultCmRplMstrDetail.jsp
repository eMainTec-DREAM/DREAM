...
작업결과 - 상세(개선작업-교체)
author  kim21017
version $Id: maWoResultCmRplMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 		document.getElementById("selfVendorDiv").style.display="none";
// 	}else{
// 		//document.getElementById("amtDiv").style.display="none";
// 		document.getElementById("selfVendorDiv").style.display="";
// 	}
	...
	{
		goUpdate();
		goTabPage("maWoResultCmRplCraftList");
		goTabPage("maWoResultCmRplPartList");
	}
}
...
function setBtnAsStatus()
{
	...
	//예방점검기준서에 의해 생성된 작업결과는 설비,작업종류,작업형태를 변경하지못함.
	if(maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woGenType'].value =="PMPLAN"){
	    ...
	    setReadOnly('maWoResultMstrDetailDTO.woTypeDesc');
	    setReadOnly('maWoResultMstrDetailDTO.pmTypeDesc');
	}
	//작업대기(P),작업중(PRP),작업결과작성중(PRW),작업결과결재반려(PRWDA)가 아니면 작업종류,작업형태를 변경하지못함.
	if(!(maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woStatusId'].value=="P"
		|| maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woStatusId'].value=="PRP"
		|| maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woStatusId'].value=="PRW"
...
function afterAutoCmpt(code)
{
	if(code=="maWoResultMstrDetailDTO.equipDesc")
	{
		...
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.eqAsmbDesc'].value ="";
	...
	if(code=="maWoResultMstrDetailDTO.woTypeDesc")
	{
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.pmTypeId'].value = "";
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.pmTypeDesc'].value = "";
		if(typeof pmTypeAc == 'object') pmTypeAc.destroy();
		
	 	var listType = maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.woTypeId'].value+"_TYPE";
		//작업형태  AC
	    pmTypeAc = acSysDesc("maWoResultMstrDetailDTO.pmTypeDesc","maWoResultMstrDetailDTO.pmTypeId",listType,true);
	}
}
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultCmRplMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.eqAsmbDesc" tabindex="80"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.wkorDate" tabindex="71" />
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.deptDesc" tabindex="80"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.wkCtrDesc" tabindex="81"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.shiftTypeDesc" tabindex="83" />
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 담당자 -->
			...
			<!-- 자가/외주  -->
			<div class="field" id="selfVendorDiv">
			...
			<div class="field" id="amtDiv">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.laborAmt" tabindex="145" styleClass="num"/>
				</div>
			</div>
			<!-- 작업시작시간 -->
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultMstrDetailDTO.startDate" tabindex="120" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultMstrDetailDTO.startTime"  tabindex="125"/>
			...
			<div class="field">
				...
				<div class="datetime_wrap">
					<div class="input_box input_carendar">
						<html:text property="maWoResultMstrDetailDTO.endDate" tabindex="130" />
						<p class="open_calendar"><span>날짜</span></p>
					</div>
					<div class="input_box">
						<html:text property="maWoResultMstrDetailDTO.endTime" tabindex="135" />
						<p class="open_time"><span>시간</span></p>
					</div>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="145" readonly="true" />
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="150" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="155" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="160"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 품의여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isDraft" tabindex="170"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
			<div class="field_long">
				...
				<div class="input_box">
					<html:textarea property="maWoResultMstrDetailDTO.perform" styleClass="ta50" tabindex="180" />
				</div>
			</div>
			<c:set var="filePath" value="enhance/${compName}/work/list/cm/maWoResultCmRplMstrDetail_${compNo}.jsp" />
			<c:if test="${udf:isExist(filePath)}">
				<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/cm/maWoResultCmRplMstrDetail_${compNo}.jsp"></c:import>
			</c:if>
		</div> <!-- End of Form_box -->
