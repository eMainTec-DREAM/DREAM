...
{
    var url = contextPath + "/maWoResultCmLocBaseDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultCmLocBaseDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultCmLocBaseDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultCmLocBaseDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultCmLocBaseDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultCmLocBaseDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultCmLocBaseDocLibList.do">
