...
작업결과(개선작업-교체) 작업자
author  kim21017
version $Id: maWoResultCmLocBaseCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultCmLocBaseCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultCmLocBaseCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultCmLocBaseCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultCmLocBaseCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultCmLocBaseCraftList.do";
