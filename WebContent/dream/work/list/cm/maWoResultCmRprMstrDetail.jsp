...
작업결과 - 상세(개선작업-수리)
author  kim21017
version $Id: maWoResultCmRprMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
	...
	{
		goUpdate();
		goTabPage("maWoResultCmRprCraftList");
	}
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultCmRprDocLibList")
	{	
...
function afterSetDate(_name)
{
 ...
 function afterApproval()
 {
	...
	goClose('maWoResultCmRprMstrDetail');
 }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="165" readonly="true" />
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="167" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="168" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
