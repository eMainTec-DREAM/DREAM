...
<head>
<!-- 작업결과 -->
<title><bean:message key='MENU.WOCMRESULT'/></title>
...
/*         if(loginUser.wkctrId!='null'){
    ...
    acSysDesc("maWoResultMstrCommonDTO.filterPmTypeDesc","maWoResultMstrCommonDTO.filterPmTypeId",'CM_TYPE');
...
function findGridList(sheetAction)
{
    ...
    maWoResultMstrListForm.elements['strutsAction'].value = '<%=MaWoResultMstrListAction.WOCM_RESULT_LIST_FIND%>';
...
// 		createValidationCheck(myGrid, param , "goCreateAction");
 ...
 function openSelectType(){
 	...
 	var param = "strutsAction=1004"+"&maWoResultSelectDTO.selectedPmType=CM_TYPE";
