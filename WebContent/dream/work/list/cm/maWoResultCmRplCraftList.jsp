...
작업결과(개선작업-교체) 작업자
author  kim21017
version $Id: maWoResultCmRplCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultCmRplCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), "maWoResultCmRplCraftDetail"); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultCmRplCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultCmRplCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultCmRplCraftList.do";
