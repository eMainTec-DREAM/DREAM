...
작업결과 - 상세(예방작업-교체)
author  kim21017
version $Id: maWoResultPmRplMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
{	
	...
	{
		goUpdate();
		goTabPage("maWoResultPmRplCraftList");
		goTabPage("maWoResultPmRplPartList");
	}
...
function goInput()
{
	...
	if(loginUser.shiftType !='null'){
		//교대조 세팅
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.shiftTypeId'].value = loginUser.shiftType;
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.shiftTypeDesc'].value = loginUser.shiftTypeDesc;
	}
	...
	if(maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.deptId'].value==""){
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.deptId'].value    = loginUser.deptId;
		maWoResultMstrDetailForm.elements['maWoResultMstrDetailDTO.deptDesc'].value  = loginUser.deptDesc;
	}
...
function afterSetDate(_name)
{
  ...
  */
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmRplMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.eqAsmbDesc" tabindex="75"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorName" tabindex="135" />
                </div>
			</div>
			<!-- 작업시작시간 -->
			<div class="field">
			...
			<div class="field">
				...
				<div class="input_read">
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="176" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="180"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 품의여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isDraft" tabindex="190"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
			<div class="field_long">
				...
				<div class="input_box">
					<html:textarea property="maWoResultMstrDetailDTO.perform" styleClass="ta50" tabindex="200" />
				</div>
			</div>
			<c:set var="filePath" value="enhance/${compName}/work/list/pmw/maWoResultPmRplMstrDetail_${compNo}.jsp" />
			<c:if test="${udf:isExist(filePath)}">
				<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/pmw/maWoResultPmRplMstrDetail_${compNo}.jsp"></c:import>
			</c:if>
		</div> <!-- End of Form_box -->
