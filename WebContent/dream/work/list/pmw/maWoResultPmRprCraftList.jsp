...
작업결과(예방작업-수리) 작업자
author  kim21017
version $Id: maWoResultPmRprCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPmRprCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultPmRprCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPmRprCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPmRprCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultPmRprCraftList.do";
