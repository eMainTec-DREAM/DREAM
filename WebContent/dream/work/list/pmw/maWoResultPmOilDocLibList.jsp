...
{
    var url = contextPath + "/maWoResultPmOilDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPmOilDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultPmOilDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPmOilDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPmOilDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPmOilDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPmOilDocLibList.do">
