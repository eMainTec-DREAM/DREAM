...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maWoResultPmRplDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
	//Inner Page
...
{
    var url = contextPath + "/maWoResultPmRplDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPmRplDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultPmRplDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPmRplDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPmRplDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPmRplDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPmRplDocLibList.do">
