...
<head>
<!-- Overhaul 작업목록 -->
<title><bean:message key='MENU.WOPMWOVHRESULT'/></title>
...
/*         if(loginUser.wkctrId!='null'){
    ...
    acSysDesc("maWoResultMstrCommonDTO.filterPmTypeDesc","maWoResultMstrCommonDTO.filterPmTypeId",'PMW_TYPE');
...
{
    var url = contextPath + "/maWoPmwOvhResultMstrList.do";

    maWoResultMstrListForm.elements['strutsAction'].value = '<%=MaWoResultMstrListAction.WOPMWOVH_RESULT_LIST_FIND%>';
...
function goSearch()
{
	...
	maWoResultMstrListForm.elements['maWoResultMstrCommonDTO.pagePmType'].value = "OVH";	// 페이지 pm type
...
function goTabPageAction(pageId, selectedId)
{
	...
	goCommonTabPage(form, <%= MaWoResultMstrDetailAction.WO_RESULT_DETAIL_INIT %>, pageId);
...
function goOpenAction()
{
 ...
 function goCreate()
 {
	createValidationCheck(myGrid, "maWoResultPmRplMstrDetail" , "goCreateAction");
 ...
 {
		maWoResultMstrListForm.elements['maWoResultMstrCommonDTO.selectedWoType'].value = "PMW";
		maWoResultMstrListForm.elements['maWoResultMstrCommonDTO.selectedPmType'].value = "OVH";
	
		goCommonTabPage(maWoResultMstrListForm, '', pageId);
 }
...
{
	var actionUrl = contextPath + "/maWoPmwOvhResultMstrList.do";
    var param =  "&strutsAction=" + '<%= MaWoResultMstrListAction.GET_DATA %>'
              +  "&" + FormQueryString(maWoResultMstrListForm);
...
<html:form action="/maWoPmwOvhResultMstrList.do">
...
<html:hidden property="maWoResultMstrCommonDTO.pagePmType"/>
