...
작업결과 - 상세(예방작업-수리)
author  kim21017
version $Id: maWoResultPmRprMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
	...
	{
		goUpdate();
		goTabPage("maWoResultPmRprCraftList");
	}
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultPmRprDocLibList")
	{	
...
function afterSetDate(_name)
{
  ...
  */
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmRprMstrDetail');
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="166" readonly="true" />
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
