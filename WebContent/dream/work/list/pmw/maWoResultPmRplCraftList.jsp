...
작업결과(예방작업-교체) 작업자
author  kim21017
version $Id: maWoResultPmRplCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPmRplCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
     ...
     openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultPmRplCraftDetail'); 
 } 
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPmRplCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPmRplCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultPmRplCraftList.do";
