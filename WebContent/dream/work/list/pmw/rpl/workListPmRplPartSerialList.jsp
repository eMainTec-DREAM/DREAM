...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workListPmRplPartSerialDetail");
	});
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workListPmRplPartSerialDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workListPmRplPartSerialDetail',this);
	//goSearch();
