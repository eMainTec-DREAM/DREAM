...
<head>
<!-- 작업결과 -->
<title><bean:message key='MENU.WOPMWRESULT'/></title>
...
function findGridList(sheetAction)
{
    ...
    maWoResultMstrListForm.elements['strutsAction'].value = '<%=MaWoResultMstrListAction.WOPMW_RESULT_LIST_FIND%>';
...
// 		createValidationCheck(myGrid, param , "goCreateAction");
 ...
 function openSelectType(){
 	...
 	var param = "strutsAction=1004"+"&maWoResultSelectDTO.selectedPmType=PMW_TYPE";
