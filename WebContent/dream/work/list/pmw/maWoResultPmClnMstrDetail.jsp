...
작업결과 - 상세(예방작업-청소)
author  kim21017
version $Id: maWoResultPmClnMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
	...
	{
		goUpdate();
		goTabPage("maWoResultPmClnCraftList");
		goTabPage("maWoResultClnList");
	}
    ...
    eqLocDescAc = new autoC({"maWoResultMstrDetailDTO.eqLocDesc":"full_desc"});
    eqLocDescAc.setTable("TAEQLOC");
    eqLocDescAc.setKeyName("maWoResultMstrDetailDTO.eqLocId");
...
function goTabPage(pageId)
{
	...
	if(pageId == "maDocLibList" || pageId == "maWoResultPmClnDocLibList")
	{	
...
function afterSetDate(_name)
{
  ...
  */
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmClnMstrDetail');
  }
...
function goFmeaLink()
{
	...
	goFmeaList(equipId, equipDescm, wkroId);
}
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field_long">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.eqLocDesc" tabindex="45"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.wkorDate" tabindex="60" />
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.wkCtrDesc" tabindex="75"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.shiftTypeDesc" tabindex="80" />
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 담당자 -->
			...
			<div class="field">
				...
				<div class="input_box">
                    <html:text property="maWoResultMstrDetailDTO.vendorName" tabindex="115" />
                </div>
			</div>
			...
			<div class="field">
        	 ...
        	 <div class="field">
        	 	...
        	 	<div class="input_box">
        	 		<html:text property="maWoResultMstrDetailDTO.parentWoDesc" tabindex="127"/>
			...
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.closeBy" tabindex="150" readonly="true" />
				</div>
			</div>
			<!-- 생성시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.creDate" tabindex="155" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 수정시간 -->
			<div class="field">
				...
				<div class="input_read" >
					<html:text property="maWoResultMstrDetailDTO.updDate" tabindex="160" readonly="true" styleClass="datetime"/>
				</div>
			</div>
			<!-- 청소여부 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maWoResultMstrDetailDTO.isCleaning" tabindex="165"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 작업상세내용 -->
			<div class="field_long">
				...
				<div class="input_box">
					<html:textarea property="maWoResultMstrDetailDTO.perform" styleClass="ta50" tabindex="170" />
				</div>
			</div>
		</div> <!-- End of Form_box -->
