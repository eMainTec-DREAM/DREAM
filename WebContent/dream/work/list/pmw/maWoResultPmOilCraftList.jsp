...
작업결과(예방작업-윤활) 작업자
author  kim21017
version $Id: maWoResultPmOilCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPmOilCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultPmOilCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPmOilCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPmOilCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultPmOilCraftList.do";
