...
작업결과(예방작업-교체) 투입자재
author  kim21017
version $Id: maWoResultPmRplPartList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPmRplPartDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	maWoResultPartListForm.elements['maWoResultPartListDTO.woPartId'].value = "";
        return sortColumn("maWoResultPartList", this, maWoResultPartListForm, "WOPARTID", ind, direction);
    });
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPmRplPartDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPmRplPartDetail',this);
	//goSearch();
...
function goSave(){
	...
	{
		var url = contextPath + "/maWoResultPmRplPartList.do";
...
<html:hidden property="maWoResultPartDetailDTO.multiIssDesc"/><!-- MultiSelect Iss Desc -->
    ...
    <div class="article_box" id="listBox">
 	...
 	<c:set var="filePath" value="enhance/${compName}/work/list/pmw/maWoResultPmRplPartList_${compNo}.jsp" />
	<c:if test="${udf:isExist(filePath)}">
		<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/list/pmw/maWoResultPmRplPartList_${compNo}.jsp"></c:import>
	</c:if>
