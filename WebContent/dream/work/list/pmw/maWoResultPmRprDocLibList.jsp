...
{
    var url = contextPath + "/maWoResultPmRprDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPmRprDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultPmRprDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPmRprDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPmRprDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPmRprDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPmRprDocLibList.do">
