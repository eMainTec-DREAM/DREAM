...
작업결과 - 상세(예방작업-윤활)
author  kim21017
version $Id: maWoResultPmOilMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
// 	}
	...
	{
		goUpdate();
		goTabPage("maWoResultPmOilCraftList");
		goTabPage("maWoResultOilList");
	}
...
function afterSetDate(_name)
{
  ...
  */
  ...
  function afterApproval()
  {
 	...
 	goClose('maWoResultPmOilMstrDetail');
  }
