...
{
    var url = contextPath + "/maWoResultPmClnDocLibList.do";
...
function goOpen()
{
	goTabPage('maWoResultPmClnDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoResultPmClnDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoResultPmClnDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maWoResultPmClnDocLibDetail', this);
	//goSearch();
...
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maWoResultPmClnDocLibList",maDocLibListForm);
}
...
<html:form action="/maWoResultPmClnDocLibList.do">
