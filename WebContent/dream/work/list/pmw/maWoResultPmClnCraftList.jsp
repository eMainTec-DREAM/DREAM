...
작업결과(예방작업-청소) 작업자
author  kim21017
version $Id: maWoResultPmClnCraftList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maWoResultPmClnCraftDetail");
	});
 ...
 */
 ...
 function goOpenAction()
 {
 	var selectedId=myGrid.getSelectedRowId();
  	...
  	openQuickTabPage(FormQueryString(maWoResultCraftListForm), 'maWoResultPmClnCraftDetail'); 
 }
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultPmClnCraftDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultPmClnCraftDetail',this);
	//goSearch();
...
function goSave(){
	var url = contextPath + "/maWoResultPmClnCraftList.do";
