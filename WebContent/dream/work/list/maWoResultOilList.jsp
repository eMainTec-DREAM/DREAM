...
작업결과 작업설비(윤활)
author  kim21017
version $Id: maWoResultOilList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "maWoResultOilDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maWoResultOilDetail',this);
	//goSearch();
