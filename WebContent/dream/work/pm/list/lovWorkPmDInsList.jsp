...
<%@ page import="dream.work.pm.list.action.LovWorkPmDInsListAction"%>
<%
...
{
	var form = document.lovWorkPmDInsListForm;	
	form.strutsAction.value = '<%=LovWorkPmDInsListAction.LOV_EQCTGPART_AC_FIND%>';
	var url = contextPath + "/lovWorkPmDInsList.do";
	doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(form), "eqCtgPmPointId", "Y");
}
...
{	
	...
	setAcValue(myGrid, "eqCtgPmPointId");
}
/**
 * 검색
 */
...
<!-- searchbox 박스 Line -->
<html:form action="/lovWorkPmDInsList.do" >
		...
		<div class="section_wrap">
			...
			<div class="article_box">
				<div class="form_box">
					<!-- 점검항목 -->
					<div class="field">
						<label><bean:message key="LABEL.maPmMstrPointList"/></label>
						    <div class="input_box">
							<html:text property="lovWorkPmDInsListDTO.checkPoint" />
						</div>
					</div>
				</div>
			</div>
