...
<head>
<!-- 예방작업기준 -->
<title><bean:message key='LABEL.ptrlNo' />
</title>
...
function goUpdate()
{
	...
	if(maPmMstrDetailForm.elements['maPmMstrDetailDTO.revisionStatusId'].value == "W")  //제정중일 경우 필요값 넣어준다.
	{
		...
		maPmMstrDetailForm.elements['maPmMstrDetailDTO.periodTypeDesc'].value = "D";
		maPmMstrDetailForm.elements['maPmMstrDetailDTO.periodType'].value = "D";
		valSysDir('maPmMstrDetailDTO.periodType', 'maPmMstrDetailDTO.periodTypeDesc', 'PERIOD_TYPE', true);
...
function goSave()
{
  ...
  */
  function goPmsched(){
 	...
 	if(maPmMstrDetailForm.elements['maPmMstrDetailDTO.woType'].value == 'PMI' && maPmMstrDetailForm.elements['maPmMstrDetailDTO.pmType'].value == 'PINS') {
		param = "isDecoratorName=popupPage"+
					"&workCalPmPtrlMonthCommonDTO.strutsAction="+
					"&ACTION_FUNCTION=goSearch";
		url   = contextPath + "/workCalPmPtrlMonthList.do";
	}
	else {
		param = "isDecoratorName=popupPage"+
  ...
  function goRevision()
  {
  	...
  	openRev("workPmListRevUpdate", revhistId, desc, currentPageId);
  }
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.isActiveDesc" tabindex="30"/>
			...
			<div class="field_long">
				<label class="check"><bean:message key="LABEL.ptrlTitle"/></label>
				<div class="input_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.wrkcalListDesc" tabindex="80" />
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.wkCtrDesc" tabindex="110"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- 담당자 -->
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.empName" tabindex="120"/>
					<p class="open_spop"><a><span>조회</span></a></p>
				</div>
			</div>
			<!-- Revision상태 -->
