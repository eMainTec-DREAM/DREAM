...
설비
author  kim21017
version $Id: workPmListEInsEquipList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 청소설비 -->
<title><bean:message key='TAB.workPmListEInsEquipList'/></title>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListEInsEquipDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListEInsEquipList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListEInsEquipList.do";
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListEInsEquipDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workPmListEInsEquipDetail',this);
   	//goSearch();
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListEInsEquipList",workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListEInsEquipList">
