...
예방작업기준 - 목록
author  jung7126
version $Id: workPmListInsList.jsp,v 1.1 2015/12/03 01:45:27 jung7126 Exp $
since   1.0
===========================================================================--%>
...
/*         if(loginUser.wkctrId!='null'){
    ...
    /* 사용부서 */
	//------------------------------------------------------------------------------------
    usageDeptAc = new autoC({"maPmMstrCommonDTO.filterEqUsaDeptDesc":"description"});
...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("workPmListInsList", this, maPmMstrListForm, "PMID", ind, direction);
    });
...
{
    var url = contextPath + "/workPmListInsList.do";
...
function goExcel()
{
	//excelAction(myGrid);
	maPmMstrListForm.elements['maPmMstrCommonDTO.pmId'].value = "";
	excelServerAction("workPmListInsList", maPmMstrListForm );  
}
...
{
	var actionUrl = contextPath + "/workPmListInsList.do";
	
	maPmMstrListForm.elements['maPmMstrCommonDTO.exceltabNo'].value = "PMINS";
...
<html:form action="/workPmListInsList.do">
		...
		<div class="article_box">
			<div class="form_box">
				...
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterEqUsaDeptDesc" tabindex="20" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				...
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterEqGradeDesc" tabindex="20" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
			</div>
