...
예방작업기준 - 상세(일상점검)
author  jung7126
version $Id: maPmInsMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 jung7126 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
	...
	{
		goUpdate();
		goTabPage("workPmListDInsEquipList");
	}
 ...
 */
 function goPmsched(){
	...
	if(maPmMstrDetailForm.elements['maPmMstrDetailDTO.woType'].value == 'PMI' && maPmMstrDetailForm.elements['maPmMstrDetailDTO.pmType'].value == 'DINS') {
		param = "isDecoratorName=popupPage"+
					"&workCalPmDInsMonthCommonDTO.strutsAction="+
					"&workCalPmDInsMonthCommonDTO.filterPmNo="+pmNo+
					"&ACTION_FUNCTION=goSearch";
		url   = contextPath + "/workCalPmDInsMonthList.do";
	}
	else {
		param = "isDecoratorName=popupPage"+
	...
	<div class="article_box">
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.workNumber" tabindex="135" styleClass="num"/>
				</div>
			</div>
			<!-- 부서 -->
			<div class="field">
