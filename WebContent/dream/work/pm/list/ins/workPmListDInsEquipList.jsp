...
설비
author  kim21017
version $Id: workPmListDInsEquipList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 청소설비 -->
<title><bean:message key='TAB.workPmListDInsEquipList'/></title>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListDInsEquipDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListDInsEquipList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListDInsEquipList.do";
 ...
 */
 ...
 function goOpenAction()
 {
     ...
     openQuickTabPage(FormQueryString(workPmListEquipListForm), 'workPmListDInsEquipDetail'); 
 }  
  /**
   * 생성
   */
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListDInsEquipDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workPmListDInsEquipDetail',this);
   	//goSearch();
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListDInsEquipList", workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListDInsEquipList">
