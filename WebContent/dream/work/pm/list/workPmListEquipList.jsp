...
설비
author  kim21017
version $Id: workPmListEquipList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListEquipDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListEquipList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
     });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListEquipList.do";
 ...
 */
 ...
 function goOpenAction()
 {
     ...
     openQuickTabPage(FormQueryString(workPmListEquipListForm), 'workPmListEquipDetail'); 
 } 
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListEquipDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workPmListEquipDetail',this);
   	//goSearch();
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListEquipList",workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListEquipList">
