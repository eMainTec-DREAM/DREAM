...
청소설비
author  kim21017
version $Id: workPmListCalEquipDetail.jsp,v 1.0 2015/12/04 07:26:18 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
    ...
    equipDescAc.setAcResultMap({
        ...
        ,"workPmListEquipDetailDTO.eqLocId":"eqloc_id"
        ,"workPmListEquipDetailDTO.eqLocDesc":"eqLocDesc"
        ,"workPmListEquipDetailDTO.itemNo":"item_no"
        ,"workPmListEquipDetailDTO.pequipDesc":"parEquipDesc"
        ,"workPmListEquipDetailDTO.pequipUsaDeptDesc":"parEqUsaDeptDesc"
    });
    equipDescAc.init();
...
function goSave(){
	...
	var actionUrl = contextPath + "/workPmListCalEquipDetail.do";
...
{
	var objectId = workPmListEquipDetailForm.elements['workPmListEquipDetailDTO.pmEquipId'].value;
...
<html:form action="/workPmListCalEquipDetail.do">
		...
		<div class="form_box">
			...
			<div class="field">
				...
				<div class="input_read">
					<html:text property="workPmListEquipDetailDTO.itemNo" tabindex="5" readonly="true"/>
				</div>
			</div>
			<!-- 계측기 -->
			<div class="field">
			...
			<div class="field">
				...
				<div class="input_read">
					<html:text property="workPmListEquipDetailDTO.pequipDesc" tabindex="33" readonly="true"/>
				</div>
			</div>
			<!-- 설비사용부서 -->
			<div class="field">
				...
				<div class="input_read">
					<html:text property="workPmListEquipDetailDTO.pequipUsaDeptDesc" tabindex="35" readonly="true"/>
				</div>
			</div>
