...
예방작업기준 - 목록
author  jung7126
version $Id: workPmListCalList.jsp,v 1.1 2015/12/03 01:45:27 jung7126 Exp $
since   1.0
===========================================================================--%>
...
/*         if(loginUser.wkctrId!='null'){
	...
	eqGrade = new autoC({"maPmMstrCommonDTO.filterEqGradeDesc":"description"});
    ...
    eqGrade.setAcResultMap({
        "maPmMstrCommonDTO.filterEqGrade":"cdsysd_no"
    });
    eqGrade.init();
    ...
    equipDescAc.setAcResultMap({
        "maPmMstrCommonDTO.filterPEquipId":"equip_id"
    });
    ...
    //상위설비
    pEquipDescAc = new autoC({"maPmMstrCommonDTO.filterPEquipDesc":"description"});
    ...
    //설비사용부서
    usaDeptAc = new autoC({"maPmMstrCommonDTO.filterEqUsaDeptDesc":"description"});
    usaDeptAc.setAcConditionMap({
    	"comp_no":loginUser.compNo
  	   });
    usaDeptAc.setTable("TADEPT");
    usaDeptAc.setAcResultMap({
        "maPmMstrCommonDTO.filterEqUsaDeptId":"dept_id"
    });
    ...
    //상위설비사용부서
    usaDeptAc = new autoC({"maPmMstrCommonDTO.filterPEqUsaDeptDesc":"description"});
    usaDeptAc.setAcConditionMap({
    	"comp_no":loginUser.compNo
  	   });
    usaDeptAc.setTable("TADEPT");
    usaDeptAc.setAcResultMap({
        "maPmMstrCommonDTO.filterPEqUsaDeptId":"dept_id"
    });
    usaDeptAc.setAcDConditionMap({
    	"plant" : "maPmMstrCommonDTO.filterPlantId"
    });
...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("workPmListCalList", this, maPmMstrListForm, "PMID", ind, direction);
    });
...
{
    var url = contextPath + "/workPmListCalList.do";
...
<html:form action="/workPmListCalList.do">
...
<html:hidden property="maPmMstrCommonDTO.filterPEquipId"/>
<html:hidden property="maPmMstrCommonDTO.filterEqUsaDeptId"/>
<html:hidden property="maPmMstrCommonDTO.filterPEqUsaDeptId"/>
<html:hidden property="maPmMstrCommonDTO.filterEqGrade"/>
	...
	<div class="section_wrap">
		...
		<div class="article_box">
			<div class="form_box">
				...
				<div class="field">
					<label><bean:message key="LABEL.toolDesc"/></label>
					<div class="input_box">
                ...
                <div class="field">
                    ...
                    <div class="input_box">
							<html:text property="maPmMstrCommonDTO.filterEquipNo" tabindex="170" />
                        </p>
                    </div>
                </div>
				<!-- 상위설비명 -->
                <div class="field">
                    ...
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterPEquipDesc" tabindex="180" />
						<p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
                ...
                <div class="field">
                    ...
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterEqUsaDeptDesc" tabindex="190" />
						<p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
                ...
                <div class="field">
                    ...
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterPEqUsaDeptDesc" tabindex="200" />
						<p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
                ...
                <!-- 상위설비번호  -->
                <div class="field">
                    <label><bean:message key="LABEL.parEquipNo"/></label>
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterPEquipNo" tabindex="200" />
                    </div>
                </div>
                <!-- 제조사  -->
                <div class="field">
                    ...
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterMaker" tabindex="200" />
                    </div>
                </div>
                <!-- 모델  -->
                <div class="field">
                    ...
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterModel" tabindex="200" />
                    </div>
                </div>
                <!-- 등급  -->
                <div class="field">
                    <label><bean:message key="LABEL.grade0"/></label>
                    <div class="input_box">
						<html:text property="maPmMstrCommonDTO.filterEqGradeDesc" tabindex="200" />
						<p class="open_spop">
                            <a>
                                <span>조회</span>
                            </a>
