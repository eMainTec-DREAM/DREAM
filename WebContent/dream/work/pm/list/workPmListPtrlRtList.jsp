...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListPtrlRtDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListPtrlRtList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListPtrlRtList.do";
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListPtrlRtDetail" , "goCreateAction");
 }
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListPtrlRtList",workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListPtrlRtList">
