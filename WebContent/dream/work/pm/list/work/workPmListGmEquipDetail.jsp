...
청소설비
author  kim21017
version $Id: workPmListGmEquipDetail.jsp,v 1.0 2015/12/04 07:26:18 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goSave(){
	...
	var actionUrl = contextPath + "/workPmListGmEquipDetail.do";
...
<html:form action="/workPmListGmEquipDetail.do">
