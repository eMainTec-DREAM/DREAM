...
예방작업기준 - 상세(윤활)
author  kim21017
version $Id: maPmOilMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
	...
	else 
	{
		...
		goTabPage("workPmListRplEquipList");
	}
    ...
    mainMngAc.setAcResultMap({
        ...
        "maPmMstrDetailDTO.deptId":"deptId",
...
<body style="MARGIN: 0px" marginheight="0" marginwidth="0">
	...
	<html:hidden property="maPmMstrCommonDTO.selectedWoType" />
 	...
 	<html:hidden property="maPmMstrDetailDTO.eqLocType" value="IS_LOWEST_LVL" />
