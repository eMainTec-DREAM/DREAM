...
예방작업기준 - 상세(교체)
author  jung7126
version $Id: maPmRplMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 jung7126 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
    ...
    mainMngAc.setAcResultMap({  
         ...
         "maPmMstrDetailDTO.deptDesc":"deptDesc"
    });
...
function goTabPage(pageId)
{
	...
	{	
		maPmMstrDetailForm.elements['maDocLibCommonDTO.objectId'].value = maPmMstrDetailForm.elements['maPmMstrCommonDTO.pmId'].value;
		maPmMstrDetailForm.elements['maDocLibCommonDTO.objectType'].value = "PMWMSTR";  //PMWMSTR docDesc
		maPmMstrDetailForm.elements['maDocLibCommonDTO.description'].value = maPmMstrDetailForm.elements['maPmMstrDetailDTO.description'].value;
