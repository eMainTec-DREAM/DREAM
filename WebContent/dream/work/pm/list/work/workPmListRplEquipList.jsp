...
설비
author  kim21017
version $Id: workPmListRplEquipList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 청소설비 -->
<title><bean:message key='TAB.workPmListRplEquipList'/></title>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListRplEquipDetail");
	});
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
		workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListRplEquipList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListRplEquipList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(workPmListEquipListForm), 'workPmListRplEquipDetail'); 
} 
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListRplEquipDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workPmListRplEquipDetail',this);
   	//goSearch();
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListRplEquipList", workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListRplEquipList">
