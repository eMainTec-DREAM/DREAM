...
설비
author  kim21017
version $Id: workPmListRprEquipList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 청소설비 -->
<title><bean:message key='TAB.workPmListRprEquipList'/></title>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListRprEquipDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListRprEquipList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListRprEquipList.do";
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListRprEquipDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workPmListRprEquipDetail',this);
   	//goSearch();
   	if(parent.parent.findGridRow)
		parent.parent.findGridRow(workPmListEquipDetailForm.elements['maPmMstrCommonDTO.pmId'].value);
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListRprEquipList",workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListRprEquipList">
