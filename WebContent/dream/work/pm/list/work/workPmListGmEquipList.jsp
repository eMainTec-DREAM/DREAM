...
설비
author  kim21017
version $Id: workPmListGmEquipList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 청소설비 -->
<title><bean:message key='TAB.workPmListGmEquipList'/></title>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("workPmListGmEquipDetail");
	});
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
        return sortColumn("workPmListGmEquipList", this, workPmListEquipListForm, "PMEQUIPID", ind, direction);
    });
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/workPmListGmEquipList.do";
 ...
 */
 ...
 function goCreate()
 {
  	createValidationCheck(myGrid, "workPmListGmEquipDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('workPmListGmEquipDetail',this);
   	//goSearch();
...
{
	workPmListEquipListForm.elements['maPmMstrCommonDTO.pmEquipId'].value = "";
	excelServerAction("workPmListGmEquipList",workPmListEquipListForm);
}
//-->
</script>
...
<html:form action="/workPmListGmEquipList">
