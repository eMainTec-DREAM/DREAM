...
청소설비
author  kim21017
version $Id: workPmListRprEquipDetail.jsp,v 1.0 2015/12/04 07:26:18 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goSave(){
	...
	var actionUrl = contextPath + "/workPmListRprEquipDetail.do";
...
function afterSave(ajaxXmlDoc)
{
	...
	if(parent.parent.parent.findGridRow)
		parent.parent.parent.findGridRow(workPmListEquipDetailForm.elements['maPmMstrCommonDTO.pmId'].value);
...
<html:form action="/workPmListRprEquipDetail.do">
