...
예방작업기준 - 상세
author  jung7126
version $Id: maPmMstrDetail.jsp,v 1.0 2015/12/04 04:13:54 jung7126 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{
	...
	else 
	{
		...
		if(maPmMstrDetailForm.elements['maPmMstrDetailDTO.pmType'].value=="INS"){
			goTabPage("maPmMstrPointList");
		}else if(maPmMstrDetailForm.elements['maPmMstrDetailDTO.pmType'].value=="RPL"){
			goTabPage("maPmMstrPartList");
		}
	}
    ...
    equipDescAc.setAcResultMap({
        ...
        ,"maPmMstrDetailDTO.eqLocId":"eqloc_id"
        ,"maPmMstrDetailDTO.eqLocDesc":"eqLocDesc"
    });
...
{
	obj.prop("readonly","true").parent().removeClass('input_box').addClass('input_read');
	
	obj.next().find('a').hide();
}

function setEnable(obj)
{
	obj.prop("readonly","").parent().removeClass('input_read').addClass('input_box');
	
	obj.next().find('a').show();
}

function goUpdate(){
	//1일 작업횟수 = 1
	if(""==maPmMstrDetailForm.elements['maPmMstrDetailDTO.workNumber'].value){
...
function goInput()
{
	...
	valSysDir('maPmMstrDetailDTO.pmType', 'maPmMstrDetailDTO.pmTypeDesc', 'PM_TYPE', true);
	//부서정보 세팅
		...
		<div class="form_box">
			<div class="field">
				...
				<div class="input_read">
					<html:text property="maPmMstrDetailDTO.pmNo" tabindex="10" />
				</div>
			</div>
			<div class="field">
				<label class="check"><bean:message key="LABEL.equipDesc"/></label>
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.equipDesc" tabindex="50"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field_long">
				...
				<div class="input_read">
					<html:text property="maPmMstrDetailDTO.eqLocDesc" tabindex="25" readonly="true"/>
				</div>
			</div>
			<div class="field_long">
				<label class="check"><bean:message key="LABEL.pmDesc"/></label>
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.description" tabindex="30" />
				</div>
			</div>
			<div class="field">
				<!-- 사용량/시간 구분-->
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.scheduleTypeDesc" tabindex="40" />
					<p class="open_spop">
						<a>
						<span>조회</span></a>
					</p>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.deptDesc" tabindex="50" />
					<p class="open_spop">
						<a>
						<span>조회</span></a>
					</p>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.wkCtrDesc" tabindex="55"/>
					<p class="open_spop">
						<a>
							<span>조회</span>
						</a>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.usage" tabindex="70" styleClass="num"/>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.woResBef" tabindex="90" styleClass="num"/>
				</div>
			</div>
			<div class="field">
				<!-- 다음일정 생성 예정일 -->
				<label><bean:message key="LABEL.lastSchDate"/></label>
				<div class="input_read">
					<html:text property="maPmMstrDetailDTO.lastSchDate" tabindex="110" readonly="true"/>
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.isActiveDesc" tabindex="110"/>
                    <p class="open_spop">
                        <a>
                            <span>조회</span>
                        </a>
			...
			<div class="field">
				...
				<div class="input_read">
					<html:text property="maPmMstrDetailDTO.pmTypeDesc" tabindex="120" readonly="true" />
				</div>
			</div>
			<div class="field">
				<!-- 작업종류 -->
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.woTypeDesc" tabindex="130" readonly="true"/>
				</div>
			</div>
			<div class="field">
				<!-- 작업유형 -->
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.pmCategDesc" tabindex="140" />
					<p class="open_spop">
						<a>
						<span>조회</span></a>
					</p>
			...
			<div class="field_long">
				...
				<div class="input_box">
					<html:text property="maPmMstrDetailDTO.remark" tabindex="180" />
				</div>
			</div>
		</div> <!-- End of Form_box -->
