...
예방작업기준 - 목록
author  jung7126
version $Id: workPmListTrList.jsp,v 1.1 2015/12/03 01:45:27 jung7126 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/workPmListTrList.do";

    maPmMstrListForm.elements['strutsAction'].value = '<%=MaPmMstrListAction.PM_TR_LIST_FIND%>';
...
<html:form action="/workPmListTrList.do">
