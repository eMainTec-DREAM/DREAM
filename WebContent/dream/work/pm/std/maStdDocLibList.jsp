...
첨부문서 - 목록
author  youngjoo38
version $Id: maStdDocLibList.jsp,v 1.1 2017/09/19 01:45:27 youngjoo38 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/maStdDocLibList.do";
...
function goOpen()
{
	goTabPage('maStdDocLibDetail');
}

function goOpenAction()
{
    //openQuickTabPage(FormQueryString(maDocLibListForm),'maStdDocLibDetail');
...
function goCreate()
{
	createValidationCheck(myGrid, "maStdDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maStdDocLibDetail', this);
	//goSearch();
...
<html:form action="/maStdDocLibList.do">
