...
function findGridRow(_docId)
{
	...
	var wpplPage = searchPage("workPmiPointList");
...
function goOpen()
{
	goTabPage('workPmiRInsPointValueDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiRInsPointValueDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "workPmiRInsPointValueDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/workPmiRInsPointDocLibList.do";
...
{
	goClose('workPmiRInsPointValueDocLibDetail', this);
...
<html:form action="/workPmiRInsPointDocLibList.do">
