...
function goOpen()
{
	goTabPage('workPmiCInsPointDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiCInsPointDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "workPmiCInsPointDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/workPmiCInsPointDocLibList.do";
...
{
	goClose('workPmiCInsPointDocLibDetail', this);
	//goSearch();
...
<html:form action="/workPmiCInsPointDocLibList.do">
