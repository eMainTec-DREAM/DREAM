...
function findGridRow(_docId)
{
	...
	var wpplPage = searchPage("workPmiDInsPointList");
...
function goOpen()
{
	goTabPage('workPmiDInsPointDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiDInsPointDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "workPmiDInsPointDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/workPmiDInsPointDocLibList.do";
...
{
	goClose('workPmiDInsPointDocLibDetail', this);
	//goSearch();
	var wpplPage = searchPage("workPmiDInsPointList");
	if(typeof wpplPage.goSearch  == "function") wpplPage.goSearch();
...
<html:form action="/workPmiDInsPointDocLibList.do">
