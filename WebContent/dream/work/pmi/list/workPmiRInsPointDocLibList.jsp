...
function goOpen()
{
	goTabPage('workPmiRInsPointDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiRInsPointDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "workPmiRInsPointDocLibDetail" , "goCreateAction");
}
...
{
	goClose('workPmiRInsPointDocLibDetail', this);
