...
function goOpen()
{
	goTabPage('workPmiPointDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiPointDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "workPmiPointDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/workPmiPointDocLibList.do";
...
{
	goClose('workPmiPointDocLibDetail', this);
	//goSearch();
...
<html:form action="/workPmiPointDocLibList.do">
