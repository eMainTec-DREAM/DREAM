...
{
    var url = contextPath + "/workPmiDocLibList.do";
...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'workPmiDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "workPmiDocLibDetail" , "goCreateAction");
}
...
{
	goClose('workPmiDocLibDetail', this);
	//goSearch();
...
<html:form action="/workPmiDocLibList.do">
