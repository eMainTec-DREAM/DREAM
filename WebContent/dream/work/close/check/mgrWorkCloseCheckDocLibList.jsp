...
첨부문서 - 목록
author  youngjoo38
version $Id: mgrWorkCloseCheckDocLibList.jsp,v 1.1 2017/09/19 01:45:27 youngjoo38 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/mgrWorkCloseCheckDocLibList.do";
...
function goOpen()
{
	goTabPage('mgrWorkCloseCheckDocLibDetail');
}

function goOpenAction()
{
    //openQuickTabPage(FormQueryString(maDocLibListForm),'mgrWorkCloseCheckDocLibDetail');
...
function goCreate()
{
	createValidationCheck(myGrid, "mgrWorkCloseCheckDocLibDetail" , "goCreateAction");
}
...
{
	goClose('mgrWorkCloseCheckDocLibDetail', this);
	//goSearch();
...
<html:form action="/mgrWorkCloseCheckDocLibList.do">
