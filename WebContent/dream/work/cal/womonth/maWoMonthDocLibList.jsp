...
첨부문서(월간작업일정) - 목록
author  jung7126
version $Id: maWoMonthDocLibList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function goOpen()
{
	goTabPage('maWoMonthDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'maWoMonthDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maWoMonthDocLibDetail" , "goCreateAction");
}

function goCreateAction(pageId)
{
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	goCommonTabPage(maDocLibListForm, '', "maWoMonthDocLibDetail");
}
...
{
	goClose('maWoMonthDocLibDetail', this);
	//goSearch();
