...
<head>
<!-- 예방작업일정 -->
<title><bean:message key='MENU.YEARPMSCHED'/></title>
...
{
	//PMW만 조회되도록 처리 
	maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.filterWoTypeId'].value = "PMW+PMI"; 
    ...
    subMngAc.init();
 	...
 	// 담당자 자동완성
    planEmpAc = new autoC({"maWoYearSchedCommonDTO.filterPlanEmpDesc":"emp_name"});
    planEmpAc.setTable("TAEMP");
    planEmpAc.setAcResultMap({
        "maWoYearSchedCommonDTO.filterPlanEmpId":"emp_id"
      , "IS_USE":"Y"
    });
    ...
    planEmpAc.init();
 	...
 	// 담당자 자동완성
    empAc = new autoC({"maWoYearSchedCommonDTO.filterEmpDesc":"emp_name"});
    empAc.setTable("TAEMP");
    empAc.setAcResultMap({
        "maWoYearSchedCommonDTO.filterEmpId":"emp_id"
      , "IS_USE":"Y"
    });
    empAc.setAcDConditionMap({
    	"dept_id" : "maWoYearSchedCommonDTO.filterExeDeptId",
    	"plant" : "maWoYearSchedCommonDTO.filterPlantId"
    });
    empAc.init();
    ...
    // 내/외자
    acSysDesc("maWoYearSchedCommonDTO.filterPlfTypeDesc","maWoYearSchedCommonDTO.filterPlfTypeId","PLF_TYPE");
...
{
		if(code=="maWoYearSchedCommonDTO.filterWoTypeDesc")
		{
			if(pmTypeAc) pmTypeAc.destroy();
			
		 	var listType = maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.filterWoTypeId'].value+"_TYPE";
			//작업형태  AC
		    acSysDesc("maWoYearSchedCommonDTO.filterPmTypeDesc","maWoYearSchedCommonDTO.filterPmTypeId",listType);
		}
}
...
{
	maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.pmSchedId'].value = "";	// 검색시 Tab 이동Key Clear
	maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.wkOrId'].value = "";	// 검색시 Tab 이동Key Clear
    ...
    maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.planEmpId'].value       = maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.filterPlanEmpId'].value;
    maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.planEmpDesc'].value     = maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.filterPlanEmpDesc'].value;
    maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.empId'].value           = maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.filterEmpId'].value;
    maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.empDesc'].value         = maWoYearSchedListForm.elements['maWoYearSchedCommonDTO.filterEmpDesc'].value;
...
function goOpen(rowId)
{
	...
	else
	{
		...
		maWoYearSchedListForm.elements['maWoResultMstrCommonDTO.wkOrId'].value = wkOrId;
		maWoYearSchedListForm.elements['maWoResultMstrCommonDTO.selectedWoType'].value = woType;
...
<html:hidden property="maWoYearSchedCommonDTO.filterPlanEmpId"/>
<html:hidden property="maWoYearSchedCommonDTO.filterEmpId"/>
<html:hidden property="maWoYearSchedCommonDTO.filterPlantId"/>
<html:hidden property="maWoYearSchedCommonDTO.planEmpId"/>
<html:hidden property="maWoYearSchedCommonDTO.planEmpDesc"/>
<html:hidden property="maWoYearSchedCommonDTO.empId"/>
<html:hidden property="maWoYearSchedCommonDTO.empDesc"/>
		...
		<div class="article_box">
			<div class="form_box">
				...
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoYearSchedCommonDTO.filterDeptDesc" tabindex="15" />
				...
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoYearSchedCommonDTO.filterExeDeptDesc" tabindex="20" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				<!-- 계획담당자 -->
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoYearSchedCommonDTO.filterPlanEmpDesc" tabindex="21" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				<!-- 실행담당자 -->
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoYearSchedCommonDTO.filterEmpDesc" tabindex="22" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				<div class="field">
                ...
                <div class="field">
                    ...
                    <div class="input_box">
                         <html:text property="maWoYearSchedCommonDTO.filterPlfTypeDesc" tabindex="55"/>
                         <p class="open_spop"><a><span>조회</span></a></p>
                    </div>
                </div>
				<!-- 법정설비여부 -->
				...
				<div class="field">
					...
					<div class="input_box">
						<html:text property="maWoYearSchedCommonDTO.filterWoTypeDesc" tabindex="120" />
						<p class="open_spop"><a><span>조회</span></a></p>
					</div>
				</div>
				<!-- 작업형태  -->
                ...
                <c:set var="filePath" value="enhance/${compName}/work/cal/pmyear/maWoYearSchedList_${compNo}.jsp" />
				<c:if test="${udf:isExist(filePath)}">
					<c:import charEncoding="UTF-8" url="/enhance/${compName}/work/cal/pmyear/maWoYearSchedList_${compNo}.jsp"></c:import>
				</c:if>
			</div>
		</div><!--article_box end-->
