...
{
    var url = contextPath + "/assetRptWorkHistLibList.do";
...
function goOpen()
{
	goTabPage('assetRptWorkHistLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'assetRptWorkHistLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "assetRptWorkHistLibDetail" , "goCreateAction");
}
...
{
	goClose('assetRptWorkHistLibDetail', this);
	//goSearch();
...
<html:form action="/assetRptWorkHistLibList.do">
