...
function initChart(){
	...
	assetRptLccLocDetailForm.elements['assetRptLccLocDetailDTO.chartValue'].value = "<bean:message key='LABEL.maintAmt'/>";
...
function findChart(idx,plant,line){
	var url = contextPath + "/assetRptLccLocMaintAmtDetailChart.do";
...
<html:form action="/assetRptLccLocMaintAmtDetailChart.do">
