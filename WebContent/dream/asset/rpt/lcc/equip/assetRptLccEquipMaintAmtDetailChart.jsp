...
function initChart(){
	...
	assetRptLccEquipDetailForm.elements['assetRptLccEquipDetailDTO.chartValue'].value = "<bean:message key='LABEL.maintAmt'/>";
...
function findChart(idx,plant,line){
	var url = contextPath + "/assetRptLccEquipMaintAmtDetailChart.do";
...
<html:form action="/assetRptLccEquipMaintAmtDetailChart.do">
