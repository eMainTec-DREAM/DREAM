...
function initChart(){
	...
	assetRptLccEquipDetailForm.elements['assetRptLccEquipDetailDTO.chartValue'].value = "<bean:message key='LABEL.woTimeMin'/>";
...
function findChart(idx,plant,line){
	var url = contextPath + "/assetRptLccEquipWorkTimeDetailChart.do";
...
<html:form action="/assetRptLccEquipWorkTimeDetailChart.do">
