...
function initChart(){
	...
	assetRptLccUsDeptDetailForm.elements['assetRptLccUsDeptDetailDTO.chartValue'].value = "<bean:message key='LABEL.woTimeMin'/>";
...
function findChart(idx,plant,line){
	var url = contextPath + "/assetRptLccUsDeptWorkTimeDetailChart.do";
...
<html:form action="/assetRptLccUsDeptWorkTimeDetailChart.do">
