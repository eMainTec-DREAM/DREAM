...
function initChart(){
	...
	assetRptLccUsDeptDetailForm.elements['assetRptLccUsDeptDetailDTO.chartValue'].value = "<bean:message key='LABEL.bdTimeFreq'/>";
...
function findChart(idx,plant,line){
	var url = contextPath + "/assetRptLccUsDeptDetailChart.do";
...
<html:form action="/assetRptLccUsDeptDetailChart.do">
