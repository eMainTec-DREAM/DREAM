...
갱신이력
author  euna0207
version $Id: maEqMoldMstrModHistDetail.jsp,v 1.0 2019/08/05 07:26:18 euna0207 Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 갱신이력 -->
<title><bean:message key="TAB.maEqMoldMstrModHistDetail"/></title>
...
function goSave(){
	...
	var actionUrl = contextPath + "/maEqMoldMstrModHistDetail.do";
...
<html:form action="/maEqMoldMstrModHistDetail.do">
