...
{
    var url = contextPath + "/maEqVehicleDocLibList.do";
...
function goOpen()
{
	goTabPage('maEqVehicleDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqVehicleDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqVehicleDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maEqVehicleDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maEqVehicleDocLibList", maDocLibListForm);
}
...
<html:form action="/maEqVehicleDocLibList.do">
