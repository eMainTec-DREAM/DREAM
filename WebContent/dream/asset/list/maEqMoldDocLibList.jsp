...
{
    var url = contextPath + "/maEqMoldDocLibList.do";
...
function goOpen()
{
	goTabPage('maEqMoldDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqMoldDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqMoldDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maEqMoldDocLibDetail', this);
	//goSearch();
...
<html:form action="/maEqMoldDocLibList.do">
