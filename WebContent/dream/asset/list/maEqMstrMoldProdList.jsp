...
구성자재
author  kim21017
version $Id: maEqMstrMoldProdList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function initGrid()
{
	...
	myGrid.attachEvent("onRowSelect",function(rowId, columnId){
		goTabPage("maEqMstrMoldProdDetail");
	});
...
function findGridList(sheetAction)
{
	...
	var url = contextPath + "/maEqMstrMoldProdList.do";
 ...
 */
 function goOpen(){
  ...
  function goOpenAction()
  {
      ...
      openQuickTabPage(FormQueryString(maEqMstrMoldProdListForm), 'maEqMstrMoldProdDetail'); 
  } 
...
//   	excelAction(myGrid);
	...
	excelServerAction("maEqMstrMoldProdList", maEqMstrMoldProdListForm);
  }
  /**
   * 생성
   */
 function goCreate()
 {
	  createValidationCheck(myGrid, "maEqMstrMoldProdDetail" , "goCreateAction");
 }
...
function afterDelete(){
	goClose('maEqMstrMoldProdDetail',this);
   	//goSearch();
...
<html:form action="/maEqMstrMoldProdList.do">
