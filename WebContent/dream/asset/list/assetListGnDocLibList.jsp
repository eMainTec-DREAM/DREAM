...
function goOpen()
{
	goTabPage('assetListGnDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'assetListGnDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "assetListGnDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/assetListGnDocLibList.do";
...
{
	goClose('assetListGnDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("assetListGnDocLibList", maDocLibListForm);
}
...
<html:form action="/assetListGnDocLibList.do">
