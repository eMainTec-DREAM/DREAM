...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
    	...
    	return sortColumn("assetListAssList", this, assetListAssListForm, "EQASSLISTID", ind, direction);
	});
...
{
    var url = contextPath + "/assetListAssList.do";
...
function goOpen()
{
    goTabPage('assetListAssDetail');//assAssetDetail
}
...
function goCreate()
{
    createValidationCheck(myGrid, "assetListAssDetail" , "goCreateAction");
}
...
function goExcel()
{
   	//excelAction(myGrid);
    assetListAssListForm.elements['assetListAssListDTO.eqasslistId'].value = "";
    excelServerAction("assetListAssList", assetListAssListForm);
}
...
<html:form action="/assetListAssList.do">
