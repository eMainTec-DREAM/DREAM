...
{
    var url = contextPath + "/maEqBuildingDocLibList.do";
...
function goOpen()
{
	goTabPage('maEqBuildingDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqBuildingDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqBuildingDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maEqBuildingDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maEqBuildingDocLibList", maDocLibListForm);
}
...
<html:form action="/maEqBuildingDocLibList.do">
