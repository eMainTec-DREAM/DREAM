...
생산품목
author  euna0207
version $Id: maEqMoldMstrProdDetail.jsp,v 1.0 2019/08/05 07:26:18 euna0207 Exp $
since   1.0
===========================================================================--%>
...
function goSave(){
	...
	var actionUrl = contextPath + "/maEqMoldMstrProdDetail.do";
...
<html:form action="/maEqMoldMstrProdDetail.do">
