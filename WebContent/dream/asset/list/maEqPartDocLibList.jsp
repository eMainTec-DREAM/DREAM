...
{
    var url = contextPath + "/maEqPartDocLibList.do";
...
function goOpen()
{
	goTabPage('maEqPartDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqPartDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqPartDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maEqPartDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maEqPartDocLibList", maDocLibListForm);	
}
...
<html:form action="/maEqPartDocLibList.do">
