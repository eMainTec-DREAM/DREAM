...
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/maEqDocLibList.do";
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maEqDocLibList", maDocLibListForm);
}
...
<html:form action="/maEqDocLibList.do">
    	...
    	<div class="sheader_box">
	       ...
	       <div class="article_box" style="display:none;">
	           <div class="form_box">
				...
				<c:set var="filePath" value="enhance/${compName}/asset/list/maEqDocLibList_${compNo}.jsp" />
				<c:if test="${udf:isExist(filePath)}">
					<c:import charEncoding="UTF-8" url="/enhance/${compName}/asset/list/maEqDocLibList_${compNo}.jsp"></c:import>
				</c:if>
			</div>
		</div><!--article_box end-->
