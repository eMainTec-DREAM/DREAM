...
{
    var url = contextPath + "/maEqToolDocLibList.do";
...
function goOpen()
{
	goTabPage('maEqToolDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqToolDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqToolDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maEqToolDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maEqToolDocLibList", maDocLibListForm);
}
...
<html:form action="/maEqToolDocLibList.do">
