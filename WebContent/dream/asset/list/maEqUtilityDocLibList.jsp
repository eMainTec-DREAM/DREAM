...
{
    var url = contextPath + "/maEqUtilityDocLibList.do";
...
function goOpen()
{
	goTabPage('maEqUtilityDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maEqUtilityDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maEqUtilityDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maEqUtilityDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("maEqUtilityDocLibList", maDocLibListForm);
}
...
<html:form action="/maEqUtilityDocLibList.do">
