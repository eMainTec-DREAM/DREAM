...
설비마스터 - 목록
author  kim21017
version $Id: maEqUtilityMstrList.jsp,v 1.1 2015/12/03 01:45:27 kim21017 Exp $
since   1.0
===========================================================================--%>
...
function loadPage() 
{      
	maEqMstrListForm.elements['maEqMstrCommonDTO.eqCtgType'].value = "UT";
...
function initGrid()
{
	...
	myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
		...
		return sortColumn("maEqUtilityMstrList", this, maEqMstrListForm, "EQUIPID", ind, direction);
	});
...
{
    var url = contextPath + "/maEqUtilityMstrList.do";

    maEqMstrListForm.elements['strutsAction'].value = '<%=MaEqMstrListAction.EQ_UTIL_LIST_FIND%>';
 ...
 */
 ...
 {
	maEqMstrListForm.elements['maEqMstrCommonDTO.equipId'].value = "";	
 	excelServerAction("maEqUtilityMstrList", maEqMstrListForm);
 }
...
{
	maEqMstrListForm.elements['maEqMstrCommonDTO.selectedEqCtgTypeId'].value = 'UT';
 ...
 */
 function goOpen(){
	 goTabPage('maEqUtilityMstrDetail');
}
 ...
 function goOpenAction()
 {
	...
	var form = document.maEqMstrListForm;
	form.elements['maEqMstrCommonDTO.selectedEqCtgTypeId'].value = 'UT';
	form.elements['maEqMstrCommonDTO.equipId'].value = getValueById(myGrid, selectedId,'EQUIPID');
	form.elements['strutsAction'].value = '<%=MaEqMstrDetailAction.EQ_MSTR_DETAIL_INIT%>';
    openQuickTabPage(FormQueryString(form), 'maEqUtilityMstrDetail'); 
 } 
 ...
 function goCreate()
 {
	 createValidationCheck(myGrid, "maEqUtilityMstrDetail" , "goCreateAction");}
...
<html:form action="/maEqUtilityMstrList.do">
