...
function initGrid()
{
	...
	setHeader(myGrid, "gridbox", "goSearch", "eqAsmbByPmValLov"); // grid, grid id
}
...
{
	lovEqAsmbListForm.elements['strutsAction'].value = '<%=LovEqAsmbListAction.LOV_EQASMB_BY_PM_AC_FIND%>';
    var url = contextPath + "/eqAsmbByPmValLov.do";
...
<BODY style="MARGIN: 0px" marginheight="0" marginwidth="0">
	<!-- searchbox 박스 Line -->
	<html:form action="/eqAsmbByPmValLov" >
