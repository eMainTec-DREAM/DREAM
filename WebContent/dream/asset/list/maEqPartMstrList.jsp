...
설비마스터 - 목록
author  jung7126
version $Id: maEqPartMstrList.jsp,v 1.1 2015/12/03 01:45:27 hyosung Exp $
since   1.0
===========================================================================--%>
...
<head>
<!-- 설비마스터 -->
<title><bean:message key="MENU.EQDEVICEMSTR"/></title>
...
function loadPage() 
{      
	maEqMstrListForm.elements['maEqMstrCommonDTO.eqCtgType'].value = "PT";
    ...
    pEquipDescAc.setKeyName("maEqMstrCommonDTO.filterPEqId"); 
    pEquipDescAc.init();
  //----------------------------------------------------------------//
...
{
    var url = contextPath + "/maEqPartMstrList.do";

    maEqMstrListForm.elements['strutsAction'].value = '<%=MaEqMstrListAction.EQ_PART_LIST_FIND%>';
 ...
 */
 ...
 {
	 maEqMstrListForm.elements['maEqMstrCommonDTO.equipId'].value = "";
    excelServerAction("maEqPartMstrList", maEqMstrListForm);
 }
...
function goTabPageAction(pageId,selectedId)
{
    ...
    maEqMstrListForm.elements['maEqMstrCommonDTO.selectedEqCtgTypeId'].value='PT'
 ...
 */
 ...
 function goCreate()
 {
     createValidationCheck(myGrid, "maEqPartMstrDetail" , "goCreateAction");
 }
...
<html:form action="/maEqPartMstrList.do">
