...
function goOpen()
{
	goTabPage('assetListItDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'assetListItDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "assetListItDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/assetListItDocLibList.do";
...
{
	goClose('assetListItDocLibDetail', this);
	//goSearch();
...
// 	excelAction(myGrid);
	maDocLibListForm.elements['maDocLibCommonDTO.docId'].value = "";
	excelServerAction("assetListItDocLibList", maDocLibListForm);
}
...
<html:form action="/assetListItDocLibList.do">
