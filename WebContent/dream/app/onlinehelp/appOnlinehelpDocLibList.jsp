...
첨부문서 - 목록
author  youngjoo38
version $Id: appOnlinehelpDocLibList.jsp,v 1.1 2017/09/19 01:45:27 youngjoo38 Exp $
since   1.0
===========================================================================--%>
...
{
    var url = contextPath + "/appOnlinehelpDocLibList.do";
...
function goOpen()
{
	goTabPage('appOnlinehelpDocLibDetail');
}

function goOpenAction()
{
    //openQuickTabPage(FormQueryString(maDocLibListForm),'appOnlinehelpDocLibDetail');
...
function goCreate()
{
	createValidationCheck(myGrid, "appOnlinehelpDocLibDetail" , "goCreateAction");
}
...
{
	goClose('appOnlinehelpDocLibDetail', this);
	//goSearch();
...
<html:form action="/appOnlinehelpDocLibList.do">
