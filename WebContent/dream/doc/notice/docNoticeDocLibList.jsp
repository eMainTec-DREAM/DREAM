...
function goOpen()
{
	goTabPage('docNoticeDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'docNoticeDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "docNoticeDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/docNoticeDocLibList.do";
...
{
	goClose('docNoticeDocLibDetail', this);
	//goSearch();
...
<html:form action="/docNoticeDocLibList.do">
