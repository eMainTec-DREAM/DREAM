...
function goOpen()
{
	goTabPage('docNoticeCheckDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'docNoticeCheckDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "docNoticeCheckDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/docNoticeCheckDocLibList.do";
...
{
	goClose('docNoticeCheckDocLibDetail', this);
	//goSearch();
...
<html:form action="/docNoticeCheckDocLibList.do">
