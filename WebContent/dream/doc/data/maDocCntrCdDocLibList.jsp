...
function initGrid()
{
    ...
    myGrid.attachEvent("onBeforeSorting",function(ind,type,direction){
        ...
        return sortColumn("maDocCntrCdDocLibList", this, maDocLibListForm, "DOCID", ind, direction);
    });
...
{
    var url = contextPath + "/maDocCntrCdDocLibList.do";
...
function goOpen()
{
	goTabPage('maDocCntrCdDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm), 'maDocCntrCdDocLibDetail'); 
} 
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "maDocCntrCdDocLibDetail" , "goCreateAction");
}
...
{
	goClose('maDocCntrCdDocLibDetail', this);
	//goSearch();
...
<html:form action="/maDocCntrCdDocLibList.do">
