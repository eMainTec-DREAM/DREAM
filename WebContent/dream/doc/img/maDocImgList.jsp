...
function loadPage() 
{
	...
	acSysDesc("maDocImgCommonDTO.objectTypeDesc","maDocImgCommonDTO.objectTypeCode","OBJECT_TYPE");
	
	deptAc = new autoC({"maDocImgCommonDTO.deptDesc":"description"});
    deptAc.setAcConditionMap({
    	"comp_no":loginUser.compNo
  	   });
    deptAc.setTable("TADEPT");
    deptAc.setAcResultMap({
        "maDocImgCommonDTO.deptId":"dept_id"
    });
    deptAc.init();
    
    mainMngAc = new autoC({"maDocImgCommonDTO.regDesc":"emp_name"});
    mainMngAc.setAcConditionMap({
    	"comp_no":loginUser.compNo
  	   });
    mainMngAc.setTable("TAEMP");
    mainMngAc.setAcResultMap({
        "maDocImgCommonDTO.regId":"emp_id"
    });
    mainMngAc.setAcDConditionMap({
    	"dept_id" : "maDocImgCommonDTO.deptId"
    });
    mainMngAc.init();
}
...
function findGridList(sheetAction)
{
    ...
    doGridAction(sheetAction, myGrid, "gridbox", url, FormQueryString(maDocImgListForm), "IMAGEID", "Y");
...
function goOpenAction()
{
    ...
    maDocImgListForm.elements['maDocImgCommonDTO.imageId'].value = getValueById(myGrid, selectedId,'imageId');
    maDocImgListForm.elements['strutsAction'].value = '<%=MaDocImgDetailAction.DOCIMG_DETAIL_INIT%>';
    openQuickTabPage(FormQueryString(maDocImgListForm), 'maDocImgDetail'); 
} 
 ...
 */
  ...
  */
  ...
  {
     var objectId = maDocImgListForm.elements['maDocImgCommonDTO.imageId'].value;
...
<html:hidden property="maDocImgCommonDTO.regId"/>
