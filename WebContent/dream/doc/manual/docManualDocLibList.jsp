...
{
    var url = contextPath + "/docManualDocLibList.do";
...
function goOpen()
{
	goTabPage('docManualDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'docManualDocLibDetail');
}
...
function goCreate()
{
	createValidationCheck(myGrid, "docManualDocLibDetail" , "goCreateAction");
}
...
{
	goClose('docManualDocLibDetail', this);
	//goSearch();
...
<html:form action="/docManualDocLibList.do">
