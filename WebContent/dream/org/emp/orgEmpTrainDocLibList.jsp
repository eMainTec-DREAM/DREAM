...
function goOpen()
{
	goTabPage('orgEmpTrainDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'orgEmpTrainDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "orgEmpTrainDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/orgEmpTrainDocLibList.do";
...
{
	goClose('orgEmpTrainDocLibDetail', this);
	//goSearch();
...
<html:form action="/orgEmpTrainDocLibList.do">
