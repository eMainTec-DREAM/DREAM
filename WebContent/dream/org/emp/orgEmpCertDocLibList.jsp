...
function goOpen()
{
	goTabPage('orgEmpCertDocLibDetail');
}
function goOpenAction()
{
    ...
    openQuickTabPage(FormQueryString(maDocLibListForm),'orgEmpCertDocLibDetail');
}
/**
 * 생성
 */
function goCreate()
{
	createValidationCheck(myGrid, "orgEmpCertDocLibDetail" , "goCreateAction");
}
...
function goDelete()
{
	...
	var url = contextPath + "/orgEmpCertDocLibList.do";
...
{
	goClose('orgEmpCertDocLibDetail', this);
	//goSearch();
...
<html:form action="/orgEmpCertDocLibList.do">
