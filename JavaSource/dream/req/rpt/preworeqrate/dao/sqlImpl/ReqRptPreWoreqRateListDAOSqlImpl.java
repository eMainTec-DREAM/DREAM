package dream.req.rpt.preworeqrate.dao.sqlImpl;
 ...
 */
public class ReqRptPreWoreqRateListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements ReqRptPreWoreqRateListDAO
{
    ...
    public List findList(ReqRptPreWoreqRateCommonDTO reqRptPreWoreqRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("     , CONVERT(NUMERIC(5,2), (SUM(c_cnt) * 1.0 / SUM(tot_cnt)) *100)      AS mitRate      ");
        query.append(" FROM  ( SELECT                                                                           ");
        query.append("                a.comp_no                                                                 ");
        query.append("              , a.plant                                                                   ");
        query.append("              , (SUBSTRING(a.wkor_date, 1, 4)+'-'+SUBSTRING(a.wkor_date, 5, 2)) AS yyyymm ");
