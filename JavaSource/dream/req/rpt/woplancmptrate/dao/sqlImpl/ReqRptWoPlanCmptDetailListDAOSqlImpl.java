 ...
 */
public class ReqRptWoPlanCmptDetailListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements ReqRptWoPlanCmptDetailListDAO
{
    ...
    public List findList(ReqRptWoPlanCmptDetailListDTO reqRptWoPlanCmptDetailListDTO, User user) throws Exception
    {
        ...
        query.getDate("ISNULL(E.end_date, a.end_date)", "initDate");
