 ...
 */
public class ReqRptPreWoPlanDetailListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements ReqRptPreWoPlanDetailListDAO
{			
    ...
    public List findList(ReqRptPreWoPlanDetailListDTO reqRptPreWoPlanDetailListDTO, User user) throws Exception
    {
        ...
        query.append("    ,left(a.cre_date,8)																						AS WoCreDate		");
        ...
        query.getOrderByQuery("a.wkor_id","a.wkor_date ASC", reqRptPreWoPlanDetailListDTO.getOrderBy(), reqRptPreWoPlanDetailListDTO.getDirection());
