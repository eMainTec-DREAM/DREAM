 ...
 * 
 */
public class MaWoReqResDetailDTO extends BaseDTO
{
    /** 처리사항 ID */
    ...
    public String getWoReqGenType() {
		return woReqGenType;
	}
	public void setWoReqGenType(String woReqGenType) {
		this.woReqGenType = woReqGenType;
	}
	/** 작업요청처리방법 */
