 ...
 */
public class ReqWoPlanRsltListDAOSqlImpl extends BaseJdbcDaoSupportSql implements ReqWoPlanRsltListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(MaWoReqCommonDTO maWoReqCommonDTO,ReqWoPlanRsltListDTO reqWoPlanRsltListDTO, User user)
    {
        ...
        query.append("     , dbo.SFACODETODESC(y.pm_type, 'PM_TYPE', 'SYS', x.comp_no) 		AS pmTypeDesc	");
        ...
        query.getOrderByQuery("x.woreqres_id", "y.wo_no", reqWoPlanRsltListDTO.getOrderBy(), reqWoPlanRsltListDTO.getDirection());
