 ...
 */
public class ReqWorkDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements ReqWorkDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public ReqWorkDetailDTO findDetail(ReqWorkCommonDTO reqWorkCommonDTO, User user)
    {
        ...
        //query.append("      , SUBSTR(x.req_time, 9, 2) ||':'|| SUBSTR(x.req_time, 11, 2)  AS reqTime          ");
