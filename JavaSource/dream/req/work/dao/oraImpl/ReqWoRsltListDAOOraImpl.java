 ...
 */
public class ReqWoRsltListDAOOraImpl extends BaseJdbcDaoSupportOra implements ReqWoRsltListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(MaWoReqCommonDTO maWoReqCommonDTO,ReqWoRsltListDTO reqWoRsltListDTO, User user)
    {
        ...
        query.getOrderByQuery("y.wo_no", reqWoRsltListDTO.getOrderBy(), reqWoRsltListDTO.getDirection());
