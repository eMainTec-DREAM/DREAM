 ...
 */
public class MaWoReqListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaWoReqListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(MaWoReqCommonDTO maWoReqCommonDTO, User user)
    {
        ...
        query.append("     , SFACODE_TO_DESC(x.req_priority,'REQ_PRIORITY','SYS',x.comp_no,'"+user.getLangId()+"') 							AS REQPRIORITYDESC	");
        query.append("     ,(SELECT a.description              																									");
        ...
        query.append("     , SFACODE_TO_DESC(x.woreq_channel,'WOREQ_CHANNEL','SYS','"+ user.getCompNo() +"','"+ user.getLangId() +"')		AS REQCHANNELDESC	");
        query.append("     , (SELECT a.description             																									");
        ...
        query.getOrderByQuery("x.woreq_id desc", maWoReqCommonDTO.getOrderBy(), maWoReqCommonDTO.getDirection());
