 ...
 */
public class MaQnaListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaQnaListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findQnaList(MaQnaCommonDTO maQnaCommonDTO)
    {
        ...
        query.getOrderByQuery("x.question_id","x.reg_date desc", maQnaCommonDTO.getOrderBy(), maQnaCommonDTO.getDirection());
    ...
    {        
        ...
        query.getAndQuery("x.question_no", maQnaCommonDTO.getFilterQuestionNo());
        query.getAndQuery("x.title", maQnaCommonDTO.getFilterQuestionTitle());
