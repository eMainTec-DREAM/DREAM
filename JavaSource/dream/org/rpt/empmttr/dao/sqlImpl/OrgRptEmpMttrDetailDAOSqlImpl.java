 ...
 */
public class OrgRptEmpMttrDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements OrgRptEmpMttrDetailDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findDetail(OrgRptEmpMttrCommonDTO orgRptEmpMttrCommonDTO, OrgRptEmpMttrDetailDTO orgRptEmpMttrDetailDTO, User loginUser)
    {
        ...
        query.append("    ) x                                           ");
        query.getOrderByQuery("x.empId","x.wkorDate", orgRptEmpMttrDetailDTO.getOrderBy(), orgRptEmpMttrDetailDTO.getDirection());
