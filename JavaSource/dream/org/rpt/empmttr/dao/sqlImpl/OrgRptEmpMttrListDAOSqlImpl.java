package dream.org.rpt.empmttr.dao.sqlImpl;
 ...
 */
public class OrgRptEmpMttrListDAOSqlImpl extends BaseJdbcDaoSupportSql implements OrgRptEmpMttrListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(OrgRptEmpMttrCommonDTO orgRptEmpMttrCommonDTO, User loginUser)
    {
        ...
        query.append("    , ROUND((x.workTime/CASE x.failCnt WHEN 0 THEN 1 ELSE x.failCnt END),2) AS mttr     ");
        query.append(" FROM                 ");
        query.append("    (                 ");
        query.append("        SELECT        ");
        ...
        query.append("    ) x                                           ");
        query.getOrderByQuery("x.empId","ROUND((x.workTime/CASE x.failCnt WHEN 0 THEN 1 ELSE x.failCnt END),2)", orgRptEmpMttrCommonDTO.getOrderBy(), orgRptEmpMttrCommonDTO.getDirection());
