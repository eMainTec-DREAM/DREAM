 ...
 */
public class MaVendorDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaVendorDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaVendorDetailDTO findDetail(String compNo, String vendorId, User user)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(x.vendor_type , 'VENDOR_TYPE', 'USR', '"+compNo+"','"+user.getLangId()+"') vendorTypeDesc         ");
