 ...
 */
public class LovEmpListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovEmpListDAO
{
    /**
     * 검색
     * @author  ssong
    ...
    public List findEmpList(LovEmpListDTO lovEmpListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.emp_id", lovEmpListDTO.getOrderBy(), lovEmpListDTO.getDirection());
	...
	public List findEmpAcList(LovEmpListDTO lovEmpListDTO, User user, Map<String, String> conditionMap) {
        ...
        query.getCodeLikeQuery("x.is_join","SFACODE_TO_DESC(x.is_join,'IS_USE','SYS','','"+user.getLangId()+"')", lovEmpListDTO.getIsJoinId(), lovEmpListDTO.getIsJoinDesc());;
        ...
        query.getOrderByQuery("emp_id", lovEmpListDTO.getOrderBy(), lovEmpListDTO.getDirection());
