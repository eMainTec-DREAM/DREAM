 ...
 */
public class OrgEmpCertDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements OrgEmpCertDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public OrgEmpCertDetailDTO findDetail(OrgEmpCertListDTO orgEmpCertListDTO, MaEmpCommonDTO maEmpCommonDTO, User user)
    {
        ...
        query.append("		 SFACODE_TO_DESC(y.cert_type,'CERT_TYPE','USR','"+user.getCompNo()+"','"+user.getLangId()+"') 			certTypeDesc,	");
        query.append("       x.acq_date acqDate,		");
        query.append("       x.exp_date as expDate,		");      
        query.append("       x.empcert_status empCertStatus,		");
        query.append("		 SFACODE_TO_DESC(x.empcert_status,'EMPCERT_STATUS','SYS','','"+user.getLangId()+"') 			empCertStatusDesc,	");
