 ...
 */
public class MaEmpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEmpListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(x.is_mail_rec, 'IS_USE', 'SYS', x.comp_no,'"+user.getLangId()+"') isMailRecDesc ");
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(x.is_direct, 'IS_USE', 'SYS', x.comp_no,'"+user.getLangId() + "')     isDirectDesc    		");
        query.append("FROM   TAEMP x                                            ");
        query.append("WHERE  1=1                                                "); 
        query.append(this.getWhere(maEmpCommonDTO, user));
        query.getOrderByQuery("x.emp_id","x.emp_id", maEmpCommonDTO.getOrderBy(), maEmpCommonDTO.getDirection());
