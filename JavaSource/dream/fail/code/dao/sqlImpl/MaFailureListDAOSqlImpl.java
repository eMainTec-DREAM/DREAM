 ...
 */
public class MaFailureListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaFailureListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.getOrderByQuery("x.failure_id", "x.fail_type, ISNULL(x.ord_no, 9999)", maFailureCommonDTO.getOrderBy(), maFailureCommonDTO.getDirection());
