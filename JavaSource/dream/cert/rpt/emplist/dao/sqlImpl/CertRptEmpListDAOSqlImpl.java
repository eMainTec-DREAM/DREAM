package dream.cert.rpt.emplist.dao.sqlImpl;
 ...
 */
public class CertRptEmpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements CertRptEmpListDAO
{
	/**
     * grid find
     * @author  ssong
    ...
    public List findList(CertRptEmpCommonDTO certRptEmpCommonDTO    ,User user)
    {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.empcert_status, 'EMPCERT_STATUS', 'SYS', a.comp_no,'100') as empCertStatusName      ");
    ...
    private String getWhere(CertRptEmpCommonDTO certRptEmpCommonDTO, User user)
    {
        ...
        //상태
        query.getCodeLikeQuery("c.cert_type", "dbo.SFACODE_TO_DESC(c.cert_type, 'CERT_TYPE', 'USR', a.comp_no,'"+user.getLangId()+"')", 
