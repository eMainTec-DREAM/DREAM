 ...
 */
public class CertDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements CertDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public CertDetailDTO findDetail(User user, String certListId)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.cert_type, 'CERT_TYPE', 'USR', x.comp_no,'"+user.getLangId()+"') certTypeDesc, ");
