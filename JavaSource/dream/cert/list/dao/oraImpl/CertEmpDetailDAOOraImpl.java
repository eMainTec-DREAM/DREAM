 ...
 */
public class CertEmpDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements CertEmpDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public CertEmpDetailDTO findDetail(String empCertListId, User loginUser)
    {
        ...
        query.append("    ,SFACODE_TO_DESC(a.empcert_status, 'EMPCERT_STATUS', 'SYS', a.comp_no,'"+ loginUser.getCompNo()+ "') as empCertStatusName     ");
