 ...
 */
public class MaPtBudgetDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtBudgetDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaPtBudgetDetailDTO findDetail(MaPtBudgetCommonDTO maPtBudgetCommonDTO, User loginUser)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.accnt_no,'ACCNT_NO','SYS','','"+loginUser.getLangId()+"')    accountDesc,		");
