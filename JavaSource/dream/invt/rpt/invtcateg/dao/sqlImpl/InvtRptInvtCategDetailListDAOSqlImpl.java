 ...
 */
public class InvtRptInvtCategDetailListDAOSqlImpl extends BaseJdbcDaoSupportSql implements InvtRptInvtCategDetailListDAO
{
    @Override
    public List findDetailList(InvtRptInvtCategDetailListForm invtRptInvtCategDetailListForm, User loginUser)
    {
        ...
        query.append("    , dbo.SFACODE_TO_DESC(x.invt_type, 'INVT_TYPE', 'SYS', x.comp_no, '"+loginUser.getLangId()+"') INVTTYPEDESC		");
        ...
        query.append("GROUP BY x.comp_no, x.invt_type	");
