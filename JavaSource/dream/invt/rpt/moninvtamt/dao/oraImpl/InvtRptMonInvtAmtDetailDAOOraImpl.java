 ...
 */
public class InvtRptMonInvtAmtDetailDAOOraImpl  extends BaseJdbcDaoSupportOra implements InvtRptMonInvtAmtDetailDAO
{
    ...
    public List findDetailList(InvtRptMonInvtAmtDetailForm invtRptMonInvtAmtDetailForm, User loginUser)
    {
        ...
        query.append("       , NVL(SUM(y.totamt),0)    TOTPRICE    					");
