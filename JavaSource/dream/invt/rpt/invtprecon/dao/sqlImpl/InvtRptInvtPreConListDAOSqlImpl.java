 ...
 * @author youngjoo38
 * @version $Id: InvtRptInvtPreConListDAOSqlImpl.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class InvtRptInvtPreConListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements InvtRptInvtPreConListDAO
{
    ...
    public List findList(InvtRptInvtPreConCommonDTO invtRptInvtPreConCommonDTO, User user) throws Exception
    {
        ...
        query.append("    ,(SELECT aa.description FROM TADEPT aa WHERE aa.dept_id=a.deptId AND aa.comp_no=a.compNo)   dept  ");
        ...
        query.getOrderByQuery("a.compNo", "a.YEAR", invtRptInvtPreConCommonDTO.getOrderBy(), invtRptInvtPreConCommonDTO.getDirection());
    ...
    {        
        ...
        // 투자구분
        query.getCodeLikeQuery("invtCateg","dbo.SFACODE_TO_DESC(invtCateg,'INVT_CATEG','SYS','','"+user.getLangId()+"')", invtRptInvtPreConCommonDTO.getFilterInvtCateg(), invtRptInvtPreConCommonDTO.getFilterInvtCategDesc());
