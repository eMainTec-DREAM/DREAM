package dream.invt.rpt.priceexerate.dao.oraImpl;
 ...
 */
public class InvtRptPriceExeRateListDAOOraImpl  extends BaseJdbcDaoSupportOra implements InvtRptPriceExeRateListDAO
{
    ...
    public List findList(InvtRptPriceExeRateCommonDTO invtRptPriceExeRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("    ,NVL(b.mit_cnt,0) 																		as mitCnt		");
        query.append("    ,ROUND(NVL(b.mit_cnt,0) / case when b.tot_cnt is null then 1 else b.tot_cnt end *100,2) 	as mitRate		");
