 ...
 */
public class InvtPrcListDAOOraImpl extends BaseJdbcDaoSupportOra implements InvtPrcListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(InvtCommonDTO invtCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.invtlist_id", invtCommonDTO.getOrderBy(), invtCommonDTO.getDirection());
