 ...
 */
public class InvtPhaseListDAOSqlImpl extends BaseJdbcDaoSupportSql implements InvtPhaseListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(InvtCommonDTO invtCommonDTO, User user)
    {
        ...
        String compNo = invtCommonDTO.getCompNo();
        
        query.append("SELECT                                            ");
        query.append("       '' seqNo                                   ");
        query.append("       ,'' isDelCheck                             ");
        query.append("       ,a.ord_no ordNo                              ");
        query.append("       ,dbo.SFACODE_TO_DESC(a.invt_proc_ltype,'INVT_PROC_LTYPE','USR','"+user.getCompNo()+"','"+user.getLangId()+"') invtProcLtypeDesc  ");
        query.append("       ,dbo.SFACODE_TO_DESC(a.invt_proc_stype,'INVT_PROC_STYPE','USR','"+user.getCompNo()+"','"+user.getLangId()+"') invtProcStypeDesc  ");
//        query.append("       ,'' contents ");
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(a.invtphase_status,'INVTPHASE_STATUS','SYS','','"+user.getLangId()+"') invtphaseStatusDesc  ");
        ...
        query.getOrderByQuery("a.invtphase_id", "a.ord_no", invtCommonDTO.getOrderBy(), invtCommonDTO.getDirection());
    ...
    private String getWhere(InvtCommonDTO invtCommonDTO, User user)
    {
        ...
        {
            query.getAndQuery("invtphase_id", invtCommonDTO.getInvtphaseId());
