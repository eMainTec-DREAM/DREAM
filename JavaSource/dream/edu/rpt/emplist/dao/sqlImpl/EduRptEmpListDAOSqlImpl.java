package dream.edu.rpt.emplist.dao.sqlImpl;
 ...
 */
public class EduRptEmpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements EduRptEmpListDAO
{
	/**
     * grid find
     * @author  ssong
    ...
    public List findList(EduRptEmpCommonDTO eduRptEmpCommonDTO    ,User user)
    {
        ...
        query.getOrderByQuery("a.emptrainlist_id", "c.courselist_no", eduRptEmpCommonDTO.getOrderBy(), eduRptEmpCommonDTO.getDirection());
    ...
    private String getWhere(EduRptEmpCommonDTO eduRptEmpCommonDTO, User user)
    {
        ...
        //상태
        query.getCodeLikeQuery("c.course_type", "dbo.SFACODE_TO_DESC(c.course_type, 'EDU_TYPE', 'SYS', c.comp_no,'"+user.getLangId()+"')", 
