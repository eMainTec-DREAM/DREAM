 ...
 */
public class EduDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements EduDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public EduDetailDTO findDetail(User user, String courseListId)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.course_type, 'COURSE_TYPE', 'USR', x.comp_no,'"+user.getLangId()+"') courseTypeDesc, ");        
