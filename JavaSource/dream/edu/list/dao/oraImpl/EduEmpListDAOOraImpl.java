 ...
 */
public class EduEmpListDAOOraImpl extends BaseJdbcDaoSupportOra implements EduEmpListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findEmpList(EduCommonDTO eduCommonDTO, EduEmpListDTO eduEmpListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("b.dept_id, b.emp_no", eduEmpListDTO.getOrderBy(), eduEmpListDTO.getDirection());
