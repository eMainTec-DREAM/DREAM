 ...
 */
public class AssetStdCtctrDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetStdCtctrDetailDAO
{
    /**
     * detail find
     * @author ghlee
    ...
    public AssetStdCtctrDetailDTO findDetail(User user, String ctctrId)
    {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC( x.is_use, 'IS_USE','SYS',x.comp_no, ?)   isUse  ");
