 ...
 */
public class AssetStdProductEquipListDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetStdProductEquipListDAO
{
    ...
    { 
    	...
    	query.getOrderByQuery("x.prod_seq", assetStdProductCommonDTO.getOrderBy(), assetStdProductCommonDTO.getDirection());
	...
	public String getWhere(AssetStdProductCommonDTO assetStdProductCommonDTO, AssetStdProductEquipListDTO assetStdProductEquipListDTO, User user)
	{
		QueryBuffer query = new QueryBuffer();
