 ...
 */
public class MaLnGoalDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaLnGoalDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaLnGoalDetailDTO findDetail(MaLnGoalCommonDTO maLnGoalCommonDTO, User loginUser)
    {
        ...
        query.append("       plant,                                                             ");
        query.append("       dbo.SFAPLANTTODESC(comp_no, plant) plantDesc,                      ");
        query.append("       yyyymm,                                                            ");
