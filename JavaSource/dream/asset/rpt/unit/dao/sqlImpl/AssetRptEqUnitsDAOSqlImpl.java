package dream.asset.rpt.unit.dao.sqlImpl;
 ...
 */
public class AssetRptEqUnitsDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetRptEqUnitsDAO
{
	...
	public String getOrderBy(AssetRptEqUnitsDTO assetRptEqUnitsDTO, User user) {
		...
		query.getOrderByQuery("x.equip_id", "x.equip_id", assetRptEqUnitsDTO.getOrderBy(), assetRptEqUnitsDTO.getDirection());		
