package dream.asset.rpt.eqParts.dao.sqlImpl;
 ...
 */
public class AssetRptEqPartsDAOSqlImpl  extends BaseJdbcDaoSupportSql implements AssetRptEqPartsDAO
{
    public List findList(AssetRptEqPartsDTO assetRptEqPartsDTO, User user) throws Exception
    {
        ...
        query.append("    ,ISNULL(c.full_desc, c.description)   AS EQASMBDESC       ");
        ...
        query.getOrderByQuery("a.equip_id", "a.equip_id, b.eqpart_id", assetRptEqPartsDTO.getOrderBy(), assetRptEqPartsDTO.getDirection());
