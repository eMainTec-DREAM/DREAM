package dream.asset.rpt.nyearpo.dao.oraImpl;
 ...
 */
public class AssetRptNYearPOListDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetRptNYearPOListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(AssetRptNYearPOCommonDTO assetRptNYearPOCommonDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("a.ven_po_no", assetRptNYearPOCommonDTO.getOrderBy(), assetRptNYearPOCommonDTO.getDirection());
