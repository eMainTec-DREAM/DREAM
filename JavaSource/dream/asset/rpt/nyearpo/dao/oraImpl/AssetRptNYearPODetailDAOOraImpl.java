 ...
 */
public class AssetRptNYearPODetailDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetRptNYearPODetailDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findDetail(AssetRptNYearPOCommonDTO assetRptNYearPOCommonDTO, AssetRptNYearPODetailDTO assetRptNYearPODetailDTO, User loginUser)
    {
        ...
        query.append("   , TO_NUMBER(d.lead_time) * d.last_price  	AS TOTAMT				");
