package dream.asset.rpt.ass.asset.dao.oraImpl;
...
/**
 * AssetRptAssAssetScore Page - List DAO implements
 * @author nhkim8548
 * @version $Id: AssetRptAssAssetScoreListDAOOraImpl.java,v 1.0 2017/08/23 15:21:40 nhkim8548 Exp $
 * @since 1.0
 * 
 ...
 */
public class AssetRptAssAssetScoreListDAOOraImpl  extends BaseJdbcDaoSupportOra implements AssetRptAssAssetScoreListDAO
{
    /**
     * grid find
     * @author  nhkim8548
    ...
    public List findList(AssetRptAssAssetScoreCommonDTO assetRptAssAssetScoreCommonDTO, User user) throws Exception
    {
        ...
        query.append("       , SFACODE_TO_DESC(y.ass_point_type, 'ASS_POINT_TYPE', 'SYS', '"+ user.getCompNo() +"', '"+ user.getLangId() +"') AS assCategoryType ");
        ...
        query.getOrderByQuery("x.equip_id, y.eqasspval_id", assetRptAssAssetScoreCommonDTO.getOrderBy(), assetRptAssAssetScoreCommonDTO.getDirection());        
