 ...
 */
public class AssetRptWorkHistDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetRptWorkHistDetailDAO
{
    ...
    public AssetRptWorkHistDetailDTO findRptWorkHistDetail(AssetRptWorkHistCommonDTO assetRptWorkHistCommonDTO, User user) 
    {
        ...
        query.append("            , dbo.SFACODE_TO_DESC(x.WO_TYPE, 'WO_TYPE', 'SYS','', ?)                                					AS WOTYPE       	");
