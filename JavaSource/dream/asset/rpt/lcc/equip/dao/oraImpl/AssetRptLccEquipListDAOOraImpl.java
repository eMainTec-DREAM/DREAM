 ...
 */
public class AssetRptLccEquipListDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetRptLccEquipListDAO
{
    /**
     * grid find
     * @author  ghlee
...
//        query.append("    ,(SELECT description FROM TADEPT WHERE dept_id=b.usage_dept)   usageDeptDesc        ");
        ...
        query.getOrderByQuery("COUNT(a.item_no) DESC", assetRptLccEquipCommonDTO.getOrderBy(), assetRptLccEquipCommonDTO.getDirection());
