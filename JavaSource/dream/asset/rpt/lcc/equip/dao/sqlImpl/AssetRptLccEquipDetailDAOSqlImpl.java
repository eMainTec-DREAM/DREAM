 ...
 */
public class AssetRptLccEquipDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetRptLccEquipDetailDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findDetail(AssetRptLccEquipDetailDTO assetRptLccEquipDetailDTO, User loginUser)
    {
        ...
        for(int i=0; i<monthArr.length; i++){
            ...
            if("0".equals(this.findCount(assetRptLccEquipDetailDTO, loginUser))) {
                ...
                query.append("	  ,COALESCE(MAX(x.equipId),0)											equipId	  	  ");
                query.append("	  ,COALESCE(MAX(x.equipDesc),'')										equipDesc	  ");
                query.append("FROM                                                                                    ");
                query.append("    (                                                                         ");
                query.append("    SELECT                                                                    ");
    ...
    public String getWhere(AssetRptLccEquipDetailDTO assetRptLccEquipDetailDTO,User loginUser)
    {
        ...
        String fromDate = assetRptLccEquipDetailDTO.getStartDate().replace("-", "") + "01";
        String toDate   = assetRptLccEquipDetailDTO.getEndDate().replace("-", "") + "31";
