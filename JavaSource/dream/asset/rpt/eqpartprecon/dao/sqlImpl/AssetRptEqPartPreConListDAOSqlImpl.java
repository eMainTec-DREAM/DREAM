 ...
 */
public class AssetRptEqPartPreConListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements AssetRptEqPartPreConListDAO
{
    ...
    public List findList(AssetRptEqPartPreConCommonDTO assetRptEqPartPreConCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.equip_id", "x.description", assetRptEqPartPreConCommonDTO.getOrderBy(), assetRptEqPartPreConCommonDTO.getDirection());
