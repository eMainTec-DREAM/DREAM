 ...
 */
public class AssetRptMtbfmttrUsDeptListDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetRptMtbfmttrUsDeptListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(AssetRptMtbfmttrUsDeptCommonDTO assetRptMtbfmttrUsDeptCommonDTO, User loginUser) throws Exception
    {
        ...
        query.append("WHERE 1=1                                                                                                         ");
        query.getOrderByQuery("a.usage_dept", assetRptMtbfmttrUsDeptCommonDTO.getOrderBy(), assetRptMtbfmttrUsDeptCommonDTO.getDirection());
