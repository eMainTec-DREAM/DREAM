 ...
 */
public class AssetRptMtbfmttrEquipListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetRptMtbfmttrEquipListDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findList(AssetRptMtbfmttrEquipCommonDTO assetRptMtbfmttrEquipCommonDTO, User loginUser) throws Exception
    {
        ...
        query.getOrderByQuery("a.equip_id", "(SELECT full_desc FROM TAEQLOC WHERE comp_no = a.comp_no AND eqloc_id = a.eqloc_id), a.description", assetRptMtbfmttrEquipCommonDTO.getOrderBy(), assetRptMtbfmttrEquipCommonDTO.getDirection());
