 ...
 */
public class AssetRptMtbfmttrLocListDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetRptMtbfmttrLocListDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findList(AssetRptMtbfmttrLocCommonDTO assetRptMtbfmttrLocCommonDTO, User loginUser) throws Exception
    {
        ...
        query.getOrderByQuery("(SELECT full_desc FROM TAEQLOC WHERE comp_no=a.comp_no and eqloc_id=a.eqloc_id)", assetRptMtbfmttrLocCommonDTO.getOrderBy(), assetRptMtbfmttrLocCommonDTO.getDirection());
