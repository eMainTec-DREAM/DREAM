 ...
 */
public class AssetListAssListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements AssetListAssListDAO
{
    ...
    public List findList(AssetListAssListDTO assetListAssListDTO, User user) throws Exception
    {
        ...
        query.append("      , (SELECT dbo.SFACODE_TO_DESC( x.eqasslist_type, 'EQASSLIST_TYPE', 'SYS', x.comp_no, '"+user.getLangId()+"') 		");
        query.append("        )    					AS ASSTYPEDESC					"); 
        ...
        query.getOrderByQuery("x.eqasslist_id", "x.eqasslist_no", assetListAssListDTO.getOrderBy(), assetListAssListDTO.getDirection());
