 ...
 */
public class MaEqMstrMoldModHistListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrMoldModHistListDAO 
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findMoldModHistList(MaEqMstrCommonDTO maEqMstrCommonDTO, MaEqMstrMoldModHistListDTO maEqMstrMoldModHistListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("a.eqmoldmodhist_id", "a.ord_no", maEqMstrMoldModHistListDTO.getOrderBy(), maEqMstrMoldModHistListDTO.getDirection());
