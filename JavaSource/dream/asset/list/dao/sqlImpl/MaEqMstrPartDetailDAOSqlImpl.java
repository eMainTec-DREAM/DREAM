 ...
 */
public class MaEqMstrPartDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrPartDetailDAO
{
    String compNo = "";
    ...
    public int insertDetail(MaEqMstrPartDetailDTO maEqMstrPartDetailDTO, MaEqMstrCommonDTO maEqMstrCommonDTO, User user)
    {
        ...
        result = getJdbcTemplate().update(query.toString(), getObject(objects));
