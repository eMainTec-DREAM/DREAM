 ...
 * 설비 예방점검 목록 dao
 * @author  kim21017
 * @version $Id: MaEqMstrPmInsListDAOSqlImpl.java,v 1.0 2015/12/02 09:14:12 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmInsListDAOTarget"
 * @spring.txbn id="maEqMstrPmInsListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmInsListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrPmInsListDAO
{
	...
	public List findEqPmInsList(MaEqMstrCommonDTO maEqMstrCommonDTO, MaEqMstrPmInsListDTO maEqMstrPmInsListDTO, User user)
		...
		query.getOrderByQuery("x.pm_id", "x.pm_no", maEqMstrPmInsListDTO.getOrderBy(), maEqMstrPmInsListDTO.getDirection());
