 ...
 * 설비 예방점검 항목 목록 dao
 * @author  kim21017
 * @version $Id: MaEqMstrPmInsPointListDAOSqlImpl.java,v 1.0 2015/12/02 09:14:12 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmInsPointListDAOTarget"
 * @spring.txbn id="maEqMstrPmInsPointListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmInsPointListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrPmInsPointListDAO
{
	...
	public List findEqPmInsPointList(MaEqMstrPmInsDetailDTO maEqMstrPmInsDetailDTO, MaEqMstrPmInsPointListDTO maEqMstrPmInsPointListDTO, User user) throws Exception {
		...
		query.getOrderByQuery("x.pm_point_id", "x.step_num", maEqMstrPmInsPointListDTO.getOrderBy(), maEqMstrPmInsPointListDTO.getDirection());
