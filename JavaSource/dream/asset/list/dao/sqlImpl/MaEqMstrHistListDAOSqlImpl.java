 ...
 */
public class MaEqMstrHistListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrHistListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findEqMstrHistList(MaEqMstrHistListDTO maEqMstrHistListDTO, User user)
    {
        ...
        query.getDate("SUBSTRING(x.upd_date,1,8)", "changeDate");
        query.append(",																	");
        ...
        query.append("		(SELECT dbo.SFACODE_TO_DESC(a.plf_type,'PLF_TYPE','SYS','','"+user.getLangId()+"')		");
