 ...
 */
public class AssetListMstrToolsListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetListMstrToolsListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findPartList(MaEqMstrCommonDTO maEqMstrCommonDTO, AssetListMstrToolsListDTO assetListMstrToolsListDTO, User loginUser)
    {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(b.guage_type, 'GUAGE_TYPE','USR',b.comp_no, '"+loginUser.getLangId()+"') as gaugeType ");
        query.append("    ,a.maker                                                              maker     ");
        query.append("    ,a.model_no                                                           model     ");
        query.append("    ,(select top 1 aa.last_cplt_date from tapmequip aa where a.comp_no = aa.comp_no and a.equip_id = b.equip_id ) as LASTCPLTDATE ");
        query.append("    ,(select top 1 aa.next_plan_date from tapmequip aa where a.comp_no = aa.comp_no and a.equip_id = b.equip_id ) as NEXTPLANDATE ");
        ...
        query.getOrderByQuery("a.equip_id", "a.item_no", assetListMstrToolsListDTO.getOrderBy(), assetListMstrToolsListDTO.getDirection());
