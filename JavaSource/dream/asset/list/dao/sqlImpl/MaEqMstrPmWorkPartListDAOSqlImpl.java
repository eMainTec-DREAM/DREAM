 ...
 * 설비 예방작업 부품 목록 dao
 * @author  kim21017
 * @version $Id: MaEqMstrPmWorkPartListDAOSqlImpl.java,v 1.0 2015/12/02 09:14:12 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmWorkPartListDAOTarget"
 * @spring.txbn id="maEqMstrPmWorkPartListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmWorkPartListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrPmWorkPartListDAO
{
	...
	public List findEqPmWorkPartList(MaEqMstrPmWorkDetailDTO maEqMstrPmWorkDetailDTO, MaEqMstrPmWorkPartListDTO maEqMstrPmWorkPartListDTO, User user) throws Exception {
		...
		query.getOrderByQuery("y.part_id", "y.part_no", maEqMstrPmWorkPartListDTO.getOrderBy(), maEqMstrPmWorkPartListDTO.getDirection());
