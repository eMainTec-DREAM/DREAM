 ...
 */
public class LovEquipListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovEquipListDAO
{
    /**
     * 설비 검색
     * @author  ssong
    ...
    public List findEquipList(LovEquipListDTO lovEquipListDTO, User loginUser, Map<String, String> conditionMap)
    {
        ...
        query.append("      dbo.SFACODE_TO_DESC(x.eq_status,'EQ_STATUS','SYS','','"+loginUser.getLangId()+"') eqStatusDesc,   ");
        ...
        query.append("		, dbo.SFACODE_TO_DESC(x.eqctg_type,'EQCTG_TYPE','SYS','','"+loginUser.getLangId()+"')	eqCtgTypeDesc	");
        ...
        query.getOrderByQuery("x.equip_id", "x.ord_no", lovEquipListDTO.getOrderBy(), lovEquipListDTO.getDirection());
...
//		query.getAndQuery("eqctg_type", conditionMap);
        query.append(this.getWhere(lovEquipListDTO, loginUser, conditionMap));
        //query.append("ORDER BY ord_no													");
        query.getOrderByQuery("x.equip_id", "x.ord_no, x.item_no, x.equip_id", lovEquipListDTO.getOrderBy(), lovEquipListDTO.getDirection());
