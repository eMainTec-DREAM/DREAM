 ...
 */
public class AssetListTcycleDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssetListTcycleDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public AssetListTcycleDetailDTO findDetail(String equipId, String eqPmCycleId, User user)
    {
        ...
        query.append("       dbo.SFACODE_TO_DESC(y.period_type, 'PERIOD_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"') periodTypeDesc,	");
...
//        query.append("				AND pmsched_status<>'C')) nextCalDate						");
        ...
        query.append("FROM   TAEQPMCYCLE x 								");
