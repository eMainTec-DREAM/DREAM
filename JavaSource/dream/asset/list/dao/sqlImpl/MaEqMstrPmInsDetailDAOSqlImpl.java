 ...
 * 설비 예방점검 상세 dao
 * @author  kim21017
 * @version $Id: MaEqMstrPmInsDetailDAOSqlImpl.java,v 1.0 2015/12/04 08:10:27 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmInsDetailDAOTarget"
 * @spring.txbn id="maEqMstrPmInsDetailDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmInsDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrPmInsDetailDAO
{
