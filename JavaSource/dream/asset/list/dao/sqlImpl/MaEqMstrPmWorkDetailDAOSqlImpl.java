 ...
 * 설비 예방작업 상세 dao
 * @author  kim21017
 * @version $Id: MaEqMstrPmWorkDetailDAOSqlImpl.java,v 1.0 2015/12/04 08:10:27 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmWorkDetailDAOTarget"
 * @spring.txbn id="maEqMstrPmWorkDetailDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmWorkDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrPmWorkDetailDAO
{
	...
	public MaEqMstrPmWorkDetailDTO findDetail(MaEqMstrCommonDTO maEqMstrCommonDTO, MaEqMstrPmWorkListDTO maEqMstrPmWorkListDTO,
		...
		query.append("		,dbo.SFACODE_TO_DESC(x.period_type,'PERIOD_TYPE','SYS','','"+user.getLangId()+"') AS periodTypeDesc		");
		...
		MaEqMstrPmWorkDetailDTO maEqMstrPmWorkDetailDTO = 
				(MaEqMstrPmWorkDetailDTO)this.getJdbcTemplate().query(query.toString(), new MwareExtractor(new MaEqMstrPmWorkDetailDTO()));
