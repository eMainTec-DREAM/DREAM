 ...
 */
public class MaEqMstrAsmbDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrAsmbDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public int resetEqAsmbFullDesc(String compNo)
    {
        ...
        query.append("EXEC dbo.SP_EQ_UPD_EQASMB_ALL '"+compNo+"'; ");
	...
	{		
    	...
    	{	// 전체 복사인 경우
    		query.append("  , NEXT VALUE FOR sqaeqasmb_id    	");
    		query.append("  , NEXT VALUE FOR sqaeqasmb_id    	");
    	}
