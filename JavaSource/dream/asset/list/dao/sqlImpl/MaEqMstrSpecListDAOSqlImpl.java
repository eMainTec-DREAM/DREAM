 ...
 */
public class MaEqMstrSpecListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrSpecListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findSpecList(MaEqMstrCommonDTO maEqMstrCommonDTO, MaEqMstrSpecListDTO maEqMstrSpecListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.eqspec_id", "x.ord_no", maEqMstrSpecListDTO.getOrderBy(), maEqMstrSpecListDTO.getDirection());
