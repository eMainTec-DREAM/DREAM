 ...
 */
public class MaEqMstrHistDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMstrHistDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaEqMstrHistDetailDTO findDetail(String eqalthist_id, User user)
    {
        ...
        query.append("		dbo.SFACODE_TO_DESC(y.plf_type,'PLF_TYPE','SYS','','"+user.getLangId()+"')	plfTypeDesc,	");
