...
/**
 * 설비 예방작업 부품 상세 DAO IMPL
 * @author  kim21017
 * @version $Id: MaEqMstrPmWorkPartDetailDAOOraImpl.java,v 1.0 2015/12/04 08:10:27 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmWorkPartDetailDAOTarget"
 * @spring.txbn id="maEqMstrPmWorkPartDetailDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmWorkPartDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqMstrPmWorkPartDetailDAO
{
