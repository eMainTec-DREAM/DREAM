 ...
 */
public class AssetListPartOpQtyDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetListPartOpQtyDAO
{
    @Override
    public List find(AssetListPartOpQtyDTO assetListPartOpQtyDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("a.ord_no", assetListPartOpQtyDTO.getOrderBy(), assetListPartOpQtyDTO.getDirection());
