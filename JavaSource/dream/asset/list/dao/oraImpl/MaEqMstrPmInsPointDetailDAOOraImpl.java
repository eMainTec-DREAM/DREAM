...
/**
 * 설비 예방점검 항목 상세 DAO IMPL
 * @author  kim21017
 * @version $Id: MaEqMstrPmInsPointDetailDAOOraImpl.java,v 1.0 2015/12/04 08:10:27 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmInsPointDetailDAOTarget"
 * @spring.txbn id="maEqMstrPmInsPointDetailDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmInsPointDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqMstrPmInsPointDetailDAO
{
