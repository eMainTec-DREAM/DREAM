 ...
 * 설비 예방작업 목록 DAO IMPL
 * @author  kim21017
 * @version $Id: MaEqMstrPmWorkListDAOOraImpl.java,v 1.0 2015/12/02 09:14:12 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmWorkListDAOTarget"
 * @spring.txbn id="maEqMstrPmWorkListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmWorkListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqMstrPmWorkListDAO
{
	...
	public List findEqPmWorkList(MaEqMstrCommonDTO maEqMstrCommonDTO, MaEqMstrPmWorkListDTO maEqMstrPmWorkListDTO, User user)
		...
		query.getOrderByQuery("x.pm_no", maEqMstrPmWorkListDTO.getOrderBy(), maEqMstrPmWorkListDTO.getDirection());
