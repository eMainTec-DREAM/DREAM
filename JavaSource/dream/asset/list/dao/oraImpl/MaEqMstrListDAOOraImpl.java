 ...
 */
public class MaEqMstrListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqMstrListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findEqMstrList(MaEqMstrCommonDTO maEqMstrCommonDTO, User user)
    {
        ...
        query.append("        FROM TAEQLOC                                             	");
        query.append("        WHERE comp_no = x.comp_no                                 ");
        query.append("         AND eqloc_lvl_type ='L4'                                	");
        query.append("          AND eqloc_id = x.eqloc_id)              eqLocNo         ");
        query.append("		,(SELECT full_desc											");
        ...
        query.append("        START WITH A.dept_id = x.usage_dept                       ");
        query.append("        CONNECT BY PRIOR p_dept_id = dept_id                      ");
        query.append("       ) 											usageTeamDept	");
        query.append("      ,(SELECT description                                        ");
        ...
        //예방점검,정기교체 갯수
        query.append("  ,(select case when count(*) > 0 then 'Y' else 'N' end                 ");
...
//        query.append(", SFACODE_TO_DESC(x.eq_grade,'EQ_GRADE','SYS','','"+user.getLangId()+"') eqGradeDesc");
        ...
        query.append("        ,(SELECT      											");
        query.append("        		(SELECT description FROM TADEPT WHERE comp_no=b.comp_no AND dept_id=b.dept_id)||'/'||b.emp_name    ");
        query.append("         FROM TAUSER a INNER JOIN TAEMP b                         ");
        query.append("         ON a.comp_no = b.comp_no                                 ");
        query.append("          AND a.emp_id = b.emp_id                                 ");
        query.append("         WHERE a.comp_no = x.comp_no                             	");
        query.append("          AND a.user_id = x.upd_by)				updBy       	");
        ...
        query.append("        	 AND a.emp_id = b.emp_id                   				");
        query.append("         WHERE a.comp_no = x.comp_no       						");
        query.append("        	 AND a.user_id = x.cre_by) 				creBy       	");
        ...
        query.getOrderByQuery("x.ord_no", maEqMstrCommonDTO.getOrderBy(), maEqMstrCommonDTO.getDirection());
    ...
    public List findEqToolMstrList(MaEqMstrCommonDTO maEqMstrCommonDTO, User user)
    {
        ...
        query.append("      SFACODE_TO_DESC(y.guage_type,'GUAGE_TYPE','USR','"+compNo+"','ko') guaTypeDesc,         ");
        query.append("      (select param1 from tacdsysd where list_type='EQCTG_TYPE' AND cdsysd_no = x.eqctg_type) param,");
        query.append("      SFACODE_TO_DESC(x.revision_status,'REVISION_STATUS','SYS','','"+user.getLangId()+"')    revisionStatus,    ");
        query.append("      x.is_last_version                                  isLastVersion        ");
        query.append("      ,x.prod_shape                               prodShape    ");
        ...
        query.append("       WHERE a.comp_no=x.comp_no AND a.user_id=x.cre_by)  creBy   ");
        query.append("      ,x.cre_date	           creDate 								");
        query.append("      ,(SELECT A.CYCLE||SFACODE_TO_DESC(A.period_type,'PERIOD_TYPE','SYS','','ko')        ");
        ...
        query.getOrderByQuery("22", maEqMstrCommonDTO.getOrderBy(), maEqMstrCommonDTO.getDirection());
    ...
    public List findEqMoldMstrList(MaEqMstrCommonDTO maEqMstrCommonDTO,User user)
    {
        ...
        query.append("      ,SFACODE_TO_DESC(y.eqmold_atype, 'EQMOLD_ATYPE', 'USR', x.comp_no, '"+user.getLangId()+"') eqMoldAtypeDesc       ");
        query.append("      ,SFACODE_TO_DESC(y.eqmold_btype, 'EQMOLD_BTYPE', 'USR', x.comp_no, '"+user.getLangId()+"') eqMoldBtypeDesc       ");
        query.append("      ,SFACODE_TO_DESC(y.eqmold_ctype, 'EQMOLD_CTYPE', 'USR', x.comp_no, '"+user.getLangId()+"') eqMoldCtypeDesc       ");
        query.append("FROM   TAEQUIPMENT x INNER JOIN TAEQMOLD y                       	");
        query.append("  ON x.comp_no = y.comp_no                                     	");
        query.append(" and x.equip_id = y.equip_id                                   	");
        query.append(this.getWhere(maEqMstrCommonDTO,user));
        query.append("    and x.EQCTG_TYPE = 'MD'                                       ");
        query.getCodeLikeQuery("y.eqmold_atype", "SFACODE_TO_DESC(y.eqmold_atype, 'EQMOLD_ATYPE', 'USR', '"+user.getCompNo()+"', '"+user.getLangId()+"')", maEqMstrCommonDTO.getFilterEqMoldAtype(), maEqMstrCommonDTO.getFilterEqMoldAtypeDesc());
        query.getCodeLikeQuery("y.eqmold_btype", "SFACODE_TO_DESC(y.eqmold_btype, 'EQMOLD_BTYPE', 'USR', '"+user.getCompNo()+"', '"+user.getLangId()+"')", maEqMstrCommonDTO.getFilterEqMoldBtype(), maEqMstrCommonDTO.getFilterEqMoldBtypeDesc());
        query.getCodeLikeQuery("y.eqmold_ctype", "SFACODE_TO_DESC(y.eqmold_ctype, 'EQMOLD_CTYPE', 'USR', '"+user.getCompNo()+"', '"+user.getLangId()+"')", maEqMstrCommonDTO.getFilterEqMoldCtype(), maEqMstrCommonDTO.getFilterEqMoldCtypeDesc());
        query.getOrderByQuery("x.ord_no", maEqMstrCommonDTO.getOrderBy(), maEqMstrCommonDTO.getDirection());
    ...
    {        
        ...
        if (!"".equals(maEqMstrCommonDTO.getFilterStartDate()) || !"".equals(maEqMstrCommonDTO.getFilterEndDate()))
        {
            ...
            query.append(" AND y.wrk_date >= TO_CHAR(TRUNC(SYSDATE, 'IW') + 0 ,'yyyymmdd')  ");
            query.append(" AND y.wrk_date <= TO_CHAR(SYSDATE,'yyyymmdd')                    ");
        ...
        //상태
        query.getCodeLikeQuery("x.eq_status","SFACODE_TO_DESC(x.eq_status,'EQ_STATUS','SYS','','"+user.getLangId()+"')", maEqMstrCommonDTO.getEqStatusId(), maEqMstrCommonDTO.getEqStatusDesc());;
	...
	public int insertCopyEqAsmb(String newId, String oldId, User user)
	{
    	...
    	query.append("	) SELECT 										");
    	query.append("	 x.comp_no,		sqaeqasmb_id.nextval,	?,		");
	...
	public int insertCopyEqTool(String newId, String oldId, User user)
	{
    	...
    	query.append("	 , tolerance, pmcalibstdtp_id, cal_point							");
    	query.append("	) SELECT 															");
	...
	public int insertCopyEqSpec(String newId, String oldId, User user)
	{
    	...
    	query.append("	) SELECT 											");
    	query.append("	comp_no, sqaeqspec_id.nextval, ?, categ, prompt		");
    	query.append("	 , response, uom, ord_no							");
	...
	public int insertCopyEqPart(String newId, String oldId, User user)
	{
    	...
    	query.append("	) SELECT 																		");
    	query.append("	comp_no, sqaeqpart_id.nextval, eqasmb_id, ?, part_id							");
		query.append("	 , consist_qty																	");
		query.append("	 , eq_ctg_part_id, eq_ctg_asmb_id												");
	...
	public int insertCopyEqAsset(String newId, String oldId, User user)
	{
    	...
    	query.append("	) SELECT 											");
    	query.append("	comp_no, sqaeqasset_id.nextval, asset_id, ?			");
	...
	public int insertCopyEqItems(String newId, String oldId, User user)
	{
		...
		query.append("	) SELECT 											");
    	query.append("	comp_no, sqaeqitem_id.nextval,?,item_name, item_qty	");
    	query.append("	, remark, ord_no									");
	...
	public int insertCopyEqVendor(String newId, String oldId, User user)
	{
		...
		query.append("	) SELECT 											");
    	query.append("	comp_no, sqaeqvendor_id.nextval, ?, vendor_id		");
	...
	public int insertCopyEqHist(String newId, String oldId, User user)
	{
    	...
    	query.append("	)	SELECT											");
    	query.append("	 x.comp_no,		SQAEQALTHIST_ID.nextval,TO_CHAR(SYSDATE,'YYYYMMDD HH24:MI:SS'),		");
	...
	public void SP_IF_UPD_TXEQUIPMENT(String equipId, User user) throws Exception
    {
        ...
        query.append("begin                                                 ");
        query.append("SP_IF_UPD_TXEQUIPMENT('"+user.getCompNo()+"', "+equipId+", '"+user.getUserNo()+"');     ");
        query.append("end;                                                  ");
	...
	public List findImgFileList(String oldImageId, User user)
    {
        ...
        query.append("       ,sqaimgdata_id.nextval new_imgdata_id  ");
	...
	public List findImgList(String objectId, String objectType, User user)
    {
        ...
        query.append("       ,sqaimage_id.nextval new_image_id      ");
	...
	public List findDocList(String objectId, String objectType, User user)
    {
        ...
        query.append("       ,sqaobjdoc_id.nextval 	AS new_objdoc_id	");
	...
	public List findDocFileList(String oldDocId, User user)
    {
        ...
        query.append("       ,x.nf_file_name 		AS nf_file_name     ");
        query.append("       ,x.nf_file_path 		AS nf_file_path     ");
        query.append("       ,sqadocdata_no.nextval	AS new_docdata_id	");
