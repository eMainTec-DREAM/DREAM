 ...
 */
public class AssetListITSWListDAOOraImpl  extends BaseJdbcDaoSupportOra implements AssetListITSWListDAO
{
    ...
    public List findList(AssetListITSWListDTO assetListITSWListDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.sw_name", assetListITSWListDTO.getOrderBy(), assetListITSWListDTO.getDirection());
