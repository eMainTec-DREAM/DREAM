 ...
 * 설비 예방작업 상세 DAO IMPL
 * @author  kim21017
 * @version $Id: MaEqMstrPmWorkDetailDAOOraImpl.java,v 1.0 2015/12/04 08:10:27 kim21017 Exp $
 * @since   1.0
 * @spring.bean id="maEqMstrPmWorkDetailDAOTarget"
 * @spring.txbn id="maEqMstrPmWorkDetailDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqMstrPmWorkDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqMstrPmWorkDetailDAO
{
	...
	public MaEqMstrPmWorkDetailDTO findDetail(MaEqMstrCommonDTO maEqMstrCommonDTO, MaEqMstrPmWorkListDTO maEqMstrPmWorkListDTO,
		...
		query.append("		,SFACODE_TO_DESC(x.pm_type,'PMW_TYPE','SYS','','"+user.getLangId()+"') AS pmTypeDesc		");
