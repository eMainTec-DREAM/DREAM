 ...
 */
public class MaEqCtgSpecListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqCtgSpecListDAO
{
    /**
     * grid find
     * @author  syyang
    ...
    public List findSpecList(MaEqCatalogCommonDTO maEqCatalogCommonDTO, MaEqCtgSpecListDTO maEqCtgSpecListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.eqctgspec_id", "x.ord_no", maEqCatalogCommonDTO.getOrderBy(), maEqCatalogCommonDTO.getDirection());
