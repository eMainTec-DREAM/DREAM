...
/**
 * 설비종류의 점검항목 탭 detail dao sql impl
 * @author  euna0207
 * @version $Id: MaEqCatalogPointDetailDAOSqlImpl.java,v 1.0 2015/12/04 08:10:27 euna0207 Exp $
 * @since   1.0
 * @spring.bean id="maEqCatalogPointDetailDAOTarget"
 * @spring.txbn id="maEqCatalogPointDetailDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaEqCatalogPointDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqCatalogPointDetailDAO
{
	...
	public MaEqCatalogPointDetailDTO findDetail(MaEqCatalogCommonDTO maEqCatalogCommonDTO, MaEqCatalogPointListDTO maEqCatalogPointListDTO,
		...
		MaEqCatalogPointDetailDTO maEqCatalogPointDetailDTO = 
				(MaEqCatalogPointDetailDTO)this.getJdbcTemplate().query(query.toString(), getObject(objects), new MwareExtractor(new MaEqCatalogPointDetailDTO()));
