 ...
 */
public class MaEqCtgAsmbDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqCtgAsmbDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaEqCtgAsmbDetailDTO findDetail(MaEqCtgAsmbListDTO maEqCtgAsmbListDTO, User user)
    {
        ...
        MaEqCtgAsmbDetailDTO maEqCtgAsmbDetailDTO = 
        		(MaEqCtgAsmbDetailDTO)getJdbcTemplate().query(query.toString(),getObject(objects), new MwareExtractor(new MaEqCtgAsmbDetailDTO()));
