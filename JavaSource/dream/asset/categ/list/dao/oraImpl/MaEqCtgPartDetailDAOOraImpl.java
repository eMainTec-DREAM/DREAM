 ...
 */
public class MaEqCtgPartDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqCtgPartDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaEqCtgPartDetailDTO findDetail(MaEqCtgPartListDTO maEqCtgPartListDTO, User user)
    {
        ...
        query.append("      , (SELECT SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+user.getCompNo()+"','"+user.getLangId()+"') FROM DUAL)	periodTypeDesc	");
        ...
        MaEqCtgPartDetailDTO maEqCtgPartDetailDTO = 
        		(MaEqCtgPartDetailDTO)getJdbcTemplate().query(query.toString(),objects, new MwareExtractor(new MaEqCtgPartDetailDTO()));
    ...
    public String copyDetail(String oldEqCtgId, String newEqCtgId, String oldKeyId, String newKeyId, User user)
    {
    	...
    	{	// 전체 복사인 경우
    		query.append("  , sqaeqspec_id.NEXTVAL   				");
    	}
