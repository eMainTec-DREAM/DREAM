 ...
 */
public class MaEqCtgSpecDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqCtgSpecDetailDAO
{
    /**
     * detail find
     * @author syyang
    ...
    public MaEqCtgSpecDetailDTO findDetail(MaEqCtgSpecListDTO maEqCtgSpecListDTO, User user)
    {
        ...
        MaEqCtgSpecDetailDTO maEqCtgSpecDetailDTO = 
        		(MaEqCtgSpecDetailDTO)getJdbcTemplate().query(query.toString(),objects, new MwareExtractor(new MaEqCtgSpecDetailDTO()));
     ...
     * @param maEqCatalousergCommonDTO
     * @return
     */
