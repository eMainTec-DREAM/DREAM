 ...
 */
public class LovEqCtgPartAcListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovEqCtgPartAcListDAO
{
    /**
     * 검색
     * @author  youngjoo38
    ...
    public List findEqCtgPartAcList(LovEqCtgPartAcListDTO lovEqCtgPartAcListDTO, User loginUser)
    {
    	...
    	// 부품명/규격
    	query.getCodeLikeQuery("x.part_id", "(SELECT a.description||', '||a.pt_size FROM TAPARTS a WHERE a.comp_no = x.comp_no AND a.part_id = x.part_id)"
	...
	public List findEqCtgPartAcAcList(LovEqCtgPartAcListDTO lovEqCtgPartAcListDTO, User user, Map<String, String> conditionMap) throws Exception {
        ...
        query.getOrderByQuery("(SELECT a.part_no FROM TAPARTS a WHERE a.comp_no = x.comp_no AND a.part_id = x.part_id)", lovEqCtgPartAcListDTO.getOrderBy(), lovEqCtgPartAcListDTO.getDirection());
	...
	private String getWhere(LovEqCtgPartAcListDTO lovEqCtgPartAcListDTO, User user, Map<String, String> conditionMap) throws Exception
	{
		...
		// 부품명/규격
		query.getLikeQuery("(SELECT a.description||', '||a.pt_size FROM TAPARTS a WHERE a.comp_no = x.comp_no AND a.part_id = x.part_id)", lovEqCtgPartAcListDTO.getPartNameSize());
		// 부위명
