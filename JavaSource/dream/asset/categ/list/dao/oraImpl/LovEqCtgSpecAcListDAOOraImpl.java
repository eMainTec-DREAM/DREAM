 ...
 */
public class LovEqCtgSpecAcListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovEqCtgSpecAcListDAO
{
    /**
     * 검색
     * @author  youngjoo38
	...
	public List findEqCtgSpecAcAcList(LovEqCtgSpecAcListDTO lovEqCtgSpecAcListDTO, User user, Map<String, String> conditionMap) throws Exception {
        ...
        query.getOrderByQuery("x.categ", lovEqCtgSpecAcListDTO.getOrderBy(), lovEqCtgSpecAcListDTO.getDirection());
