 ...
 */
public class RcmPmtaskDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements RcmPmtaskDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public RcmPmtaskDetailDTO findDetail(RcmPmtaskCommonDTO rcmPmtaskCommonDTO)
    {
        ...
        query.append("       SFACODE_TO_DESC(h.rcm_task_type,'RCM_TASK_TYPE','SYS','','ko') rcmTaskTypeDesc,	");
        query.append("       h.rcm_task_type rcmTaskType,	");
        query.append("       SFACODE_TO_DESC(h.period_type,'PERIOD_TYPE','SYS','','ko') periodTypeDesc,	");
