 ...
 */
public class RcmSysDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements RcmSysDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public RcmSysDetailDTO findDetail(User user, String id)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.rcmlist_status, 'RCMLIST_STATUS', 'SYS', x.comp_no,'"+user.getLangId()+"') rcmListStatusDesc,	");
        ...
        query.append("       SFACODE_TO_DESC(x.rcm_categ, 'RCM_CATEG', 'USR', x.comp_no,'')     rcmCategDesc,  ");
