 ...
 */
public class RcmSysFEnvListDAOOraImpl extends BaseJdbcDaoSupportOra implements RcmSysFEnvListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(RcmSysCommonDTO rcmSysCommonDTO, RcmSysFEnvListDTO rcmSysFEnvListDTO, User user)
    {
        ...
        query.append("		SFACODE_TO_DESC(x.rcmfenv_type,'RCMFENV_TYPE','SYS','','"+user.getLangId()+"')	rcmFEnvType,");
