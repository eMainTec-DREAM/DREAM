 ...
 */
public class RcmSysEqDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements RcmSysEqDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public RcmSysEqDetailDTO findDetail(String rcmListId, String rcmEqId, User user)
    {
        ...
        query.append("		,dbo.SFACODE_TO_DESC(y.eq_status,'EQ_STATUS','SYS','','"+user.getLangId()+"') eqStatusDesc");
