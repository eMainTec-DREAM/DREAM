 ...
 */
public class RcmCrityMatrixDAOOraImpl extends BaseJdbcDaoSupportOra implements RcmCrityMatrixDAO
{
    ...
    { 
        ...
        return QueryBuffer.toStringArray(getJdbcTemplate().queryForList(query.toString()));
    } 
    ...
    { 
        ...
        query.append("      ,x.crityvalue_id AS crityvalueId         										");
