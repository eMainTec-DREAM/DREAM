 ...
 */
public class RcmTaskMapItemListDAOSqlImpl extends BaseJdbcDaoSupportSql implements RcmTaskMapItemListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findItemList(RcmTaskMapCommonDTO rcmTaskMapCommonDTO, RcmTaskMapItemListDTO rcmTaskMapItemListDTO, User user)
    {
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.taskmap_rslt_ytype,'TASKMAP_RSLT_TYPE','SYS','','"+user.getLangId()+"') yType		");
        query.append("       ,dbo.SFACODE_TO_DESC(x.taskmap_rslt_ntype,'TASKMAP_RSLT_TYPE','SYS','','"+user.getLangId()+"') nType		");
