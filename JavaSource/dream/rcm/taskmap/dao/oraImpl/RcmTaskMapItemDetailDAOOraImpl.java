 ...
 */
public class RcmTaskMapItemDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements RcmTaskMapItemDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public RcmTaskMapItemDetailDTO findDetail(RcmTaskMapItemListDTO rcmTaskMapItemListDTO, RcmTaskMapCommonDTO rcmTaskMapCommonDTO, User user)
    {
        ...
        query.append("        ,SFACODE_TO_DESC(x.taskmap_rslt_ytype,'TASKMAP_RSLT_TYPE','SYS','','"+user.getLangId()+"') ytypeDesc		");
        query.append("        ,SFACODE_TO_DESC(x.taskmap_rslt_ntype,'TASKMAP_RSLT_TYPE','SYS','','"+user.getLangId()+"') ntypeDesc		");
