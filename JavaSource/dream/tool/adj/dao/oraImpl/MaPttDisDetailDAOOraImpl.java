 ...
 */
public class MaPttDisDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPttDisDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public MaPttDisDetailDTO findDetail(User user, String ptdisuseListId)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.ptdisuse_status, 'PTDISUSE_STATUS', 'SYS', x.comp_no,'"+user.getLangId()+"') ptDisStatusDesc,");
        ...
        query.append("          SFAIDTODESC(x.exe_dept, '', 'DEPT', x.comp_no)  exeDeptDesc,     ");
