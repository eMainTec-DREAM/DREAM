 ...
 */
public class MaPttDisPartsListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPttDisPartsListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findAnsList(MaPttDisCommonDTO maPttDisCommonDTO, MaPttDisPartsListDTO maPttDisPartsListDTO, User user)
    {
        ...
        query.getOrderByQuery("x.ptdisuseitem_id","x.ptdisuseitem_id DESC", maPttDisCommonDTO.getOrderBy(), maPttDisCommonDTO.getDirection());
