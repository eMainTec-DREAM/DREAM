 ...
 */
public class MaPttRecListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPttRecListDAO
{
    /**
     * grid find
     * @author  ssong
    ...
    public List findList(MaPttRecCommonDTO maPttRecCommonDTO,User user)
    {
        ...
        query.getOrderByQuery("x.prreclist_id DESC", maPttRecCommonDTO.getOrderBy(), maPttRecCommonDTO.getDirection());
	...
	@Override
	public String findTotalCount(MaPttRecCommonDTO maPttRecCommonDTO, User user) {
		QueryBuffer query = new QueryBuffer();
