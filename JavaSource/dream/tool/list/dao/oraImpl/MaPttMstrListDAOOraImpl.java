 ...
 */
public class MaPttMstrListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPttMstrListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("       SFACODE_TO_DESC(x.mro_type, 'MRO_TYPE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"')  mroType,");
        ...
        query.getOrderByQuery("x.part_id DESC", maPttMstrCommonDTO.getOrderBy(), maPttMstrCommonDTO.getDirection());
