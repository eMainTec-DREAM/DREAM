package dream.app.doc.dao.sqlImpl;
 ...
 */
public class AppDocReqDAOSqlImpl extends BaseJdbcDaoSupportSql implements AppDocReqDAO
{
    ...
    public void insertRootFlow(AppDocReqDTO appDocReqDTO) 
    {
        ...
        query.append(")                                         ");
        query.append("VALUES (                                  ");
        query.append("    NEXT VALUE FOR SQ2APP_FLOW_NO,               ");
        query.append("    ?,    CONVERT(VARCHAR, GETDATE(), 112),   ");
        query.append("    ?,    0,                              ");
        query.append("    ?,    ?,                              ");
        query.append("    'C',  'A',                            ");
...
//    }
    ...
    public void setAppDocStatus(AppDocReqDTO appDocReqDTO)
    {
        ...
        query.append("       x.update_date = CONVERT(VARCHAR, GETDATE(), 112)   ");
        query.append("WHERE  x.app_doc_no  = ?                              ");
    ...
    public String[] findDefaultInform(AppDocReqDTO appDocReqDTO)
    {
        ...
        if("WOR".equals(wfType))
        {
        	...
        	// 내용에 요청상세가 들어가야 함
	        query.append("SELECT                                   	            	");
	        query.append("       dbo.SUBSTRB(description, 1, 198) appTitle,      ");
        ...
        else if("BMAI".equals(wfType))
        {
        	...
        	// 내용에 비정상내용이 들어가야 함
        	query.append("SELECT                                   	           		");
	        query.append("       dbo.SUBSTRB(SUBJECT, 1, 198) appTitle,        ");
        ...
        else if("HSEREV".equals(wfType))
        {
            ...
            query.append("SELECT                                                    ");
            query.append("       dbo.SUBSTRB(y.doc_name, 1, 198) appTitle,              ");
            query.append("       ''  appRemark,                                     ");
            query.append("       ''  noData                                         ");
