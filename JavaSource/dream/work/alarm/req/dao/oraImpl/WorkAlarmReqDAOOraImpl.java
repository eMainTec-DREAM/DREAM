package dream.work.alarm.req.dao.oraImpl;
 ...
 */
public class WorkAlarmReqDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkAlarmReqDAO
{
	...
	public String getColums(WorkAlarmReqDTO workAlarmReqDTO, User user) {
		...
		query.append("        , SFACODE_TO_DESC(y.woreq_status, 'WOREQ_STATUS', 'SYS', 100, 'ko')     								AS WOREQSTATUS	");
	...
	public String getOrderBy(WorkAlarmReqDTO workAlarmReqDTO, User user) {
		...
		query.getOrderByQuery("x.alarmreq_id Desc", workAlarmReqDTO.getOrderBy(), workAlarmReqDTO.getDirection());		
