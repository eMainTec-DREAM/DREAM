 ...
 */
public class WorkPlanApprListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPlanApprListDAO
{
    public List findList(WorkPlanApprCommonDTO workPlanApprCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.woplanappr_id", "x.upd_date DESC", workPlanApprCommonDTO.getOrderBy(), workPlanApprCommonDTO.getDirection());
