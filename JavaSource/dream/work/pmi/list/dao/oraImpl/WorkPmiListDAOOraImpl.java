 ...
 */
public class WorkPmiListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkPmiListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(WorkPmiCommonDTO workPmiCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("4 DESC", workPmiCommonDTO.getOrderBy(), workPmiCommonDTO.getDirection());
