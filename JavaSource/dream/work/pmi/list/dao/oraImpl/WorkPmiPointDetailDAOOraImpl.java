 ...
 */
public class WorkPmiPointDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkPmiPointDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public WorkPmiPointDetailDTO findDetail(String pminslistId, String pmInsPointId, String pmPointId, User user)
    {
        ...
        WorkPmiPointDetailDTO workPmiPointDetailDTO = (WorkPmiPointDetailDTO)getJdbcTemplate().query(query.toString(), objects, new MwareExtractor(new WorkPmiPointDetailDTO()));
