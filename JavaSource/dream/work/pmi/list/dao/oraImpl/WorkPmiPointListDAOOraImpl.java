 ...
 */
public class WorkPmiPointListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkPmiPointListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findPointList(WorkPmiCommonDTO workPmiCommonDTO, WorkPmiPointListDTO workPmiPointListDTO, User loginUser, boolean isComplete) throws Exception
    {
        ...
        query.getOrderByQuery("y.step_num", workPmiCommonDTO.getOrderBy(), workPmiCommonDTO.getDirection());
