package dream.work.list.dept.sched.list.dao.sqlImpl;
 ...
 */
public class WorkListDeptSchedListDeptListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListDeptSchedListDeptListDAO
{
	@Override
    public List findList(WorkListDeptSchedCommonDTO workListDeptSchedCommonDTO, WorkListDeptSchedListDeptListDTO workListDeptSchedListDeptListDTO, User user)
    {
        ...
        query.getOrderByQuery("x.wkor_id", "x.START_DATE, x.END_DATE", workListDeptSchedListDeptListDTO.getOrderBy(), workListDeptSchedListDeptListDTO.getDirection());
        
        return getJdbcTemplate().queryForList(query.toString(workListDeptSchedListDeptListDTO.getIsLoadMaxCount(), workListDeptSchedListDeptListDTO.getFirstRow()));
    }
