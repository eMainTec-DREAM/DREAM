 ...
 */
public class WorkListDeptSchedListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListDeptSchedListDAO
{
    @Override
    public List findList(WorkListDeptSchedCommonDTO workListDeptSchedCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.comp_no", "x.dept_id", workListDeptSchedCommonDTO.getOrderBy(), workListDeptSchedCommonDTO.getDirection());
