 ...
 */
public class MaWoResultPointListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaWoResultPointListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findPointList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, MaWoResultPointListDTO maWoResultPointListDTO, User loginUser)
    {
        ...
        query.append("		,SFACODE_TO_DESC(x.pm_point_rslt_status,'PM_POINT_RSLT_STATUS','SYS','','"+loginUser.getLangId()+"') rsltStatusDesc	");
        ...
        query.getOrderByQuery("y.step_num", maWoResultPointListDTO.getOrderBy(), maWoResultPointListDTO.getDirection());
