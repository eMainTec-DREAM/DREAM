 ...
 */
public class WorkListBmRplPartSerialListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkListBmRplPartSerialListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    { 
        ...
        query.getOrderByQuery("woparts_serial_id DESC", workListBmRplPartSerialListDTO.getOrderBy(), workListBmRplPartSerialListDTO.getDirection());
    ...
    private String getWhere(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, WorkListBmRplPartSerialListDTO workListBmRplPartSerialListDTO, MaWoResultPartDetailDTO maWoResultPartDetailDTO, User loginUser)
    {
    	...
    	{
    		query.getAndQuery("woparts_serial_id", workListBmRplPartSerialListDTO.getWopartSerialId());
