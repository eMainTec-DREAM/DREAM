 ...
 */
public class MaWoResultPartListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaWoResultPartListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findPartList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, MaWoResultPartListDTO maWoResultPartListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.part_id", maWoResultPartListDTO.getOrderBy(), maWoResultPartListDTO.getDirection());
