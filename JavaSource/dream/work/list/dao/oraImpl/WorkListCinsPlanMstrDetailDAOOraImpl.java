...
/**
 * WorkListCinsPlanMstr Page - Detail DAO implements
 * @author youngjoo38
 * @version $Id: WorkListCinsPlanMstrDetailDAOOraImpl.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkListCinsPlanMstrDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkListCinsPlanMstrDetailDAO
{
    String compNo = "";
    public WorkListCinsPlanMstrDetailDTO findDetail(WorkListCinsPlanMstrCommonDTO workListCinsPlanMstrCommonDTO, User user) 
    {
        ...
        WorkListCinsPlanMstrDetailDTO workListCinsPlanMstrDetailDTO = 
                (WorkListCinsPlanMstrDetailDTO)getJdbcTemplate().query(query.toString(), objects, new MwareExtractor(new WorkListCinsPlanMstrDetailDTO()));
    ...
    public int insertDetail(WorkListCinsPlanMstrCommonDTO workListCinsPlanMstrCommonDTO, WorkListCinsPlanMstrDetailDTO workListCinsPlanMstrDetailDTO, User user)
    {
        ...
        query.append("   , pm_id              , ?                   ");
        query.append("   , (SELECT a.equip_id FROM TAPMEQUIP a WHERE a.pmequip_id = ? )  , TO_CHAR(SYSDATE, 'yyyymmdd')       ");
        query.append("   , ?                  , ?                   ");
        query.append("   , ?                                        ");
    ...
    public int completeDetail(WorkListCinsPlanMstrDetailDTO workListCinsPlanMstrDetailDTO, User user)
    {
        ...
        query.append(") VALUES (                                ");
        query.append("      ?             , sqapminsdlist_id.NEXTVAL        ");
        query.append("    , ?             , ?                   ");
    ...
    public int getPmInsdPointCnt(WorkListCinsPlanMstrDetailDTO workListCinsPlanMstrDetailDTO)
    {
        ...
        //rtnValue = getJdbcTemplate().update(query.toString(), objects);
        rtnValue = Integer.parseInt(QueryBuffer.listToString(getJdbcTemplate().queryForList(query.toString(),objects)));
    ...
    public int inserPmInsdPoint(WorkListCinsPlanMstrDetailDTO workListCinsPlanMstrDetailDTO)
    {
        ...
        query.append("  )                                                   ");
        query.append("  ( SELECT                                            ");
        query.append("        comp_no                , sqapminsdpoint_id.NEXTVAL     ");
        query.append("      , pminsdlist_id          , ?                    ");
        query.append("      , ?                      , ?                    ");
        ...
        query.append("  FROM (                                              ");
        query.append("    SELECT                                            ");
        query.append("        comp_no                , ROWNUM rno           ");
        ...
        query.append("      , 'P'   , pm_point_id   , remark , 'GD'         ");
