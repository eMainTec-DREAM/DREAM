 ...
 */
public class WorkListCavalListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkListCavalListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findCavalList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, WorkListCavalListDTO workListCavalListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.wocalibetcvalue_id", workListCavalListDTO.getOrderBy(), workListCavalListDTO.getDirection());
