 ...
 */
public class WoPlanPartListDAOOraImpl extends BaseJdbcDaoSupportOra implements WoPlanPartListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findPartList(WoPlanCommonDTO woPlanCommonDTO, WoPlanPartListDTO woPlanPartListDTO, User loginUser)
    {
        ...
        query.append("		SFACODE_TO_DESC(x.part_grade,'PART_GRADE','SYS','','"+loginUser.getLangId()+"')	partGrade,");
        query.append("       x.remark 						remark			");
        query.append("FROM   TAWOPLANPARTS x								");
        query.append("WHERE  1=1											");
        query.append(this.getWhere(woPlanCommonDTO,woPlanPartListDTO,loginUser));
        query.getOrderByQuery("x.part_id", woPlanPartListDTO.getOrderBy(), woPlanPartListDTO.getDirection());
