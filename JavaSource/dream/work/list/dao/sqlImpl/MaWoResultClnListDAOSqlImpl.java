 ...
 */
public class MaWoResultClnListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWoResultClnListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findClnList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, MaWoResultClnListDTO maWoResultClnListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.woequip_id", "x.woequip_id", maWoResultClnListDTO.getOrderBy(), maWoResultClnListDTO.getDirection());
