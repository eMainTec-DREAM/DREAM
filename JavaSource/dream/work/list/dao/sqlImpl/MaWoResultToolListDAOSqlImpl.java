 ...
 */
public class MaWoResultToolListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWoResultToolListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findToolList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, MaWoResultToolListDTO maWoResultToolListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.wotool_id", "x.part_id", maWoResultToolListDTO.getOrderBy(), maWoResultToolListDTO.getDirection());
