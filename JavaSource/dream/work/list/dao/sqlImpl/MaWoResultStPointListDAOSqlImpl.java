 ...
 */
public class MaWoResultStPointListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWoResultStPointListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findStPointList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, MaWoResultStPointListDTO maWoResultStPointListDTO, User loginUser)
    {
        ...
        query.append("		dbo.SFACODE_TO_DESC(x.st_point_rslt_status,'ST_POINT_RSLT_STATUS','SYS','','"+loginUser.getLangId()+"') rsltStatusDesc,	");
        ...
        query.getOrderByQuery("x.wostpoint_id", "y.step_num", maWoResultStPointListDTO.getOrderBy(), maWoResultStPointListDTO.getDirection());
