 ...
 */
public class WoPlanListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WoPlanListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findWoResultMstrList(WoPlanCommonDTO woPlanCommonDTO, User user)
    {
        ...
        query.append("     , dbo.SFACODE_TO_DESC(x.shift_type, 'SHIFT_TYPE', 'SYS', '', '"+user.getLangId()+"')				AS SHIFTDESC    		");
     ...
     * Filter 조건
     * @author  kim21017
     * @version $Id: WoPlanListDAO.java,v 1.0 2015/12/02 09:14:12 kim21017 Exp $
     * @since   1.0
     * 
     * @param woPlanCommonDTO
     * @return
