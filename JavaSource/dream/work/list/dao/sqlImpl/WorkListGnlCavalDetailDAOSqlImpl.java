 ...
 */
public class WorkListGnlCavalDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListGnlCavalDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public WorkListGnlCavalDetailDTO findDetail(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, User user)
    {
    	...
    	query.append("SELECT                                        	");
    	query.append("       dbo.SFACODE_TO_DESC(calib_point_type,'CALIB_POINT_TYPE','SYS','',? ) calibPointTypeDesc        	");
