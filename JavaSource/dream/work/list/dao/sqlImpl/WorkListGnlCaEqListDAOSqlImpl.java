 ...
 */
public class WorkListGnlCaEqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListGnlCaEqListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findCavalList(MaWoResultMstrCommonDTO maWoResultMstrCommonDTO, User loginUser)
    {
        ...
        query.append("		 ,dbo.SFACODE_TO_DESC(sopdoc_no,'CALIB_SOPDOC_NO','USR','"+loginUser.getCompNo()+"','"+loginUser.getLangId()+"')	calibSopdocNoDesc	");
        ...
        query.getOrderByQuery("x.wocalibstdeq_id", "x.wocalibstdeq_id", maWoResultMstrCommonDTO.getOrderBy(), maWoResultMstrCommonDTO.getDirection());
