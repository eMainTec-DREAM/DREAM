 ...
 * @author youngjoo38
 * @version $Id: WorkListPointListDAOSqlImpl.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkListPointListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkListPointListDAO
{
    ...
    public List findList(WorkListPtrlResultCommonDTO workListPtrlResultCommonDTO, WorkListPointListDTO workListPointListDTO, User user) throws Exception
    {
        ...
        query.append("     , dbo.SFACODE_TO_DESC( x.pm_point_rslt_status, 'PM_POINT_RSLT_STATUS','SYS',x.comp_no, '"+user.getLangId()+"')    AS pmPointRsltStatusDesc ");
        ...
        query.getOrderByQuery("x.pmptrlrsltpoint_id", "x.pm_point_id", workListPtrlResultCommonDTO.getOrderBy(), workListPtrlResultCommonDTO.getDirection());
    ...
    public String findTotalCount(WorkListPtrlResultCommonDTO workListPtrlResultCommonDTO, 
            WorkListPointListDTO workListPointListDTO, User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
