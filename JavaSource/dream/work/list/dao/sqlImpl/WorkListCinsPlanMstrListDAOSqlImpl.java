 ...
 * 일상점검목록 dao
 * @author  youngjoo38
 * @version $Id: workListCinsPlanMstrListDAO.java,v 1.0 2015/12/02 09:14:12 youngjoo38 Exp $
 * @since   1.0
 * @spring.bean id="workListCinsPlanMstrListDAOTarget"
 * @spring.txbn id="workListCinsPlanMstrListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class WorkListCinsPlanMstrListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListCinsPlanMstrListDAO
{
    /**
     * grid find
     * @author  youngjoo38
     * @version $Id: workListCinsPlanMstrCommonDTO.java,v 1.0 2015/12/02 09:14:12 youngjoo38 Exp $
     * @since   1.0
     * 
     * @param workListCinsPlanMstrCommonDTO
     * @return List
     */
    public List findList(WorkListCinsPlanMstrCommonDTO workListCinsPlanMstrCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.pminsdsched_id", "x.plan_date", workListCinsPlanMstrCommonDTO.getOrderBy(), workListCinsPlanMstrCommonDTO.getDirection());
    ...
    {        
        ...
        if(!"".equals(workListCinsPlanMstrCommonDTO.getFilterIsComplete().toUpperCase()))
        {
            ...
            query.append(" = ISNULL((SELECT (CASE WHEN a.pmsched_status = 'C' THEN 'Y' ELSE 'N' END )FROM TAPMINSDLIST a WHERE a.comp_no = x.comp_no AND a.pminsdlist_id = x.pminsdlist_id),'N') ");
        }
    ...
    public String findTotalCount(WorkListCinsPlanMstrCommonDTO workListCinsPlanMstrCommonDTO,User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
        query.append("SELECT                                                                                ");
