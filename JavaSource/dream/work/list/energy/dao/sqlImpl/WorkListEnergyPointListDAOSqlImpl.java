 ...
 */
public class WorkListEnergyPointListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListEnergyPointListDAO
{
    /**
     * grid find
     * @author  sy.yang
    ...
    public List findPointList(WorkListEnergyMstrListCommonDTO workListEnergyMstrListCommonDTO, WorkListEnergyPointListDTO workListEnergyPointListDTO, User loginUser) throws Exception
    {
        ...
        query.getOrderByQuery("x.pminspoint_id", "y.step_num", workListEnergyMstrListCommonDTO.getOrderBy(), workListEnergyMstrListCommonDTO.getDirection());
