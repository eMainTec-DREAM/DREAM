 ...
 */
public class WorkListEnergyMstrListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkListEnergyMstrListDAO
{
    /**
     * grid find
     * @author  sy.yang
    ...
    public List findList(WorkListEnergyMstrListCommonDTO workListEnergyMstrListCommonDTO, User user)
    {
        ...
        query.append("		,dbo.SFACODE_TO_DESC(x.pm_type,'PMU_TYPE','SYS','','"+user.getLangId()+"')				AS PMTYPEDESC			");
        query.append("		,x.pmsched_status											AS PMISCHEDSTATUS	");
        query.append("		,dbo.SFACODE_TO_DESC(x.pmsched_status,'PMSCHED_STATUS','SYS','','"+user.getLangId()+"')	AS PMISCHEDSTATUSDESC	");
        ...
        query.getOrderByQuery("x.pminslist_id", "x.wkor_date,x.description,x.pminslist_id", workListEnergyMstrListCommonDTO.getOrderBy(), workListEnergyMstrListCommonDTO.getDirection());
