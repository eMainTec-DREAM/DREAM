...
/**
 * WorkListCinsPlanMstr Page - Detail DTO
 * @author youngjoo38
 * @version $Id: WorkListCinsPlanMstrDetailDTO.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 *
 */
public class WorkListCinsPlanMstrDetailDTO extends BaseDTO
{
    /** 결과 ID */
    ...
    public String getPmpointCnt()
    {
        return pmpointCnt;
    }
    public void setPmpointCnt(String pmpointCnt)
    {
        this.pmpointCnt = pmpointCnt;
    }
    ...
    {
        return listStatusDesc;
    }
    public void setListStatusDesc(String listStatusDesc)
    {
        this.listStatusDesc = listStatusDesc;
    }
