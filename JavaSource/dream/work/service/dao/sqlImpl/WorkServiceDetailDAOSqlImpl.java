 ...
 * @author cjscjs9
 * @version $Id: workServiceDetailDAOSqlImpl.java,v 1.0 2018/08/02 09:12:40 cjscjs9 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkServiceDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkServiceDetailDAO
{
    ...
    public WorkServiceDetailDTO findWorkServiceDetail(WorkServiceCommonDTO workServiceCommonDTO, User user) 
    {
        ...
        query.append("	,dbo.SFACODE_TO_DESC(a.service_uom,'SERVICE_UOM', 'SYS', '',  ?)				  AS serviceUomDesc 	");
