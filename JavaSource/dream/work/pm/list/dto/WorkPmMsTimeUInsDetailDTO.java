 ...
 * @since   1.0
 */
public class WorkPmMsTimeUInsDetailDTO extends BaseDTO
{
	/** 작업시간 ID */
	private String pmMsTimeId		= "";
	
	/** 기존 작업시간 */
	private String oldMeasureTime	= "";
    /** 작업시간 */
	...
	public String getOldMeasureTime() {
		return oldMeasureTime;
	}
	public void setOldMeasureTime(String oldMeasureTime) {
