...
/**
 * WorkPmiDInsPoint Page - Detail DTO
 * @author youngjoo38
 * @version $Id: WorkPmiDInsPointDetailDTO.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 *
 */
public class WorkPmiDInsPointDetailDTO extends BaseDTO
{
    /** KEY 일상점검 점검결과 ID */                                
    ...
    public void setPmInsDPointId(String pmInsDPointId)
    {
        ...
        super.setAuditKey(pmInsDPointId);
    }
