...
/**
 * WorkPmiCIns Page - Detail DAO implements
 * @author youngjoo38
 * @version $Id: WorkPmiCInsDetailDAOOraImpl.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkPmiCInsDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkPmiCInsDetailDAO
{
    ...
    public WorkPmiCInsDetailDTO findDetail(WorkPmiCInsCommonDTO workPmiCInsCommonDTO, User user) 
    {
        ...
        query.append("       , (SELECT SFACODE_TO_DESC(a.eqctg_type,'EQCTG_TYPE','SYS','','"+user.getLangId()+"')  eqctgTypeDesc  ");
        query.append("          FROM TAEQUIPMENT a                                                             ");
        ...
        query.append("       , SFACODE_TO_DESC(x.pmsched_status,'PMSCHED_STATUS','SYS','"+user.getCompNo()+"','"+user.getLangId()+"')    schedStatusDesc     ");
...
//        query.append("          WHERE a.pm_id = x.pm_id)                                       pmInsDListNo    ");
        ...
        WorkPmiCInsDetailDTO workPmiCInsDetailDTO = 
                (WorkPmiCInsDetailDTO)getJdbcTemplate().query(query.toString(), objects, new MwareExtractor(new WorkPmiCInsDetailDTO()));
            ...
            WorkPmiCInsCommonDTO workPmiCInsCommonDTO)
    {
        ...
        query.append("WHERE  1 = 1                  ");
        query.getAndQuery("a.pminsdlist_id", workPmiCInsCommonDTO.getPmInsDListId()); // 점검기준ID
        query.getAndQuery("a.wkor_date", workPmiCInsCommonDTO.getPopupWorkDate()); // 작업일자
    ...
    public int executePmUpdate(WorkPmiCInsDetailDTO workPmiCInsDetailDTO) throws Exception
    {
        ...
        query.append("BEGIN SP_PM_UPDATE_LASTCPLT_DATE (                ");
