 ...
 */
public class MaPmMstrPointDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPmMstrPointDetailDAO
{
    /**
     * detail find
     * @author jung7126
...
//        query.append("         AND eqasmb_id = x.eqasmb_id)      eqAsmbToDesc,                                ");
	...
	public int insertLovDetail(MaPmMstrPointDetailDTO maPmMstrPointDetailDTO, MaPmMstrCommonDTO maPmMstrMstrCommonDTO, User user) {
		 ...
		 query.append(" , (SELECT aa.EQASMB_ID																							");
		 query.append("    FROM taeqasmb aa 																							");
		 query.append("    WHERE aa.comp_no = x.comp_no																					");
		 query.append("    AND aa.eq_ctg_asmb_id = x.eq_ctg_asmb_id 																	");
		 query.append("    AND rownum = 1 )									eqasmb_id													");
