 ...
 */
public class WorkPmiCInsPointListDAOOraImpl  extends BaseJdbcDaoSupportOra implements WorkPmiCInsPointListDAO
{
    ...
    public List findList(WorkPmiCInsCommonDTO workPmiCInsCommonDTO, User user) throws Exception
    {
        ...
        query.append("  , SFACODE_TO_DESC(x.check_type, 'CHECK_TYPE', 'SYS', '"+user.getCompNo()+"','"+user.getLangId()+"')	checkTypeDesc	");
        query.append("  , SFACODE_TO_DESC(y.pm_point_rslt_status,'PM_POINT_RSLT_STATUS','SYS','"+user.getCompNo()+"', '"+user.getLangId()+"')	pmPointRsltStatus	");
        query.append("  , y.result_value||' / '||y.result_value2||' / '||y.result_value3                                	resultVal		");
        ...
        query.getOrderByQuery("x.step_num", workPmiCInsCommonDTO.getOrderBy(), workPmiCInsCommonDTO.getDirection());
    ...
    {        
        ...
        //System.out.println("workPmiCInsCommonDTO.getPmInsDListId() : " + workPmiCInsCommonDTO.getPmInsDListId());
