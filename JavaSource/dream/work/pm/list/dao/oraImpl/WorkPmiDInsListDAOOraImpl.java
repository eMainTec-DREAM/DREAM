...
/**
 * WorkPmiDIns Page - List DAO implements
 * @author youngjoo38
 * @version $Id: WorkPmiDInsListDAOOraImpl.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkPmiDInsListDAOOraImpl  extends BaseJdbcDaoSupportOra implements WorkPmiDInsListDAO
{

    /**
     * grid find
     * @author  youngjoo38
     * @version $Id: workPmiDInsListDAO.java,v 1.0 2017/08/22 15:20:12 youngjoo38 Exp $
     * @since   1.0
     * 
    ...
    public List findList(WorkPmiDInsCommonDTO workPmiDInsCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.pmInsDlist_id", workPmiDInsCommonDTO.getOrderBy(), workPmiDInsCommonDTO.getDirection());
    ...
    public String findTotalCount(
            WorkPmiDInsCommonDTO workPmiDInsCommonDTO, User user) {
        QueryBuffer query = new QueryBuffer();
