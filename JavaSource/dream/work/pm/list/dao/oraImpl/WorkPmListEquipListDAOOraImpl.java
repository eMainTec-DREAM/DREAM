 ...
 */
public class WorkPmListEquipListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkPmListEquipListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findEqList(MaPmMstrCommonDTO maPmMstrCommonDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.pmequip_id, x.is_active", maPmMstrCommonDTO.getOrderBy(), maPmMstrCommonDTO.getDirection());
