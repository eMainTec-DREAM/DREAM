 ...
 */
public class MaPmEqClnListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPmEqClnListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findClnList(MaPmMstrCommonDTO maPmMstrCommonDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.pmequip_id", maPmMstrCommonDTO.getOrderBy(), maPmMstrCommonDTO.getDirection());
