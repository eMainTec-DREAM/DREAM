 ...
 */
public class WorkPmiDInsPointListDAOOraImpl  extends BaseJdbcDaoSupportOra implements WorkPmiDInsPointListDAO
{
    ...
    public List findList(WorkPmiDInsCommonDTO workPmiDInsCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.step_num", workPmiDInsCommonDTO.getOrderBy(), workPmiDInsCommonDTO.getDirection());
