 ...
 */
public class LovStdCheckPointListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovStdCheckPointListDAO
{
    /**
     * 검색
     * @author  youngjoo38
    ...
    public List findStdCheckPointList(LovStdCheckPointListDTO lovStdCheckPointListDTO, User loginUser)
    {
        ...
        query.append("   , SFACODE_TO_DESC( x.check_point_type , 'CHECK_POINT_TYPE','SYS',x.comp_no, '"+loginUser.getLangId()+"')  checkPointTypeDesc  ");
