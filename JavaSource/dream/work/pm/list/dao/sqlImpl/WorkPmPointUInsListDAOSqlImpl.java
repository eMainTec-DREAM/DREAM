 ...
 */
public class WorkPmPointUInsListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmPointUInsListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.pm_point_id", "x.pm_point_id", maPmMstrCommonDTO.getOrderBy(), maPmMstrCommonDTO.getDirection());
