 ...
 */
public class WorkPmiDInsPointDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmiDInsPointDetailDAO
{
    ...
    public WorkPmiDInsPointDetailDTO findDetail(WorkPmiDInsCommonDTO workPmiDInsCommonDTO, User user) 
    {
        ...
        WorkPmiDInsPointDetailDTO workPmiDInsPointDetailDTO = 
                (WorkPmiDInsPointDetailDTO)getJdbcTemplate().query(query.toString(), getObject(objects), new MwareExtractor(new WorkPmiDInsPointDetailDTO()));
