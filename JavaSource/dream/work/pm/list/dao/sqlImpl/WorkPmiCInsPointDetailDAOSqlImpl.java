 ...
 */
public class WorkPmiCInsPointDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmiCInsPointDetailDAO
{
    ...
    public WorkPmiCInsPointDetailDTO findDetail(WorkPmiCInsCommonDTO workPmiCInsCommonDTO, User user) 
    {
        ...
        query.append("      , dbo.SFACODE_TO_DESC(y.check_type,'CHECK_TYPE','SYS','', ?)   checkTypeDesc");
        query.append("      , x.pm_point_rslt_status                        pmPointRsltStatusId         ");
        query.append("      , dbo.SFACODE_TO_DESC(x.pm_point_rslt_status,'PM_POINT_RSLT_STATUS','SYS','', ?)   pmPointRsltStatus          ");
        ...
        query.append("      , convert(nvarchar,y.check_min)+' / '+convert(nvarchar,y.check_basis_val)+' / '+convert(nvarchar,y.check_max)+' . ('+y.uom+')' checkValUom ");
        ...
        WorkPmiCInsPointDetailDTO workPmiCInsPointDetailDTO = 
                (WorkPmiCInsPointDetailDTO)getJdbcTemplate().query(query.toString(), getObject(objects), new MwareExtractor(new WorkPmiCInsPointDetailDTO()));
    ...
    public int insertDetail(WorkPmiCInsPointDetailDTO workPmiCInsPointDetailDTO, User user)
    {
        ...
        rtnValue2 =  getJdbcTemplate().update(query.toString(), getObject(objects));
