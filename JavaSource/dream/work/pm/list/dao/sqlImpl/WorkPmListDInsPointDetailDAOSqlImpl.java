 ...
 */
public class WorkPmListDInsPointDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmListDInsPointDetailDAO
{
    ...
    public WorkPmListDInsPointDetailDTO findDetail(MaPmMstrCommonDTO maPmMstrCommonDTO, User user) 
    {
        ...
        query.append("  , dbo.SFACODE_TO_DESC(x.check_type, 'CHECK_TYPE', 'SYS', ?, ?)        checkType      ");
        ...
        WorkPmListDInsPointDetailDTO workPmListDInsPointDetailDTO = 
                (WorkPmListDInsPointDetailDTO)getJdbcTemplate().query(query.toString(), getObject(objects), new MwareExtractor(new WorkPmListDInsPointDetailDTO()));
