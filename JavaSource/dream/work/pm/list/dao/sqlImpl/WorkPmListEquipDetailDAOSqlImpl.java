 ...
 */
public class WorkPmListEquipDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmListEquipDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public int deletePmSchedulePmEQuip(String compNo, String pmEquipId)
    {
    	...
    	query.append("EXEC dbo.SP_PM_MAKE_SCHEDPMEQUIP_DELETE	                             ");
    	query.append("                  '"+compNo+"'          ");
    ...
    public int updateSchedEquipDetail(WorkPmListEquipDetailDTO workPmListEquipDetailDTO, MaPmMstrCommonDTO maPmMstrCommonDTO, User user)
    {
    	...
    	query.append("                                 AND plan_date >= convert(varchar(8), getdate(), 112)          ");
    	query.append("                             )                              ");
	...
	public int mergeEqPmCycle(WorkPmListEquipDetailDTO workPmListEquipDetailDTO, MaPmMstrCommonDTO maPmMstrCommonDTO,
		...
		query.append("SELECT NEXT VALUE FOR SQAEQPMCYCLE_ID	");
    	
        String eqpmcycleId = QuerySqlBuffer.listToString(this.getJdbcTemplate().queryForList(query.toString()));
