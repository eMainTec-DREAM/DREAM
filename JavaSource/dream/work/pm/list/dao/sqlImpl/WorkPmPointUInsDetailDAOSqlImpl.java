 ...
 */
public class WorkPmPointUInsDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmPointUInsDetailDAO
{
	@Override
	...
	public String setStepNum(WorkPmPointUInsDetailDTO workPmPointUInsDetailDTO, User user) throws Exception {
		...
		query.append("SELECT ISNULL(MAX(step_num)+10,100)	");
