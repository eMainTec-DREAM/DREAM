 ...
 */
public class WorkPmListDInsPointListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkPmListDInsPointListDAO
{
    ...
    public List findList(MaPmMstrCommonDTO maPmMstrCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.pm_point_id", "x.step_num", maPmMstrCommonDTO.getOrderBy(), maPmMstrCommonDTO.getDirection());
