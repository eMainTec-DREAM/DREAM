 ...
 */
public class MaPmMstrDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPmMstrDetailDAO
{
    /**
     * detail find
     * @author jung7126
    ...
    public MaPmMstrDetailDTO findDetail(MaPmMstrCommonDTO maPmMstrCommonDTO, User user)
    {
        ...
        query.append("        dbo.SFACODE_TO_DESC(x.pm_type, x.wo_type+'_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"')		pmTypeDesc,         ");
        query.append("        x.schedule_type											scheduleType,                   ");
        query.append("        dbo.SFACODE_TO_DESC(x.schedule_type, 'SCHEDULE_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"') scheduleTypeDesc,   ");
        query.append("        x.cycle													cycle,                          ");
        query.append("        x.period_type												periodType,                     ");
        query.append("        dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"') 	periodTypeDesc,     ");
        query.append("        x.USAGE													usage,                          ");
        query.append("        x.init_wrk_date											initWrkDate,                    ");
        query.append("        x.is_active												isActive,                       ");
        query.append("    	  dbo.SFACODE_TO_DESC( x.is_active, 'IS_USE','SYS',x.comp_no, '"+user.getLangId()+"')				isActiveDesc,       ");
        query.append("        x.wo_res_bef												woResBef,                       ");
        query.append("        x.REMARK													remark,							");
        query.append("        x.pm_categ												pmCateg,						");
        query.append("        dbo.SFACODE_TO_DESC(x.pm_categ, 'PM_CATEG', 'SYS', '"+compNo+"','"+user.getLangId()+"')			pmCategDesc,		");
        query.append("        x.wo_type													woType,                         ");
        query.append("        dbo.SFACODE_TO_DESC(x.wo_type, 'WO_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"')				woTypeDesc,			");
        ...
        query.append("        ,dbo.SFACODE_TO_DESC(x.revision_status, 'REVISION_STATUS', 'SYS', '"+compNo+"','"+user.getLangId()+"') revisionStatusDesc	");
        ...
        query.append("WHERE  x.pm_id = '"+maPmMstrCommonDTO.getPmId()+"'												");
        query.append("  AND  x.comp_no  = '"+compNo+"'								        							");
    
        MaPmMstrDetailDTO maPmMstrDetailDTO = 
        		(MaPmMstrDetailDTO)getJdbcTemplate().query(query.toString(), new MwareExtractor(new MaPmMstrDetailDTO()));
...
//                
    ...
    public int createWorkOrder(String compNo, String Pmid) throws Exception
    {
    	...
    	query.append("EXEC dbo.SP_PM_MAKE_TO_ONESCHED	                             ");
    	query.append("                  '"+compNo+"'          ");
    	query.append("                 ,"+Pmid+"	          ");
    ...
    {
    	QuerySqlBuffer query = new QuerySqlBuffer();
    	query.append("EXEC dbo.SP_PM_MAKE_SCHEDALL_DELETE                ");
        query.append("                  '"+compNo+"'         			");
        query.append("                 ,'"+pmId+"'                  ");
    ...
    @Override
    public int updatePmEquip(MaWoResultMstrDetailDTO maWoResultMstrDetailDTO,
            MaWoResultPmCalDTO maWoResultPmCalDTO, String pmId)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
        ...
        Object[] objects = new Object[] {
                ...
                ,maWoResultPmCalDTO.getCalibResultStatus()
