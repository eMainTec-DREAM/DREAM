 ...
 * @author youngjoo38
 * @version $Id: WorkPmCheckListDAOSqlImpl.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkPmCheckListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkPmCheckListDAO
{
    ...
    public List findList(WorkPmCheckCommonDTO workPmCheckCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.std_check_point_id", "x.std_check_point_no", workPmCheckCommonDTO.getOrderBy(), workPmCheckCommonDTO.getDirection());
