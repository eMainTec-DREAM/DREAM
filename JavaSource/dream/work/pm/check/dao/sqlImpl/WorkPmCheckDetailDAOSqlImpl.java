 ...
 */
public class WorkPmCheckDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmCheckDetailDAO
{
    ...
    public WorkPmCheckDetailDTO findDetail(WorkPmCheckCommonDTO workPmCheckCommonDTO, User user) 
    {
        ...
        query.append("      , dbo.SFACODE_TO_DESC( x.check_point_type , 'CHECK_POINT_TYPE','SYS',x.comp_no, ?)  checkPointTypeDesc  ");
