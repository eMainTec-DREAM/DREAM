 ...
 * @author kim21017
 * @version $Id: WorkPmStdCalibListDAOOraImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkPmStdCalibListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkPmStdCalibListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.pmcalibstdtp_no", workPmStdCalibCommonDTO.getOrderBy(), workPmStdCalibCommonDTO.getDirection());
