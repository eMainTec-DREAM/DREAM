 ...
 */
public class MaStdWoTypeListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaStdWoTypeListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("		, (SELECT SFACODE_TO_DESC(x.wo_type,'WO_TYPE','SYS','','"+loginUser.getLangId()+"') FROM DUAL) woType	");
        query.append("		, (SELECT SFACODE_TO_DESC(x.pm_type, x.wo_type||'_TYPE','SYS','','"+loginUser.getLangId()+"') FROM DUAL) pmType	");
