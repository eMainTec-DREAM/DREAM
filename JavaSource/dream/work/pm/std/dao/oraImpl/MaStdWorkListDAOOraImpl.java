 ...
 */
public class MaStdWorkListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaStdWorkListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("		SFACODE_TO_DESC((SELECT y.wo_type FROM TASTWRKWORK y WHERE x.stwrkwork_id=y.stwrkwork_id AND x.comp_no=y.comp_no),'WO_TYPE','SYS','','"+loginUser.getLangId()+"') woType,	");
