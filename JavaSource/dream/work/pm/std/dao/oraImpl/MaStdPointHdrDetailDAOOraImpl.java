 ...
 */
public class MaStdPointHdrDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaStdPointHdrDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaStdPointHdrDetailDTO findDetail(MaStdPointCommonDTO maStdPointCommonDTO, User loginUser)
    {
        ...
        query.append("      ,(SELECT SFACODE_TO_DESC(x.revision_status, 'REVISION_STATUS', 'SYS', '"+loginUser.getCompNo()+"','"+loginUser.getLangId()+"') FROM DUAL) revisionStatusDesc	");
        ...
        query.append("      ,(SELECT SFACODE_TO_DESC(x.stwrk_status, 'STWRK_STATUS', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') FROM DUAL) stwrkStatusDesc		");
