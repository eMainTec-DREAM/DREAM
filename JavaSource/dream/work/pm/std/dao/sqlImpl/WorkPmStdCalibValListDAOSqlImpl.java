 ...
 * @author kim21017
 * @version $Id: WorkPmStdCalibValListDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkPmStdCalibValListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkPmStdCalibValListDAO
{
    ...
    { 
        ...
        query.append("		,dbo.SFACODE_TO_DESC(x.calib_point_type,'CALIB_POINT_TYPE','SYS',''			");
        ...
        query.getOrderByQuery("x.pmcalibstdvalue_id", "x.ord_no", workPmStdCalibCommonDTO.getOrderBy(), workPmStdCalibCommonDTO.getDirection());
