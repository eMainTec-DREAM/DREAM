 ...
 * 월간예방일정 공통 DTO
 * @author  kim21017
 * @version $Id: WorkCalPmDInsMonthCommonDTO.java,v 1.0 2015/12/02 09:13:08 kim21017 Exp $
 * @since   1.0
 *
 */
public class WorkCalPmDInsMonthCommonDTO extends BaseDTO
{
	/** 스케쥴 ID */
	private String pmInsDSchedId 			= "";   //PMINSDSCHED_ID   pmSchedId
	/** pmequip ID */
