 ...
 */
public class WorkCalPmDInsMonthListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkCalPmDInsMonthListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findSchedList(WorkCalPmDInsMonthCommonDTO workCalPmDInsMonthCommonDTO, User user)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(x.pmsched_status,'PMSCHED_STATUS','SYS','','"+user.getLangId()+"')                        as PMSCHEDSTATUSDESC    ");
        ...
        query.append("       ,SFACODE_TO_DESC(y.pm_type,y.wo_type||'_TYPE','SYS','','"+user.getLangId()+"')                             as PMTYPEDESC           ");
        ...
        query.append("       ,SFACODE_TO_DESC(y.period_type,'PERIOD_TYPE','SYS','','"+user.getLangId()+"')                              as PERIODTYPEDESC       ");
        ...
        query.getOrderByQuery("x.sched_date, y.description", workCalPmDInsMonthCommonDTO.getOrderBy(), workCalPmDInsMonthCommonDTO.getDirection());
	...
	public void SP_PM_MAKE_TO_PMI(String pmInsdSchedId, User user) throws Exception
	{
        ...
        query.append("begin                                                       ");
        query.append("SP_PM_MAKE_TO_PMIDAY('"+user.getCompNo()+"',"+pmInsdSchedId+"); ");
        query.append("end;                                                        ");
