package dream.work.cal.pmrinsyear.dao.sqlImpl;
 ...
 */
public class WorkCalPmRInsYearListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkCalPmRInsYearListDAO
{
	/**
     * grid find
     * @author  kim21017
    ...
    public List findSchedMonthlyList(WorkCalPmRInsYearCommonDTO workCalPmRInsYearCommonDTO,User user)
    {
        ...
        query.append("      ,convert(char,y.cycle) + y.period_type                             as cycle           ");
        ...
        query.getOrderByQuery("x.pminssched_id", "x.sched_date, y.description", workCalPmRInsYearCommonDTO.getOrderBy(), workCalPmRInsYearCommonDTO.getDirection());
    ...
    public List findYearInsReport(WorkCalPmRInsYearCommonDTO workCalPmRInsYearCommonDTO,User user)
    {
        ...
        query.append("			,convert(char,y.cycle) + y.period_type period									");
