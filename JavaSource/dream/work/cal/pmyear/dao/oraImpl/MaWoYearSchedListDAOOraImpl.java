 ...
 */
public class MaWoYearSchedListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaWoYearSchedListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findSchedList(MaWoYearSchedCommonDTO maWoYearSchedCommonDTO,User user)
    {
        ...
        query.getOrderByQuery("x.sched_date, y.description", maWoYearSchedCommonDTO.getOrderBy(), maWoYearSchedCommonDTO.getDirection());
