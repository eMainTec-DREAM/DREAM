 ...
 */
public class WorkCalPmInsApprSchedListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkCalPmInsApprSchedListDAO
{
    public List findList(WorkCalPmInsApprCommonDTO workCalPmInsApprCommonDTO,WorkCalPmInsApprDetailDTO workCalPmInsApprDetailDTO, User user)
    {
        ...
        query.append("     , CONVERT(nvarchar, x.cycle) + (SELECT dbo.SFACODE_TO_DESC(x.period_type,'PERIOD_TYPE','SYS','','"+user.getLangId()+"'))    AS cycle				                        	");
        ...
        query.getOrderByQuery("x.pminsschedapprlist_id", "x.sched_date", workCalPmInsApprCommonDTO.getOrderBy(), workCalPmInsApprCommonDTO.getDirection());
    ...
    @Override
    public void deletePmInsSchedApprList(
            ...
            WorkCalPmInsApprDetailDTO workCalPmInsApprDetailDTO, User user)
    {
        ...
        query.append("       next value for sqapminsschedapprlist_id,                ");
        query.append("       ?,                                                     ");
