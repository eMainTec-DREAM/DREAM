 ...
 */
public class WorkCalPmInsApprListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkCalPmInsApprListDAO
{
    public List findList(WorkCalPmInsApprCommonDTO workCalPmInsApprCommonDTO, User user)
    {
        ...
        query.append("              THEN SUBSTRING(x.yyyymm, 1, 4)+'-'+SUBSTRING(x.yyyymm, 5, 2)");
        query.append("              ELSE ''                                                     ");
        ...
        query.getOrderByQuery("x.pminsschedappr_id", "x.upd_date DESC", workCalPmInsApprCommonDTO.getOrderBy(), workCalPmInsApprCommonDTO.getDirection());
