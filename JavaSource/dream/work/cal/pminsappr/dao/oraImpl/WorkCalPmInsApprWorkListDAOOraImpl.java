 ...
 */
public class WorkCalPmInsApprWorkListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkCalPmInsApprWorkListDAO
{
    public List findList(WorkCalPmInsApprCommonDTO workCalPmInsApprCommonDTO,WorkCalPmInsApprDetailDTO workCalPmInsApprDetailDTO, User user)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(y.pmsched_status,'PMSCHED_STATUS','SYS','','"+user.getLangId()+"') AS pmSchedStatus ");
        ...
        query.append("       ,SFACODE_TO_DESC(z.schedule_type,'SCHEDULE_TYPE','SYS','','"+user.getLangId()+"')	AS scheduleTypeDesc");
        query.append("       ,z.cycle||z.period_type                                        AS cycle         	");
        ...
        query.getOrderByQuery("y.sched_date", workCalPmInsApprCommonDTO.getOrderBy(), workCalPmInsApprCommonDTO.getDirection());
