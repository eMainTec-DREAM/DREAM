package dream.work.cal.pmcinsmonth.dao.oraImpl;
 ...
 */
public class WorkCalPmCInsMonthListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkCalPmCInsMonthListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    private String getWhere(WorkCalPmCInsMonthCommonDTO workCalPmCInsMonthCommonDTO,User user)
    {
        ...
        //설비
        query.getCodeLikeQuery("a.equip_id", "a.description||a.item_no",workCalPmCInsMonthCommonDTO.getEquipId(), workCalPmCInsMonthCommonDTO.getEquipDesc());
        
        //위치
        query.getEqLocLevelQuery("a.eqloc_id", workCalPmCInsMonthCommonDTO.getEqLocId(), workCalPmCInsMonthCommonDTO.getEqLocDesc(), user.getCompNo());
        
        //부서명
        query.getDeptLevelQuery("z.dept_id", workCalPmCInsMonthCommonDTO.getDeptId(), workCalPmCInsMonthCommonDTO.getDeptDesc(), user.getCompNo());
        
        //담당자
        query.getCodeLikeQuery("z.emp_id", "(SELECT a.emp_name FROM  TAEMP a WHERE a.emp_id = z.emp_id AND a.comp_no=z.comp_no)", workCalPmCInsMonthCommonDTO.getEmpId(), workCalPmCInsMonthCommonDTO.getEmpDesc());
