package dream.work.cal.woweek.dto;
 ...
 * 주간작업일정 공통 DTO
 * @author  kim21017
 * @version $Id: MaWoWeekWoCommonDTO.java,v 1.0 2015/12/02 09:13:08 kim21017 Exp $
 * @since   1.0
 * 
 */
public class MaWoWeekWoCommonDTO extends BaseDTO
{
	/** wo ID */
	private String wkOrId 					= "";
	/** 필터 년월일 */
	private String filterWkorDate 			= "";
	/** 필터 부서id */
	...
	//검색 시작일
	private String startWkorDate			= "";
	//검색종료일
	private String endWkorDate				= "";
	//클릭한 cnt의 wotype
	private String clickedWoType			= "";
	/** 설비유형Id */
	...
	public String getClickedWoType() {
		return clickedWoType;
	}
	public void setClickedWoType(String clickedWoType) {
		this.clickedWoType = clickedWoType;
	}
	public String getStartWkorDate() {
		return startWkorDate;
	}
	public void setStartWkorDate(String startWkorDate) {
		this.startWkorDate = startWkorDate;
	}
	public String getEndWkorDate() {
		return endWkorDate;
	}
	public void setEndWkorDate(String endWkorDate) {
		this.endWkorDate = endWkorDate;
	}
	...
	public String getFilterWkorDate() {
		return filterWkorDate;
	}
	public void setFilterWkorDate(String filterWkorDate) {
		this.filterWkorDate = CommonUtil.convertDate(filterWkorDate);
	}
