 ...
 */
public class WorkCalPmRInsPeriodListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkCalPmRInsPeriodListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findSchedList(WorkCalPmRInsPeriodCommonDTO workCalPmRInsPeriodCommonDTO, User user)
    {
        ...
        query.append("       ,(SELECT SFACODE_TO_DESC(x.pmsched_status,'PMSCHED_STATUS','SYS','','"+user.getLangId()+"') FROM DUAL) AS pmSchedStatusDesc    ");
        ...
        query.append("       ,(SELECT SFACODE_TO_DESC(y.schedule_type,'SCHEDULE_TYPE','SYS','','"+user.getLangId()+"') FROM DUAL)   AS scheduleTypeDesc     ");
        query.append("       ,y.period_type                                                                                         AS periodType           ");
        query.append("       ,(SELECT SFACODE_TO_DESC(y.period_type,'PERIOD_TYPE','SYS','','"+user.getLangId()+"') FROM DUAL)       AS periodTypeDesc       ");
        query.append("       ,y.cycle                                                                                               AS cycle                ");
        query.append("       ,y.cycle||y.period_type                                                                                AS cycleDesc            ");
        ...
        query.append("       ,(SELECT SFACODE_TO_DESC(y.pm_type,y.wo_type||'_TYPE','SYS','','"+user.getLangId()+"') FROM DUAL)      AS pmTypeDesc           ");
        ...
        query.getOrderByQuery("x.plan_date, y.description", workCalPmRInsPeriodCommonDTO.getOrderBy(), workCalPmRInsPeriodCommonDTO.getDirection());
