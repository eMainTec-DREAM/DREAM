package dream.work.cal.pmptrlmonth.dao.oraImpl;
 ...
 */
public class WorkCalPmPtrlMonthListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkCalPmPtrlMonthListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findSchedList(WorkCalPmPtrlMonthCommonDTO workCalPmPtrlMonthCommonDTO, User user)
    {
        ...
        query.append("      , SFACODE_TO_DESC(y.pmsched_status, 'PMSCHED_STATUS', 'SYS', y.comp_no, '"+user.getLangId()+"')   AS proStatus                ");
        ...
        query.getOrderByQuery("x.pm_id", workCalPmPtrlMonthCommonDTO.getOrderBy(), workCalPmPtrlMonthCommonDTO.getDirection());
