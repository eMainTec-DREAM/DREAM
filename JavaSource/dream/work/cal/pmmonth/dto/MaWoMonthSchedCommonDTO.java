package dream.work.cal.pmmonth.dto;
 ...
 * 월간예방일정 공통 DTO
 * @author  kim21017
 * @version $Id: MaWoMonthSchedCommonDTO.java,v 1.0 2015/12/02 09:13:08 kim21017 Exp $
 * @since   1.0
 * 
 */
public class MaWoMonthSchedCommonDTO extends BaseDTO
{
	/** 스케쥴 ID */
	...
	/** Filter - WO작업상태 ID */
    private String filterWoStatusId		= "";
    /** Filter - WO작업상태 DESC */
	...
	public String getFilterWoStatusId() {
		return filterWoStatusId;
	}
	public void setFilterWoStatusId(String filterWoStatusId) {
		this.filterWoStatusId = filterWoStatusId;
	}
