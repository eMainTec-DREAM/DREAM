 ...
 */
public class MaWoMonthSchedListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaWoMonthSchedListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findSchedList(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, User user)
    {
        ...
        query.append("       (SELECT SFACODE_TO_DESC(x.pmsched_status,'PMSCHED_STATUS','SYS','','"+user.getLangId()+"') FROM DUAL)												pmSchedStatus,	");
        ...
        query.append("        TO_CHAR(CASE zz.eqctg_type WHEN 'MD' THEN '('||zz.old_eq_no||')' || zz.item_no ELSE zz.item_no END)	 AS EQUIPNO,							");
        ...
        query.append("      , TO_CHAR(DECODE(zz.eqctg_type,'MD','('||zz.old_eq_no||')'||zz.description,zz.description))	                                AS equipDesc,				");
        ...
        query.append("       (SELECT SFACODE_TO_DESC(y.pm_type,y.wo_type||'_TYPE','SYS','','"+user.getLangId()+"') FROM DUAL)				pmTypeDesc,											");
        query.append("       y.pm_type																pmType,																	");
        query.append("       (SELECT SFACODE_TO_DESC(y.schedule_type,'SCHEDULE_TYPE','SYS','','"+user.getLangId()+"') FROM DUAL)			scheduleTypeDesc,									");
        ...
        query.append("      ,(SELECT SFAIDTODESC(z.vendor_id, '', 'VENDOR', z.comp_no) FROM DUAL)           			vendorDesc 																");
        query.append("      ,z.tot_amt       														totAmt																	");
        query.append("      ,z.self_vendor_type                                            			selfVendorType    														");
        query.append("      ,(SELECT SFACODE_TO_DESC(z.self_vendor_type,'SELF_VENDOR_TYPE','SYS','','"+user.getLangId()+"') FROM DUAL)		selfVendorTypeDesc                                  ");
        ...
        query.getOrderByQuery("x.sched_date, y.description", maWoMonthSchedCommonDTO.getOrderBy(), maWoMonthSchedCommonDTO.getDirection());
    ...
    public int createWorkOrder(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, String id)
    {
    	...
    	query.append("		)																			");
    	query.append("SELECT a.comp_no,		SQAWKOR_ID.nextval, SQAWKOR_ID.CURRVAL, 					");
    	query.append("		'['||DECODE(a.pm_type,'INS','PMI','PMW')||']'||a.description,	'P',		DECODE(a.pm_type,'INS','PMI','PMW'),				a.pm_type,			");
    	...
    	query.append("SELECT a.comp_no,SQAWOEQUIP_ID.nextval,a.wkor_id,b.equip_id			");
    ...
    public int createWoCraft(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, String id)
    {
    	...
    	query.append("		)																				");
    	query.append("SELECT x.comp_no,		SQAWOCRAFT_ID.NEXTVAL, x.wkor_id,								");
        query.append("				(SELECT MIN(b.main_mng_id)												");
        query.append("					FROM TAPMEQUIP a, TAEQUIPMENT b										");
        query.append("					WHERE a.comp_no = b.comp_no											");
        query.append("						AND a.equip_id = b.equip_id										");
    ...
    public int createWoPart(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, String id)
    {
    	...
    	query.append("		)																				");
    	query.append("SELECT x.comp_no,		SQAWOPART_ID.NEXTVAL, x.wkor_id,								");
    ...
    public int createWoPoint(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, String id)
    {
        ...
        query.append("      )                                                                               ");
        query.append("SELECT x.comp_no,     SQAWOPOINT_ID.NEXTVAL,  x.wkor_id,                              ");
        query.append("       y.pm_point_id, (select cdsysd_no from 											");
        query.append("                (select * from tacdsysd												");
        query.append("                where list_type='PM_POINT_RSLT_STATUS'								");
        query.append("                order by ord_no)														");
        query.append("                where rownum=1),              'GD'                                    ");
    ...
    {   
        ...
        query.append("      )                                                                               ");
        query.append("SELECT x.comp_no,     SQAWOEQUIP_ID.NEXTVAL,  x.wkor_id,                              ");
    ...
    public int updatePmSchedStatus(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, String id)
    {
    	...
    	query.append("UPDATE TAPMSCHED x SET x.pmsched_status = 'S'								");
    ...
    public int updateLastSchDate(MaWoMonthSchedCommonDTO maWoMonthSchedCommonDTO, String id)
    {
    	...
    	query.append("UPDATE TAPMLST a SET a.last_sch_date = 															");
    	query.append("		DECODE(a.period_type,																		");
    	query.append("			'Y',to_char(add_months(to_date(a.last_sch_date,'yyyymmdd'), 1*a.cycle*12), 'yyyymmdd'),	");
    	query.append("			'M',to_char(add_months(to_date(a.last_sch_date,'yyyymmdd'), a.cycle*1), 'yyyymmdd'),	");
    	query.append("			'W',to_char(to_date(a.last_sch_date,'yyyymmdd')+1*a.cycle*7, 'yyyymmdd'),				");
    	query.append("			'D',to_char(to_date(a.last_sch_date,'yyyymmdd')+a.cycle*1, 'yyyymmdd'))					");
    	query.append("WHERE 1=1																							");
    ...
    public void SP_PM_MAKE_WO_BYONE(String compNo, String userNo, String pmschedId) throws Exception
    {
        ...
        query.append("begin                                                 ");
        query.append("SP_PM_MAKE_TO_WO('"+compNo+"',"+pmschedId+"); ");
//        query.append("SP_PM_MAKE_WO_BYONE('"+compNo+"',"+pmschedId+"); ");
        query.append("end;                                                  ");
