 ...
 */
public class MaWoSchedListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWoSchedListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findSchedList(MaWoSchedCommonDTO maWoSchedCommonDTO, User user)
    {
        ...
        query.append("     , (SELECT a.emp_id FROM TAWORKORDER a WHERE a.pm_id = x.pm_id AND a.wkor_id = x.wkor_id)     	AS EMPID       		");
        query.append("     , (SELECT a.emp_name FROM TAEMP a WHERE a.emp_id = (SELECT b.emp_id FROM TAWORKORDER b WHERE b.pm_id = x.pm_id AND b.wkor_id = x.wkor_id))  AS empDesc     ");
        ...
        query.append("		, (SELECT CASE b.eqctg_type WHEN 'MD' THEN '('+b.old_eq_no+')'+b.item_no ELSE b.item_no END				");
        ...
        query.append("		, (SELECT CASE b.eqctg_type WHEN 'MD' THEN '('+b.old_eq_no+')'+b.description ELSE b.description END		");
        query.append("			FROM TAPMEQUIP a, TAEQUIPMENT b											");
        query.append("			WHERE a.comp_no = b.comp_no												");
        query.append("				AND a.equip_id = b.equip_id											");
        query.append("				AND a.pm_id = y.pm_id												");
        ...
        query.append("		  WHERE a.comp_no = y.comp_no												");
        query.append("		  AND a.wkctr_id = y.wkctr_id) 						        AS WKCTRDESC	");
        ...
        query.append("      , CONVERT(NVARCHAR,y.cycle)+y.period_type                   AS CYCLE		");
        query.append("      , y.USAGE                                                   AS USAGE        ");
        query.append("      , (SELECT a.wo_status                                                       ");
        query.append("           FROM TAWORKORDER a                                                     ");
        query.append("          WHERE a.comp_no = x.comp_no                                             ");
        query.append("            AND a.wkor_id = x.wkor_id)                            AS woStatus     ");
        query.append("      , x.pmsched_status                                          AS pmStatusCode ");
        query.append("      ,  y.pm_id                                                  AS PMID         ");
        query.append("      , (SELECT a.param2 FROM TACDSYSD a WHERE a.cdsysd_no=y.pm_type AND a.list_type= y.wo_type+'_TYPE')  AS PARAM  		");
        query.append("		, (SELECT (SELECT b.param1 FROM TACDSYSD b WHERE b.list_type=a.wo_type+'_TYPE' AND b.cdsysd_no= a.pm_type)			");
        query.append("		   FROM TAWORKORDER a														");
        query.append("		   WHERE a.comp_no = x.comp_no												");
        query.append("		       AND a.wkor_id = x.wkor_id	)						 AS WOPARAM     ");
        ...
        query.getOrderByQuery("x.pmsched_id", "x.sched_date, y.description", maWoSchedCommonDTO.getOrderBy(), maWoSchedCommonDTO.getDirection());
    ...
    {        
      ...
      //담당자(정)
        ...
        if(!"".equals(maWoSchedCommonDTO.getWkOrId())){
            query.getAndQuery("x.wkor_id", maWoSchedCommonDTO.getWkOrId());
