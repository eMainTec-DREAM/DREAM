package dream.work.plan.service.dao.oraImpl;
 ...
 */
public class WoPlanServiceDAOOraImpl extends BaseJdbcDaoSupportOra implements WoPlanServiceDAO
{
	...
	public String getColums(WoPlanServiceDTO woPlanServiceDTO, User user) {
		...
		query.append("     , SFACODE_TO_DESC(x.service_uom, 'SERVICE_UOM', 'SYS', x.comp_no,'"+ user.getLangId() +"') 	AS UOMDESC			");
	...
	public String getOrderBy(WoPlanServiceDTO woPlanServiceDTO, User user) {
		...
		query.getOrderByQuery("x.woplanservice_id", "ord_no DESC", woPlanServiceDTO.getOrderBy(), woPlanServiceDTO.getDirection());		
