 ...
 */
public class LovWorkLetCategListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovWorkLetCategListDAO
{
	@Override
	public List findWorkLetCategAcList(LovWorkLetCategListDTO lovWorkLetCategListDTO, User user, Map<String, String> conditionMap)
	{
        ...
        query.append(" 		,SFACODE_TO_DESC(a.woletctg_type,'WOLETCTG_TYPE','SYS','','ko')		AS woLetCtgTypeDesc	");
        ...
        query.getOrderByQuery("a.woletctg_id", lovWorkLetCategListDTO.getOrderBy(), lovWorkLetCategListDTO.getDirection());
