 ...
 * @author euna0207
 * @version $Id: WorkLetCategEtcListDAOOraImpl.java,v 1.0 2015/12/02 09:12:40 euna0207 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkLetCategEtcListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkLetCategEtcListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("a.woletctgetc_id", workLetCategEtcListDTO.getOrderBy(), workLetCategEtcListDTO.getDirection());
