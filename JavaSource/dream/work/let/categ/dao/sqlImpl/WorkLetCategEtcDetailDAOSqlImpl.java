 ...
 * @author euna0207
 * @version $Id: WorkLetCategEtcDetailDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 euna0207 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkLetCategEtcDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkLetCategEtcDetailDAO
{
    ...
    public WorkLetCategEtcDetailDTO findDetail(WorkLetCategCommonDTO workLetCategCommonDTO, WorkLetCategEtcListDTO workLetCategEtcListDTO, User user) 
    {
        ...
        query.append(", dbo.SFACODE_TO_DESC(a.is_use, 'IS_USE', 'SYS', '', 'ko')        											 AS isUseDesc		");
        ...
        WorkLetCategEtcDetailDTO workLetCategEtcDetailDTO = 
        		(WorkLetCategEtcDetailDTO)getJdbcTemplate().query(query.toString(), getObject(objects), new MwareExtractor(new WorkLetCategEtcDetailDTO()));
