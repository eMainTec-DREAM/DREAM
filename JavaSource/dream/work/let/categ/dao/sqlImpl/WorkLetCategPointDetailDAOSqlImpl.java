 ...
 * @author euna0207
 * @version $Id: WorkLetCategPointDetailDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 euna0207 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkLetCategPointDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkLetCategPointDetailDAO
{
    ...
    public WorkLetCategPointDetailDTO findDetail(WorkLetCategCommonDTO workLetCategCommonDTO, WorkLetCategPointListDTO workLetCategPointListDTO, User user) 
    {
        ...
        query.append(", dbo.SFACODE_TO_DESC(a.check_type, 'CHECK_TYPE', 'SYS', '', ?) 					AS checkTypeDesc	");
        ...
        WorkLetCategPointDetailDTO workLetCategPointDetailDTO = 
        		(WorkLetCategPointDetailDTO)getJdbcTemplate().query(query.toString(), getObject(objects), new MwareExtractor(new WorkLetCategPointDetailDTO()));
