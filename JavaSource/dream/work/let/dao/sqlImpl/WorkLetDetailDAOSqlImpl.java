 ...
 */
public class WorkLetDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkLetDetailDAO
{
    /**
     * detail find
     * @author syyang
    ...
    public WorkLetDetailDTO findDetail(WorkLetCommonDTO workLetCommonDTO,User user)
    {
        ...
        query.append("		,dbo.SFACODE_TO_DESC(x.wolet_status,'WOLET_STATUS','SYS','','"+lang+"')				woLetStatusDesc		");
