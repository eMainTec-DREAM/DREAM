...
/**
 * 안전작업허가서 작업유형 - 점검항목 상세 Form
 * @author syyang
 * @version $Id: WorkLetPermitPointDetailForm.java,v 1.0 2015/12/02 09:12:40 syyang Exp $
 * @since 1.0
 * @struts.form name="workLetPermitPointDetailForm"
 */
public class WorkLetPermitPointDetailForm extends BaseForm
{
    /** 안전작업허가서 작업유형 상세 DTO  */
