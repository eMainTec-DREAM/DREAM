 ...
 * @author syyang
 * @version $Id: WorkLetPermitPointListDAOOraImpl.java,v 1.0 2015/12/02 09:12:40 syyang Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkLetPermitPointListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkLetPermitPointListDAO
{
    ...
    { 
        ...
        query.append("		, SFACODE_TO_DESC(x.check_type, 'CHECK_TYPE', 'SYS', '', 'ko')	AS checkTypeDesc	");
        ...
        query.getOrderByQuery("x.step_num", workLetPermitPointListDTO.getOrderBy(), workLetPermitPointListDTO.getDirection());
