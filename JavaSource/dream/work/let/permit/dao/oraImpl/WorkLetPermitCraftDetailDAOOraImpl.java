 ...
 */
public class WorkLetPermitCraftDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkLetPermitCraftDetailDAO
{
    /**
     * detail find
     * @author syyang
    ...
    public WorkLetPermitCraftDetailDTO findDetail(String woLetListId, String woLetListCraftId, User user)
    {
        ...
        query.append("		,SFACODE_TO_DESC(x.craft_type, 'CRAFT_TYPE', 'SYS', '', '"+user.getLangId()+"')	AS craftTypeDesc	");
