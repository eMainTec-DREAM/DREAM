 ...
 * @author kim21017
 * @version $Id: WorkFmeaResListDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkFmeaResListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkFmeaResListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.wofmea_id", "x.wofmea_no", workFmeaResCommonDTO.getOrderBy(), workFmeaResCommonDTO.getDirection());
