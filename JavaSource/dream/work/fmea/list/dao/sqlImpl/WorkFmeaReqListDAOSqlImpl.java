 ...
 * @author kim21017
 * @version $Id: WorkFmeaReqListDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class WorkFmeaReqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkFmeaReqListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.wofmea_id", "x.wofmea_no", workFmeaReqCommonDTO.getOrderBy(), workFmeaReqCommonDTO.getDirection());
