 ...
 */
public class WorkRptMaintRateListDAOOraImpl  extends BaseJdbcDaoSupportOra implements WorkRptMaintRateListDAO
{
    ...
    public List findList(WorkRptMaintRateCommonDTO workRptMaintRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("  , NVL(SUM(i.tot_amt),0) + NVL(SUM(i.woparts_tot_price),0)                                                      AS USEAMT       ");
        query.append("  , COUNT(1)                                                                                                     AS ALLMAINTCNT  ");
        query.append("  , SUM(i.complete_cnt)                                                                                          AS COMPLETECNT  ");
        query.append("  , ROUND(SUM(i.complete_cnt) / COUNT(1)*100,2)                                                                  AS COMPLETERATE ");
        query.append("  FROM(                                                                                                                          ");
        query.append("    SELECT                                                                     ");
        ...
        query.getOrderByQuery("(SELECT a.description FROM TAPLANT a WHERE a.comp_no = i.comp_no "
