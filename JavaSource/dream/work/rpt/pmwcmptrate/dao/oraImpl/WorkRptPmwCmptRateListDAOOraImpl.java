package dream.work.rpt.pmwcmptrate.dao.oraImpl;
 ...
 */
public class WorkRptPmwCmptRateListDAOOraImpl  extends BaseJdbcDaoSupportOra implements WorkRptPmwCmptRateListDAO
{
    ...
    public List findList(WorkRptPmwCmptRateCommonDTO workRptPmwCmptRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("  ,NVL(sum(CASE WHEN b.start_date <= a.sched_date  THEN 1 ELSE 0 END),0) AS c_cnt     ");
        ...
        query.append(" GROUP BY c.comp_no,c.plant,SUBSTR(a.sched_date,1,6)      ");
        query.getOrderByQuery("c.comp_no,c.plant,SUBSTR(a.sched_date,1,6)", workRptPmwCmptRateCommonDTO.getOrderBy(), workRptPmwCmptRateCommonDTO.getDirection());
    ...
    public String findTotalCount(
        ...
        query.append("FROM (									            ");
        query.append("SELECT c.comp_no,c.plant,SUBSTR(a.sched_date,1,6) yyyymm ");
        query.append(" FROM TAPMSCHED a INNER JOIN TAWORKORDER b        ");
        query.append("  ON a.comp_no = b.comp_no AND a.pmsched_id = b.pmsched_id        ");
        query.append(" INNER JOIN TAPMLST c ON a.comp_no = c.comp_no AND a.pm_id = c.pm_id ");
        query.append(" INNER JOIN TAPMEQUIP d ON c.comp_no = d.comp_no AND c.pm_id = d.pm_id AND a.pmequip_id = d.pmequip_id ");
