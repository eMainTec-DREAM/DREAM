 ...
 */
public class WorkRptPmwCmptDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkRptPmwCmptDetailDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findDetail(WorkRptPmwCmptDetailDTO workRptPmwCmptDetailDTO, User loginUser) throws Exception
    {
        ...
        query.getOrderByQuery("a.wkor_date ASC", workRptPmwCmptDetailDTO.getOrderBy(), workRptPmwCmptDetailDTO.getDirection());
