 ...
 */
public class WorkRptPmiEquipPlanDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkRptPmiEquipPlanDetailDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findDetail(WorkRptPmiEquipPlanDetailDTO workRptPmiEquipPlanDetailDTO, User loginUser)  throws Exception
    {
        ...
        query.getOrderByQuery("a.pminslist_id", "b.sched_date ASC", workRptPmiEquipPlanDetailDTO.getOrderBy(), workRptPmiEquipPlanDetailDTO.getDirection());
