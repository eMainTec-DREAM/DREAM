package dream.work.rpt.pmiequipplanrate.dao.sqlImpl;
 ...
 */
public class WorkRptPmiEquipPlanRateListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkRptPmiEquipPlanRateListDAO
{
    ...
    public List findList(WorkRptPmiEquipPlanRateCommonDTO workRptPmiEquipPlanRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("  ,isnull(sum(CASE WHEN b.start_date <= a.sched_date  THEN 1 ELSE 0 END),0)			AS completeCnt	");
        ...
        query.append("       / count(*)     												");
        query.append("     ) *100)         								AS completeRate		");
        ...
        query.append("GROUP BY b.comp_no,b.plant,LEFT(a.sched_date,6)      					");
        query.getOrderByQuery("b.comp_no", "b.comp_no,b.plant,LEFT(a.sched_date,6)", workRptPmiEquipPlanRateCommonDTO.getOrderBy(), workRptPmiEquipPlanRateCommonDTO.getDirection());
    ...
    public String findTotalCount(WorkRptPmiEquipPlanRateCommonDTO workRptPmiEquipPlanRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("FROM(													");
        query.append("		SELECT 											");
        query.append("	  		b.comp_no,b.plant,LEFT(a.sched_date,6) yyyymm	");
        query.append("		FROM TAPMINSSCHED a INNER JOIN TAPMINSLIST b       	");
        query.append("		 ON a.comp_no = b.comp_no AND a.pminssched_id = b.pminssched_id	");
        query.append("		WHERE 1=1        								");
        query.append(this.getWhere(workRptPmiEquipPlanRateCommonDTO, user));
