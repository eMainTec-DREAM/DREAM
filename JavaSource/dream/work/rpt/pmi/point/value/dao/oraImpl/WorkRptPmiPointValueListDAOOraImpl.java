package dream.work.rpt.pmi.point.value.dao.oraImpl;
 ...
 * 정기점검항목결과 - 목록 DaoImpl
 * @author  nhkim8548
 * @version $Id: WorkRptPmiPointValueListDAO.java, v1.0 2019/07/10 11:08:12 nhkim8548 Exp $
 * @since   1.0
 * @spring.bean id="workRptPmiPointValueListDAOTarget"
 * @spring.txbn id="workRptPmiPointValueListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class WorkRptPmiPointValueListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkRptPmiPointValueListDAO
{
    /**
     * grid find
     * @author  nhkim8548
    ...
    public List findPointValueList(WorkRptPmiPointValueCommonDTO workRptPmiPointValueCommonDTO, User user) throws Exception
    {
        ...
        query.append("        , SFACODE_TO_DESC(z.check_type,'CHECK_TYPE','SYS','','"+ user.getCompNo() +"')                            AS checkType        ");
        ...
        query.append("        , SFACODE_TO_DESC(y.pm_point_rslt_status,'PM_POINT_RSLT_STATUS','SYS','','"+ user.getCompNo() +"')        AS rsltStatusDesc   ");
        ...
        query.getOrderByQuery("x.pminslist_id DESC", workRptPmiPointValueCommonDTO.getOrderBy(), workRptPmiPointValueCommonDTO.getDirection());
