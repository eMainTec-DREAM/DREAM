 ...
 */
public class WorkRptEqEngDetailListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkRptEqEngDetailListDAO
{
    @Override
    public List findDetailList(WorkRptEqEngDetailListForm workRptEqEngDetailListForm, User loginUser)
    {
    	...
    	query.append("SELECT                         					");
        query.append("         ''     							seqNo	");
        query.append("       , SUBSTRING(x.usage_date,1,4) +'-'+        ");
        query.append("         SUBSTRING(x.usage_date,5,2)   USAGEDATE  ");
