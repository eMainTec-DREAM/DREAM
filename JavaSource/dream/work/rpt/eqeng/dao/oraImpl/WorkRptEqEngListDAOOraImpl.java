 ...
 */
public class WorkRptEqEngListDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkRptEqEngListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findTotalCount(WorkRptEqEngListForm workRptEqEngListForm, User loginUser)
    {
    	...
    	query.append("       , NVL(MAX(z.totalUsage),0)     totalUsage		");
    	query.append("FROM TADAY a LEFT OUTER JOIN (						");
    	query.append("SELECT                                         		");
    	query.append("      NVL(a.usage_date,'')        	usageDate       ");
    	query.append("    , NVL(SUM(a.TOTUSAGE),0)     		totalUsage      ");
    	query.append("FROM (                                        		");
    	query.append("SELECT                                        		");
    	...
    	query.append("ORDER BY a.usage_date   								");
    	query.append(") z             										");
