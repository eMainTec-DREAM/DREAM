 ...
 */
public class WorkRptPmiCmptDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkRptPmiCmptDetailDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findDetail(WorkRptPmiCmptDetailDTO workRptPmiCmptDetailDTO, User loginUser) throws Exception
    {
        ...
        query.append("    ,SFACODE_TO_DESC(c.pm_point_rslt_status,'PM_POINT_RSLT_STATUS','SYS','','"+loginUser.getLangId()+"')	AS pmPointRsltStatusDesc	");
        ...
        query.getOrderByQuery("b.sched_date ASC", workRptPmiCmptDetailDTO.getOrderBy(), workRptPmiCmptDetailDTO.getDirection());
