 ...
 */
public class WorkRptPmiCmptRateListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkRptPmiCmptRateListDAO
{
    ...
    public List findList(WorkRptPmiCmptRateCommonDTO workRptPmiCmptRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("	  ,convert(numeric(5,2),((sum(CASE WHEN a.PMSCHED_STATUS = 'C' THEN 1.0 ELSE 0 END)) / count(*)) *100)	AS completeRate	");
        ...
        query.getOrderByQuery("b.comp_no", "b.comp_no,b.plant,LEFT(a.sched_date,6)", workRptPmiCmptRateCommonDTO.getOrderBy(), workRptPmiCmptRateCommonDTO.getDirection());
