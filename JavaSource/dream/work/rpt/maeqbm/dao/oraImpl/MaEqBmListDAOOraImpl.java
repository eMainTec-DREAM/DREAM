package dream.work.rpt.maeqbm.dao.oraImpl;
 ...
 */
public class MaEqBmListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaEqBmListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findEqBmList(MaEqBmListDTO maEqBmListDTO, User user)
    {
		...
		query.append("       ,TO_CHAR(TO_DATE(z.eqdn_start_date,'yyyymmdd'),'yyyy-mm-dd')||' '||TO_CHAR(TO_DATE(eqdn_start_time,'hh24miss'),'hh24:mi') eqDnStartTime	");
		query.append("       ,TO_CHAR(TO_DATE(z.eqdn_end_date,'yyyymmdd'),'yyyy-mm-dd')||' '||TO_CHAR(TO_DATE(eqdn_end_time,'hh24miss'),'hh24:mi') eqDnEndTime			");
		...
		query.getOrderByQuery("x.start_date", maEqBmListDTO.getOrderBy(), maEqBmListDTO.getDirection());
