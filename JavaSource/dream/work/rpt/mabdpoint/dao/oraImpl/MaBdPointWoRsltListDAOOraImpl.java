 ...
 */
public class MaBdPointWoRsltListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaBdPointWoRsltListDAO
{
    /**
     * grid find
     * @author  syyang
    ...
    public List findList(MaBdPointCommonDTO maBdPointCommonDTO,MaBdPointWoRsltListDTO maBdPointWoRsltListDTO, User user)
    {
        QueryBuffer query = new QueryBuffer();
            ...
            query.getOrderByQuery("x.wongpointres_id", maBdPointWoRsltListDTO.getOrderBy(), maBdPointWoRsltListDTO.getDirection());
