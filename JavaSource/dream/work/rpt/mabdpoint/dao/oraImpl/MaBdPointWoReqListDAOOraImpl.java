 ...
 */
public class MaBdPointWoReqListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaBdPointWoReqListDAO
{
    /**
     * grid find
     * @author  syyang
    ...
    public List findList(MaBdPointCommonDTO maBdPointCommonDTO, MaBdPointWoReqListDTO maBdPointWoReqListDTO, User user)
    {
        QueryBuffer query = new QueryBuffer();
	        ...
	        query.append("		,SFACODE_TO_DESC(y.woreq_status,'WOREQ_STATUS','SYS','','"+user.getLangId()+"')		AS woReqStatusDesc	");
            ...
            query.getOrderByQuery("x.wongpointres_id", maBdPointWoReqListDTO.getOrderBy(), maBdPointWoReqListDTO.getDirection());
