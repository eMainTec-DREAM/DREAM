package dream.work.rpt.mawotype.dao.sqlImpl;
 ...
 */
public class MaWoTypeChartDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWoTypeChartDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(MaWoTypeChartDTO maWoTypeChartDTO)
    {
        ...
        query.append("		 ,ISNULL(COUNT(y.wkor_id),0) woCnt	");
        query.append("		 ,ISNULL(ROUND((1.*COUNT(y.wkor_id))/	");
        query.append("			(SELECT count(1) 			");
        query.append("			FROM TAWORKORDER y			");
        query.append("			WHERE 1=1					");
        query.append(this.getWhere(maWoTypeChartDTO));
        query.append("			) * 100,2),0) woCntRate		");
        query.append("		 ,ISNULL(SUM(y.work_time),0) woTime");
        query.append("		 ,ISNULL(ROUND((1.*SUM(y.work_time))/	");
