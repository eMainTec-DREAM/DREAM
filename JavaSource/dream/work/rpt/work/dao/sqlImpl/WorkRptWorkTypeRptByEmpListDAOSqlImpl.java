 ...
 */
public class WorkRptWorkTypeRptByEmpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkRptWorkTypeRptByEmpListDAO
{
	@Override
    public List findList(WorkRptWorkTypeRptByEmpCommonDTO workRptWorkTypeRptByEmpCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.comp_no", "x.emp_id desc", workRptWorkTypeRptByEmpCommonDTO.getOrderBy(), workRptWorkTypeRptByEmpCommonDTO.getDirection());
