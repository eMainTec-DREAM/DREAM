 ...
 */
public class WorkRptWorkTypeRptByEmpWoTypeDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkRptWorkTypeRptByEmpWoTypeDAO
{
	...
	public List findWoTypeList(WorkRptWorkTypeRptByEmpWoTypeDTO workRptWorkTypeRptByEmpWoTypeDTO, User user) {
        ...
        query.append("GROUP BY x.comp_no, x.emp_id, x.dept_id, left(x.wkor_date,6), x.wo_type				");
