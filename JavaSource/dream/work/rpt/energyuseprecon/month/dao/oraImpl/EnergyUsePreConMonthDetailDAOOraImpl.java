 ...
 */
public class EnergyUsePreConMonthDetailDAOOraImpl  extends BaseJdbcDaoSupportOra implements EnergyUsePreConMonthDetailDAO
{
    ...
    public List findDetail(EnergyUsePreConMonthDetailDTO energyUsePreConMonthDetailDTO, User user) throws Exception
    {
        ...
        query.append("        ,NVL(b.unit_price,0)                                         unitPrice       ");
        ...
        query.getOrderByQuery("b.yyyymm", energyUsePreConMonthDetailDTO.getOrderBy(), energyUsePreConMonthDetailDTO.getDirection());
    ...
    {        
        ...
        // 항목
        query.getCodeLikeQuery("a.check_point_type", "SFACODE_TO_DESC(a.check_point_type, 'CHECK_POINT_TYPE', 'SYS', '"+user.getCompNo()+"', '"+user.getLangId()+"')", energyUsePreConMonthDetailDTO.getCheckPointType(), energyUsePreConMonthDetailDTO.getCheckPointDesc());
