package dream.work.rpt.mabmeqlist.dao.sqlImpl;
 ...
 */
public class MaBmEqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaBmEqListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findBmEqList(MaBmEqListDTO maBmEqListDTO, User user)
    {
        ...
        query.append("			deptDesc AS DEPTDESC				");
        ...
        query.append("				AND key_no='total2')										");
        query.append("			,NULL,'',NULL,'',NULL,'','',NULL	");
        query.append("			,count(x.wkor_id)												");
        query.append("			,ROUND(SUM(y.eqdn_work_time)/60,2),'','',''						");
        query.append("FROM TAWORKORDER x,														");
        query.append("		(SELECT b.eqloc_id eqloc_id											");
        query.append("				,b.eqctg_id eqctg_id										");
        query.append("				,b.comp_no comp_no											");
    ...
    {        
        ...
        query.getAndQuery("SUBSTRING(x.start_date,1,4)", maBmEqListDTO.getFilterYyyy().substring(0, 4));
