 ...
 */
public class MaPmTrendDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPmTrendDetailDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findDetail(MaPmTrendCommonDTO maPmTrendCommonDTO, MaPmTrendDetailDTO maPmTrendDetailDTO, User loginUser)
    {
        ...
        query.getAndQuery("y.pm_id", maPmTrendDetailDTO.getPmId());
