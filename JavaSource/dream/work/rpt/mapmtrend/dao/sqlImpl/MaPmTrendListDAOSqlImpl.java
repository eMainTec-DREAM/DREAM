 ...
 */
public class MaPmTrendListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPmTrendListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(MaPmTrendCommonDTO maPmTrendCommonDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.pm_point_id", "b.equip_id, x.check_point", maPmTrendCommonDTO.getOrderBy(), maPmTrendCommonDTO.getDirection());
