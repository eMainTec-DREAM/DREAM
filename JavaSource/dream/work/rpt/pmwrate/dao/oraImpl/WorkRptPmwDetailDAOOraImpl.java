 ...
 */
public class WorkRptPmwDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements WorkRptPmwDetailDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findDetail(WorkRptPmwDetailDTO workRptPmwDetailDTO, User loginUser) throws Exception
    {
        ...
        query.getOrderByQuery("a.wkor_date ASC", workRptPmwDetailDTO.getOrderBy(), workRptPmwDetailDTO.getDirection());
