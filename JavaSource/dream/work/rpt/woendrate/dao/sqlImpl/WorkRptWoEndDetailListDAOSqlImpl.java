 ...
 */
public class WorkRptWoEndDetailListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkRptWoEndDetailListDAO
{
    ...
    public List findList(WorkRptWoEndDetailListDTO workRptWoEndDetailListDTO, User user) throws Exception
    {
        ...
        query.append("    ,LEFT(a.close_date,8)																					 	AS WoEndDate	");
        ...
        query.getOrderByQuery("a.wkor_id", "a.wkor_date", workRptWoEndDetailListDTO.getOrderBy(), workRptWoEndDetailListDTO.getDirection());
