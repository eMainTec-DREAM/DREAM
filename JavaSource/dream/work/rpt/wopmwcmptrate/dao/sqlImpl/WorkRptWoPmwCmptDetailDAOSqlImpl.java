 ...
 */
public class WorkRptWoPmwCmptDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements WorkRptWoPmwCmptDetailDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findDetail(WorkRptWoPmwCmptDetailDTO workRptWoPmwCmptDetailDTO, User loginUser) throws Exception
    {
        ...
        query.append("    ,isnull(isnull(b.sched_date,c.start_date),a.start_date) AS sched_date       ");
        ...
        query.getOrderByQuery("a.wkor_id", "a.wkor_date ASC", workRptWoPmwCmptDetailDTO.getOrderBy(), workRptWoPmwCmptDetailDTO.getDirection());
