 ...
 */
public class WorkRptPmiEquipCmptRateListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements WorkRptPmiEquipCmptRateListDAO
{
    ...
    public List findList(WorkRptPmiEquipCmptRateCommonDTO workRptPmiEquipCmptRateCommonDTO, User user) throws Exception
    {
        ...
        query.append("GROUP BY b.plant,LEFT(a.sched_date,6), b.comp_no 						");
        query.getOrderByQuery("b.comp_no", "b.plant, LEFT(a.sched_date,6)", workRptPmiEquipCmptRateCommonDTO.getOrderBy(), workRptPmiEquipCmptRateCommonDTO.getDirection());
