 ...
 */
public class MaLineTimeDowListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaLineTimeDowListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findDowList(MaLineTimeCommonDTO maLineTimeCommonDTO, MaLineTimeDowListDTO maLineTimeDowListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.ord_no", maLineTimeCommonDTO.getOrderBy(), maLineTimeCommonDTO.getDirection());
