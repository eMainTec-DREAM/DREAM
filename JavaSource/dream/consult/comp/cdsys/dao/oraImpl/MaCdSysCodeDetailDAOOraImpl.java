 ...
 */
public class MaCdSysCodeDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaCdSysCodeDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public int insertDetail(MaCdSysCodeDetailDTO maCdSysCodeDetailDTO, MaCdSysCommonDTO maCdSysCommonDTO, User user)
    {
    	...
    	query.append("UPDATE TACDSYSD x	SET										");
    	query.append("list_type = (												");
    	query.append("			SELECT list_type								");
    	query.append("			  FROM TACDSYSM									");
    	query.append("			 WHERE cdsysm_id = x.cdsysm_id)					");
    	query.append("WHERE x.cdsysm_id = ?                                 	");
