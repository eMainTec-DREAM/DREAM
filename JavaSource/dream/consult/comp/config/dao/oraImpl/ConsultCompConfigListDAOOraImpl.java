 ...
 */
public class ConsultCompConfigListDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultCompConfigListDAO
{
    /**
     * grid find
     * @author  syyang
    ...
    public List findConfigList(ConsultCompConfigCommonDTO consultCompConfigCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.name", consultCompConfigCommonDTO.getOrderBy(), consultCompConfigCommonDTO.getDirection());
