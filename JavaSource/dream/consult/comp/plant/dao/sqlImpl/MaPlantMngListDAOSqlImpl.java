 ...
 */
public class MaPlantMngListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPlantMngListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findPlantList(MaPlantMngCommonDTO maPlantMngCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.plant_id", "x.comp_no", maPlantMngCommonDTO.getOrderBy(), maPlantMngCommonDTO.getDirection());
