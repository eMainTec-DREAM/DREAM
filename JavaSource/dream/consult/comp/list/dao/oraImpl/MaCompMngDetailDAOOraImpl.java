 ...
 */
public class MaCompMngDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaCompMngDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaCompMngDetailDTO findDetail(MaCompMngCommonDTO maCompMngCommonDTO, User user)
    {
        ...
        query.append("		 ,(SELECT SFACODE_TO_DESC(x.ct_path,'CT_PATH','SYS','','"+user.getLangId()+"') FROM DUAL) ctPathDesc");
