package dream.consult.comp.eqmgr.dao.sqlImpl;
 ...
 */
public class MaEqMngListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaEqMngListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findEqMngList(MaEqMngCommonDTO maEqMngCommonDTO,User user)
    {
        ...
        query.getOrderByQuery("x.equip_id","x.ord_no", maEqMngCommonDTO.getOrderBy(), maEqMngCommonDTO.getDirection());
