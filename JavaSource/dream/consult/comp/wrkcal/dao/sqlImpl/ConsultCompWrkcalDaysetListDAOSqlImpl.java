 ...
 */
public class ConsultCompWrkcalDaysetListDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConsultCompWrkcalDaysetListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findDaysetList(ConsultCompWrkcalCommonDTO consultCompWrkcalCommonDTO, ConsultCompWrkcalDaysetListDTO consultCompWrkcalDaysetListDTO, User user)
    {
        ...
        query.getOrderByQuery("x.wrkcaldayset_id","x.cal_date", consultCompWrkcalCommonDTO.getOrderBy(), consultCompWrkcalCommonDTO.getDirection());
