 ...
 */
public class MaPtWhDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtWhDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public MaPtWhDetailDTO findDetail(MaPtWhCommonDTO maPtWhCommonDTO, User user)
    {
        ...
        query.append("		 ,SFACODE_TO_DESC(x.wh_type,'WH_TYPE','SYS','','"+user.getLangId()+"')	whTypeDesc	");
        query.append("       ,x.wh_categ whCateg    									                            ");
        query.append("		 ,SFACODE_TO_DESC(x.wh_categ,'WH_CATEG','SYS','','"+user.getLangId()+"') whCategDesc	");
