 ...
 */
public class MaPtWhListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtWhListDAO
{
	/**
     * grid find
     * @author  ssong
    ...
    public List findPtWhList(MaPtWhCommonDTO maPtWhCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.wcode_id", "x.wname", maPtWhCommonDTO.getOrderBy(), maPtWhCommonDTO.getDirection());
