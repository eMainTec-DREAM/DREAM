 ...
 */
public class LovWhListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovWhListDAO
{
    /**
     * 사용창고 검색
     * @author  kim21017
            ...
            Map<String, String> conditionMap)
    {
        ...
        query.getOrderByQuery("a.wcode_id","a.wcode", lovWhListDTO.getOrderBy(), lovWhListDTO.getDirection());
