 ...
 */
public class ConsultCompTerminalExListDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConsultCompTerminalExListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findTerminalExList(ConsultCompTerminalExCommonDTO consultCompTerminalExCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.service_type","x.terminal_no", consultCompTerminalExCommonDTO.getOrderBy(), consultCompTerminalExCommonDTO.getDirection());
