 ...
 */
public class ConsultCompTerminalListDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConsultCompTerminalListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findTerminalList(ConsultCompTerminalCommonDTO consultCompTerminalCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.service_type","x.terminal_no", consultCompTerminalCommonDTO.getOrderBy(), consultCompTerminalCommonDTO.getDirection());
