 ...
 */
public class ConsultCompIntfListDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultCompIntfListDAO
{
    ...
    { 
        ...
        query.append("      ,SFACODE_TO_DESC(x.is_use,'IS_USE','SYS','','"+user.getLangId()+"') 	AS isUse        ");
        ...
        query.getOrderByQuery("x.intf_no", consultCompIntfCommonDTO.getOrderBy(), consultCompIntfCommonDTO.getDirection());
