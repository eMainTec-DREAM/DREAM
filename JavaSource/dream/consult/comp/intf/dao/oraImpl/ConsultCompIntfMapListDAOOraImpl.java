package dream.consult.comp.intf.dao.oraImpl;
 ...
 */
public class ConsultCompIntfMapListDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultCompIntfMapListDAO
{
    ...
    { 
        ...
        query.append("    , SFACODE_TO_DESC(x.intf_param_type, 'INTF_PARAM_TYPE', 'SYS',x.comp_no,'"+lang+"') paramTypeDesc		");
        query.append("    , x.param_seq 															  AS paramSeq			");
        query.append("    , x.s_table_name 															  AS stabName			");
        query.append("    , x.s_field_name 															  AS sfieldName			");
        query.append("    , SFACODE_TO_DESC(x.s_is_pk,'IS_USE','SYS', x.comp_no, '"+lang+"')      AS sisPkDesc			");
        query.append("    , x.s_field_type  														  AS sfieldTypeDesc		");
        query.append("    , x.s_field_size  														  AS sfieldSizeDesc		");
        query.append("    , SFACODE_TO_DESC(x.s_is_not_null,'IS_USE','SYS', x.comp_no, '"+lang+"')AS sisNotNullDesc		");
        query.append("    , x.s_remark  															  AS sremark			");
        query.append("    , x.t_table_name 															  AS ttabName			");
        query.append("    , x.t_field_name 															  AS tfieldName			");
        query.append("    , SFACODE_TO_DESC(x.t_it_pk,'IS_USE','SYS', x.comp_no, '"+lang+"')      AS tisPkDesc			");
        query.append("    , x.t_field_type  														  AS tfieldTypeDesc		");
        query.append("    , x.t_field_size  														  AS tfieldSizeDesc		");
        query.append("    , SFACODE_TO_DESC(x.t_it_not_null,'IS_USE','SYS', x.comp_no, '"+lang+"')AS tisNotNullDesc		");
        ...
        query.getOrderByQuery("x.param_seq", consultCompIntfMapListDTO.getOrderBy(), consultCompIntfMapListDTO.getDirection());
