 ...
 * @author youngjoo38
 * @version $Id: ConsultCompUserListDAOSqlImpl.java,v 1.0 2017/08/10 09:12:40 youngjoo38 Exp $
 * @since 1.0
 * 
 ...
 */
public class ConsultCompUserListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements ConsultCompUserListDAO
{
    ...
    public List findCompUserList(ConsultCompUserCommonDTO consultCompUserCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.user_id","x.user_name", consultCompUserCommonDTO.getOrderBy(), consultCompUserCommonDTO.getDirection());
