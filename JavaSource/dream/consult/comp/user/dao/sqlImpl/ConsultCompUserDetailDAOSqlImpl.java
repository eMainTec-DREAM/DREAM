 ...
 */
public class ConsultCompUserDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConsultCompUserDetailDAO
{
    ...
    public ConsultCompUserDetailDTO findCompUserDetail(ConsultCompUserCommonDTO consultCompUserCommonDTO, User user) 
    {
        ...
        query.append("    , dbo.SFACODE_TO_DESC(x.shift_type, 'SHIFT_TYPE', 'SYS', x.comp_no, ?)	AS shiftTypeDesc	");
        query.append("    , x.is_use                                AS isUseId         ");
        query.append("    , dbo.SFACODE_TO_DESC( x.is_use, 'IS_USE','SYS',x.comp_no, ?)             AS isUseDesc        ");
        ...
        query.append("       WHERE a.comp_no = x.comp_no                               ");
        query.append("           AND y.plant = a.plant)             AS plantDesc       ");
        query.append("    , x.alarm_view_yn                         AS alarmViewYnId   ");
        query.append("    , dbo.SFACODE_TO_DESC( x.alarm_view_yn , 'IS_USE','SYS',x.comp_no, ?)     AS alarmViewYn      ");
        ...
        query.append("    , dbo.SFACODE_TO_DESC(x.eqctg_type, 'EQCTG_TYPE', 'SYS', x.comp_no, ?)    AS eqCtgTypeDesc    ");
        ...
        query.append("    , dbo.SFACODE_TO_DESC( x.menu_display, 'MENU_DISPLAY','SYS',x.comp_no, ?) AS menuDisplayDesc  ");
