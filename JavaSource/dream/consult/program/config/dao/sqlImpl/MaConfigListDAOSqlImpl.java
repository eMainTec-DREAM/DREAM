 ...
 */
public class MaConfigListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaConfigListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findConfigList(MaConfigCommonDTO maConfigCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.config_id","x.name", maConfigCommonDTO.getOrderBy(), maConfigCommonDTO.getDirection());
