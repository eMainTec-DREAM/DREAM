 ...
 */
public class ConsultPgmMsgDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultPgmMsgDetailDAO
{
    /**
     * detail find
     * @author youngjoo38
    ...
    public ConsultPgmMsgDetailDTO findDetail(ConsultPgmMsgCommonDTO consultPgmMsgCommonDTO, User user)
    {
        ...
        query.append("    , SFACODE_TO_DESC(x.message_object_type, 'MESSAGE_OBJECT_TYPE', 'SYS', '', ? ) msgObjTypeDesc		");
        query.append("    , SFACODE_TO_DESC(x.mail_use, 'IS_USE', 'SYS', '', ? )  isMailUseDesc		");
        query.append("    , SFACODE_TO_DESC(x.sms_use, 'IS_USE', 'SYS', '', ? )   isSmsUseDesc		");
