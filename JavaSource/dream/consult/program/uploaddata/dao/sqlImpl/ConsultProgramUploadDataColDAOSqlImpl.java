 ...
 */
public class ConsultProgramUploadDataColDAOSqlImpl  extends BaseJdbcDaoSupportSql implements ConsultProgramUploadDataColDAO
{
    ...
    public List findList(ConsultProgramUploadDataDTO consultProgramUploadDataDTO, ConsultProgramUploadDataColDTO consultProgramUploadDataColDTO, User user) throws Exception
    {
        ...
        query.append("  , dbo.SFACODE_TO_DESC(x.is_key,'IS_USE','SYS','','"+user.getLangId()+"') AS isKey     ");
        query.append("  , x.is_system              AS isSystemId              ");
        query.append("  , dbo.SFACODE_TO_DESC(x.is_system,'IS_USE','SYS','','"+user.getLangId()+"') AS isSystem     ");
        query.append("  , x.is_editable              AS isEditableId              ");
        query.append("  , dbo.SFACODE_TO_DESC(x.is_editable,'IS_USE','SYS','','"+user.getLangId()+"') AS isEditable     ");
        query.append("  , x.is_system_display              AS isSystemDisplayId              ");
        query.append("  , dbo.SFACODE_TO_DESC(x.is_system_display,'IS_USE','SYS','','"+user.getLangId()+"') AS isSystemDisplay     ");
        ...
        query.getOrderByQuery("x.table_id","x.ord_no", consultProgramUploadDataDTO.getOrderBy(), consultProgramUploadDataDTO.getDirection());
    ...
    public String findTotalCount(ConsultProgramUploadDataDTO consultProgramUploadDataDTO, 
            ConsultProgramUploadDataColDTO consultProgramUploadDataColDTO, User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
