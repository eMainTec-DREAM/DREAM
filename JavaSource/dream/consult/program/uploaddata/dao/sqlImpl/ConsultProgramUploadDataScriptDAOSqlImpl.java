 ...
 */
public class ConsultProgramUploadDataScriptDAOSqlImpl  extends BaseJdbcDaoSupportSql implements ConsultProgramUploadDataScriptDAO
{
    public List findList(ConsultProgramUploadDataDTO consultProgramUploadDataDTO, ConsultProgramUploadDataScriptDTO consultProgramUploadDataScriptDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.excelexscript_id","x.ord_no", consultProgramUploadDataDTO.getOrderBy(), consultProgramUploadDataDTO.getDirection());
    ...
    public String findTotalCount(ConsultProgramUploadDataDTO consultProgramUploadDataDTO, 
            ConsultProgramUploadDataScriptDTO consultProgramUploadDataScriptDTO, User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
