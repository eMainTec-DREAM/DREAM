package dream.consult.program.setting.upload.dao.oraImpl;
 ...
 */
public class ConsultPgmSettingUpdDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultPgmSettingUpdDAO
{
    ...
    { 
        ...
        if(!"".equals(consultPgmSettingUpdDTO.getTableName())) {
            ...
            query.getOrderByQuery("1", consultPgmSettingUpdDTO.getOrderBy(), consultPgmSettingUpdDTO.getDirection());
        }
    ...
    public List getDummyHeader(ConsultPgmSettingUpdDTO consultPgmSettingUpdDTO, User user) throws Exception
    {
        ...
        query.append("    (SELECT key_name FROM TALANG WHERE key_no='ISDELCHECK'                ");
        query.append("                                                  AND key_type='LABEL'                          ");
        query.append("                                                  AND lang='"+user.getLangId()+"') VALUE, ");
        ...
        query.append("    'false'  hidden,                                                                                  ");
        query.append("    (SELECT key_name FROM TALANG WHERE key_no='seqNo'                        ");
        query.append("                                                  AND key_type='LABEL'                          ");
        query.append("                                                  AND lang='"+user.getLangId()+"') VALUE, ");
        query.append("    '10'                                                                                      height   ");
        query.append("FROM dual     ");
        ...
        query.append("    WHERE exceltab_id = ?          ");
        query.append("        and is_use = 'Y'           ");
        query.append("    ORDER BY NVL(ord_no,0)       ");
        query.append(")     ");
	...
	public void uploadData(String pgmName, User user) throws SqlIgnoreException {
		try{
            ...
            query.append("BEGIN															");
            query.append(pgmName);
            query.append("(	'"+user.getCompNo()+"', '"+user.getUserNo()+"',0);			");
            query.append("END;															");
