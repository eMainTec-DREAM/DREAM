 ...
 */
public class MaHelpDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaHelpDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaHelpDetailDTO findDetail(MaHelpCommonDTO maHelpCommonDTO)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(y.helpdesk_status,'HELPDESK_STATUS','SYS','','"+user.getLangId()+"') AS helpdeskStatusDesc 	");
