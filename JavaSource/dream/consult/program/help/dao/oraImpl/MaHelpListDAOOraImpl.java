package dream.consult.program.help.dao.oraImpl;
 ...
 */
public class MaHelpListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaHelpListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.getOrderByQuery("y.helpdesk_id DESC", maHelpCommonDTO.getOrderBy(), maHelpCommonDTO.getDirection());
...
//        return getJdbcTemplate().queryForList(query.toString());
    ...
    {        
        ...
        query.getCodeLikeQuery("y.helpdesk_status", "SFACODE_TO_DESC(y.helpdesk_status,'HELPDESK_STATUS','SYS','','"+user.getLangId()+"')", maHelpCommonDTO.getHelpdeskStatus(), maHelpCommonDTO.getHelpdeskStatusDesc());
