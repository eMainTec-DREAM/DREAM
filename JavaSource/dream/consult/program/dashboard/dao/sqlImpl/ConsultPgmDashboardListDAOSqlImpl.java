 ...
 */
public class ConsultPgmDashboardListDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConsultPgmDashboardListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findList(ConsultPgmDashboardCommonDTO consultPgmDashboardCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.DBCONTENTS_ID", "x.description", consultPgmDashboardCommonDTO.getOrderBy(), consultPgmDashboardCommonDTO.getDirection());
