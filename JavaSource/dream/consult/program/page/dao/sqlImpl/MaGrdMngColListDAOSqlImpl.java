 ...
 */
public class MaGrdMngColListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaGrdMngColListDAO
{
    /**
     * grid find
     * @author  jung7126
    ...
    public List findColList(MaGrdMngCommonDTO maGrdMngCommonDTO, User user)
    {
        ...
        query.append("       dbo.SFACODE_TO_DESC(x.type,'COLUMN_TYPE','SYS','','"+user.getLangId()+"') type,	");
        query.append("       x.width,                                                               ");
        query.append("       x.ord_no ordNo,                                                        ");
        query.append("       dbo.SFACODE_TO_DESC(x.align,'ALIGN_TYPE','SYS','','"+user.getLangId()+"')    alignDesc,  ");
        query.append("       CASE UPPER(x.hidden) WHEN 'TRUE' THEN 'Y' ELSE 'N' END as hidden,             ");
        ...
        query.getOrderByQuery("x.pggridcol_id","z.file_name, y.grid_obj_id, x.ord_no", maGrdMngCommonDTO.getOrderBy(), maGrdMngCommonDTO.getDirection());
    ...
    private String getWhere(MaGrdMngCommonDTO maGrdMngCommonDTO, User user)
    {
        ...
        query.getLikeQuery("CASE UPPER(x.hidden) WHEN 'TRUE' THEN 'Y' ELSE 'N' END", maGrdMngCommonDTO.getFilterHidden());
