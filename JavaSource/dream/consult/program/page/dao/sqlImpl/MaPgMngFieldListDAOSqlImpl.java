 ...
 */
public class MaPgMngFieldListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPgMngFieldListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findFieldList(MaPgMngCommonDTO maPgMngCommonDTO, MaPgMngFieldListDTO maPgMngFieldListDTO)
    {
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.readonly_yn,'READONLY_YN','SYS','','"+maPgMngCommonDTO.getUserLang()+"') readonlyYn   ");
        query.append("       ,x.key_no  														keyNo		");
        query.append("		 ,dbo.SFACODE_TO_DESC(x.field_option,'FIELD_OPTION','SYS','','"+maPgMngCommonDTO.getUserLang()+"')fieldOptionDesc	");
//        query.append("       ,x.readonly_yn  													readonlyYn  ");
        query.append("       ,(SELECT top 1 key_name														");
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.group_option,'GROUP_OPTION','SYS','','"+maPgMngCommonDTO.getUserLang()+"')	groupOptionDesc	");
        ...
        query.getOrderByQuery("x.pgfield_id","(SELECT a.file_name FROM TAPAGE a WHERE a.page_id = x.page_id)"
