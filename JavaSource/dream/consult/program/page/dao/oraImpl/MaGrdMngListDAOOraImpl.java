 ...
 */
public class MaGrdMngListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaGrdMngListDAO
{
    /**
     * grid find
     * @author  jung7126
...
//        query.append("		  		WHERE a.page_id = x.page_id AND rownum=1 )) pgDesc,");
        ...
        query.getOrderByQuery("x.pggrid_id", maPgMngCommonDTO.getOrderBy(), maPgMngCommonDTO.getDirection());
