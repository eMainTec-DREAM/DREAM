 ...
 */
public class MaPgMngBtnDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPgMngBtnDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaPgMngBtnDetailDTO findDetail(MaPgMngBtnDetailDTO maPgMngBtnDetailDTO)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(x.button_loc,'BUTTON_LOC','SYS','','"+lang+"') buttonLocDesc");
        query.append("       ,(SELECT description									");
        query.append("          FROM TABUTTON										");
