 ...
 */
public class MaPgMngFieldValueListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPgMngFieldValueListDAO
{
	...
	public List findList(MaPgMngCommonDTO maPgMngCommonDTO, MaPgMngFieldListDTO maPgMngFieldListDTO,
		...
		query.append("				THEN SFACODE_TO_DESC(x.default_value,'"+maPgMngFieldDetailDTO.getCodeListTypeId()+"','SYS','','"+user.getLangId()+"')			");
		query.append("				WHEN 'TACDUSRD'							");
		query.append("				THEN SFACODE_TO_DESC(x.default_value,'"+maPgMngFieldDetailDTO.getCodeListTypeId()+"','USR',x.comp_no,'"+user.getLangId()+"')	");
		...
		query.append("			THEN SFACODE_TO_DESC(x.default_value,'DATE_INPUT_TYPE','SYS','','"+user.getLangId()+"')				");
		query.append("			WHEN 'MONTH_INPUT_TYPE'						");
		query.append("			THEN SFACODE_TO_DESC(x.default_value,'MONTH_INPUT_TYPE','SYS','','"+user.getLangId()+"')			");
		query.append("			WHEN 'YEAR_INPUT_TYPE'						");
		query.append("			THEN SFACODE_TO_DESC(x.default_value,'YEAR_INPUT_TYPE','SYS','','"+user.getLangId()+"')				");
		query.append("			ELSE x.default_value						");
		...
		query.getOrderByQuery("x.comp_no", maPgMngFieldValueListDTO.getOrderBy(), maPgMngFieldValueListDTO.getDirection());
