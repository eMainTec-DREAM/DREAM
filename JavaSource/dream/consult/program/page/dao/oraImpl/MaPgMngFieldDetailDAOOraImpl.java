 ...
 */
public class MaPgMngFieldDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPgMngFieldDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaPgMngFieldDetailDTO findDetail(MaPgMngFieldDetailDTO maPgMngFieldDetailDTO)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(x.hidden_yn,'IS_USE','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')	hiddenYnDesc ");
        query.append("       ,x.ord_no										     				ordNo		     		");
        query.append("       ,x.display_yn   								     				displayYn				");
        query.append("       ,SFACODE_TO_DESC(x.display_yn,'IS_USE','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')	displayYnDesc ");
        query.append("       ,x.readonly_yn  								     				readonlyYn              ");
        query.append("       ,SFACODE_TO_DESC(x.readonly_yn,'READONLY_YN','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')	readonlyYnDesc ");
        query.append("       ,x.check_yn   									     				checkYn					");
        query.append("       ,SFACODE_TO_DESC(x.check_yn,'CHECK_YN','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')    checkYnDesc ");
        query.append("       ,SFACODE_TO_DESC(x.field_option,'FIELD_OPTION','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')			fieldOptionDesc	");        
        ...
        query.append("       ,SFACODE_TO_DESC(x.form_input_type,'FORM_INPUT_TYPE','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')	formInputTypeDesc	");
        ...
        query.append("       		SFACODE_TO_DESC(x.form_input_detail_type,'CODE_INPUT_TYPE','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')			");
        ...
        query.append("       ,SFACODE_TO_DESC(x.group_option,'GROUP_OPTION','SYS','','"+maPgMngFieldDetailDTO.getUserLang()+"')		groupOptionDesc	");
