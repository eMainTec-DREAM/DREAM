 ...
 */
public class MaLangMngListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaLangMngListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findKeyList(MaLangMngCommonDTO maLangMngCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("lang_id","x.lang, x.key_type, x.key_no", maLangMngCommonDTO.getOrderBy(), maLangMngCommonDTO.getDirection());
