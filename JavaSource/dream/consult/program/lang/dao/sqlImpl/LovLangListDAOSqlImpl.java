 ...
 */
public class LovLangListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovLangListDAO
{
    /**
     * 다국어 검색
     * @author  kim21017
    ...
    public List findLangList(LovLangListDTO lovLangListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("lang_id","key_no", lovLangListDTO.getOrderBy(), lovLangListDTO.getDirection());
