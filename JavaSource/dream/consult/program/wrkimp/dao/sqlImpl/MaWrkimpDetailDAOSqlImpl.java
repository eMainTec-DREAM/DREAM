 ...
 */
public class MaWrkimpDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWrkimpDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaWrkimpDetailDTO findDetail(MaWrkimpCommonDTO maWrkimpCommonDTO, User user)
    {
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.gowrkimp_status,'GOWRKIMP_STATUS','SYS','','"+user.getLangId()+"') AS gowrkimpStatusDesc         ");
