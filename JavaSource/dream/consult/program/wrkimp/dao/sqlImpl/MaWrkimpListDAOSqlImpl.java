package dream.consult.program.wrkimp.dao.sqlImpl;
 ...
 */
public class MaWrkimpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaWrkimpListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.gowrkimp_status,'GOWRKIMP_STATUS','SYS','','"+user.getLangId()+"') AS gowrkimpStatus          ");
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.wrkimp_cre_type,'WRKIMP_CRE_TYPE','SYS','','"+user.getLangId()+"') as wrkimpCreTypeDesc       ");
        ...
        query.getOrderByQuery("x.gowrkimp_id", "x.gowrkimp_no", maWrkimpCommonDTO.getOrderBy(), maWrkimpCommonDTO.getDirection());
    ...
    {        
        ...
        query.getCodeLikeQuery("x.gowrkimp_status", "dbo.SFACODE_TO_DESC(x.gowrkimp_status,'GOWRKIMP_STATUS','SYS','','"+user.getLangId()+"')", maWrkimpCommonDTO.getGowrkimpStatus(), maWrkimpCommonDTO.getGowrkimpStatusDesc());
        ...
        query.getCodeLikeQuery("x.wrkimp_cre_type", "dbo.SFACODE_TO_DESC(x.wrkimp_cre_type,'WRKIMP_CRE_TYPE','SYS','','"+user.getLangId()+"')", maWrkimpCommonDTO.getWrkImpCreType(), maWrkimpCommonDTO.getWrkImpCreTypeDesc());
