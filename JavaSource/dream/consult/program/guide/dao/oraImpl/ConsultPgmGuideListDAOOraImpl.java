 ...
 * @author kim21017
 * @version $Id: ConsultPgmGuideListDAOOraImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class ConsultPgmGuideListDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultPgmGuideListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.pgguide_no", consultPgmGuideCommonDTO.getOrderBy(), consultPgmGuideCommonDTO.getDirection());
