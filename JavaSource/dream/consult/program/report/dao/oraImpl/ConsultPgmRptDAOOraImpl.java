package dream.consult.program.report.dao.oraImpl;
 ...
 */
public class ConsultPgmRptDAOOraImpl extends BaseJdbcDaoSupportOra implements ConsultPgmRptDAO
{
	...
	public String getOrderBy(ConsultPgmRptDTO consultPgmRptDTO, User user) {
		...
		query.getOrderByQuery("x.rptlist_id", consultPgmRptDTO.getOrderBy(), consultPgmRptDTO.getDirection());		
