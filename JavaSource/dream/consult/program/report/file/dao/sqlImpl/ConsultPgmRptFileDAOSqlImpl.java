package dream.consult.program.report.file.dao.sqlImpl;
 ...
 */
public class ConsultPgmRptFileDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConsultPgmRptFileDAO
{
	...
	public String getColums(ConsultPgmRptFileDTO consultPgmRptFileDTO, User user) {
		...
		query.append("    , (SELECT dbo.SFACODE_TO_DESC(x.rptfile_type, 'RPTFILE_TYPE', 'SYS', '', '"+user.getLangId()+"') ) 		AS reportFileType		");
	...
	public String getOrderBy(ConsultPgmRptFileDTO consultPgmRptFileDTO, User user) {
		...
		query.getOrderByQuery("x.rptfile_id","x.file_name", consultPgmRptFileDTO.getOrderBy(), consultPgmRptFileDTO.getDirection());		
