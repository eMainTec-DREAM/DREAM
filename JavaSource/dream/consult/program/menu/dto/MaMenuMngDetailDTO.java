 ...
 * 버튼 - 상세 DTO
 * @author  kim21017
 * @version $Id: MaMenuMngDetailDTO.java,v 1.0 2015/12/02 08:44:16 kim21017 Exp $
 * @since   1.0
 *
 */
public class MaMenuMngDetailDTO extends BaseDTO
{
	/** 메뉴ID */
	...
	/**  외부 Get방식 Link 메뉴 여부*/
	private String isGetLink	= "";
	
	public String getIsGetLink() {
		return isGetLink;
	}
	public void setIsGetLink(String isGetLink) {
		this.isGetLink = isGetLink;
	}
