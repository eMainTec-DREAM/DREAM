 ...
 * @author kim21017
 * @version $Id: TableValLovDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class TableValLovDAOSqlImpl extends BaseJdbcDaoSupportSql implements TableValLovDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.table_id","x.table_name", tableValLovDTO.getOrderBy(), tableValLovDTO.getDirection());
