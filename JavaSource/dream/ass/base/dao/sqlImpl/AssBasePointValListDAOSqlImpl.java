 ...
 * @author kim21017
 * @version $Id: AssBasePointValListDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class AssBasePointValListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssBasePointValListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.assbasepval_id", "x.ord_no", assBaseCommonDTO.getOrderBy(), assBaseCommonDTO.getDirection());
