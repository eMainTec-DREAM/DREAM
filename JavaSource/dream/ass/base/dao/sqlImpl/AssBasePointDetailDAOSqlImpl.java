 ...
 * @author kim21017
 * @version $Id: AssBasePointDetailDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class AssBasePointDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssBasePointDetailDAO
{
    ...
    public AssBasePointDetailDTO findDetail(AssBaseCommonDTO assBaseCommonDTO, AssBasePointListDTO assBasePointListDTO, User user) 
    {
        ...
        query.append("		,dbo.SFACODE_TO_DESC(x.ass_point_value_type,'ASS_POINT_VALUE_TYPE','SYS',''	");
