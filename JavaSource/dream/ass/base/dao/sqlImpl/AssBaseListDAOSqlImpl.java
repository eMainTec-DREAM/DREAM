 ...
 * @author kim21017
 * @version $Id: AssBaseListDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class AssBaseListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssBaseListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.assbaselist_id", "x.assbaselist_no", assBaseCommonDTO.getOrderBy(), assBaseCommonDTO.getDirection());
