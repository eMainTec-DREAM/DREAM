 ...
 * @author kim21017
 * @version $Id: AssBaseGradeDetailDAOSqlImpl.java,v 1.0 2015/12/02 09:12:40 kim21017 Exp $
 * @since 1.0
 * 
 ...
 */
public class AssBaseGradeDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssBaseGradeDetailDAO
{
    ...
    public AssBaseGradeDetailDTO findDetail(AssBaseCommonDTO assBaseCommonDTO, AssBaseGradeListDTO assBaseGradeListDTO, User user) 
    {
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+user.getCompNo()+"','"+user.getLangId()+"') PERIODTYPEDESC          ");
