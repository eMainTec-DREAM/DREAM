 ...
 */
public class AssAssetScoreCopyLovDAOSqlImpl extends BaseJdbcDaoSupportSql implements AssAssetScoreCopyLovDAO
{
	@Override
			...
			Map<String, String> conditionMap) throws Exception
	{
        ...
        query.getOrderByQuery("x.eqasslist_id", "x.eqasslist_no", assAssetScoreCopyLovDTO.getOrderBy(), assAssetScoreCopyLovDTO.getDirection());
	...
	public List findAssScoreList(AssAssetScoreCopyLovDTO assAssetScoreCopyLovDTO, User user) {
        ...
        query.getOrderByQuery("x.eqasspval_id", "x.eqasspval_id", assAssetScoreCopyLovDTO.getOrderBy(), assAssetScoreCopyLovDTO.getDirection());
