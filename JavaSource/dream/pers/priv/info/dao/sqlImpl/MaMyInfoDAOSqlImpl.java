 ...
 */
public class MaMyInfoDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaMyInfoDAO
{
    /**
     * grid find
     * @author  kim21017
	...
	public MaMyInfoCommonDTO findDetail(MaMyInfoCommonDTO maMyInfoCommonDTO)
    {
        ...
        query.append("		  WHERE a.usrgrp_id = x.usrgrp_id		                                                                ");
        ...
        query.append("       dbo.SFAPLANTTODESC(y.comp_no,y.plant)                                       		plantDesc,			");
        query.append("		x.filter_plant			                                                            filterPlant,	 	");
        query.append("       dbo.SFAPLANTTODESC(x.comp_no,x.filter_plant)                                       filterPlantDesc,	");
        query.append("       x.eqctg_type  	                                                                    eqCtgTypeId,        ");
        query.append("       dbo.SFACODE_TO_DESC(x.eqctg_type, 'EQCTG_TYPE', 'SYS', x.comp_no,'"+lang+"')       eqCtgTypeDesc,      ");
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(x.menu_display, 'MENU_DISPLAY', 'SYS', x.comp_no,'"+lang+"')   menuDisplayDesc     ");
    ...
    public int updateDetail(MaMyInfoCommonDTO maMyInfoCommonDTO)
    {
    	...
    	query.append("	,filter_dept_id		= dbo.IS_EMPTY(?)  	");
    	query.append("	,eqloc_id        	= dbo.IS_EMPTY(?)	");
    	query.append("	,filter_emp_id		= dbo.IS_EMPTY(?)	");
    	query.append("	,filter_wkctr_id	= dbo.IS_EMPTY(?) 	");
    	query.append("	,filter_usage_dept_id = dbo.IS_EMPTY(?)	");
    	query.append("  ,filter_plant       = dbo.IS_EMPTY(?)	");
