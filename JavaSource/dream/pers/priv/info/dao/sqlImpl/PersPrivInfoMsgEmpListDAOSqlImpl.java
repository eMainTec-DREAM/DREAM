 ...
 */
public class PersPrivInfoMsgEmpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements PersPrivInfoMsgEmpListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(MaMyInfoCommonDTO maMyInfoCommonDTO, User user)
    {
        ...
        query.append("    , dbo.SFACODE_TO_DESC(x.mail_use, 'IS_USE', 'SYS', x.comp_no, '"+user.getLangId()+"') isMailUseDesc		");
        query.append("    , dbo.SFACODE_TO_DESC(x.sms_use, 'IS_USE', 'SYS', x.comp_no, '"+user.getLangId()+"') isSmsUseDesc		");
        ...
        query.getOrderByQuery("x.msgempset_id","x.message_object_type", maMyInfoCommonDTO.getOrderBy(), maMyInfoCommonDTO.getDirection());
