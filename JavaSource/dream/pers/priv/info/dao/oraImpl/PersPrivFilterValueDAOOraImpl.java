 ...
 */
public class PersPrivFilterValueDAOOraImpl extends BaseJdbcDaoSupportOra implements PersPrivFilterValueDAO
{
	...
	public String getColums(PersPrivFilterValueDTO persPrivFilterValueDTO, User user) {
		...
		query.append("    , (SELECT SFACODE_TO_DESC(x.is_default, 'IS_USE', 'SYS', '', '"+user.getLangId()+"') FROM dual) 			AS isDefault		");
	...
	public String getOrderBy(PersPrivFilterValueDTO persPrivFilterValueDTO, User user) {
		...
		query.getOrderByQuery("x.usrfiltervalue_id", persPrivFilterValueDTO.getOrderBy(), persPrivFilterValueDTO.getDirection());		
