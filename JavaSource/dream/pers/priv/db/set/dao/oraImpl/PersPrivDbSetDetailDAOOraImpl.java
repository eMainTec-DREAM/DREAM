 ...
 * @author nhkim8548
 * @version $Id: PersPrivDbSetDetailDAOOraImpl.java,v 1.0 2018/07/31 13:33:40 nhkim8548 Exp $
 * @since 1.0
 * 
 ...
 */
public class PersPrivDbSetDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements PersPrivDbSetDetailDAO
{
    ...
    public PersPrivDbSetDetailDTO findDetail(PersPrivDbSetCommonDTO persPrivDbSetCommonDTO, User user) 
    {
        ...
        query.append("         , SFACODE_TO_DESC(x.is_use, 'IS_USE', 'SYS', x.comp_no, '"+ user.getLangId() +"') AS usrDbMenuIsUseDesc ");
        ...
        PersPrivDbSetDetailDTO persPrivDbSetDetailDTO = 
        		(PersPrivDbSetDetailDTO)getJdbcTemplate().query(query.toString(), objects, new MwareExtractor(new PersPrivDbSetDetailDTO()));
