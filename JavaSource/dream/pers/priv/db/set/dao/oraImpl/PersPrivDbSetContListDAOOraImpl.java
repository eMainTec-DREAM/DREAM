 ...
 * @author nhkim8548
 * @version $Id: PersPrivDbSetContListDAOOraImpl.java,v 1.0 2017/08/22 15:19:40 nhkim8548 Exp $
 * @since 1.0
 * 
 ...
 */
public class PersPrivDbSetContListDAOOraImpl  extends BaseJdbcDaoSupportOra implements PersPrivDbSetContListDAO
{
    /**
     * grid find
     * @author  nhkim8548
    ...
    public List findList(PersPrivDbSetCommonDTO persPrivDbSetCommonDTO, PersPrivDbSetContListDTO persPrivDbSetContListDTO, User user) throws Exception
    {
        ...
        query.append("        , SFACODE_TO_DESC(y.dbcontents_type, 'DBCONTENTS_TYPE', 'SYS', x.comp_no, '"+ user.getLangId() +"')                  AS usrDbCntType    "); 
        ...
        query.append("        , SFACODE_TO_DESC(y.dbcontents_width, 'DBCONTENTS_WIDTH', 'SYS', '"+ user.getCompNo() +"', '"+ user.getLangId() +"') AS usrDbCntWidth   ");
        ...
        query.getOrderByQuery("x.usrdbmenucnts_id", persPrivDbSetContListDTO.getOrderBy(), persPrivDbSetContListDTO.getDirection());        
