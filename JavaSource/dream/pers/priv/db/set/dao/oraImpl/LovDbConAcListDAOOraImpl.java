 ...
 * Contents Lov 
 * @author  nhkim8548
 * @version $Id: LovDbConAcListDAOOraImpl.java,v 1.0 2018/08/06 09:36:40 nhkim8548 Exp $
 * @since   1.0
 *
 ...
 */
public class LovDbConAcListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovDbConAcListDAO
{
    ...
    public List findList(LovDbConAcListDTO lovDbConAcListDTO, User user)
    {
        ...
        query.append("       , SFACODE_TO_DESC(x.dbcontents_type, 'DBCONTENTS_TYPE', 'SYS', '"+ user.getCompNo() +"', '"+ user.getLangId() +"')    AS usrDbCntType    ");
        ...
        query.append("       , SFACODE_TO_DESC(x. dbcontents_width, 'DBCONTENTS_WIDTH', 'SYS', '"+ user.getCompNo() +"', '"+ user.getLangId() +"') AS usrDbCntWidth   ");
