 ...
 * @author nhkim8548
 * @version $Id: PersPrivDbSetListDAOOraImpl.java,v 1.0 2018/07/31 07:43:40 nhkim8548 Exp $
 * @since 1.0
 * 
 ...
 */
public class PersPrivDbSetListDAOOraImpl extends BaseJdbcDaoSupportOra implements PersPrivDbSetListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.usrdbmenu_id", persPrivDbSetCommonDTO.getOrderBy(), persPrivDbSetCommonDTO.getDirection());        
