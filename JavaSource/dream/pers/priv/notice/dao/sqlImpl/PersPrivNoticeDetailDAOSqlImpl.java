 ...
 */
public class PersPrivNoticeDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements PersPrivNoticeDetailDAO
{
    /**
     * detail find
     * @author nhkim8548
    ...
    public PersPrivNoticeDetailDTO findDetail(MaMyInfoCommonDTO maMyInfoCommonDTO, User user)
    {
        ...
        query.append("     , dbo.SFACODE_TO_DESC(x.is_notice, 'IS_USE', 'SYS', x.comp_no, ?)    AS isNoticeDesc         ");
