 ...
 */
public class MaAppLineUsrListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaAppLineUsrListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findAnsList(MaAppLineCommonDTO maAppLineCommonDTO, MaAppLineUsrListDTO maAppLineUsrListDTO, User user)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(x.apprusr_type,'APPRUSR_TYPE','SYS','','"+maAppLineCommonDTO.getUserLang()+"') apprUsrType           ");
        ...
        query.getOrderByQuery("x.appr_seq", maAppLineUsrListDTO.getOrderBy(), maAppLineUsrListDTO.getDirection());
