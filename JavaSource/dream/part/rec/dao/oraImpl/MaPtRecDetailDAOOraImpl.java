 ...
 */
public class MaPtRecDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtRecDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public MaPtRecDetailDTO findDetail(User user, String prRecListId)
    {
        ...
        query.append("       ,SFACODE_TO_DESC(x.prreclist_status, 'PRRECLIST_STATUS', 'SYS', x.comp_no, ? ) prRecListStatusDesc "); 
        ...
        query.append("       ,sfacode_to_desc(x.is_make_part_no,'IS_USE','SYS',x.comp_no, ? )   isMakePartNo    ");
        query.append("       ,SFACODE_TO_DESC(x.part_grade,'PART_GRADE','SYS','', ? )           partGradeDesc   ");
        ...
        query.append("      , SFACODE_TO_DESC(x.currency, 'CURRENCY', 'SYS', x.comp_no,'"+ user.getLangId() +"')	AS currencyDesc	");
...
//
//      nextPartId = QueryBuffer.listToString(getJdbcTemplate().queryForList(query.toString()));
...
//      query.setClear();
    ...
    public int updateDetail(MaPtRecDetailDTO maPtRecDetailDTO, User user)
    {
        ...
        Object[] objects = new Object[] {
                ...
                , CommonUtil.getRowDateToNum(maPtRecDetailDTO.getTotPrice())
                , maPtRecDetailDTO.getInspector()
                , maPtRecDetailDTO.getPrRecListNo()
                , maPtRecDetailDTO.getIsMakePartNoId()
                , maPtRecDetailDTO.getPartGrade()
