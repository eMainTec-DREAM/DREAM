 ...
 */
public class MaPtRecSerialDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtRecSerialDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public int insertDetail(MaPtRecSerialDetailDTO maPtRecSerialDetailDTO, MaPtRecCommonDTO maPtRecCommonDTO)
    {
    	...
    	query.append("	)	VALUES				(							");
    	query.append("	?,				?,					?,				");
    	query.append("	(SELECT part_id FROM TAPTPRRECLIST WHERE prreclist_id=? AND comp_no=?),				?,    ?				");
    	query.append("	)													");
