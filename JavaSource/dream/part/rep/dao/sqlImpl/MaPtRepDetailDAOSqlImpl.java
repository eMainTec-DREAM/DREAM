 ...
 */
public class MaPtRepDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtRepDetailDAO
{
	/**
     * detail find
     * @author ssong
    ...
    public MaPtRepDetailDTO findDetail(MaPtRepCommonDTO maPtRepCommonDTO, User loginUser)
    {
        ...
        query.append("       dbo.SFACODE_TO_DESC(x.ptrepairlist_status, 'REPAIR_STATUS', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') ptRepairListStatusDesc, "); 
        ...
        query.append("       dbo.SFAIDTODESC(x.request_By, '', 'EMP', x.comp_no) requestName,	");  
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.part_grade, 'PART_GRADE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') partGradeDesc   ");  
    ...
    public int insertDetail(MaPtRepDetailDTO maPtRepDetailDTO, User loginUser)
    {
    	...
    	query.append("  ?,          	?,              ?,            	?,             		");
    	query.append("  ?,          	?,             	?,            	NULLIF(?,''),       ");
    	query.append("  NULLIF(?,''),   NULLIF(?,''),   NULLIF(?,''),   ?,   				");
    	query.append("  ?,          	?,             	?,            	?,             		");
    	query.append("  ?,          	?,			   	?,				?					");
    	query.append(")                                                         			");
  ...
  public int executeSpPtInstock(MaPtRepDetailDTO maPtRepDetailDTO, User loginUser) throws Exception
  {
      ...
      query.append("EXEC dbo.SP_PT_INSTOCK '"+maPtRepDetailDTO.getCompNo()+"', '"+maPtRepDetailDTO.getPtRecHistId()+"';  ");
  ...
  public int executeSpPtOutstock(MaPtRepDetailDTO maPtRepDetailDTO, User loginUser) throws Exception
  {
      ...
      query.append("EXEC dbo.SP_PT_OUTSTOCK '"+loginUser.getCompNo()+"', '"+maPtRepDetailDTO.getPtRecHistId()+"'; ");
  ...
  public int insertEqHistory(MaPtRepDetailDTO maPtRepDetailDTO,User user, String status)
  {
    ...
    query.append(")VALUES(          											  ");
    query.append("        ?,             NEXT VALUE FOR SQAEQHISTORY_ID   		  ");
    query.append("       ,(SELECT item_no                 ");
    query.append("         FROM TAEQUIPMENT               ");
    query.append("         WHERE equip_id= ?)             ");//item_no
    query.append("        ,dbo.IS_EMPTY(?)                ");//serialNo
    query.append("        ,NULL                           ");//wkor_id
    query.append("        ,NULL                           ");//pminslist_id
    query.append("       ,dbo.IS_EMPTY(?)                 ");//repair_id
    query.append("       ,''              				  ");//desc
    query.append("       ,?	        					  ");//설비상태
