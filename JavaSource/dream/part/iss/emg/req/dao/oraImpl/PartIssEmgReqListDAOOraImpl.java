 ...
 */
public class PartIssEmgReqListDAOOraImpl extends BaseJdbcDaoSupportOra implements PartIssEmgReqListDAO
{
    ...
    { 
        ...
        query.append("    ,SFACODE_TO_DESC(a.ptemgissreq_status,'PTEMGISSREQ_STATUS','SYS','','"+user.getLangId()+"')     AS ptEmgIssReqStatusDesc ");
        ...
        query.getOrderByQuery("a.req_date desc", partIssEmgReqCommonDTO.getOrderBy(), partIssEmgReqCommonDTO.getDirection());
