 ...
 */
public class PartIssEmgReqDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements PartIssEmgReqDetailDAO
{
    ...
    public PartIssEmgReqDetailDTO findIssReqDetail(PartIssEmgReqCommonDTO partIssEmgReqCommonDTO, User user) 
    {
        ...
        query.append("    ,SFACODE_TO_DESC(a.ptemgissreq_status,'PTEMGISSREQ_STATUS','SYS','',?)                                AS ptEmgIssReqStatusDesc    ");
    ...
    public int updateReqInfo(PartIssEmgReqDetailDTO partIssEmgReqDetailDTO, User user)
    {
        ...
        query.append("UPDATE TAPTEMGISSLIST a SET							");
        query.append("			(a.req_by		,a.rec_by					");
        query.append("			,a.req_dept		 				            ");
        query.append("			,a.wcode_id		,a.to_wcode_id 				");
        query.append("			,a.req_date		,a.issue_date  				");
        query.append("			,a.plant		,a.ctctr_id  				");
        query.append("			,a.equip_id		,a.eqasmb_id) 				");
        query.append("		= (SELECT 	b.req_by		,b.rec_by			");
        query.append("					,b.req_dept					        ");
        query.append("					,b.wcode_id		,b.to_wcode_id 		");
        query.append("					,b.req_date		,b.req_date			");
        query.append("					,b.plant		,b.ctctr_id			");
        query.append("					,b.equip_id		,b.eqasmb_id		");
        query.append("			FROM TAPTEMGISSREQ	b						");
