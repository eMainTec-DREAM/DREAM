 ...
 */
public class LovEmgPartListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovEmgPartListDAO
{
    /**
     * 항목 검색
     * @author  ssong
...
//        query.append("        ,issue_date issueDate     ");
        ...
        query.append("        ,dbo.SFACODE_TO_DESC(x.ptemgiss_status,'PTEMGISS_STATUS','SYS','','"+loginUser.getLangId()+"') ptemgissStatusDesc     ");
        query.append("        ,ptemg_task_status ptemgTaskStatus     									");
        query.append("        ,dbo.SFACODE_TO_DESC(x.ptemg_task_status,'PTEMG_TASK_STATUS','SYS','','"+loginUser.getLangId()+"') ptemgTaskStatusDesc     ");
        ...
        query.getOrderByQuery("x.ptemgisslist_id desc","x.ptemgisslist_id desc", lovEmgPartListDTO.getOrderBy(), lovEmgPartListDTO.getDirection());
    ...
    {        
        ...
        query.getCodeLikeQuery("x.ptemgiss_status", "dbo.SFACODE_TO_DESC(x.ptemgiss_status,'PTEMGISS_STATUS','SYS','','"+loginUser.getLangId()+"')", lovEmgPartListDTO.getPtemgissStatus(), lovEmgPartListDTO.getPtemgissStatusDesc());
        ...
        query.getCodeLikeQuery("x.ptemg_task_status", "dbo.SFACODE_TO_DESC(x.ptemg_task_status,'PTEMG_TASK_STATUS','SYS','','"+loginUser.getLangId()+"')", lovEmgPartListDTO.getPtemgTaskStatus(), lovEmgPartListDTO.getPtemgTaskStatusDesc());
