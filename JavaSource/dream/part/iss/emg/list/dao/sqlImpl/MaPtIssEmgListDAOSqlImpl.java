 ...
 */
public class MaPtIssEmgListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtIssEmgListDAO
{
    /**
     * grid find
     * @author  ssong
...
//        query.append("        ,issue_date issueDate     ");
    ...
    {        
        ...
        query.getCodeLikeQuery("x.ptemgiss_status", "dbo.SFACODE_TO_DESC(x.ptemgiss_status,'PTEMGISS_STATUS','SYS','','"+user.getLangId()+"')", maPtIssEmgCommonDTO.getPtemgissStatus(), maPtIssEmgCommonDTO.getPtemgissStatusDesc());
        ...
        query.getCodeLikeQuery("x.ptemg_task_status", "dbo.SFACODE_TO_DESC(x.ptemg_task_status,'PTEMG_TASK_STATUS','SYS','','"+user.getLangId()+"')", maPtIssEmgCommonDTO.getPtemgTaskStatus(), maPtIssEmgCommonDTO.getPtemgTaskStatusDesc());
    ...
    public int deletePtIssEmg(String ptemgisslist_id, User user)
    {
        ...
        query.append("    and PTEMGISS_STATUS not in ('C','X')      ");
