 ...
 */
public class MaPtIssListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtIssListDAO
{
    /**
     * grid find
     * @author  ssong
    ...
    public List findPtIssList(MaPtIssCommonDTO maPtIssCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.ptisslist_id DESC","x.ptisslist_id DESC", maPtIssCommonDTO.getOrderBy(), "".equals(maPtIssCommonDTO.getDirection())?"desc":maPtIssCommonDTO.getDirection());
