 ...
 */
public class PartIssWoItemListDAOSqlImpl extends BaseJdbcDaoSupportSql implements PartIssWoItemListDAO
{
    /**
     * grid find
     * @author  hyosung
    ...
    public List findPtIssList(PartIssWoItemListDTO partIssWoItemListDTO, User user)
    {
        ...
        query.append("        WHERE a.equip_id=x.equip_id)     description            ");
