 ...
 */
public class PartIssWoItemDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements PartIssWoItemDetailDAO
{
    /**
     * detail find
     * @author hyosung
    ...
    /*public int insertPtIss(PartIssWoItemDetailDTO partIssWoItemDetailDTO,User loginUser)
    {
   ...
   /* public int updateEqSerial(PartIssWoItemDetailDTO partIssWoItemDetailDTO)
    {
        QueryBuffer query = new QueryBuffer();
    ...
    @Override
    public int insertRemark(PartIssWoItemDetailDTO partIssWoItemDetailDTO,
            User loginUser)
    {
