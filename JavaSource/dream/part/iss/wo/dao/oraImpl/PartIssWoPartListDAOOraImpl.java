 ...
 */
public class PartIssWoPartListDAOOraImpl extends BaseJdbcDaoSupportOra implements PartIssWoPartListDAO
{
    public List findWoPartList(PartIssWoPartListDTO partIssWoPartListDTO, User user)
    {
        ...
        query.append("    ,SFACODE_TO_DESC(b.wo_status,'WO_STATUS','SYS','','"+user.getLangId()+"') AS woStatusDesc ");
        ...
        query.getOrderByQuery("a.wopart_id", partIssWoPartListDTO.getOrderBy(), partIssWoPartListDTO.getDirection());
