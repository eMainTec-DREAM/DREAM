 ...
 */
public class MaPtPoDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtPoDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaPtPoDetailDTO findDetail(String poListId, User user)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.polist_status, 'PO_STATUS', 'SYS', x.comp_no,'"+user.getLangId()+"') poStatusDesc, "); 
