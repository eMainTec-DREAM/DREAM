 ...
 */
public class MaPtBuyReqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtBuyReqListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findItemList(MaPtBuyReqHdrCommonDTO maPtBuyReqHdrCommonDTO, MaPtBuyReqListDTO maPtBuyReqListDTO, User user)
    {
        ...
        query.append("     , dbo.SFACODE_TO_DESC(x.currency,'CURRENCY','SYS','','"+user.getLangId()+"') currDesc    ");
        query.append("     , y.part_no                          partNo      ");
        query.append("     , y.erp_part_no                      erpPartNo   ");
        query.append("     , y.model                            model       ");
        query.append("     , dbo.SFACODE_TO_DESC(y.uom,'UOM','USR',y.comp_no,'"+user.getLangId()+"')    uomDesc     ");
        query.append("     , y.seller                           seller      ");
        query.append("     , y.part_no+', '+x.description+', '+ISNULL(x.pt_size,'')   partDescSize    ");
        ...
        query.append("     , ISNULL(x.unit_price,0)*ISNULL(rec_qty,0)    totalPrice            ");
        ...
        query.append("    , dbo.SFACODE_TO_DESC(x.pur_group,'PUR_GROUP','USR',x.comp_no,'"+user.getLangId()+"')   purGroupDesc   ");
        query.append("    , x.accnt_type                        accntType   ");
        query.append("    , dbo.SFACODE_TO_DESC(x.accnt_type,'ACCNT_TYPE','SYS','','"+user.getLangId()+"')   accntTypeDesc   ");
        ...
        query.append(this.getWhere(maPtBuyReqHdrCommonDTO,maPtBuyReqListDTO));
    ...
    private String getWhere(MaPtBuyReqHdrCommonDTO maPtBuyReqHdrCommonDTO, MaPtBuyReqListDTO maPtBuyReqListDTO)
    {
    	QuerySqlBuffer query = new QuerySqlBuffer();
