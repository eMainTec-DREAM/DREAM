 ...
 */
public class MaPtBuyReqDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtBuyReqDetailDAO
{
    /**
     * detail update
     * @author kim21017
    ...
    public int insertDetail(MaPtBuyReqDetailDTO maPtBuyReqDetailDTO, MaPtBuyReqHdrCommonDTO maPtBuyReqHdrCommonDTO, User user)
    {
    	...
    	query.append("	  ?				   , ?					, ?				");
    	query.append("	, ?				   , ?					, ?				");
    	query.append("	, CONVERT(FLOAT, dbo.IS_EMPTY(?))	    , ?				, CONVERT(FLOAT, 	dbo.IS_EMPTY(?))				");
    	query.append("	, ?                , ?					, ?				");
    	query.append("	, ?                , ?					, ?				");
    	query.append("	, ?                , ?					, ?				");
    	query.append("	)														");
