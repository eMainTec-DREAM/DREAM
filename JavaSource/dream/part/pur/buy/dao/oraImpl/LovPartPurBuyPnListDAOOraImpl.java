 ...
 */
public class LovPartPurBuyPnListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovPartPurBuyPnListDAO
{
    /**
     * 현장신청부품 검색 AC LOV
     * @author  js.lee
			...
			Map<String, String> conditionMap)
    {
        ...
        query.append("  AND x.rec_qty > NVL(x.pr_on_qty, 0)					");
        query.append(this.getWhere(lovPartPurBuyPnListDTO, user, columnMap, conditionMap));
        query.getOrderByQuery("x.PTPNLIST_ID", lovPartPurBuyPnListDTO.getOrderBy(), lovPartPurBuyPnListDTO.getDirection());
