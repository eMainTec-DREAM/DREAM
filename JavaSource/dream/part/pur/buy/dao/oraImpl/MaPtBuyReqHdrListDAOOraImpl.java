 ...
 */
public class MaPtBuyReqHdrListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtBuyReqHdrListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findBuyList(MaPtBuyReqHdrCommonDTO maPtBuyReqHdrCommonDTO, User user)
    {
        ...
        query.append("		SFACODE_TO_DESC(x.ptprlist_status,'PTPRLIST_STATUS','SYS','','"+user.getLangId()+"') ptPrListStatus,	");
        ...
        query.append("     , (SELECT NVL(SUM(a.rec_qty*a.unit_price),0) 	");
