 ...
 */
public class MaPtPurReqDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtPurReqDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public MaPtPurReqDetailDTO findDetail(MaPtReqCommonDTO maPtReqCommonDTO, User loginUser)
    {
        ...
        query.append("       , dbo.SFAIDTODESC(x.dept_id, '', 'DEPT', x.comp_no) AS entDeptDesc   ");
        ...
        query.append("       , dbo.SFACODE_TO_DESC(x.ptpnlist_status, 'PTPNLIST_STATUS', 'SYS', x.comp_no,'\"+loginUser.getLangId()+\"') AS inputStatusDesc ");
        ...
        query.append("       , y.part_no+(CASE y.part_no WHEN NULL THEN '' ELSE ',' END)+x.description+(CASE x.description WHEN NULL THEN '' ELSE ',' END)+x.pt_size AS detailTitle ");
        ...
        query.append("       , dbo.SFACODE_TO_DESC(x.plant, 'PTPNLIST_STATUS', 'SYS', x.comp_no,'\"+loginUser.getLangId()+\"') AS inputStatusDesc ");
        query.append("       , y.model 											 AS ptmodel		  ");
        query.append("       , x.uom 											 AS uom  		  ");
        query.append("       , dbo.SFACODE_TO_DESC(x.uom, 'UOM', 'USR', x.comp_no,'"+loginUser.getLangId()+"') AS uomDesc       ");
