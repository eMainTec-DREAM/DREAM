package dream.part.pur.req.dao.sqlImpl;
 ...
 */
public class MaPtPurReqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtPurReqListDAO
{
    /**
     * grid find
     * @author  ssong
    ...
    public List findList(MaPtReqCommonDTO maPtReqCommonDTO, User user)
    {
        ...
        query.append("       , dbo.SFACODE_TO_DESC(x.ptpnlist_status, 'PTPNLIST_STATUS', 'SYS', '"+ user.getCompNo() +"','"+user.getLangId()+"') AS purstatus     ");
        query.append("       , dbo.SFAIDTODESC(x.dept_id, '', 'DEPT', '"+ user.getCompNo() +"')                                                  AS reqDept       ");
        ...
        query.append("       , dbo.SFAIDTODESC(x.rec_dept, '', 'DEPT', '"+ user.getCompNo() +"')                                                 AS recDeptDesc   ");
        ...
        query.append("       , dbo.SFACODE_TO_DESC(x.uom, 'UOM', 'USR', x.comp_no,'"+user.getLangId()+"')                                        AS uomDesc       ");
        ...
        query.getOrderByQuery("x.ptpnlist_id","x.ptpnlist_id DESC", maPtReqCommonDTO.getOrderBy(), maPtReqCommonDTO.getDirection());
    ...
    public List selectMaPtPurReqDetail(String id, User user)
    {
        ...
        query.append("      , dbo.SFACODE_TO_DESC(x.ptpnlist_status, 'PTPNLIST_STATUS', 'SYS', '100','ko') AS PTPNLISTSTATUS ");
        query.append("      , ( SELECT                                                                                       ");
