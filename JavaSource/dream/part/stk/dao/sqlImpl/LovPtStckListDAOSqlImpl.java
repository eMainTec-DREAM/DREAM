 ...
 */
public class LovPtStckListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovPtStckListDAO
{
    /**
     * 재고 검색 AC LOV
     * @author  ghlee
			...
			Map<String, String> conditionMap)
    {
        ...
        query.append("      ,c.description+', '+ISNULL(c.pt_size,'')  AS pt_name_size    ");
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(c.part_group, 'PART_GROUP', 'USR', a.comp_no,'"+loginUser.getLangId()+"')      part_group_desc   ");
        query.append("      ,c.pt_abc_class                                              ");
        query.append("      ,dbo.SFACODE_TO_DESC(c.pt_abc_class, 'PT_ABC_CLASS', 'SYS', a.comp_no,'"+loginUser.getLangId()+"')  pt_abc_class_desc ");
        query.append("      ,a.part_grade                                                ");
        query.append("      ,dbo.SFACODE_TO_DESC(a.part_grade, 'PART_GRADE', 'SYS', a.comp_no,'"+loginUser.getLangId()+"')      part_grade_desc   ");
        ...
        query.getOrderByQuery("a.wcode_id","c.part_no, b.wname", lovPtStckListDTO.getOrderBy(), lovPtStckListDTO.getDirection());
    ...
    {        
        ...
        if(!"".equals(lovPtStckListDTO.getFilterQtyCnt())){
        	query.append("AND ISNULL(a.stock_qty,0) >= "+lovPtStckListDTO.getFilterQtyCnt()+"");
        }
