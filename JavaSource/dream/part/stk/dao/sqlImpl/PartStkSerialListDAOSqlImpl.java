 ...
 */
public class PartStkSerialListDAOSqlImpl extends BaseJdbcDaoSupportOra implements PartStkSerialListDAO
{
    /**
     * grid find
     * @author  hyosung
    ...
    public List findSerialList(PartStkSerialListDTO partStkSerialListDTO, User user)
    {
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(a.eq_status,'EQ_STATUS','SYS','','ko')    equipStatus   ");
