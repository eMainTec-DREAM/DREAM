 ...
 */
public class PartStkCurrentDAOOraImpl extends BaseJdbcDaoSupportOra implements PartStkCurrentDAO
{
	...
	public String getOrderBy(PartStkCurrentDTO partStkCurrentDTO, User user) {
		...
		query.getOrderByQuery("a.part_no", partStkCurrentDTO.getOrderBy(), partStkCurrentDTO.getDirection());		
