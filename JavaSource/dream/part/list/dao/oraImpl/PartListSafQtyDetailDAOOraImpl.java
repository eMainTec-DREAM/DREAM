 ...
 */
public class PartListSafQtyDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements PartListSafQtyDetailDAO
{
    ...
    public int insertPtWhEmpDetail(PartListSafQtyDetailDTO partListSafQtyDetailDTO, User user)
    {
    	...
    	query.append("    INSERT (a.comp_no		,a.safty_qty		,a.max_safty_qty        ");
    	query.append("            ,a.part_id    ,a.wcode_id         					)   ");
