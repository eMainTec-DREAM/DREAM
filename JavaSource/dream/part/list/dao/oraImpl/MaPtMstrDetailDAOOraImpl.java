 ...
 */
public class MaPtMstrDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtMstrDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaPtMstrDetailDTO findDetail(MaPtMstrCommonDTO maPtMstrCommonDTO, User loginUser)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.uom, 'UOM', 'USR', x.comp_no,'"+loginUser.getLangId()+"') uomDesc,        ");
        ...
        query.append("       SFACODE_TO_DESC(x.pt_abc_class, 'PT_ABC_CLASS', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') ptAbcClassDesc,");
        ...
        query.append("        SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') periodTypeDesc,          ");
        ...
        //query.append("       SFACODE_TO_DESC(x.is_stock_control,'IS_USE','SYS',x.comp_no,'"+loginUser.getLangId()+"') isStockControl,           ");
        query.append("       SFACODE_TO_DESC(x.part_group, 'PART_GROUP', 'USR', x.comp_no,'"+loginUser.getLangId()+"') partGroupDesc,");
        query.append("       SFACODE_TO_DESC(x.var_class, 'VAR_CLASS', 'USR', x.comp_no,'"+loginUser.getLangId()+"') varClassDesc,");
        query.append("       x.is_asset_stock                            ISASSETSTOCKID   ");
        query.append("      ,SFACODE_TO_DESC(x.is_asset_stock,'IS_USE','SYS',x.comp_no,'"+loginUser.getLangId()+"') ISASSETSTOCKDESC           ");
        query.append("      ,x.erp_part_no                          erpPartNo   ");
        query.append("      , x.currency                          															AS currencyId  		");
        query.append("      , SFACODE_TO_DESC(x.currency, 'CURRENCY', 'SYS', x.comp_no,'"+ loginUser.getLangId() +"') 		AS currencyDesc		");
        query.append("      , x.is_serial_part 																				AS isSerialPartId	");
        query.append("      , SFACODE_TO_DESC(x.is_serial_part, 'IS_USE', 'SYS', x.comp_no,'"+ loginUser.getLangId() +"') 	AS isSerialPartDesc	");
    ...
    public int updateDetail(MaPtMstrDetailDTO maPtMstrDetailDTO, User loginUser)
    {
    	...
    	query.append("	     description    	= NVL(upper(?),'')     				");
    	query.append("     , pt_size        	= NVL(upper(?),'')     				");
        query.append("     , uom            	= ?            						");
    ...
    public int updateEqPartCycle(MaPtMstrDetailDTO maPtMstrDetailDTO, User loginUser)
    {
    	...
    	query.append("    and period_type is null    ");
