 ...
 */
public class PartListImgLinkUrlDAOOraImpl extends BaseJdbcDaoSupportOra implements PartListImgLinkUrlDAO
{
    ...
    { 
        ...
        query.append("    ,(SELECT SFACODE_TO_DESC(a.is_received,'IS_USE','SYS','','"+user.getLangId()+"') FROM DUAL)                           AS isReceivedDesc           ");
        query.append("    ,a.received_time                                                                                                      AS receivedTime             ");
        query.append("    ,a.image_receive_status                                                                                               AS imageReceiveStatus       ");
        query.append("    ,(SELECT SFACODE_TO_DESC(a.image_receive_status,'IMAGE_RECEIVE_STATUS','SYS','','"+user.getLangId()+"') FROM DUAL)    AS imageReceiveStatusDesc   ");
        ...
        query.getOrderByQuery("a.ptimgurl_id", partListImgLinkUrlDTO.getOrderBy(), partListImgLinkUrlDTO.getDirection());
