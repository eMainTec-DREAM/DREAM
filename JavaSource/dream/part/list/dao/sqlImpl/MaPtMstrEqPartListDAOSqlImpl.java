 ...
 */
public class MaPtMstrEqPartListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtMstrEqPartListDAO
{
    /**
     * grid find
     * @author  ssong
...
//        return getJdbcTemplate().queryForList(query.toString());
        query.getOrderByQuery("x.eqpart_id","x.eqpart_id", maPtMstrCommonDTO.getOrderBy(), maPtMstrCommonDTO.getDirection());
