 ...
 */
public class MaPtMstrWoPtHistListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaPtMstrWoPtHistListDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findPtMstrWoPtHistList(MaPtMstrCommonDTO maPtMstrCommonDTO,User user)
    {
        ...
        query.append("    ,CASE WHEN b.wkor_date IS NOT NULL THEN SUBSTRING(b.wkor_date,1,4)+'-'+SUBSTRING(b.wkor_date,5,2)+'-'+SUBSTRING(b.wkor_date,7,2) ELSE b.wkor_date END  AS useDate          ");
        ...
        query.getOrderByQuery("a.wopart_id","b.wkor_date desc", maPtMstrCommonDTO.getOrderBy(), maPtMstrCommonDTO.getDirection());
