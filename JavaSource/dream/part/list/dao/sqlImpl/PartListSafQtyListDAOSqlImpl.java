 ...
 */
public class PartListSafQtyListDAOSqlImpl extends BaseJdbcDaoSupportSql implements PartListSafQtyListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.part_id","x.PART_ID", partListSafQtyListDTO.getOrderBy(), partListSafQtyListDTO.getDirection());
