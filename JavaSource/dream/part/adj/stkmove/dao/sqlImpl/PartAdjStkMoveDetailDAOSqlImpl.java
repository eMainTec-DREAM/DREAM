 ...
 */
public class PartAdjStkMoveDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements PartAdjStkMoveDetailDAO
{
    /**
     * detail find
     * @author ghlee
     ...
     * @return
     */
    public PartAdjStkMoveDetailDTO findDetail(PartAdjStkMoveCommonDTO partAdjStkMoveCommonDTO, User user)
    {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.ptstkmove_status,'PTSTKMOVE_STATUS','SYS','','ko')                 AS ptStkMoveStatusDesc  ");
        ...
        query.append("    ,b.description+', '+ISNULL(b.pt_size,'')                                                  AS ptNameSize           ");
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.part_grade,'PART_GRADE','SYS','','ko')                             AS partGradeDesc        ");
     ...
     * @return
     */
    public int insertDetail(PartAdjStkMoveDetailDTO partAdjStkMoveDetailDTO, User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
     ...
     * @return
     */
    public int updateDetail(PartAdjStkMoveDetailDTO partAdjStkMoveDetailDTO, User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
    ...
    public int insertPtIssHistory(PartAdjStkMoveDetailDTO partAdjStkMoveDetailDTO, String ptIssHistId, String issMode, User user) throws Exception
    {
        ...
        query.append("       y.last_price,   ISNULL(x.move_qty, 0)*ISNULL(y.last_price, 0)");
    ...
    public int executeSpPtOutStock(String ptIssHistId, User user) throws Exception
    {
        ...
        query.append("exec dbo.SP_PT_OUTSTOCK '"+user.getCompNo()+"', '"+ptIssHistId+"' ;  ");
    ...
    public int executeSpPtInStock(String ptRecHistId, User user) throws Exception
    {
        ...
        query.append("exec dbo.SP_PT_INSTOCK '"+user.getCompNo()+"', '"+ptRecHistId+"' ;  ");
