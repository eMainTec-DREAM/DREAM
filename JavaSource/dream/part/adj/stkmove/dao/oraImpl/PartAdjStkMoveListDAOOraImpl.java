 ...
 */
public class PartAdjStkMoveListDAOOraImpl extends BaseJdbcDaoSupportOra implements PartAdjStkMoveListDAO
{
    /**
     * grid find
     * @author  ghlee
    ...
    public List findItemList(PartAdjStkMoveCommonDTO partAdjStkMoveCommonDTO, User user)
    {
        ...
        query.append("    ,CASE WHEN a.move_date IS NOT NULL THEN SUBSTR(a.move_date,1,4)||'-'||SUBSTR(a.move_date,5,2)||'-'||SUBSTR(a.move_date,7,2)   ");
        query.append("             ELSE a.move_date END                                                                 AS moveDate                     ");
        query.append("    ,a.ptstkmove_status                                                                           AS ptStkMoveStatus              ");
        query.append("    ,SFACODE_TO_DESC(a.ptstkmove_status,'PTSTKMOVE_STATUS','SYS','','"+user.getLangId()+"')       AS ptStkMoveStatusDesc          ");
        ...
        query.append("    ,b.description||', '||b.pt_size                                                               AS partNameSize                 ");
        ...
        query.getOrderByQuery("a.ptstkmove_no", partAdjStkMoveCommonDTO.getOrderBy(), partAdjStkMoveCommonDTO.getDirection());
