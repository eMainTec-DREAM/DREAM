 ...
 */
public class PartAdjStkTakeItemListDAOOraImpl extends BaseJdbcDaoSupportOra implements PartAdjStkTakeItemListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findItemList(PartAdjStkTakeCommonDTO partAdjStkTakeCommonDTO, PartAdjStkTakeListDTO partAdjStkTakeListDTO, User user)
    {
        ...
        query.append("      , SFACODE_TO_DESC(x.part_grade,'PART_GRADE','SYS','','"+user.getLangId()+"') AS ptGrade         ");
        query.append("      , x.stock_qty                                                                AS stockQty        ");
        ...
        query.getOrderByQuery("x.ptstktakelist_id DESC", partAdjStkTakeListDTO.getOrderBy(), partAdjStkTakeListDTO.getDirection());
