 ...
 */
public class PartAdjStkTakeDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements PartAdjStkTakeDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public PartAdjStkTakeDetailDTO findDetail(PartAdjStkTakeCommonDTO partAdjStkTakeCommonDTO,User user)
    {
        ...
        query.append("	    SFACODE_TO_DESC(x.ptstktake_status,'PTSTKTAKE_STATUS','SYS','','"+user.getLangId()+"') 			ptStkTakeStatusDesc,	");
...
//        query.append("         AND  a.user_id = x.reg_id) userDesc,              			");
	...
	public int insertPtRecHistory(String ptRecHistId, String recQty, String partGrade,
		 ...
		 query.append("       y.dept_Id,       y.wcode_Id,             TO_CHAR(SYSDATE, 'YYYYMMDD'),   		");
		 query.append("       x.part_id,      x.part_grade,           ? recQty,         		");
		 query.append("       z.last_price,   NVL(?, 0)*NVL(z.last_price, 0) totPrice  		");
    ...
    public int confirmDetail(PartAdjStkTakeDetailDTO partAdjStkTakeDetailDTO, User user) throws Exception
    {
    	...
    	query.append("	act_date				= TO_CHAR(SYSDATE, 'YYYYMMDD')	");
    	query.append("WHERE ptstktakelist_id    = ?		");
    	query.append("  AND comp_no 		    = ?		");
     ...
     * @return
     */
    public int updateItemRecHistory(String ptRecHistId, String issQty, String partGrade,
			PartAdjStkTakeDetailDTO partAdjStkTakeDetailDTO, User loginUser, String ptStkTakeItemId)
    {
    	QueryBuffer query = new QueryBuffer();
