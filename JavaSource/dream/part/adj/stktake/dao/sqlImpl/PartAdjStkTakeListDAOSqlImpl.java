 ...
 */
public class PartAdjStkTakeListDAOSqlImpl extends BaseJdbcDaoSupportSql implements PartAdjStkTakeListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findItemList(PartAdjStkTakeCommonDTO partAdjStkTakeCommonDTO, User user)
    {
        ...
        query.append("        dbo.SFACODE_TO_DESC(x.ptstktake_status,'PTSTKTAKE_STATUS','SYS','','"+user.getLangId()+"')             status,          ");
        ...
        query.getOrderByQuery("x.ptstktakelist_id","x.ptstktakelist_no", partAdjStkTakeCommonDTO.getOrderBy(), partAdjStkTakeCommonDTO.getDirection());
