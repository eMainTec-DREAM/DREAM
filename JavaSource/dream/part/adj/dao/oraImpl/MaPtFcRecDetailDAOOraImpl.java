 ...
 */
public class MaPtFcRecDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaPtFcRecDetailDAO
{
    /**
     * detail find
     * @author ssong
    ...
    public MaPtFcRecDetailDTO findDetail(User user, String fcRecListId)
    {
        ...
        query.append("       SFACODE_TO_DESC(x.fcreclist_status, 'FCRECLIST_STATUS', 'SYS', x.comp_no,'"+user.getLangId()+"') fcRecListStatusDesc, "); 
        ...
        query.append("      , (SELECT SFACODE_TO_DESC(x.part_grade, 'PART_GRADE', 'SYS', x.comp_no, '"+user.getLangId()+"') FROM dual) partGradeDesc		");
    ...
    public int updateGrDate(MaPtFcRecDetailDTO maPtFcRecDetailDTO, String compNo)
    {
        ...
        query.append("UPDATE TAPARTS SET last_gr_date = TO_CHAR(sysdate,'yyyymmdd'),  ");
        query.append("       seller = ?	                        ");
        query.append("WHERE comp_no = ?                         ");
