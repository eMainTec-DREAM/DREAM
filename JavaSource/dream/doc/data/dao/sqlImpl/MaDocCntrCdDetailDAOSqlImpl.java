 ...
 */
public class MaDocCntrCdDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaDocCntrCdDetailDAO
{
    /**
     * detail find
     * @author 
    ...
    public MaDocCntrCdDetailDTO findDetail(MaDocCntrCdCommonDTO maDocCntrCdCommonDTO, User loginUser)
    {
        ...
        query.append("       dbo.SFACODE_TO_DESC(x.doccntr_categ, 'DOCCNTR_CATEG', 'USR', x.comp_no,'"+loginUser.getLangId()+"') docCntrCategDesc, ");
