 ...
 */
public class MaDocCntrCdListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaDocCntrCdListDAO
{
    /**
     * grid find
     * @author  
...
//    	query.append("ORDER  BY doccntr_no                                      			");
        query.getOrderByQuery("x.doccntr_no desc", maDocCntrCdCommonDTO.getOrderBy(), maDocCntrCdCommonDTO.getDirection());
