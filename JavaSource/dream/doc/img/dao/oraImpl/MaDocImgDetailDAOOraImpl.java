 ...
 */
public class MaDocImgDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaDocImgDetailDAO
{
    /**
     * detail find
     * @author jung7126
    ...
    public MaDocImgDetailDTO findDetail(String docId, User user)
    {
        ...
        query.append("        SFAIDTODESC(x.reg_id , '', 'EMP', '"+compNo+"') regDesc,                         ");
...
//                maDocImgDetailDTO.getDocId()
    ...
    public List getImgFileList(String objectId, String objectType, String param)
    {
        ...
        query.append("       ,TO_CHAR(x.imgdata_id) file_name       ");
