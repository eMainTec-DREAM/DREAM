...
/**
 * DocNoticeDept - Detail DAO
 * @author youngjoo38
 * @version $Id$
 * @since 1.0
 *
 */
public interface DocNoticeDeptDetailDAO
{
    /**
     * FIND DETAIL
    ...
    public int insertNotiUsrDetail(DocNoticeCommonDTO docNoticeCommonDTO,DocNoticeDeptDetailDTO docNoticeDeptDetailDTO, User user) throws Exception;
    public int insertNotiUsrAgain(DocNoticeCommonDTO docNoticeCommonDTO,DocNoticeDeptDetailDTO docNoticeDeptDetailDTO, User user) throws Exception;
