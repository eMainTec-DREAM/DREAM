 ...
 */
public class DocNoticeDeptListDAOOraImpl  extends BaseJdbcDaoSupportOra implements DocNoticeDeptListDAO
{

    /**
     * grid find
     * @author  youngjoo38
     * @version $Id: docNoticeDeptListDAO.java,v 1.0 2017/08/22 15:20:12 youngjoo38 Exp $
     * @since   1.0
     * 
    ...
    public List findList(DocNoticeCommonDTO docNoticeCommonDTO, DocNoticeDeptListDTO docNoticeDeptListDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("x.notidept_id", docNoticeCommonDTO.getOrderBy(), docNoticeCommonDTO.getDirection());
    ...
    public String findTotalCount(DocNoticeCommonDTO docNoticeCommonDTO,
            DocNoticeDeptListDTO docNoticeDeptListDTO, User user) throws Exception 
    {
        QueryBuffer query = new QueryBuffer();
