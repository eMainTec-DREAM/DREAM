 ...
 */
public class DocNoticeDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements DocNoticeDetailDAO
{
    ...
    public DocNoticeDetailDTO findDetail(DocNoticeCommonDTO docNoticeCommonDTO, User user) 
    {
        ...
        query.append("  , dbo.SFACODE_TO_DESC(x.notice_status, 'NOTICE_STATUS', 'SYS', x.comp_no, ? ) AS noticeStatus         		");
