 ...
 */
public class DocNoticeListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements DocNoticeListDAO
{
    ...
    public List findList(DocNoticeCommonDTO docNoticeCommonDTO, User user) throws Exception
    {
        ...
        query.append("  , dbo.SFACODE_TO_DESC(x.notice_status, 'NOTICE_STATUS', 'SYS', x.comp_no, '"+user.getLangId()+"') AS NOTICESTATUSDESC");
        ...
        query.getOrderByQuery("x.notice_id DESC", "x.notice_no desc", docNoticeCommonDTO.getOrderBy(), docNoticeCommonDTO.getDirection());
     ...
     * Filter 조건
     * @author  youngjoo38
     * @version $Id: docNoticeListDAO.java,v 1.0 2017/08/22 15:19:40 youngjoo38 Exp $
     * @since   1.0
     * 
     * @param docNoticeCommonDTO
     * @return
