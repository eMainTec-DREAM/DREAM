 ...
 */
public class MaNstGrpDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MaNstGrpDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public MaNstGrpDetailDTO findDetail(MaNstGrpCommonDTO maNstGrpCommonDTO, User loginUser)
    {
        ...
        query.append("SELECT															");
        query.append("		SFAPLANTTODESC('"+loginUser.getCompNo()+"', x.pop_plant) AS popPlantDesc");
    ...
    public int insertDetail(MaNstGrpDetailDTO maNstGrpDetailDTO)
    {
    	...
    	query.append("	)	VALUES											");
    	query.append("	(?,				SQAPOPLNRUNRATE_ID.NEXTVAL,	?,		");
    	query.append("	 ?,				?									");
    	query.append("	)													");
