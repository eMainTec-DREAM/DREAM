 ...
 */
public class MaNstGrpListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaNstGrpListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findNstGrpList(MaNstGrpCommonDTO maNstGrpCommonDTO)
    {
        ...
        query.append("		,dbo.SFAPLANTTODESC('"+maNstGrpCommonDTO.getCompNo()+"', x.pop_plant) as popPlantNo	");
    ...
    {        
        ...
        query.getLikeQuery("dbo.SFAPLANTTODESC('"+maNstGrpCommonDTO.getCompNo()+"',x.pop_plant)", maNstGrpCommonDTO.getFilterPlant());
