 ...
 */
public class MgrLangFailcodeDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrLangFailcodeDAO
{
	...
	private String getOrderBy(MaResCommonDTO maResCommonDTO, User user) {
		...
		query.getOrderByQuery("x.failure_id","x.failure_id", maResCommonDTO.getOrderBy(), maResCommonDTO.getDirection());		
