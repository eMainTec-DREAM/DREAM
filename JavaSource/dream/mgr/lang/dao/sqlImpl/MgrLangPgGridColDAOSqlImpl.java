 ...
 */
public class MgrLangPgGridColDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrLangPgGridColDAO
{
	...
	private String getOrderBy(MaResCommonDTO maResCommonDTO, User user) {
		...
		query.getOrderByQuery("x.pggridcol_id","x.pggridcol_id", maResCommonDTO.getOrderBy(), maResCommonDTO.getDirection());		
