 ...
 */
public class MgrLangSyscodeDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrLangSyscodeDAO
{
	...
	private String getOrderBy(MaResCommonDTO maResCommonDTO, User user) {
		...
		query.getOrderByQuery("x.cdsysd_id", maResCommonDTO.getOrderBy(), maResCommonDTO.getDirection());		
