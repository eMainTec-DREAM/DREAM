 ...
 */
public class MgrLangMenuDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrLangMenuDAO
{
	...
	private String getOrderBy(MaResCommonDTO maResCommonDTO, User user) {
		...
		query.getOrderByQuery("x.menu_no", maResCommonDTO.getOrderBy(), maResCommonDTO.getDirection());		
