 ...
 * @version $Id:$
 * @since   1.0
 * @spring.bean id="mgrLangPgBtnDAOTarget"
 * @spring.txbn id="mgrLangPgBtnDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MgrLangPgBtnDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrLangPgBtnDAO
{
	...
	private String getColums(MaResCommonDTO maResCommonDTO, User user) {
    	...
    	query.append(" , x.button_no                                                        BUTTONID		");
    	...
    	query.append("		AND lang = '"+user.getLangId()+"')     BUTTONDESC    ");
    ...
    {        
		...
		query.append("					AND a.key_type = 'BUTTON')		");
