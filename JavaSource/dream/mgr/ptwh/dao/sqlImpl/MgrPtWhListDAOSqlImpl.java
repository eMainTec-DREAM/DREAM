 ...
 */
public class MgrPtWhListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrPtWhListDAO
{
    ...
    { 
        ...
        query.append("        ,dbo.SFACODE_TO_DESC(wh_type,'WH_TYPE','SYS','','"+user.getLangId()+"') 			AS whTypeDesc	");
        ...
        query.getOrderByQuery("x.wcode_id","x.wcode_id", mgrPtWhCommonDTO.getOrderBy(), mgrPtWhCommonDTO.getDirection());
