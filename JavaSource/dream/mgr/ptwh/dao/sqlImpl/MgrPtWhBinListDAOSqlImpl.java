 ...
 */
public class MgrPtWhBinListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrPtWhBinListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.PTBINLIST_ID","x.PTBINLIST_ID", mgrPtWhBinListDTO.getOrderBy(), mgrPtWhBinListDTO.getDirection());
