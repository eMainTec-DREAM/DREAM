 ...
 */
public class MgrPtWhDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrPtWhDetailDAO
{
    ...
    public MgrPtWhDetailDTO findDetail(MgrPtWhCommonDTO mgrPtWhCommonDTO, User user) 
    {
        ...
        query.append("		,SFACODE_TO_DESC(x.wh_type,'WH_TYPE','SYS','','"+user.getLangId()+"') 				AS whTypeDesc 	");
