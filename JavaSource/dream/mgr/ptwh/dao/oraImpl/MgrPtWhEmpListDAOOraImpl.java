 ...
 */
public class MgrPtWhEmpListDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrPtWhEmpListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.WHUSER_ID", mgrPtWhEmpListDTO.getOrderBy(), mgrPtWhEmpListDTO.getDirection());
