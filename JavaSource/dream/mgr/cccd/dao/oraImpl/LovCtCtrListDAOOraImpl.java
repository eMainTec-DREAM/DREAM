package dream.mgr.cccd.dao.oraImpl;
 ...
 */
public class LovCtCtrListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovCtCtrListDAO
{
    /**
     * CP 검색
     * @author  ssong
    ...
    public List findCtCtrACList(LovCtCtrListDTO lovCtCtrListDTO, User user, Map<String, String> conditionMap)
    {
        ...
        query.getOrderByQuery("x.ctctr_no", lovCtCtrListDTO.getOrderBy(), lovCtCtrListDTO.getDirection());
