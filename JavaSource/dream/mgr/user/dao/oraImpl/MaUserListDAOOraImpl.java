 ...
 */
public class MaUserListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaUserListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("      ,SFAIDTODESC(y.dept_id, '', 'DEPT', x.comp_no)         deptDesc   "); 
        ...
        query.append("      ,SFACODE_TO_DESC(x.menu_display, 'MENU_DISPLAY', 'SYS', x.comp_no,'"+loginUser.getLangId()+"')  menuDisplayDesc ");
        query.append("      ,x.usrgrp_id                                           usrGrpId        ");
        query.append("      ,SFAIDTODESC(x.usrgrp_id, '', 'USRGRP', x.comp_no)     usrGrpName      ");
        ...
        query.append("      ,SFACODE_TO_DESC(x.is_use, 'IS_USE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"')         isUseDesc       ");
        query.append("      ,x.is_monitor                                          isMonitor       ");
        query.append("      ,SFACODE_TO_DESC(x.is_monitor, 'IS_USE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"')         isMonitorDesc       ");
        query.append("      ,x.eqctg_type                                          eqCtgTypeId     ");
        query.append("      ,SFACODE_TO_DESC(x.eqctg_type, 'EQCTG_TYPE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') eqCtgTypeDesc   ");
        query.append("      ,x.shift_type                                          shiftTypeId     ");
        query.append("      ,SFACODE_TO_DESC(x.shift_type, 'SHIFT_TYPE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"') shiftTypeDesc   ");
        ...
        query.append("      ,SFACODE_TO_DESC(x.is_locked, 'IS_USE', 'SYS', x.comp_no,'"+loginUser.getLangId()+"')           isLockedDesc        ");
        query.append("      ,x.filter_usage_dept_id                                 filterUsageDeptId   ");
        query.append("      ,SFAIDTODESC(x.filter_usage_dept_id,'', 'DEPT','100')   filterUsageDeptDesc ");
        ...
        query.append("      ,SFACODE_TO_DESC(x.is_direct, 'IS_USE', 'SYS', x.comp_no,'"+loginUser.getLangId() + "')     isDirectDesc            ");
        ...
        query.getOrderByQuery("user_no", maUserCommonDTO.getOrderBy(), maUserCommonDTO.getDirection());
