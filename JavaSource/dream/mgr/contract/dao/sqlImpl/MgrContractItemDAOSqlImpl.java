 ...
 */
public class MgrContractItemDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrContractItemDAO
{
    /**
     * grid find
     * @author  youngjoo38
	...
	public String getColums(MgrContractItemDTO mgrContractItemDTO, User user) {
		...
		query.append("    , ISNULL(x.amount, (qty*unit_price)) 	amount				");
	...
	public String getOrderBy(MgrContractItemDTO mgrContractItemDTO, User user) {
		...
		query.getOrderByQuery("ISNULL(x.ord_no,x.contractitem_id)", mgrContractItemDTO.getOrderBy(), mgrContractItemDTO.getDirection());		
