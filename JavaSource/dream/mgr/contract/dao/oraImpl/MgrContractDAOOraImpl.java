 ...
 */
public class MgrContractDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrContractDAO
{
    /**
     * grid find
     * @author  youngjoo38
	...
	public String getColums(MgrContractDTO mgrContractDTO, User user) {
		...
		query.append("                TO_CHAR(TO_DATE(x.start_date,'yyyy-mm-dd'),'yyyy-mm-dd') 									");
		query.append("                    || ' ~ ' || 																			");
		query.append("                        TO_CHAR(TO_DATE(x.end_date,'yyyy-mm-dd'),'yyyy-mm-dd')							");
		query.append("          ELSE 																							");
		query.append("                TO_CHAR(TO_DATE(x.start_date,'yyyy-mm-dd'),'yyyy-mm-dd') 									");
		query.append("                    || ' ~ ' 																				");
		query.append("           END )																							");
