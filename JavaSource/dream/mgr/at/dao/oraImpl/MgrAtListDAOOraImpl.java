 ...
 */
public class MgrAtListDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrAtListDAO
{
    /**
     * grid find
     * @author  youngjoo38
    ...
    public List findList(MgrAtCommonDTO mgrAtCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.update_time DESC", mgrAtCommonDTO.getOrderBy(), mgrAtCommonDTO.getDirection());
...
//        query.append("  AND x.file_name != ''                       ");
        ...
        // 변경일자
        query.getAndDateQuery("SUBSTR(x.update_time, 1, 8)", mgrAtCommonDTO.getFilterFromDate(), mgrAtCommonDTO.getFilterToDate());
