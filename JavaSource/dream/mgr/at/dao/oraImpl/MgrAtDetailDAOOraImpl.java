 ...
 */
public class MgrAtDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrAtDetailDAO
{
    public MgrAtDetailDTO findDetail(MgrAtCommonDTO mgrAtCommonDTO, User user) throws Exception
    {
    	...
    	MgrAtDetailDTO mgrAtDetailDTO = 
        		(MgrAtDetailDTO)getJdbcTemplate().query(query.toString(), objects, new MwareExtractor(new MgrAtDetailDTO()));
