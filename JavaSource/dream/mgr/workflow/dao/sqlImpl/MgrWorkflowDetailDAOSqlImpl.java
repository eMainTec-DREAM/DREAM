 ...
 */
public class MgrWorkflowDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrWorkflowDetailDAO
{
    ...
    public MgrWorkflowDetailDTO findWorkflowDetail(MgrWorkflowCommonDTO mgrWorkflowCommonDTO, User user) 
    {
        ...
        query.append(",dbo.SFACODE_TO_DESC(workflow_type, 'WORKFLOW_TYPE', 'SYS', comp_no,'"+user.getLangId()+"') workflowTypeDesc"); 
