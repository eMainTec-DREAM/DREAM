 ...
 */
public class MgrWorkflowListDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrWorkflowListDAO
{
    ...
    { 
        ...
        query.append(",SFACODE_TO_DESC(workflow_type, 'WORKFLOW_TYPE', 'SYS', a.comp_no,'"+user.getLangId()+"') workflowType"); 
        ...
        query.getOrderByQuery("a.wflist_id", mgrWorkflowCommonDTO.getOrderBy(), mgrWorkflowCommonDTO.getDirection());
