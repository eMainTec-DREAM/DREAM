 ...
 */
public class MgrWorkflowPhaseListDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrWorkflowPhaseListDAO
{
    ...
    { 
        ...
        query.append("       ,SFACODE_TO_DESC(approval_type,'APPROVAL_TYPE','SYS','','"+user.getLang()+"')    AS approvalType ");
        query.append("       ,SFACODE_TO_DESC(grade_type,'GRADE_TYPE','SYS','','"+user.getLang()+"')             AS gradeType     ");
        ...
        query.getOrderByQuery("step_num", mgrWorkflowPhaseListDTO.getOrderBy(), mgrWorkflowPhaseListDTO.getDirection());
