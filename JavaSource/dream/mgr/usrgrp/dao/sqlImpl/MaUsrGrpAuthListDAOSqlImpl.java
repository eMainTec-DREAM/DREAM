 ...
 */
public class MaUsrGrpAuthListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaUsrGrpAuthListDAO
{
    /**
     * grid find
     * @author  
...
//        query.append("  AND  1=2                         ");
	...
	public List findUsrGrpPageList(MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
        ...
        query.append("                       ELSE ISNULL((SELECT TOP 1 '1' FROM TAUGPGPGAU b        ");
