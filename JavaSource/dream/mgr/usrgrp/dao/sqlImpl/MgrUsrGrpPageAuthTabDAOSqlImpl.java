 ...
 */
public class MgrUsrGrpPageAuthTabDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrUsrGrpPageAuthTabDAO
{
    @Override
    public List findList(MgrUsrGrpPageAuthTabDTO mgrUsrGrpPageAuthTabDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("a.pgpage_id","a.ord_no", mgrUsrGrpPageAuthTabDTO.getOrderBy(), mgrUsrGrpPageAuthTabDTO.getDirection());
