 ...
 */
public class MgrUsrGrpPageAuthGridColDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrUsrGrpPageAuthGridColDAO
{
    ...
    public String getOrderBy(MgrUsrGrpPageAuthGridColDTO mgrUsrGrpPageAuthGridColDTO, User user)
    {
        ...
        query.getOrderByQuery("x.ord_no", mgrUsrGrpPageAuthGridColDTO.getOrderBy(), mgrUsrGrpPageAuthGridColDTO.getDirection());
