 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="maUsrGrpAuthListDAOTarget"
 * @spring.txbn id="maUsrGrpAuthListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class MaUsrGrpAuthListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaUsrGrpAuthListDAO
{
    /**
     * grid find
     * @author  
    ...
    { 
        ...
        query.append("         AND  a.lang = '"+maUsrGrpCommonDTO.getUserLang()+"') description,             ");
        ...
        //query.append("              AND  y.usrgrp_id ='"+maUsrGrpCommonDTO.getUsrGrpId()+"'), '') ISDELCHECK , ");
        query.append("              AND  y.usrgrp_id ='"+maUsrGrpCommonDTO.getUsrGrpId()+"'), '') AUTHCHECK , ");
...
//        query.append("      MIN(LEVEL) OVER() AS minLvl                     ");
        ...
        if("ANDROID".equals(maUsrGrpCommonDTO.getFilterServiceType())){
        	query.append("AND x.service_type IN ('ANDROID','ANT','BEE','CRICKET') ");
        }else{
        	query.getStringEqualQuery("x.service_type", maUsrGrpCommonDTO.getFilterServiceType());
        }
...
//        query.append("       x.description,                            ");
        ...
        query.append("        WHERE b.pgpage_id = y.pgpage_id          ");
        query.append("            AND b.usrgrp_id = '"+maUsrGrpCommonDTO.getUsrGrpId()+"'),'') auth, ");
        query.append("       'TAB' type,                               ");
        query.append("       y.pgpage_id keyNo,                        ");
        query.append("       x.page_id code,                           ");
        query.append("       y.page_id pCode,                          ");
...
//        query.append("        ) AS description,                         ");
        ...
        query.append("              AND   b.usrgrp_id = '"+maUsrGrpCommonDTO.getUsrGrpId()+"'),'') ISDELCHECK,");
...
//        query.append("  AND  1=2                         ");
     ...
     * @throws Exception
     */
    private String getWhere(MaUsrGrpCommonDTO maUsrGrpCommonDTO)
    {        
        QueryBuffer query = new QueryBuffer();
        
        query.getAndQuery("x.comp_no", maUsrGrpCommonDTO.getFilterCompNo());
    ...
    public int insertMenuAuth(String menu_id, MaUsrGrpCommonDTO maUsrGrpCommonDTO)
    {
        ...
        Object[] objects = new Object[] {
                maUsrGrpCommonDTO.getCompNo(),
                maUsrGrpCommonDTO.getUsrGrpId(),
                menu_id
        };
    ...
    public int deleteMenuAuth(String menu_id, MaUsrGrpCommonDTO maUsrGrpCommonDTO)
    {
        ...
        query.append("WHERE  usrgrp_id   = '"+maUsrGrpCommonDTO.getUsrGrpId()+"'     ");
    ...
    public int chkTabAuth(String keyNo, MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
        ...
        query.getAndQuery("usrgrp_id", maUsrGrpCommonDTO.getUsrGrpId());
	...
	public int chkMenuAuth(String keyNo, MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
        ...
        query.append("WHERE  1=1												");
        query.getAndQuery("comp_no",  maUsrGrpCommonDTO.getCompNo());
        query.getAndQuery("usrgrp_id", maUsrGrpCommonDTO.getUsrGrpId());
	...
	public List findUsrGrpPageList(MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
        ...
        Object[] objects = new Object[] {
        		maUsrGrpCommonDTO.getUserLang(),
        		maUsrGrpCommonDTO.getMenuId(),
        		maUsrGrpCommonDTO.getUsrGrpId(),
        		maUsrGrpCommonDTO.getUsrGrpId(),
        		maUsrGrpCommonDTO.getMenuId()
		};
	...
	@Override
	public int deleteAllPagePageAuth(String pageId, MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
		QueryBuffer query = new QueryBuffer();
	...
	@Override
	public void grantAllPageBtnAuth(String pageId, MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
		QueryBuffer query = new QueryBuffer();
	...
	public List findUsrGrpBtnList(MaUsrGrpCommonDTO maUsrGrpCommonDTO) {
		...
		query.append("           AND  x.lang = ? ) btnDesc								");
		...
		query.append("               AND  k.usrgrp_id = ? ),'') ISDELCHECK 					");
