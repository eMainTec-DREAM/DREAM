 ...
 */
public class MgrUsrGrpPageAuthBtnDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrUsrGrpPageAuthBtnDAO
{
    @Override
    public List findList(MgrUsrGrpPageAuthBtnDTO mgrUsrGrpPageAuthBtnDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("a.button_loc, a.ord_no", mgrUsrGrpPageAuthBtnDTO.getOrderBy(), mgrUsrGrpPageAuthBtnDTO.getDirection());
