 ...
 */
public class MaMailListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaMailListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findMailList(MaMailCommonDTO maMailCommonDTO, User user)
    {
        ...
        query.append("		 dbo.SFACODE_TO_DESC(x.mail_scope_type,'MAIL_SCOPE_TYPE','SYS','','"+user.getLangId()+"') AS mailScopeTypeDesc,	");
        ...
        query.getOrderByQuery("x.mail_list_id","x.mail_list_no", maMailCommonDTO.getOrderBy(), maMailCommonDTO.getDirection());
