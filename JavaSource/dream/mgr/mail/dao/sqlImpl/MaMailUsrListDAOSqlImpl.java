 ...
 */
public class MaMailUsrListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaMailUsrListDAO
{
    /**
     * grid find
     * @author  kim21017
    ...
    public List findUsrList(MaMailCommonDTO maMailCommonDTO, MaMailUsrListDTO maMailUsrListDTO, User user)
    {
        ...
        query.getOrderByQuery("x.mail_usr_id","y.emp_no", maMailUsrListDTO.getOrderBy(), maMailUsrListDTO.getDirection());
