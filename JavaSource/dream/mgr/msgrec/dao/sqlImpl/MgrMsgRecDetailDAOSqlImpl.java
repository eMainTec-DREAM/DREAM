 ...
 */
public class MgrMsgRecDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrMsgRecDetailDAO
{
    ...
    public MgrMsgRecDetailDTO findDetail(MgrMsgRecCommonDTO mgrMsgRecCommonDTO, User user) 
    {
        ...
        query.append("    , dbo.SFACODE_TO_DESC(x.message_object_type, 'MESSAGE_OBJECT_TYPE', 'SYS', x.comp_no, ? ) msgObjTypeDesc		");
        query.append("    , dbo.SFACODE_TO_DESC(x.mail_use, 'IS_USE', 'SYS', x.comp_no, ? )  isMailUseDesc		");
        query.append("    , dbo.SFACODE_TO_DESC(x.sms_use, 'IS_USE', 'SYS', x.comp_no, ? )   isSmsUseDesc		");
        query.append("    , dbo.SFACODE_TO_DESC(x.is_use, 'IS_USE', 'SYS', x.comp_no, ? )    isUseDesc			");
        query.append("    , x.message_object_type   msgObjType		");
