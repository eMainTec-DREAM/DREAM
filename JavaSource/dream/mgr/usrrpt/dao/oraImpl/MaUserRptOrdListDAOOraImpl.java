 ...
 */
public class MaUserRptOrdListDAOOraImpl extends BaseJdbcDaoSupportOra implements MaUserRptOrdListDAO
{
    /**
     * grid find
     * @author  ssong
    ...
    public List findList(MaUserRptCommonDTO maUserRptCommonDTO, User loginUser)
    {
        ...
        query.append("       SFACODE_TO_DESC(sort_type,'SORT_TYPE','SYS','','"+loginUser.getLangId()+"') sortType,		");
