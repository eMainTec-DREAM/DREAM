 ...
 */
public class MaUserRptParamDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaUserRptParamDetailDAO
{
    /**
     * detail find
     * @author ssong
	...
	public MaUserRptParamDetailDTO findDetail(MaUserRptCommonDTO maUserRptCommonDTO, User loginUser)
    {
    	...
    	query.append("       ISNULL(step_num, (SELECT ISNULL(MAX(a.step_num)+1,1) FROM TAUSRRPTWHR a WHERE a.usrrptlist_id = "+maUserRptCommonDTO.getUsrrptlistId()+")) stepNum,       	");
    	query.append("       dbo.SFACODE_TO_DESC(whr_con_operator,'WHR_CON_OPERATOR','SYS','','ko') whrConOperatorDesc,	");
