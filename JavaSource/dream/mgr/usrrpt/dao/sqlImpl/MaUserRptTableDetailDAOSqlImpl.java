 ...
 */
public class MaUserRptTableDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaUserRptTableDetailDAO
{
	/**
     * detail find
     * @author ssong
    ...
    public MaUserRptTableDetailDTO findDetail(MaUserRptCommonDTO maPtMstrCommonDTO, User loginUser)
    {
    	...
    	query.append("		 dbo.SFACODE_TO_DESC(join_type,'JOIN_TYPE','SYS','','"+loginUser.getLangId()+"')	joinTypeDesc,				");			
