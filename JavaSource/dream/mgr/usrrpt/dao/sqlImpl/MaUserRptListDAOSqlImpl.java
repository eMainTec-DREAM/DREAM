 ...
 */
public class MaUserRptListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaUserRptListDAO
{
	/**
     * grid find
     * @author  kim21017
    ...
    public List findMenuList(MaUserRptCommonDTO maUserRptCommonDTO, User loginUser)
    {
        ...
        query.append("		 dbo.SFACODE_TO_DESC(x.usrdata_type,'USRDATA_TYPE','SYS','','"+lang+"')	usrdataType,");
//        query.append("       SFACODE_TO_DESC(x.usrrpt_type,'USRRPT_TYPE','SYS','','"+lang+"')    usrrptType,    	");
        query.append("       title,                                                	");
