 ...
 */
public class MaUserRptParamListDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaUserRptParamListDAO
{
    /**
     * grid find
     * @author  ssong
	 ...
	 public List findList(MaUserRptCommonDTO maUserRptCommonDTO, User loginUser)
	    {
	        ...
	        query.append("       dbo.SFACODE_TO_DESC(whr_con_operator,'WHR_CON_OPERATOR','SYS','','"+loginUser.getLangId()+"') whrConOperator,	");
