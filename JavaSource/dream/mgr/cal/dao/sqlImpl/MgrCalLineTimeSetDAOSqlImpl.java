 ...
 */
public class MgrCalLineTimeSetDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrCalLineTimeSetDAO
{
    /**
     * grid find
     * @author  euna0207
	...
	public String getOrderBy(MgrCalLineTimeSetDTO mgrCalLineTimeSetDTO, User user) {
        ...
        query.getOrderByQuery("a.lnwrklist_id", "a.description", mgrCalLineTimeSetDTO.getOrderBy(), mgrCalLineTimeSetDTO.getDirection());
