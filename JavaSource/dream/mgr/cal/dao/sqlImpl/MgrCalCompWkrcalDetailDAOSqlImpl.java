 ...
 */
public class MgrCalCompWkrcalDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrCalCompWkrcalDetailDAO
{
    /**
     * detail find
     * @author euna0207
    ...
    public void SP_SETDEFAULT_WRKCAL_BYONE(MgrCalCompWkrcalDetailDTO mgrCalCompWkrcalDetailDTO, User user)  throws Exception {
        ...
        query.append("EXEC dbo.SP_SETDEFAULT_WRKCAL_BYONE '"+user.getCompNo()+"',"+user.getUserNo()+", "+mgrCalCompWkrcalDetailDTO.getWrkcalListId()+";  ");
