 ...
 */
public class MgrIntfParamsDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrIntfParamsDAO
{
    public List findList(MgrIntfCommonDTO mgrIntfCommonDTO, User user)
    {
        ...
        query.append("    ,NVL(c.s_field_value,a.s_default_size)    AS srcFieldValue    ");
