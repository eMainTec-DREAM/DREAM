 ...
 */
public class MgrIntfListDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrIntfListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("x.intf_no", mgrIntfCommonDTO.getOrderBy(), mgrIntfCommonDTO.getDirection());
