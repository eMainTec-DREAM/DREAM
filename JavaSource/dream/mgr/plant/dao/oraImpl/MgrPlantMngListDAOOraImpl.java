package dream.mgr.plant.dao.oraImpl;
 ...
 */
public class MgrPlantMngListDAOOraImpl extends BaseJdbcDaoSupportOra implements MgrPlantMngListDAO
{
    /**
     * grid find
     * @author  euna0207
    ...
    public List findPlantList(MgrPlantMngCommonDTO mgrPlantMngCommonDTO, User user)
    {
        ...
        query.getOrderByQuery("x.plant, x.comp_no", mgrPlantMngCommonDTO.getOrderBy(), mgrPlantMngCommonDTO.getDirection());
