 ...
 */
public class LovUsageWrkAcListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovUsageWrkAcListDAO
{
    ...
    { 
        ...
        query.getOrderByQuery("a.description", lovUsageWrkAcListDTO.getOrderBy(), lovUsageWrkAcListDTO.getDirection());
