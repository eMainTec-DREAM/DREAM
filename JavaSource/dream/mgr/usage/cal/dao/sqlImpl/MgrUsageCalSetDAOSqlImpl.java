 ...
 */
public class MgrUsageCalSetDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrUsageCalSetDAO
{
    /**
     * grid find
     * @author  youngjoo38
	...
	public String getColums(MgrUsageCalSetDTO mgrUsageCalSetDTO, User user) {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.lnwrk_create_type,'LNWRK_CREATE_TYPE','SYS','','"+user.getLangId()+"')    			runTimeSettingDesc	");
	...
	public String getOrderBy(MgrUsageCalSetDTO mgrUsageCalSetDTO, User user) {
        ...
        query.getOrderByQuery("a.lnwrklist_id","a.description", mgrUsageCalSetDTO.getOrderBy(), mgrUsageCalSetDTO.getDirection());
     ...
     * Filter 조건
     * @author  youngjoo38
     * @version $Id: MgrUsageCalSetDAO.java,v 1.0 2015/12/02 09:14:12 youngjoo38 Exp $
     * @since   1.0
     * 
     * @param mgrUsageCalSetDTO
     * @return
