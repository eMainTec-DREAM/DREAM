 ...
 */
public class MgrUsageCalSetDayDAOSqlImpl extends BaseJdbcDaoSupportSql implements MgrUsageCalSetDayDAO
{
    /**
     * grid find
     * @author youngjoo38
	...
	public String getOrderBy(MgrUsageCalSetDayDTO mgrUsageCalSetDayDTO, User user) {
        ...
        query.getOrderByQuery("x.lnwrktime_id","x.plant, x.wrk_date, x.eqloc_id", mgrUsageCalSetDayDTO.getOrderBy(), mgrUsageCalSetDayDTO.getDirection());
...
//        query.append("  AND  x.plant= '" + mgrUsageCalSetDayDTO.getPlantId()+ "'		");
//        query.append("  AND  x.eqloc_id= '" + mgrUsageCalSetDayDTO.getLineId()+ "'		");
