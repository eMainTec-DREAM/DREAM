 ...
 */
public class MgrRptLoginLogListDAOSqlImpl  extends BaseJdbcDaoSupportSql implements MgrRptLoginLogListDAO
{
    ...
    public List findList(MgrRptLoginLogCommonDTO mgrRptLoginLogCommonDTO, User user) throws Exception
    {
        ...
        query.getOrderByQuery("a.logincclog_id","a.login_time desc", mgrRptLoginLogCommonDTO.getOrderBy(), mgrRptLoginLogCommonDTO.getDirection());
     ...
     * Filter 조건
     * @author  euna0207
     * @version $Id: mgrRptLoginLogListDAO.java,v 1.0 2018/08/23 15:19:40 euna0207 Exp $
     * @since   1.0
     * 
     * @param mgrRptLoginLogCommonDTO
     * @return
