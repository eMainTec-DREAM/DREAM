package dream.mgr.rpt.cp.dao.sqlImpl;
 ...
 */
public class LovMgrRptCpDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovMgrRptCpDAO
{
    @Override
    public List findList(LovMgrRptCpDTO lovMgrRptCpDTO, User user) throws Exception
    {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.rptfile_type,'RPTFILE_TYPE','SYS','','"+user.getLangId()+"')                   AS RPTFILETYPEDESC  ");
        query.append("    ,ISNULL(a.svr_addr, c.param1)                                                                         AS SVRADDR          ");
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.is_use,'IS_USE','SYS','','"+user.getLangId()+"')                               AS ISUSEDESC        ");
