package dream.login.login.dao.sqlImpl;
 ...
 */
public class LoginDAOSqlImpl extends BaseJdbcDaoSupportSql implements LoginDAO
{
    /**
    ...
    public List findUserInfo(LoginDTO loginDTO)
    {
        ...
        query.append("             and a.usrgrp_id = z.usrgrp_id) usrgrpName,    ");
        ...
        query.append("         (SELECT c.ct_path           			             ");
        query.append("          FROM   TACOMP c                       			 ");
        query.append("          WHERE  c.comp_no = a.comp_no) ctPath,            ");
        ...
        query.append("        ISNULL((SELECT plant                              ");
        ...
        query.append("        ISNULL((SELECT d.description                      ");
        ...
        query.append("          ,ISNULL(a.menu_display,(select top 1 cdsysd_no from tacdsysd where list_type ='MENU_DISPLAY')) menuDisplay       ");
	...
	public String  countNamedUserCnt()
    {
    	...
    	query.append("                           and usrgrp_no not in (select top 1 value$                    ");
	...
	public void insertLoginTryLog(LoginDTO loginDTO, String loginTerminal, String terminalNo, String isSuccess, String paramLog)
	{
		...
		query.append("	)															");
		query.append("VALUES (														");
		query.append("	  NEXT VALUE FOR SQALOGINTRYLOG_ID	, ?								");
		query.append("	, ?							, ?								");
		query.append("	, ?							, ?								");
		query.append("	, ?							, ?								");
		query.append("	, ?							, ?								");
