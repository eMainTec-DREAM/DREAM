 ...
 */
public class MaFinderAcDAOSqlImpl extends BaseJdbcDaoSupportSql implements MaFinderAcDAO
{
            ...
            Map<String, String> conditionParam, Map<String, String> labelMap, String acLength, String lang)
    {
        ...
        for( String key : columnMap.keySet() ){
            ...
            if(!(acLength == "" || acLength == "null"))
            {
                columnName = colSeq == 1? "DISTINCT TOP "+ acLength +" "+ columnName +" ":columnName;
            }
            else
            {
                columnName = colSeq == 1? "DISTINCT("+columnName+")":columnName;
            }
...
//        if(!(acLength == "" || acLength == "null")) query.append("AND rownum <= "+acLength+"                                 ");
            ...
            Map<String, String> conditionParam)
    {
        ...
        String rtnCnt = QuerySqlBuffer.listToString(getJdbcTemplate().queryForList(query.toString()));
    ...
    public List findSysDirDescCode(String sValue, String codeType, User user)
    {
        ...
        query.append("       CDSYSD_NO as code                                  ");
        ...
        query.append("                  )                                       ");
        query.getLikeQuery("dbo.SFACODE_TO_DESC(cdsysd_no,list_type,'SYS','','"+user.getLangId()+"')", sValue);
    ...
    public List findCdsysd(String keySearchVal,Map<String, String> colMap, Map<String, String> conditionParam, String lang, String acLength, User user) {
        ...
        query.append("                          )                                       ");
        query.getLikeQuery("dbo.SFACODE_TO_DESC(cdsysd_no,list_type,'SYS','','"+lang+"')", keySearchVal);
        query.append("ORDER BY  1                                                       ");
    ...
    public List findUser(String keySearchVal,Map<String, String> colMap, Map<String, String> conditionParam, String lang, String acLength, User user) {
        ...
        query.append("SELECT                                                            ");
        query.append("       DISTINCT(ISNULL(x.user_no,'')+','+ISNULL(y.emp_name,'')) AS Zdisplay             ");//First one only For Display
        ...
        if(conditionParam.containsKey("dept_id") && !"".equals(conditionParam.get("dept_id"))) {
            ...
            query.append("SELECT dept_id FROM dbo.SFADEPT_CALL('"+conditionParam.get("comp_no")+"','"+conditionParam.get("dept_id")+"','')");
            query.append(")");
        }
    ...
    public List findEquipment(String keySearchVal, Map<String, String> colMap, Map<String, String> conditionParam,
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.eq_status,'EQ_STATUS','SYS','','"+user.getLangId()+"') AS eqStatusDesc");
    ...
    public List findDept(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("SELECT                                                            ");
        query.append("        CONCAT(x.dept_no, ', ' ,x.description, ', ' ,(SELECT a.description FROM TAPLANT a WHERE a.comp_no = x.comp_no AND a.plant = x.plant)) AS Zdisplay                      ");//First one only For Display
        ...
        query.append("          WHERE a.comp_no=x.comp_no                               ");
        query.append("          AND a.dept_id = x.dept_id                               ");
        query.append("          AND a.is_response='Y') responseBy                       ");
    ...
    public List findEmp(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("                  +'(' + ISNULL((SELECT description FROM TADEPT WHERE comp_no ='"+user.getCompNo()+"' AND dept_id = x.dept_id),'') +')') AS Zdisplay");//First one only For Display
    ...
    @Override
    public List findParts(String keySearchVal, Map<String, String> colMap, Map<String, String> conditionParam,
            String lang, String acLength, User user) {
        ...
        query.append("       ,part_id       AS part_id                                  ");
        query.append("       ,part_no       AS part_no                                  ");
        query.append("       ,description   AS description                              ");
        query.append("       ,full_desc     AS full_desc                                ");
        query.append("       ,maker         AS maker                                    ");
        query.append("       ,model         AS model                                    ");
        query.append("       ,uom           AS uom                                      ");
        query.append("       ,dbo.SFACODE_TO_DESC(x.uom, 'UOM', 'USR', x.comp_no,'"+user.getLangId()+"') AS uom_desc ");
        query.append("       ,plf_type      AS plf_type                                 ");
        query.append("       ,dbo.SFACODE_TO_DESC(plf_type,'PLF_TYPE','SYS','','"+user.getLangId()+"') AS plf_type_desc    ");
        query.append("       ,REPLACE(CONVERT(VARCHAR(50), CAST(last_price AS MONEY), 1) , '.00', '')   AS last_price      ");
        query.append("       ,vendor_code   AS vendor_code                              ");
        query.append("       ,pt_size       AS pt_size                                  ");
        query.append("       ,CONCAT(description,', ',pt_size) AS partNameSize          ");
        ...
        query.append("       ,erp_part_no   AS erp_part_no                              ");
        query.append("       ,seller        AS seller                                   ");
        query.append("       ,dbo.SFACODE_TO_DESC(x.part_group, 'PART_GROUP', 'USR', x.comp_no,'"+user.getLangId()+"')  partGroupDesc       ");
        query.append("       ,currency      AS currency                               	");
        query.append("       ,dbo.SFACODE_TO_DESC(currency,'CURRENCY','SYS','','"+ user.getLangId() +"')	AS currencyDesc	");
        ...
        if(conditionParam.containsKey("eqasmb_id") && (!"".equals(conditionParam.containsKey("eqasmb_id")) || !"".equals(conditionParam.containsKey("eqasmb_desc")) ) )
		{
        	...
        	{
        		query.append("AND exists (   SELECT c.eqasmb_id                             ");
                query.append("                 FROM dbo.SFAEQASMB_CALL('"+user.getCompNo()+"','"+conditionParam.get("eqasmb_id")+"','"+conditionParam.get("eqasmb_desc")+"') c	");
        	...
        	{
        		query.append("AND exists (   SELECT c.eqasmb_id                             ");
                query.append("                 FROM dbo.SFAEQASMB_CALL('"+user.getCompNo()+"','','"+conditionParam.get("eqasmb_desc")+"') c	");
                query.append("                WHERE c.comp_no = b.comp_no            		");
                query.append("            )                                           		");
        	}
        	query.append("           )														");
...
//      query.append("      ,is_serial_part                                         ");
    ...
    public List findLang(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("SELECT                                                            ");
        query.append("       x.key_name                 AS Zdisplay                     ");//First one only For Display
    ...
    public List findPage(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        if(conditionParam.containsKey("menu_id") && !"".equals(conditionParam.get("menu_id"))) {
            ...
            query.append("SELECT page_id FROM dbo.SFAPGPAGEINMENU_ALL('"+conditionParam.get("menu_id")+"')");
            query.append(")");
        }
        query.getAndQuery("is_use", conditionParam);
        query.append("ORDER BY  1                                                       ");
    ...
    public List findCertList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.cert_type,'CERT_TYPE','USR','"+user.getCompNo()+"','"+user.getLangId()+"') AS certTypeDesc");
    ...
    public List findUsrdList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("      ,x.cdusrd_id      ");
        query.append("      ,x.cdusrd_no      ");
        query.append("      ,x.description        ");
        ...
        query.getAndQuery("x.comp_no", conditionParam);
        query.getAndQuery("x.is_use", conditionParam);
        query.append("AND x.cdusrm_id = (SELECT cdusrm_id         ");
...
//        query.append("AND    x.is_standard_eq = 'Y'                         ");
    ...
    public List findEqAsmbList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("SELECT                                                ");
        query.append("       DISTINCT(ISNULL(full_desc,description))        AS Zdisplay         ");
    ...
    public List findInvtPrcphList(String keySearchVal, Map<String, String> columnMap,
        ...
        query.append("SELECT                                            ");
        query.append("       dbo.SFACODE_TO_DESC(y.invt_proc_ltype,'INVT_PROC_LTYPE','USR','"+user.getCompNo()+"','"+lang+"')  +' / '+dbo.SFACODE_TO_DESC(y.invt_proc_stype,'INVT_PROC_STYPE','USR','"+user.getCompNo()+"','"+lang+"') as Zdisplay        ");
        query.append("       ,dbo.SFACODE_TO_DESC(y.invt_proc_stype,'INVT_PROC_STYPE','USR','"+user.getCompNo()+"','"+lang+"')  invtProcStypeDesc   ");
        query.append("       ,dbo.SFACODE_TO_DESC(y.invt_proc_ltype,'INVT_PROC_LTYPE','USR','"+user.getCompNo()+"','"+lang+"')  invtProcLtypeDesc   ");
        ...
        query.append("WHERE  1=1                            ");
        query.getLikeQuery("dbo.SFACODE_TO_DESC(y.invt_proc_ltype,'INVT_PROC_LTYPE','USR','"+user.getCompNo()+"','"+lang+"')+dbo.SFACODE_TO_DESC(y.invt_proc_stype,'INVT_PROC_STYPE','USR','"+user.getCompNo()+"','"+lang+"')", keySearchVal);
    ...
    public List findWoList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(wo_status,'WO_STATUS','SYS','','"+loginUser.getLangId()+"')	AS woStatusDesc	");
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.wo_type,'WO_TYPE','SYS','','"+loginUser.getLangId()+"')             AS woTypeDesc	");
        query.append("       ,dbo.SFACODE_TO_DESC(x.pm_type,x.wo_type+'_TYPE','SYS','','"+loginUser.getLangId()+"')		AS pmTypeDesc	");
        ...
        query.append("         WHERE c.comp_no = x.comp_no                                 			");
        query.append("           AND c.emp_id = y.sub_mng_id) 		AS subMng                       ");
    ...
    public List findAssetList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("       CONVERT(VARCHAR, CONVERT(DATE, acq_Date), 120)  acqDate,       ");
    ...
    public List findPmList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("        ,dbo.SFAIDTODESC(x.dept_id, '', 'DEPT' , '"+loginUser.getCompNo()+"')	AS deptDesc	");
        query.append("        ,(SELECT a.emp_name               	                             	");
        query.append("          FROM   TAEMP a                  	                             	");
        query.append("          WHERE  a.emp_id = x.emp_id)			AS empName						");
        query.append("        ,dbo.SFACODE_TO_DESC(x.pm_type, x.wo_type+'_TYPE', 'SYS', '"+loginUser.getCompNo()+"','"+loginUser.getLangId()+"')		AS pmTypeDesc	");
        query.append("        ,dbo.SFACODE_TO_DESC(x.schedule_type, 'SCHEDULE_TYPE', 'SYS', '"+loginUser.getCompNo()+"','"+loginUser.getLangId()+"')	AS scheduleType	");
        query.append("        ,CONVERT(VARCHAR, x.cycle) + dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+loginUser.getCompNo()+"','"+loginUser.getLangId()+"')	AS cycleDesc	");
        query.append("        ,x.cycle  							AS cycle						");
        query.append("        ,dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+loginUser.getCompNo()+"','"+loginUser.getLangId()+"')	AS periodType	");
    ...
    public List findVendorList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("SELECT                                                    ");
        query.append("       vendor_no+', '+ISNULL(description,'')        AS Zdisplay,                    ");
        ...
        query.getAndQuery("comp_no", conditionParam);
        query.getAndQuery("is_use", conditionParam);
        query.getLikeQuery("vendor_no+ISNULL(description,'')", keySearchVal);
        query.append("ORDER BY  description                                     ");
    ...
    public List findCtCtrList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
        ...
        query.append("SELECT                                                          ");
        query.append("      DISTINCT('('+ctctr_no+')' + description) Zdisplay         ");
        query.append("      ,description                                              ");
        ...
        query.append("WHERE  1 = 1                                                    ");
        query.getLikeQuery("'('+ctctr_no+')' + description", keySearchVal);
        query.getAndQuery("comp_no", conditionParam);
        query.getAndQuery("plant", conditionParam);
        query.getAndQuery("is_use", conditionParam);
 ...
 public List findUsrRptTabList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam,
     ...
     public List findStWrkWorkList(String keySearchVal, Map<String, String> columnMap,
        ...
        query.append("SELECT                                                                                                ");
        query.append("       dbo.SFACODE_TO_DESC(x.wo_type, 'WO_TYPE', 'SYS', x.comp_no, '"+user.getLang()+"')  AS Zdisplay ");
...
//         query.append("        ,issue_date issueDate     ");
            ...
            String lang, String acLength, User user)
    {
        ...
        query.append("      ,dbo.SFACODE_TO_DESC(c.part_group, 'PART_GROUP', 'USR', a.comp_no,'"+user.getLangId()+"')      part_group_desc   ");
        query.append("      ,c.pt_abc_class                                              ");
        query.append("      ,dbo.SFACODE_TO_DESC(c.pt_abc_class, 'PT_ABC_CLASS', 'SYS', a.comp_no,'"+user.getLangId()+"')  pt_abc_class_desc ");
        query.append("      ,a.part_grade                                                ");
        query.append("      ,dbo.SFACODE_TO_DESC(a.part_grade, 'PART_GRADE', 'SYS', a.comp_no,'"+user.getLangId()+"')      part_grade_desc   ");
        ...
        {
        	query.append("AND ISNULL(a.stock_qty,0) >= "+conditionParam.get("stock_qty")+"");
        }
            ...
            User user)
    {
        ...
        query.getAndQuery("y.description", keySearchVal);
            ...
            User user)
    {
        ...
        query.append("SELECT                                                        ");
        query.append("        y.description +','+ ISNULL(y.pt_size,'') Zdisplay        ");
    ...
    @Override
    public List findPartListBinList(String keySearchVal, Map<String, String> columnMap, 
            Map<String, String> conditionParam, String lang, String acLength, User user)
    {
        QuerySqlBuffer query = new QuerySqlBuffer();
            ...
            String lang, String acLength, User user)
    {
        ...
        query.append("    ,x.description    ");
        query.append("    ,dbo.SFACODE_TO_DESC(x.accnt_type,'ACCNT_TYPE','SYS','','"+user.getLangId()+"') accnt_type     ");
            ...
            String lang, String acLength, User user)
    {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(a.ptiss_status,'PTISS_STATUS','SYS','','"+user.getLangId()+"')     AS ptIssStatusDesc      ");
        query.append("    ,(SELECT description FROM TADEPT                                                                                ");
        query.append("      WHERE comp_no = a.comp_no                                                                                     ");
	...
	{       
		...
		query.append("SELECT                                            ");
		query.append("      DISTINCT(dbo.SFACODE_TO_DESC(x.message_object_type, 'MESSAGE_OBJECT_TYPE', 'SYS', '', '"+user.getLangId()+"' )) AS Zdisplay         ");
		...
		query.append("WHERE 1 = 1                                       ");
		query.getLikeQuery("x.message_object_type+dbo.SFACODE_TO_DESC(x.message_object_type, 'MESSAGE_OBJECT_TYPE', 'SYS', '', '"+user.getLangId()+"' )", keySearchVal);
	...
	{       
		...
		query.append("SELECT                                            ");
		query.append("      DISTINCT(x.message_object_type+', '+dbo.SFACODE_TO_DESC(x.message_object_type, 'MESSAGE_OBJECT_TYPE', 'SYS', '', '"+user.getLangId()+"' )) AS Zdisplay         ");
	...
	@Override
	public List findPmUInsAcList(String keySearchVal, Map<String, String> columnMap, Map<String, String> conditionParam, String lang, String acLength, User user)
	{
        QuerySqlBuffer query = new QuerySqlBuffer();
        ...
        query.append("      ,CONVERT(VARCHAR, cycle) + dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+user.getCompNo()+"','"+user.getLangId()+"')	AS cycleDesc	");
        query.append("      ,x.cycle 									AS cycle      			");
        query.append("      ,dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+user.getCompNo()+"','"+user.getLangId()+"')		AS periodType		");
        query.append("      ,x.USAGE									AS usage                ");
        query.append("      ,x.is_active 								AS isActive             ");
        query.append("      ,x.pm_id 									AS pmId                 ");
        query.append("      ,x.pm_type 									AS pmType               ");
