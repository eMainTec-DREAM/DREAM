 ...
 */
public class CommRevHistDetailDAOOraImpl extends BaseJdbcDaoSupportOra implements CommRevHistDetailDAO
{
	/**
     * find detail
     * @author jung7126
    ...
    public CommRevHistDetailDTO findPmDetail(String revisionhistId, User user) throws Exception
    {
    	...
    	query.append("        ,SFACODE_TO_DESC(x.revision_type,'REVISION_TYPE','SYS','',?) 					revisionTypeDesc 	");
    	query.append("        ,x.revision_object_type 														revisionObjType 	");
    	query.append("        ,SFACODE_TO_DESC(x.revision_object_type,'REVISION_OBJECT_TYPE','SYS','',?) 	revisionObjTypeDesc ");
    	...
    	query.append("        ,SFACODE_TO_DESC(x.revision_status,'REVISION_STATUS','SYS','',?) 				revisionStatusDesc 	");
