 ...
 */
public class CommRevDAOOraImpl extends BaseJdbcDaoSupportOra implements CommRevDAO
{
	/**
     * Detail 조희
     * @author jung7126
	...
	public String maxRevNo(CommRevCommonDTO commRevCommonDTO, User user)
	{
		...
		query.append("    AND  x.rev_no IS NOT NULL           ");
		query.append("    ORDER BY TO_NUMBER(x.rev_no) DESC   ");
		query.append(")                                       ");
...
//				,commRevCommonDTO.getObjectNo()
    ...
    @Override
    public void copyAuditTrailObjectId(String newSeq, String id, String compNo,String newTracelogId, String tracelogId)
    {
        QueryBuffer query = new QueryBuffer();
    ...
    @Override
    public void copyAuditTrailDtlObjectId(String newSeq, String id, String compNo, String newTraceLogId, String tracelogId)
    {
        QueryBuffer query = new QueryBuffer();
        
        query.append("INSERT INTO TATRACELOGDTL         ");
        query.append("SELECT sqatracelogdtl_id.NEXTVAL, ?, field_id, field_value    ");
    ...
    @Override
    public void updateEqIdTool(String oldObjectId, String oldNewObjectId, User user)
    {
        QueryBuffer query = new QueryBuffer();
