package intf.dream.bee.woreq.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="beeWoReqListDAOTarget"
 * @spring.txbn id="beeWoReqListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class BeeWoReqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements BeeWoReqListDAO
{
	public List findWoReqList(BeeWoReqCommonDTO beeWoReqCommonDTO,Map map) throws Exception
    {
		String woReqId = CommonUtil.convertString(String.valueOf(map.get("woReqId")));
        ...
        query.append("         ,ISNULL((SELECT x.full_desc FROM TAEQLOC x                                  ");
        ...
        if(!"".equals(woReqId))
        {
        	query.append(this.getWoReqDetailColumn(beeWoReqCommonDTO, map));
        }
        
        query.append("FROM TAWOREQ a                                                                    ");
        query.append("WHERE 1=1                                                                         ");
        
        query.append(this.getWoReqWhere(beeWoReqCommonDTO, map));

        query.getOrderByQuery("a.req_date", "", "");
        
    	
        return getJdbcTemplate().queryForList(query.toString(beeWoReqCommonDTO.getIsLoadMaxCount(), beeWoReqCommonDTO.getFirstRow()));
    } 
	
	private String getWoReqDetailColumn(BeeWoReqCommonDTO beeWoReqCommonDTO, Map map) throws Exception
	{
        ...
        query.append("         ,ISNULL((SELECT x.full_desc FROM TAWKCTR x                                  ");
        query.append("                  WHERE x.comp_no = a.comp_no                                     ");
	...
	private String getWoReqWhere(BeeWoReqCommonDTO beeWoReqCommonDTO,Map map){
	    	...
	    	String isApproval = CommonUtil.convertString(String.valueOf(map.get("isApproval")));
	...
	public List findWoResList(BeeWoReqCommonDTO beeWoReqCommonDTO, Map map) throws Exception
    {
        ...
        if(!"".equals(woReqId))
        {
        	query.append(this.getWoResDetailColumn(beeWoReqCommonDTO, map));
        }
        
        query.append("FROM TAWOREQ a                                                                    ");
        query.append("WHERE 1=1                                                                         ");
        
        query.append(this.getWoResWhere(beeWoReqCommonDTO, map));
	...
	private String getWoResDetailColumn(BeeWoReqCommonDTO beeWoReqCommonDTO, Map map)
	{
		String lang = CommonUtil.convertString(String.valueOf(map.get("lang")));
    	...
    	query.append("		,(SELECT count(*) FROM tadocdata WHERE doc_id IN (SELECT x.doc_id FROM TAOBJDOC x WHERE x.comp_no = a.comp_no 				");
    	query.append("			AND x.object_id = a.woreq_id AND object_type='WOREQ'))	AS PHOTOCNT		");
    	query.append("        ,(SELECT count(1) FROM TAWOREQRES x INNER JOIN TAWORKORDER y        		");
    	query.append("         ON x.comp_no = y.comp_no        											");
    	query.append("         AND x.wkor_id = y.wkor_id          										");
    	query.append("         WHERE x.comp_no = a.comp_no                     							");
    	query.append("         AND x.woreq_id = a.woreq_id        										");
    	query.append("         AND y.wo_type NOT IN ('PMW','PMI','PMC','PM')          )    AS REQRESCNT ");
    	query.append("         ,a.EQDN_START_DATE EQDNSTARTDATE                                         ");
    	query.append("         ,a.EQDN_START_TIME EQDNSTARTTIME                                         ");
	...
	private String getWoResWhere(BeeWoReqCommonDTO beeWoReqCommonDTO, Map map)
	{
		String compNo = CommonUtil.convertString(String.valueOf(map.get("compNo")));
		String lang = CommonUtil.convertString(String.valueOf(map.get("lang")));
    	String startDate = CommonUtil.convertString(String.valueOf(map.get("startDate")));
    	...
    	query.getAndQuery("a.comp_no",compNo);
    	query.append("AND a.plant = '"+plant+"' ");
    	query.append("  AND a.woreq_status IN ("+CommonUtil.getCommaStringFromArray(BeeCommonValues.USED_WORES_STATES, "''")+") ");
    	query.append("  AND a.req_date >= '"+startDate+"'	");
    	query.append("  AND a.req_date <=  '"+endDate+"'	");
        query.getAndQuery("a.woreq_id",woReqId);
    ...
    public List findWoReqResList(Map map) throws Exception
    {
        ...
        query.append("         ,ISNULL((SELECT y.description FROM TADEPT y                 ");
        ...
        query.append("         ,ISNULL((SELECT y.emp_name FROM TAEMP y                     ");
        query.append("                  WHERE y.comp_no = a.comp_no                     ");
        ...
        query.append("AND  b.wo_type NOT IN ('PMW','PMI','PMC','PM')        ");
