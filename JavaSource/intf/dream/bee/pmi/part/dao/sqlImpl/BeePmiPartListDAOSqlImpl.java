package intf.dream.bee.pmi.part.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="beePmiPartListDAOTarget"
 * @spring.txbn id="beePmiPartListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class BeePmiPartListDAOSqlImpl extends BaseJdbcDaoSupportSql implements BeePmiPartListDAO
{
	public List findPmiPartList(BeePmiPartCommonDTO beePmiPartCommonDTO,Map map) throws Exception
    {
        ...
        query.append(this.getPmiPartWithWhere(beePmiPartCommonDTO, map));
        query.append(")																						");
    	...
    	query.append(this.getPmiPartWhere(beePmiPartCommonDTO, map));
    	query.getOrderByQuery("EQLOCORDNO, EQUIPORDNO", "", "");
    	
    	return getJdbcTemplate().queryForList(query.toString(beePmiPartCommonDTO.getIsLoadMaxCount(), beePmiPartCommonDTO.getFirstRow()));
    } 
	...
	private String getPmiPartWithWhere(BeePmiPartCommonDTO beePmiPartCommonDTO, Map map)
	{
	...
	private String getPmiPartWhere(BeePmiPartCommonDTO beePmiPartCommonDTO, Map map)
	{
		String compNo = CommonUtil.convertString(String.valueOf(map.get("compNo")));
    	...
    	String pminsdlistId = CommonUtil.convertString(String.valueOf(map.get("pminsdlistId")));
	...
	public List findPointList(Map map) throws Exception
    {
        ...
        query.append("		,CASE WHEN y.pminsdpointid is null THEN 'P' ELSE 'C' END AS STATUS				");
        query.append("		,dbo.SFACODE_TO_DESC(CASE WHEN y.pminsdpointid is null THEN 'P' ELSE 'C' END,'WO_STATUS','SYS','','"+lang+"')	AS STATUSDESC	");
    	...
    	query.append("						AND object_id = y.pminsdpointid																");
