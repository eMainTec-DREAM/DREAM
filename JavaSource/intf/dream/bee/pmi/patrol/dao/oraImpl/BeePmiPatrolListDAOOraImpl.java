package intf.dream.bee.pmi.patrol.dao.oraImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="beePmiPatrolListDAOTarget"
 * @spring.txbn id="beePmiPatrolListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class BeePmiPatrolListDAOOraImpl extends BaseJdbcDaoSupportOra implements BeePmiPatrolListDAO
{
	public List findPmiPatrolList(BeePmiPatrolCommonDTO beePmiPatrolCommonDTO, Map map) throws Exception
    {
        ...
        query.append(this.getPmiPatrolWithWhere(beePmiPatrolCommonDTO, map));
        query.append("		)																											");
    	...
    	query.append(this.getPmiPatrolWhere(beePmiPatrolCommonDTO, map));
    	
    	return getJdbcTemplate().queryForList(query.toString(beePmiPatrolCommonDTO.getIsLoadMaxCount(), beePmiPatrolCommonDTO.getFirstRow()));
    } 
	...
	private String getPmiPatrolWithWhere(BeePmiPatrolCommonDTO beePmiPatrolCommonDTO, Map map)
	{
	...
	private String getPmiPatrolWhere(BeePmiPatrolCommonDTO beePmiPatrolCommonDTO, Map map)
	{
		String compNo = CommonUtil.convertString(String.valueOf(map.get("compNo")));
    	...
    	String pmptrlrsltlistId = CommonUtil.convertString(String.valueOf(map.get("pmptrlrsltlistId")));
...
public int mergeAbnormalRslt(Map map) {
	...
	public String getInsppoint(Map map)
    {
    	QueryBuffer query = new QueryBuffer();

    	query.append("SELECT pmptrlrsltpoint_id		");
    	query.append("FROM TAPMPTRLRSLTPOINT 		");
    	query.append("WHERE 1=1						");
    	query.append("AND comp_no = ? 				");
    	query.append("AND pmptrlrsltlist_id = ? 	");
