package intf.dream.bee.pmi.day.dao.oraImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="beePmiDayListDAOTarget"
 * @spring.txbn id="beePmiDayListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class BeePmiDayListDAOOraImpl extends BaseJdbcDaoSupportOra implements BeePmiDayListDAO
{
	public List findPmiDayList(BeePmiDayCommonDTO beePmiDayCommonDTO, Map map) throws Exception
    {
        ...
        query.append(this.getPmiDayWithWhere(beePmiDayCommonDTO, map));
        query.append("		)																											");
    	...
    	query.append(this.getPmiDayWhere(beePmiDayCommonDTO, map));
    	query.getOrderByQuery("EQLOCORDNO, EQUIPORDNO", "", "");
    	
    	return getJdbcTemplate().queryForList(query.toString(beePmiDayCommonDTO.getIsLoadMaxCount(), beePmiDayCommonDTO.getFirstRow()));
    } 
	
	private String getPmiDayWithWhere(BeePmiDayCommonDTO beePmiDayCommonDTO, Map map)
	{
	...
	private String getPmiDayWhere(BeePmiDayCommonDTO beePmiDayCommonDTO, Map map)
	{
		String compNo = CommonUtil.convertString(String.valueOf(map.get("compNo")));
...
public int mergeAbnormalRslt(Map map) {
	...
	public String getInsdpoint(Map map)
    {
    	QueryBuffer query = new QueryBuffer();

    	query.append("SELECT pminsdpoint_id		");
    	query.append("FROM TAPMINSDPOINT 		");
    	query.append("WHERE 1=1					");
    	query.append("AND comp_no = ? 			");
    	query.append("AND pminsdlist_id = ? 	");
