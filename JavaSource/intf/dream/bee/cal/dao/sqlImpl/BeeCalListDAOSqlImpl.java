package intf.dream.bee.cal.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="beeCalListDAOTarget"
 * @spring.txbn id="beeCalListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class BeeCalListDAOSqlImpl extends BaseJdbcDaoSupportSql implements BeeCalListDAO
{
	public List findCalList(BeeCalCommonDTO beeCalCommonDTO, Map map) throws Exception
    {
        ...
        query.append(this.getCalListWithWhere(beeCalCommonDTO, map));
        query.append("     )							");
    	...
    	query.append("		,(SELECT top 1 x.description FROM eqInfo x WHERE x.wkor_id = b.wkor_id) 					AS EQUIPDESC	");
        ...
        query.append("		,dbo.SFACODE_TO_DESC(b.calib_corp,'CALIB_CORP','USR',b.comp_no,'"+lang+"')					AS CALIBCORPDESC	");
        query.append("		,b.calib_type 																				AS CALIBTYPE		");
        query.append("		,dbo.SFACODE_TO_DESC(b.calib_type,'CALIB_TYPE','SYS','','"+lang+"')							AS CALIBTYPEDESC	");
        query.append("      ,b.calib_result_status 																		AS CALIBRESULTSTATUS");
        query.append("		,dbo.SFACODE_TO_DESC(b.calib_result_status,'CALIB_RSLT_STATUS','SYS','','"+lang+"')	AS CALIBRESULTSTATUSDESC	");
        if(!"".equals(wkorId))
        {
        	query.append(this.getCalDetailColumn(beeCalCommonDTO, map));
        }
    	...
    	query.append(this.getCalListWhere(beeCalCommonDTO, map));
    	
    	return getJdbcTemplate().queryForList(query.toString(beeCalCommonDTO.getIsLoadMaxCount(), beeCalCommonDTO.getFirstRow()));
    } 
	private String getCalDetailColumn(BeeCalCommonDTO beeCalCommonDTO, Map map)
	{
		QuerySqlBuffer query = new QuerySqlBuffer();
	...
	private String getCalListWithWhere(BeeCalCommonDTO beeCalCommonDTO, Map map)
	{
	...
	private String getCalListWhere(BeeCalCommonDTO beeCalCommonDTO, Map map)
	{
		String compNo = CommonUtil.convertString(String.valueOf(map.get("compNo")));
	...
	public List findCalStdEqList(Map map) throws Exception
    {
        ...
        query.append("			,dbo.SFACODE_TO_DESC(a.sopdoc_no,'CALIB_SOPDOC_NO','USR','"+compNo+"','"+lang+"')	sopdoc_desc	");
	...
	public List findCalGnlValueList(Map map) throws Exception
    {
        ...
        query.append("		   ,dbo.SFACODE_TO_DESC(a.calib_point_type,'CALIB_POINT_TYPE','SYS','','"+lang+"')	AS CALIB_POINT_TYPE_DESC	");
