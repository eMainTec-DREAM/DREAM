package intf.dream.bee.stktake.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="beeStkTakeListDAOTarget"
 * @spring.txbn id="beeStkTakeListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class BeeStkTakeListDAOSqlImpl extends BaseJdbcDaoSupportSql implements BeeStkTakeListDAO
{
	public List findStkTakeList(BeeStkTakeCommonDTO beeStkTakeCommonDTO, Map map) throws Exception
    {
    	...
    	query.append(this.getStkTakeWhere(beeStkTakeCommonDTO, map));
        query.getOrderByQuery("a.description", "", "");
        
        return getJdbcTemplate().queryForList(query.toString(beeStkTakeCommonDTO.getIsLoadMaxCount(), beeStkTakeCommonDTO.getFirstRow()));
    } 
	...
	private String getStkTakeWhere(BeeStkTakeCommonDTO beeStkTakeCommonDTO, Map map)
	{
    	...
    	String ptStkTakeListId = CommonUtil.convertString(String.valueOf(map.get("ptStkTakeListId")));
    	String description = CommonUtil.convertString(String.valueOf(map.get("description")));
