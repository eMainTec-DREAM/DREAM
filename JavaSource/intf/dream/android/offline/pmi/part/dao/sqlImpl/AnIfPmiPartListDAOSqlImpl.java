package intf.dream.android.offline.pmi.part.dao.sqlImpl;
 ...
 */
public class AnIfPmiPartListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AnIfPmiPartListDAO
{
	public List findSchedList(Map map)
    {
    	...
    	query.getStringEqualQuery("b.plant", plant);
    ...
    { 
    	...
    	query.append("AND a.pm_id = b.pm_id								");
    	query.getStringEqualQuery("a.comp_no", compNo);
    	query.getStringEqualQuery("x.plant", plant);
