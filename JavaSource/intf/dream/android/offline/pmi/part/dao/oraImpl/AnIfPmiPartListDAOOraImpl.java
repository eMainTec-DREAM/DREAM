package intf.dream.android.offline.pmi.part.dao.oraImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="anIfPmiPartListDAOTarget"
 * @spring.txbn id="anIfPmiPartListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class AnIfPmiPartListDAOOraImpl extends BaseJdbcDaoSupportOra implements AnIfPmiPartListDAO
{
    ...
    public int saveInsdpoint(Map<String,String> map, String pminsdpointId)
    {
    	...
    	query.append("MERGE INTO TAPMINSDPOINT a																					");
    	...
    	query.append("	INSERT (a.comp_no,			a.pminsdpoint_id,		a.pminsdlist_id,	a.pm_id,	a.pmequip_id,			");
    	query.append("			a.actual_date,		a.pm_point_id,			a.pm_point_rslt_status,	a.result_value,	a.remark		");
    	query.append("			,is_saved																							");
    	query.append("			)																									");
    	query.append("	VALUES (b.comp_no,			?,						b.PMINSDLIST_ID,	b.pm_id,	b.pmequip_id,			");
