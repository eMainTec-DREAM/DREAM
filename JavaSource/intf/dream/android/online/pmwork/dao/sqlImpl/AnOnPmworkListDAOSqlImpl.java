package intf.dream.android.online.pmwork.dao.sqlImpl;
 ...
 */
public class AnOnPmworkListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AnOnPmworkListDAO
{
	public List findPmworkList(Map map) throws Exception
    {
    	...
    	query.append("		,(SELECT top 1 x.location_desc FROM eqInfo x WHERE x.wkor_id = a.wkor_id) 					AS EQLOCDESC	");
    	query.append("		,(SELECT top 1 x.eqloc_desc FROM eqInfo x WHERE x.wkor_id = a.wkor_id) 						AS EQLOCFULLDESC	");
