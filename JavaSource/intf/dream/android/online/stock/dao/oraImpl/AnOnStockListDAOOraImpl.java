package intf.dream.android.online.stock.dao.oraImpl;
 ...
 */
public class AnOnStockListDAOOraImpl extends BaseJdbcDaoSupportOra implements AnOnStockListDAO
{
	...
	public int insertStockLog(Map map) throws Exception
    {
        ...
        query.append(") values(                                  ");
        query.append("     ?                                     ");
        query.append("    ,SQAPTSTOCKADJ_ID.nextval              ");
