package intf.dream.android.online.count.dao.oraImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="anOnCountListDAOTarget"
 * @spring.txbn id="anOnCountListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class AnOnCountListDAOOraImpl extends BaseJdbcDaoSupportOra implements AnOnCountListDAO
{
...
//    	query.getDeptLevelQuery("a.rec_dept_id", deptId, "", compNo);
    	...
    	query.append("AND a.wodaylist_status IN("+CommonUtil.getCommaStringFromArray(CommonValues.USED_WODAILY_STATUS, "''")+")				");
