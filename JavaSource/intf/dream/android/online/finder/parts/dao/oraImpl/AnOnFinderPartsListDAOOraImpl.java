package intf.dream.android.online.finder.parts.dao.oraImpl;
 ...
 */
public class AnOnFinderPartsListDAOOraImpl extends BaseJdbcDaoSupportOra implements AnOnFinderPartsListDAO
{
	public List findPartsList(Map map) throws Exception
    {
        ...
        query.append("		   ,NVL(x.description,'') ||','|| NVL(x.pt_size,'')||','||NVL(x.model,'')||','||NVL(x.maker,'') as description	");
