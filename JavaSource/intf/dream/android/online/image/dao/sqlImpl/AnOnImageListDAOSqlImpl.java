package intf.dream.android.online.image.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="anOnImageListDAOTarget"
 * @spring.txbn id="anOnImageListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class AnOnImageListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AnOnImageListDAO
{
	...
	public String findImgDataPath(Map map) throws Exception {
        ...
        sb.append(QuerySqlBuffer.listToString(getJdbcTemplate().queryForList(query.toString())));
