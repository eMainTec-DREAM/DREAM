 ...
 * @since 1.0
 * 
 * @spring.bean id="anOnWoReqListServiceTarget"
 * @spring.txbn id="anOnWoReqListService"
 * @spring.property name="anOnWoReqListDAO" ref="anOnWoReqListDAO"
 * @spring.property name="maDocLibDetailDAO" ref="maDocLibDetailDAO"
 */
public class AnOnWoReqListServiceImpl implements AnOnWoReqListService
{
    private AnOnWoReqListDAO anOnWoReqListDAO = null;
	...
	public AnOnWoReqListDAO getAnOnWoReqListDAO() {
		return anOnWoReqListDAO;
	}
	public void setAnOnWoReqListDAO(AnOnWoReqListDAO anOnWoReqListDAO) {
		this.anOnWoReqListDAO = anOnWoReqListDAO;
	}
	
	public List findWoReqList(Map map) throws Exception
	{      
		return anOnWoReqListDAO.findWoReqList(map);
	}
	public int deleteWoReq(List list)  throws Exception
	{
		...
		for(Object obj : list){
			Map map = (Map)obj;
			anOnWoReqListDAO.deleteWoReq(map);
		}
		return resultQty;
	}
	public int insertWoReq(List list)  throws Exception
	{
		...
		for(Object obj : list){
			Map map = (Map)obj;
			anOnWoReqListDAO.insertWoReq(map);
		}
		return resultQty;
	}
	public int updateWoReq(List list)  throws Exception
	{
		...
		for(Object obj : list){
			...
			if("Y".equals(CommonUtil.convertString(map.get("isReq")))){
				...
				anOnWoReqListDAO.updateWoReqStatus(map);
				...
				anOnWoReqListDAO.updateWoReq(map);
			}
		}
		return resultQty;
	}
	...
	{      
		return anOnWoReqListDAO.findWoResList(map);
	}
	public int updateWoRes(List list)  throws Exception
	{
		...
		for(Object obj : list){
			...
			anOnWoReqListDAO.updateWoRes(map);
		}
		return resultQty;
	}
	public int deleteWoRes(List list)  throws Exception
	{
		...
		for(Object obj : list){
			Map map = (Map)obj;
			anOnWoReqListDAO.deleteWoRes(map);
		}
		return resultQty;
	}
	...
	{      
		return anOnWoReqListDAO.findWoReqResList(map);
	}
	public int insertWoReqRes(List list)  throws Exception
	{
		...
		for(Object obj : list){
			...
			anOnWoReqListDAO.insertWoReqRes(map);
			anOnWoReqListDAO.updateWoReqStatus(map);
		}
		return resultQty;
	}
	public int updateWoReqRes(List list)  throws Exception
	{
		...
		for(Object obj : list){
			Map map = (Map)obj;
			anOnWoReqListDAO.updateWoReqRes(map);
		}
		return resultQty;
	}
	public int deleteWoReqRes(List list)  throws Exception
	{
		...
		for(Object obj : list){
			Map map = (Map)obj;
			anOnWoReqListDAO.deleteWoReqRes(map);
		}
		return resultQty;
	}
	...
	{      
		List list = anOnWoReqListDAO.findPhotoList(map);
	...
	{      
		...
		for(Object obj : list){
			Map map = (Map)obj;
			List tempList = anOnWoReqListDAO.findPhotoList(map);
	...
	public int insertPhoto(List list, FormFile[] fileList)  throws Exception
	{
		...
		for(Object obj : list){
			Map map = (Map)obj;
			String docId = anOnWoReqListDAO.findDoc(map);
