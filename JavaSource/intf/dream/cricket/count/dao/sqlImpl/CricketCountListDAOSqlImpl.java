package intf.dream.cricket.count.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="cricketCountListDAOTarget"
 * @spring.txbn id="cricketCountListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class CricketCountListDAOSqlImpl extends BaseJdbcDaoSupportSql implements CricketCountListDAO
{
...
//        query.append("AND a.woreq_status IN (SELECT cdsysd_no FROM TACDSYSD WHERE list_type='WOREQ_STATUS' AND param1= 'C')                           ");
		...
		query.append("AND a.wo_status IN ("+CommonUtil.getCommaStringFromArray(CricketCommonValues.USED_WO_STATES, "''")+")	");
    	query.getStringEqualQuery("a.IS_DELETED", "N");
    	query.getStringEqualQuery("b.IS_DELETED", "N");
    	...
    	query.getStringEqualQuery("a.comp_no", compNo);
		query.append("AND a.pm_id IN ( SELECT pm_id FROM eqInfo )	");
    	query.append("AND a.pmsched_status IN ("+CommonUtil.getCommaStringFromArray(CricketCommonValues.USED_INSPECTION_STATES, "''")+")		");
    	query.getStringEqualQuery("a.IS_DELETED", "N");
    	query.getStringEqualQuery("b.IS_DELETED", "N");
    	query.getStringEqualQuery("b.wo_type", "PMI");
    	...
    	query.append("  and a.req_date >= '"+startDate+"'						");
    	query.append("  and a.req_date <=  '"+endDate+"'						");
    	query.append("AND a.ptpnlist_status IN ("+CommonUtil.getCommaStringFromArray(CricketCommonValues.USED_PTPN_STATUS, "''")+")					");
    	...
    	query.append("AND a.wodaylist_status IN("+CommonUtil.getCommaStringFromArray(CricketCommonValues.USED_WODAILY_STATUS, "''")+")				");
