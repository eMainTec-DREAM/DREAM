package intf.dream.cricket.woreq.dao.sqlImpl;
...
import intf.dream.cricket.common_value.CricketCommonValues;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="cricketWoReqListDAOTarget"
 * @spring.txbn id="cricketWoReqListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class CricketWoReqListDAOSqlImpl extends BaseJdbcDaoSupportSql implements CricketWoReqListDAO
{
	...
	public List findWoResList(Map map) throws Exception
    {
        ...
        query.getAndQuery("a.comp_no",compNo);
    	query.append("AND a.plant = '"+plant+"' ");
    	query.append("  AND a.woreq_status IN ("+CommonUtil.getCommaStringFromArray(CricketCommonValues.USED_WORES_STATES, "''")+") ");
    	query.append("  AND a.req_date >= '"+startDate+"'	");
    	query.append("  AND a.req_date <=  '"+endDate+"'	");
        query.getAndQuery("a.woreq_id",woReqId);
