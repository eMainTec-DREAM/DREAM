package intf.dream.cricket.approval.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="cricketApprovalListDAOTarget"
 * @spring.txbn id="cricketApprovalListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class CricketApprovalListDAOSqlImpl extends BaseJdbcDaoSupportSql implements CricketApprovalListDAO {
    public List findApprovalList(Map map) throws Exception {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(x.appr_status,'APPR_STATUS','SYS','','" + lang + "') AS apprStatusDesc  ");
    ...
    public List findApprovalUserList(Map map) throws Exception {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(x.apprusr_action,'APPRUSR_ACTION','SYS','','" + lang + "') AS apprUsrActionDesc  ");
        query.append("    ,x.apprusr_status AS apprUsrStatusId      ");
        query.append("    ,dbo.SFACODE_TO_DESC(x.apprusr_status,'APPRUSR_STATUS','SYS','','" + lang + "') AS apprUsrStatusDesc  ");
        query.append("    ,x.appr_date AS apprDate            ");
        query.append("    ,x.appr_time AS apprTime            ");
        query.append("    ,x.apprusr_type AS apprUsrTypeId        ");
        query.append("    ,dbo.SFACODE_TO_DESC(x.apprusr_type,'APPRUSR_TYPE','SYS','','" + lang + "') AS apprUsrTypeDesc      ");
    ...
    public List findApprovalUserNextNo(Map map) throws Exception {
        ...
        String apprListId = String.valueOf(map.get("apprListId"));
        QuerySqlBuffer query = new QuerySqlBuffer();
        query.append("SELECT MAX(ISNULL(appr_seq,0))+1  AS apprSeq  ");
        query.append("FROM TAAPPRUSR x              ");
        query.append("WHERE 1=1                  ");
        query.append("AND x.comp_no = '" + compNo + "'        ");
        query.getAndNumKeyQuery("x.apprlist_id", apprListId);
    ...
    public int insertApproval(Map map) throws Exception {
        ...
        return this.getJdbcTemplate().update(query.toString(), this.getObject(objects));
    }
    ...
    public List findApprovalLineUserList(Map map) throws Exception {
        ...
        query.append("    ,x.apprline_id AS paarLineId          ");
        query.append("    ,x.appr_seq AS apprSeq              ");
        query.append("    ,x.appr_by AS apprBy              ");
    ...
    public int addApprovalLine(Map map) throws Exception {
        ...
        query.append("       ,(SELECT MAX(ISNULL(a.appr_seq,0))            ");
    ...
    public List findApprovalReadyList(Map map) throws Exception {
        ...
        query.append("    ,dbo.SFACODE_TO_DESC(x.appr_type,'APPR_TYPE','SYS','','" + lang + "') apprTypeDesc          ");
        query.append("    ,x.appr_status AS apprStatusId          ");
        query.append("    ,dbo.SFACODE_TO_DESC(x.appr_status,'APPR_STATUS','SYS','','" + lang + "')  apprStatusDesc      ");
        query.append("    ,y.apprusr_type AS apprUsrTypeId        ");
        query.append("    ,dbo.SFACODE_TO_DESC(y.apprusr_type,'APPRUSR_TYPE','SYS','','" + lang + "')  apprUsrTypeDesc    ");
