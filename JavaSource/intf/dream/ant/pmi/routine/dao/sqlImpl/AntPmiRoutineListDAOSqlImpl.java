package intf.dream.ant.pmi.routine.dao.sqlImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="antPmiRoutineListDAOTarget"
 * @spring.txbn id="antPmiRoutineListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class AntPmiRoutineListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AntPmiRoutineListDAO
{
    ...
    public int saveInspoint(Map<String,String> map, String pminspointId)
    {
		...
		query.append("		FROM TAPMINSPOINT a, @t1 b									");
		query.append("		WHERE 	a.COMP_NO = b.COMP_NO								");
		...
		query.append("			(comp_no,			pminspoint_id,		pminslist_id,	pm_id,	pmequip_id,							");
    	query.append("			actual_date,		pm_point_id,			pm_point_rslt_status,	result_value,	remark			");
    	query.append("			,a.is_saved										)													");
		query.append("		SELECT b.comp_no,			?,					b.PMINSLIST_ID,	b.pm_id,	b.pmequip_id,				");
