package intf.dream.ant.pmi.patrol.dao.oraImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="antPmiPatrolListDAOTarget"
 * @spring.txbn id="antPmiPatrolListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class AntPmiPatrolListDAOOraImpl extends BaseJdbcDaoSupportOra implements AntPmiPatrolListDAO
{
    ...
    public int saveInsppoint(Map<String,String> map, String pmptrlrsltpointId)
    {
    	...
    	query.append("MERGE INTO TAPMPTRLRSLTPOINT a																				");
    	...
    	query.append("	INSERT (a.comp_no,			a.pmptrlrsltpoint_id,	a.pmptrlrsltlist_id,	a.pm_id,	a.pmequip_id,		");
    	query.append("			a.actual_date,		a.pm_point_id,			a.pm_point_rslt_status,	a.result_value,	a.remark		");
    	query.append("			,a.is_saved																							");
    	query.append("			)																									");
    	query.append("	VALUES (b.comp_no,			?,						b.pmptrlrsltlist_id,	b.pm_id,	b.pmequip_id,		");
	...
	public int executeSP_PM_UPDATE_LASTCPLT_DATE(Map map)
    {
        ...
        query.append("begin																				");
        query.append("SP_PM_UPDATE_LASTCPLT_DATE('"+compNo+"', '"+pmId+"','"+pmptrlschedId+"' );		");
        query.append("end;																				");
