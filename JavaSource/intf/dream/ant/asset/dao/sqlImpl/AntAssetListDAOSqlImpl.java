package intf.dream.ant.asset.dao.sqlImpl;
 ...
 */
public class AntAssetListDAOSqlImpl extends BaseJdbcDaoSupportSql implements AntAssetListDAO
{
...
//        		,convertString(map.get("equipCtgId"))
