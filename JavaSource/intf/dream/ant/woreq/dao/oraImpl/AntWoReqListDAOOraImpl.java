package intf.dream.ant.woreq.dao.oraImpl;
 ...
 * @version $Id: $
 * @since   1.0
 * @spring.bean id="antWoReqListDAOTarget"
 * @spring.txbn id="antWoReqListDAO"
 * @spring.property name="dataSource" ref="dataSource"
 */
public class AntWoReqListDAOOraImpl extends BaseJdbcDaoSupportOra implements AntWoReqListDAO
{
	public List findWoReqList(Map map) throws Exception
    {
    	...
    	query.append("  AND a.woreq_status IN ("+CommonUtil.getCommaStringFromArray(AntCommonValues.USED_WORES_STATES, "''")+") ");
    ...
    public int insertWoReqResList(Map map)
    {
        ...
        query.append("      )                                                       ");
        query.append("VALUES (                                                      ");
        query.append("     ?,SQAWOREQRES_ID.nextval,?,to_char(sysdate,'YYYYMMDD'),  ");
        query.append("     ?,?,?,?,                                                 ");
        query.append("     ?,?                                                    ");
        query.append("         )                                                    ");
