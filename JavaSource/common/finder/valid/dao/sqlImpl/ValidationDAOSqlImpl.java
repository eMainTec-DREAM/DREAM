 ...
 */
public class ValidationDAOSqlImpl extends BaseJdbcDaoSupportSql implements ValidationDAO
{
    ...
    public List findSysDirDescCode(String desc, String dirType, User user)
    {
        ...
        query.append("					)										");
        query.append(" AND dbo.SFACODE_TO_DESC(cdsysd_no,list_type,'SYS','','"+user.getLangId()+"') = '"+desc+"'");
    ...
    public String findNextNoVal(String tableName, String columnName, String compNo)
    {
        ...
        if (tableName.equals("TAFAILURE")){  //고장코드는 2자리로 셋팅...
        	query.append("SELECT 																				");
	        query.append("		LTRIM(RTRIM(RIGHT('000' + CONVERT(NVARCHAR, ISNULL(MAX(dbo.is_number("+columnName+")),100) +1), 3))) as nextEqLocNo	");
	        query.append("FROM "+tableName+"																	");
	        query.append("WHERE dbo.TRANSLATE("+columnName+",'x0123456789','x') = ''							");
	        query.getAndQuery("comp_no", compNo);
        }else{
	        query.append("SELECT 																				");
	        query.append("		LTRIM(RTRIM(RIGHT('00000' + CONVERT(NVARCHAR, ISNULL(MAX(dbo.is_number("+columnName+")),10000) +1), 5))) as nextEqLocNo	");
	        query.append("FROM "+tableName+"																	");
	        query.append("WHERE dbo.TRANSLATE("+columnName+",'x0123456789','x') = ''							");
	        query.getAndQuery("comp_no", compNo);
        }
    ...
    public List findPartsDesc(String desc, String expCode,String compNo, String lang)
    {
        ...
        query.append("       CONCAT(description,',',pt_size)     nameSize,            ");
        query.append("       maker maker,										");
        query.append("       model model,										");
        query.append("       plf_type plfType,									");
        query.append("       dbo.SFACODE_TO_DESC(plf_type,'PLF_TYPE','SYS','','"+lang+"') plfTypeDesc,");
...
//        query.append("  AND  x.part_no     like '"+ desc+"%'                        ");
    ...
    public List findEqAssetDesc(String desc, String expCode,String compNo)
    {
        ...
        query.append("       CONVERT(VARCHAR, CONVERT(DATE, acq_date), 23)	acqDate,									");
    ...
    public List findWoNo(String desc, String expCode,String compNo,String expCode2,String expCode3, String lang)
    {
        ...
        query.append("       dbo.SFACODE_TO_DESC(wo_status,'WO_STATUS','SYS','','"+lang+"') AS woStatusDesc,     ");
        ...
        query.append("       (SELECT TOP 1 c.full_desc			                        		");
    ...
    public List findEqDesc(String desc, String expCode,String compNo, String lang)
    {
        ...
        query.append("		dbo.SFACODE_TO_DESC(x.plf_type,'PLF_TYPE','SYS','','"+lang+"')	plfTypeDesc,");
