 ...
 */
public class LovWoListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovWoListDAO
{
    /**
     * 작업 검색
     * @author  kim21017
    ...
    public List findWoList(LovWoListDTO lovWoListDTO, User loginUser)
    {
        ...
        query.append("       ,dbo.SFACODE_TO_DESC(x.wo_status,'WO_STATUS','SYS','','"+loginUser.getLangId()+"')    AS woStatusDesc    		");
        ...
        query.getOrderByQuery("x.wkor_id", "x.wo_no", lovWoListDTO.getOrderBy(), lovWoListDTO.getDirection());
    ...
    {        
      ...
      //작업형태
        ...
        query.getCodeLikeQuery("x.self_vendor_type", "dbo.SFACODE_TO_DESC(x.self_vendor_type,'SELF_VENDOR_TYPE','SYS','','"+loginUser.getLangId()+"')", lovWoListDTO.getSelfVendorType(), lovWoListDTO.getSelfVendorTypeDesc());
        query.getCodeLikeQuery("x.vendor_id", "dbo.SFAIDTODESC(x.vendor_id, '', 'VENDOR', x.comp_no)", lovWoListDTO.getVendorId(), lovWoListDTO.getVendorDesc());
