 ...
 */
public class LovPtIssListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovPtIssListDAO
{
	@Override
	public List findPtIssAcList(LovPtIssListDTO lovPtIssListDTO, User user, Map<String, String> conditionMap) {
        ...
        query.getOrderByQuery("a.ptisslist_id", "a.issue_date desc", lovPtIssListDTO.getOrderBy(), lovPtIssListDTO.getDirection());
