 ...
 */
public class LovInvtListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovInvtListDAO
{
    /**
     * 투자 목록 검색
     * @author  js.lee
    ...
    public List findInvtList(LovInvtListDTO lovInvtListDTO, User user, Map<String, String> conditionMap)
    {
        ...
        query.getOrderByQuery("x.invtlist_id", "x.invtlist_id", lovInvtListDTO.getOrderBy(), lovInvtListDTO.getDirection());
...
//        }
        ...
        query.getCodeLikeQuery("x.invt_categ", "dbo.SFACODE_TO_DESC(invt_categ,'INVT_CATEG','SYS','','"+user.getLangId()+"')",lovInvtListDTO.getFilterInvtCateg(), lovInvtListDTO.getFilterInvtCategDesc());
