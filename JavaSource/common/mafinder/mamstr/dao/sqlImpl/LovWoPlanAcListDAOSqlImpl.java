 ...
 */
public class LovWoPlanAcListDAOSqlImpl extends BaseJdbcDaoSupportSql implements LovWoPlanAcListDAO
{
    /**
     * 작업 검색
     * @author  kim21017
    ...
    public List findWoPlanAcList(LovWoPlanAcListDTO lovWoPlanAcListDTO, User loginUser)
    {
        ...
        query.getOrderByQuery("x.wkor_id", "x.wo_no DESC", lovWoPlanAcListDTO.getOrderBy(), lovWoPlanAcListDTO.getDirection());
    ...
    {        
      ...
      //작업형태
        ...
        query.getCodeLikeQuery("x.self_vendor_type", "dbo.SFACODE_TO_DESC(x.self_vendor_type,'SELF_VENDOR_TYPE','SYS','','"+loginUser.getLangId()+"')", lovWoPlanAcListDTO.getSelfVendorType(), lovWoPlanAcListDTO.getSelfVendorTypeDesc());
        query.getCodeLikeQuery("x.vendor_id", "dbo.SFAIDTODESC(x.vendor_id, '', 'VENDOR', x.comp_no)", lovWoPlanAcListDTO.getVendorId(), lovWoPlanAcListDTO.getVendorDesc());
	...
	public List findWoAcList(LovWoPlanAcListDTO lovWoPlanAcListDTO, User user, Map<String, String> conditionMap) {
        ...
        query.append("       ,x.wo_no 								AS woNo                   		");
        query.append("       ,x.description 						AS woDesc                   	");
        query.append("       ,dbo.SFACODE_TO_DESC(wo_status,'WO_STATUS','SYS','','"+user.getLangId()+"')	AS woStatusDesc	");
        query.append("		 ,z.description							AS equipDesc					");
        query.append("		 ,(SELECT c.full_desc													");
        query.append("		   FROM TAEQLOC c 														");
        query.append("         WHERE c.comp_no = x.comp_no                                 			");
