 ...
 */
public class LovWoPartsListDAOOraImpl extends BaseJdbcDaoSupportOra implements LovWoPartsListDAO
{
	@Override
	public List findWoPartsAcList(LovWoPartsListDTO lovWoPartsListDTO, User loginUser, Map<String, String> conditionMap) {
		...
		query.append("       SFACODE_TO_DESC(y.part_grade,'PART_GRADE','SYS','','"+loginUser.getLangId()+"')  AS partGrade,       		");
        ...
        query.append(this.getWhere(lovWoPartsListDTO,loginUser));
        query.getOrderByQuery("x.wo_no", lovWoPartsListDTO.getOrderBy(), lovWoPartsListDTO.getDirection());
    ...
    {        
        ...
        query.getCodeLikeQuery("x.self_vendor_type", "SFACODE_TO_DESC(x.self_vendor_type,'SELF_VENDOR_TYPE','SYS','','"+loginUser.getLangId()+"')", lovWoPartsListDTO.getSelfVendorType(), lovWoPartsListDTO.getSelfVendorTypeDesc());
        query.getCodeLikeQuery("x.vendor_id", "SFAIDTODESC(x.vendor_id, '', 'VENDOR', x.comp_no)", lovWoPartsListDTO.getVendorId(), lovWoPartsListDTO.getVendorDesc());
