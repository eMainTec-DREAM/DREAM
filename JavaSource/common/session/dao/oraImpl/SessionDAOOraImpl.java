package common.session.dao.oraImpl;
 ...
 */
public class SessionDAOOraImpl extends BaseJdbcDaoSupportOra implements SessionDAO
{
    /**
     * 로그아웃 정보 기록
     * @author  javaworker
    ...
    public void saveLogoutHist(User logoutUser)
    {
        ...
        query.append("SET	logout_time = SYSDATE								");
