...
public class AES256Cipher2 {
	
	public static byte[] ivBytes = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
	private static volatile AES256Cipher2 INSTANCE;
	private static String secretKey   = "12345678901234567890123456789012"; //32bit
	...
	public static AES256Cipher2 getInstance() {
		if(INSTANCE==null){
            synchronized(AES256Cipher2.class){
                if(INSTANCE==null){
                	if(!"".equals(MwareConfig.getAesKey())){
                    	secretKey = MwareConfig.getAesKey();
                	}
                	INSTANCE=new AES256Cipher2();
                }
