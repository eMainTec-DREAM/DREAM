 ...
 */
public class ConfigGaiaDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConfigGaiaDAO
{
    /**
    ...
    public List findAllTabPages()
    {
        ...
        query.append("  AND x.isuse = 'Y'                                   ");
        query.append("ORDER BY x.sfile_id, CONVERT(NUMERIC, x.ord_no)       ");
    ...
    public List findAllMenuPath()
    {
        ...
        query.append("       CONVERT(varchar,p_sdevmenu_id )                                     pMenuId,      ");
        query.append("       CONVERT(varchar,sdevmenu_id )                                        menuId,       ");
