 ...
 */
public class ConfigDAOSqlImpl extends BaseJdbcDaoSupportSql implements ConfigDAO
{
...
//        query.append("       'TAB.'+y.file_name tabPageName,        ");
        ...
        query.append("ORDER BY x.page_id, CONVERT(NUMERIC,x.ord_no)        ");
    ...
    public List findAllMenuPath()
    {
        ...
        query.append("		convert(varchar, p_menu_id)										pMenuId,		");
        query.append("       convert(varchar, menu_id)									menuId,			");
	...
	public List findSysCodes() 
	{
        ...
        query.append("       ,y.lang                            ");
        query.append("       ,REPlACE(REPLACE(REPLACE(y.key_name,CHAR(10),''),CHAR(13),''),CHAR(0),'') AS keyName                   ");
	...
	@Override
	public void saveErrorLog(String errorlogId, String stackTrace, User loginUser,
			String url) {
		QueryBuffer query = new QueryBuffer();
		...
		query.append("    ?,  					  ?,        			");
		query.append("    ?,                      ?,             		");
		query.append("    CONVERT(varbinary(MAX),?),                    ");
	...
	public int updateErrorLog(String errorlogId, String sTstr, User loginUser,
    	...
    	query.append("		 stacktrace_clob	= stacktrace_clob+CONVERT(varbinary(MAX),?)  				");
    ...
    @Override
    public Map<String,String> executeBatch(int stActInt, String auditKey, String fileName,
            Map<String, String> auditMap, User user)
    {
        ...
        if("I".equals(dataCudType) || "U".equals(dataCudType) ||"R".equals(dataCudType)||"P".equals(dataCudType))
        {
            ...
            query.append(" )                                            ");
            query.append("VALUES (                                      ");
            query.append(" format(getdate(),'yyyyMMddHHmmss'),  '"+tracelogId+"',       '"+user.getUserNo()+"',         ");
            ...
            if(!"R".equals(dataCudType))
            {
                ...
                query2.append("VALUES (NEXT VALUE FOR SQATRACELOGDTL_ID, '"+tracelogId+"', ?, ? )                                 ");  
        ...
        else if("D".equals(dataCudType))
        {
            ...
            for(String aKey :delKeys)
            {
                ...
                query.append(" )                                            ");
                query.append("VALUES (                                      ");
                query.append(" CONVERT(VARCHAR(19),GETDATE(),120) ,  '"+tracelogId+"',       '"+user.getUserNo()+"',         ");
                query.append(" '"+user.getEmpNo()+"',               '"+user.getDeptNo()+"', '"+dataCudType+"',              ");
