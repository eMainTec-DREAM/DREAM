 ...
 */
public class ResourceDAOSqlImpl extends BaseJdbcDaoSupportSql implements ResourceDAO
{
    ...
    {
        QuerySqlBuffer buffer = new QuerySqlBuffer();
...
//        buffer.append("     WHERE ISNULL(is_comm_js_use, 'N')= 'N'						  ");
        buffer.append("        ) a                                                    ");
