 ...
 */
public class ConfigConsultDAOOraImpl extends BaseJdbcDaoSupportOra implements ConfigConsultDAO
{
    /**
    ...
    public List findAllMenuPath()
    {
        ...
        query.append("         TO_CHAR(p_ehmenu_id)                                     pMenuId,        ");
        query.append("       TO_CHAR(ehmenu_id)                                         menuId,         ");
