...
//        }
//
//        final boolean noText = this.isEmpty( value );
...
//            // 이설정이 기본설정으로 있으면 wrap-option:wrap 이 안먹는다. 
...
//
//        return this.isEmpty( value ) && emptyStyle;
//    }
//
...
//        cellTarget.setAttribute( "margin-left","3px" );
//        
...
//    {
//        if ( this.isNotEmpty( summaryInformation.getTitle() ) )
//            foDocumentFacade.setTitle( summaryInformation.getTitle() );
//
//        if ( this.isNotEmpty( summaryInformation.getAuthor() ) )
//            foDocumentFacade.setCreator( summaryInformation.getAuthor() );
//
//        if ( this.isNotEmpty( summaryInformation.getKeywords() ) )
//            foDocumentFacade.setKeywords( summaryInformation.getKeywords() );
//
//        if ( this.isNotEmpty( summaryInformation.getComments() ) )
...
//
//        if ( this.isNotEmpty( triplet.fontName ) )
