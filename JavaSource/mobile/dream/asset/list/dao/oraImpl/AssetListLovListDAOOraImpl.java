package mobile.dream.asset.list.dao.oraImpl;
 ...
 */
public class AssetListLovListDAOOraImpl extends BaseJdbcDaoSupportOra implements AssetListLovListDAO
{
    /**
     * 설비 검색
     * @author  ssong
    ...
    public List findEquipList(AssetListLovListDTO assetListLovListDTO, User loginUser)
    {
        ...
        query.append("      SFACODE_TO_DESC(x.eq_status,'EQ_STATUS','SYS','','"+loginUser.getLangId()+"') eqstatus    ");
    ...
    private String getWhere(AssetListLovListDTO assetListLovListDTO, User loginUser)
    {
        ...
        query.getLikeQuery("description", assetListLovListDTO.getSearchText());
