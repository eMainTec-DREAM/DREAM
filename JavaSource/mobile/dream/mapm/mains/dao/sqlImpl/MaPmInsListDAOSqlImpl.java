 ...
 */
public class MaPmInsListDAOSqlImpl extends BaseJdbcDaoSupportOra implements MaPmInsListDAO
{
    /**
     * grid find
     * @author  jung7126
    ...
    public List findList(MaPmInsCommonDTO maPmInsCommonDTO, User user)
    {
        ...
        query.append("        (CASE WHEN z.eqctg_type ='MD'															");
        query.append("          THEN '('+z.old_eq_no+')'+z.description												");
        ...
        query.append("        dbo.SFACODE_TO_DESC(x.schedule_type, 'SCHEDULE_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"') scheduleType,    ");
        query.append("        CONVERT(NVARCHAR,x.CYCLE) + dbo.SFACODE_TO_DESC(x.period_type, 'PERIOD_TYPE', 'SYS', '"+compNo+"','"+user.getLangId()+"') cycleDesc,");
