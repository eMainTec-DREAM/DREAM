package mobile.dream.main.dao.sqlImpl;
 ...
 */
public class MobileMainDAOSqlImpl extends BaseJdbcDaoSupportSql implements MobileMainDAO
{
    /**
     * 해당 유저그륩이 사용가능한
    ...
    public String [][] findMenus(String pMenuId, String userGroup, User loginUser)
    {
        ...
        query.append("FROM    TAMENU x ,  TAUSRGRPMENU y JOIN CTE ct ON x.menu_id = ct.menu_id	");
