 ...
 */
public class GaPgMngDetailDAOSqlImpl extends BaseJdbcDaoSupportSql implements GaPgMngDetailDAO
{
    /**
     * detail find
     * @author kim21017
    ...
    public GaPgMngDetailDTO findDetail(String pageId, User user)
    {
        ...
        query.append("		 dbo.SFACODE_TO_DESC(x.page_type,'PAGE_TYPE','SYS','','"+user.getLangId()+"') pageTypeDesc");
